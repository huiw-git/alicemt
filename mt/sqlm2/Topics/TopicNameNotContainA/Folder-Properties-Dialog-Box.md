...
# Folder Properties Dialog Box
  A folder contains projects and environments in the **SSISDB** catalog. Each folder defines permissions that apply to the contents of the folder. For more information about [!INCLUDE[ssISnoversion](../../Token\Other/ssISnoversion_md.md)] permissions, see [catalog.grant_permission &#40;SSISDB Database&#41;](../Topic/catalog.grant_permission%20\(SSISDB%20Database\).md).  
