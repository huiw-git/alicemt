...
# Placeholder-FeatureSupportedContentfor2016
  This topic provides details of features supported by the different editions of [!INCLUDE[ssCurrent](../../Token\Other/ssCurrent_md.md)].  
  
> [!NOTE]  
>  [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] is available in an Evaluation edition for a 180\-day trial period. For more information, see the [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)][Trial Software Web Site](http://go.microsoft.com/fwlink/?LinkId=190955).  
  
> [!NOTE]  
>  For features supported by Evaluation and Developer editions see the [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Enterprise feature set.  
  
 To navigate to the table for a [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] technology, click on its link:  
...
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|Maximum Compute Capacity Used by a Single Instance \([!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Database Engine\)\*|Operating System maximum|Limited to lesser of 4 Sockets or 16 cores|Limited to lesser of 4 Sockets or 16 cores|Limited to lesser of 4 Sockets or 16 cores|Limited to lesser of 1 Socket or 4 cores|Limited to lesser of 1 Socket or 4 cores|Limited to lesser of 1 Socket or 4 cores|  
...
|Maximum memory utilized \(per instance of [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Database Engine\)|Operating system maximum|128 GB|128 GB|64 GB|1 GB|1 GB|1 GB|  
|Maximum memory utilized \(per instance of [!INCLUDE[ssASnoversion](../../Token\Other/ssASnoversion_md.md)]\)|Operating system maximum|Operating system maximum|64 GB|N\/A|N\/A|N\/A|N\/A|  
|Maximum memory utilized \(per instance of [!INCLUDE[ssRSnoversion](../../Token\Other/ssRSnoversion_md.md)]\)|Operating system maximum|Operating system maximum|64 GB|64 GB|4 GB|N\/A|N\/A|  
|Maximum relational Database size|524 PB|524 PB|524 PB|524 PB|10 GB|10 GB|10 GB|  
  
 \*Enterprise Edition with Server \+ Client Access License \(CAL\) based licensing \(not available for new agreements\) is limited to a maximum of 20 cores per [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] instance. There are no limits under the Core\-based Server Licensing model. For more information, see [Compute Capacity Limits by Edition of SQL Server](../../Topics\TopicNameNotContainA/Compute-Capacity-Limits-by-Edition-of-SQL-Server.md).  
...
|Smart Backup|Yes|Yes|Yes|Yes||||  
 ...
 \*For more information on installing [!INCLUDE[ssCurrent](../../Token\Other/ssCurrent_md.md)] on Server Core, see [Install SQL Server 2016 on Server Core](../../Topics\TopicNameNotContainA/Install-SQL-Server-2016-on-Server-Core.md).  
  
 \*\*This feature is only available for 64\-bit [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)].  
...
|Feature Name|Enterprise|Business Intelligence|Standard|Web|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|[!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] change tracking|Yes|Yes|Yes|Yes|Yes|Yes|Yes|  
...
|[!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Management Studio|Yes|Yes|Yes|Yes|Yes|Yes||  
...
|[!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Agent|Yes|Yes|Yes|Yes||||  
|Microsoft System Center Operations Manager Management Pack|Yes|Yes|Yes|Yes||||  
|Database Tuning Advisor \(DTA\)|Yes|Yes|Yes\*\*|Yes\*\*||||  
|Deploy a [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Database to a Windows Azure VM Wizard|Yes|Yes|Yes|Yes|Yes|Yes|Yes|  
|[!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Data Files in Windows Azure|Yes|Yes|Yes|Yes|Yes|Yes|Yes|  
  
 \*[!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Web, [!INCLUDE[ssExpress](../../Token\Other/ssExpress_md.md)], [!INCLUDE[ssExpress](../../Token\Other/ssExpress_md.md)] with Tools, and [!INCLUDE[ssExpress](../../Token\Other/ssExpress_md.md)] with Advanced Services can be profiled using [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Standard and [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Enterprise editions.  
...
|[!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Utility control point|Yes|||||||  
|Contained Databases|Yes|Yes|Yes|Yes|Yes|Yes|Yes|  
|Buffer Pool Extension\*\*|Yes|Yes|Yes|||||  
...
|Feature Name|Enterprise|Business Intelligence|Standard|Web|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|[!INCLUDE[msCoName](../../Token\Other/msCoName_md.md)] Visual Studio Integration|Yes|Yes|Yes|Yes|Yes|Yes|Yes|  
|Intellisense \([!INCLUDE[tsql](../../Token\Other/tsql_md.md)] and MDX\)|Yes|Yes|Yes|Yes|Yes|Yes|Yes|  
|[!INCLUDE[ssBIDevStudioFull](../../Token\Other/ssBIDevStudioFull_md.md)]|Yes|Yes|Yes|Yes|Yes|||  
...
|[!INCLUDE[tsql](../../Token\Other/tsql_md.md)] endpoints|Yes|Yes|Yes|Yes||||  
...
|-------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|[!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Import and Export Wizard|Yes|Yes|Yes|Yes|Yes|Yes|Yes|  
...
> [!NOTE]  
>  -   [!INCLUDE[ssMDSshort](../../Token\Other/ssMDSshort_md.md)] is available on the 64\-bit editions of Business Intelligence and Enterprise only.  
...
|[!INCLUDE[ssGemini](../../Token\Other/ssGemini_md.md)] Gallery|Yes|Yes||||||  
|[!INCLUDE[ssGemini](../../Token\Other/ssGemini_md.md)] Data Refresh|Yes|Yes||||||  
|[!INCLUDE[ssGemini](../../Token\Other/ssGemini_md.md)] Data Feeds|Yes|Yes||||||  
...
|Feature Name|Enterprise|Business Intelligence|Standard|Web|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|Supported catalog DB [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] edition|Standard or higher|Standard or higher|Standard or higher|Web|Express|||  
|Supported data source [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] edition|All   [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] editions|All [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] editions|All [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] editions|Web|Express|||  
...
|Alerting\*\*|Yes|Yes||||||  
|[!INCLUDE[ssCrescent](../../Token\Other/ssCrescent_md.md)]\*\*|Yes|Yes||||||  
  
 \*For more information on the supported datasources in [!INCLUDE[ssRSCurrent](../../Token\Other/ssRSCurrent_md.md)], see [Data Sources Supported by Reporting Services &#40;SSRS&#41;](../../Topics\TopicNameNotContainA/Data-Sources-Supported-by-Reporting-Services--SSRS-.md).  
  
 \*\*Requires [!INCLUDE[ssRSnoversion](../../Token\Other/ssRSnoversion_md.md)] in SharePoint mode. For more information, see [Install Reporting Services SharePoint Mode](../../Topics\TopicNameNotContainA/Install-Reporting-Services-SharePoint-Mode.md).  
...
##  <a name="BIClients"></a> Business Intelligence Clients  
 The following software client applications are available on the Microsoft Downloads center and are provided to assist you with creating business intelligence documents that run on a [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] instance. When you host these documents in a server environment, use an edition of [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] that is supported for that document type. The following table identifies which [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] edition contains the server features required to host the documents created in these client applications.  
  
|Feature Name|Enterprise|Business Intelligence|Standard|Web|Express with Advanced Services|Express with Tools|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|[!INCLUDE[ssRBnoversion](../../Token\Other/ssRBnoversion_md.md)]|Yes|Yes|Yes|||||  
|Data Mining Addins for Excel and Visio 2010|Yes|Yes|Yes|||||  
|[!INCLUDE[ssGeminiClient](../../Token\Other/ssGeminiClient_md.md)] 2010|Yes|Yes||||||  
|[!INCLUDE[ssMDSshort](../../Token\Other/ssMDSshort_md.md)] [!INCLUDE[ssMDSXLS](../../Token\Other/ssMDSXLS_md.md)]|Yes|Yes||||||  
  
> [!NOTE]  
>  1.  [!INCLUDE[ssGeminiClient](../../Token\Other/ssGeminiClient_md.md)] is an Excel addin and does not depend on [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)]. However [!INCLUDE[ssGeminiShort](../../Token\Other/ssGeminiShort_md.md)] is required for sharing and collaborating with [!INCLUDE[ssGemini](../../Token\Other/ssGemini_md.md)] workbooks in SharePoint and this capability is available as part of [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] Enterprise and Business Intelligence editions.  
> 2.  The above table identifies the [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] editions that are required to enable these client tools; however these features can access data hosted on any edition of [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)].  
