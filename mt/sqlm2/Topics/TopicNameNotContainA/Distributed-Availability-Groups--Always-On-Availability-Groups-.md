---
title: Distributed Availability Groups (Always On Availability Groups)
ms.custom: na
...
# Distributed Availability Groups (Always On Availability Groups)
 ...
 ![AlwaysOn Distributed Availability Groups](../../Images\Image\ImageNotContaina/AlwaysOn_Distributed_Availability_Groups.png "AlwaysOn_Distributed_Availability_Groups")  
...
> [!NOTE]  
>  The **LISTENER\_URL** specifies the listener for each availability group along with the database mirroring endpoint of the availability group. In this example, that is port `5022` \(not port `60173` used to create the listener\).  
...
## Distributed Availability Group tasks  
 This section provides additional information on managing and using Distributed Availability Groups.  
