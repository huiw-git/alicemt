...
|EXECUTE|CLR types, external scripts, procedures \([!INCLUDE[tsql](../../Token\Other/tsql_md.md)] and CLR\), scalar and aggregate functions \([!INCLUDE[tsql](../../Token\Other/tsql_md.md)] and CLR\), and synonyms|  
...
|RECEIVE|[!INCLUDE[ssSB](../../Token\Other/ssSB_md.md)] queues|  
...
##  <a name="_permissions"></a> SQL Server Permissions  
 The following table provides a complete list of [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] permissions. [!INCLUDE[ssSDS](../../Token\Other/ssSDS_md.md)] permissions are only available for base securables that are supported. Server level permissions cannot be granted in [!INCLUDE[ssSDS](../../Token\Other/ssSDS_md.md)], however in some cases database permissions are available instead.  
...
|DATABASE|ALTER ANY COLUMN ENCRYPTION KEY|ALCK<br /><br /> Applies to [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] \([!INCLUDE[ssSQL15](../../Token\Other/ssSQL15_md.md)] through current\), [!INCLUDE[ssSDS](../../Token\Other/ssSDS_md.md)].|SERVER|CONTROL SERVER|  
|DATABASE|ALTER ANY COLUMN MASTER KEY|ALCM<br /><br /> Applies to [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] \([!INCLUDE[ssSQL15](../../Token\Other/ssSQL15_md.md)] through current\), [!INCLUDE[ssSDS](../../Token\Other/ssSDS_md.md)].|SERVER|CONTROL SERVER|  
|DATABASE|ALTER ANY CONTRACT|ALSC|SERVER|CONTROL SERVER|  
|DATABASE|ALTER ANY DATABASE AUDIT|ALDA|SERVER|ALTER ANY SERVER AUDIT|  
|DATABASE|ALTER ANY DATABASE DDL TRIGGER|ALTG|SERVER|CONTROL SERVER|  
|DATABASE|ALTER ANY DATABASE EVENT NOTIFICATION|ALED|SERVER|ALTER ANY EVENT NOTIFICATION|  
|DATABASE|ALTER ANY DATABASE EVENT SESSION|AADS<br /><br /> Applies to [!INCLUDE[ssSDS](../../Token\Other/ssSDS_md.md)].|SERVER|ALTER ANY EVENT SESSION|  
|DATABASE|ALTER ANY DATABASE SCOPED CONFIGURATION|ALDC<br /><br /> Applies to [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] \([!INCLUDE[ssSQL15](../../Token\Other/ssSQL15_md.md)] through current\), [!INCLUDE[ssSDS](../../Token\Other/ssSDS_md.md)].|SERVER|CONTROL SERVER|  
...
|DATABASE|ALTER ANY MASK|AAMK<br /><br /> Applies to [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] \([!INCLUDE[ssSQL15](../../Token\Other/ssSQL15_md.md)] through current\).|SERVER|CONTROL SERVER|  
|DATABASE|ALTER ANY MESSAGE TYPE|ALMT|SERVER|CONTROL SERVER|  
|DATABASE|ALTER ANY REMOTE SERVICE BINDING|ALSB|SERVER|CONTROL SERVER|  
|DATABASE|ALTER ANY ROLE|ALRL|SERVER|CONTROL SERVER|  
|DATABASE|ALTER ANY ROUTE|ALRT|SERVER|CONTROL SERVER|  
|DATABASE|ALTER ANY SCHEMA|ALSM|SERVER|CONTROL SERVER|  
|DATABASE|ALTER ANY SECURITY POLICY|ALSP<br /><br /> Applies to [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] \([!INCLUDE[ssSQL15](../../Token\Other/ssSQL15_md.md)] through current\), [!INCLUDE[ssSDS](../../Token\Other/ssSDS_md.md)].|SERVER|CONTROL SERVER|  
...
|DATABASE|EXECUTE ANY EXTERNAL SCRIPT|EAES<br /><br /> Applies to [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] \([!INCLUDE[ssSQL15](../../Token\Other/ssSQL15_md.md)] through current\).|SERVER|CONTROL SERVER|  
|DATABASE|INSERT|IN|SERVER|CONTROL SERVER|  
|DATABASE|KILL DATABASE CONNECTION|KIDC<br /><br /> Only applies to [!INCLUDE[ssSDS](../../Token\Other/ssSDS_md.md)]. Use ALTER ANY CONNECTION in [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)].|SERVER|ALTER ANY CONNECTION|  
|DATABASE|REFERENCES|RF|SERVER|CONTROL SERVER|  
|DATABASE|SELECT|SL|SERVER|CONTROL SERVER|  
|DATABASE|SHOWPLAN|SPLN|SERVER|ALTER TRACE|  
|DATABASE|SUBSCRIBE QUERY NOTIFICATIONS|SUQN|SERVER|CONTROL SERVER|  
|DATABASE|TAKE OWNERSHIP|TO|SERVER|CONTROL SERVER|  
|DATABASE|UNMASK|UMSK<br /><br /> Applies to [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] \([!INCLUDE[ssSQL15](../../Token\Other/ssSQL15_md.md)] through current\).|SERVER|CONTROL SERVER|  
|DATABASE|UPDATE|UP|SERVER|CONTROL SERVER|  
|DATABASE|VIEW ANY COLUMN ENCRYPTION KEY DEFINITION|VWCK<br /><br /> Applies to [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] \([!INCLUDE[ssSQL15](../../Token\Other/ssSQL15_md.md)] through current\), [!INCLUDE[ssSDS](../../Token\Other/ssSDS_md.md)].|SERVER|VIEW SERVER STATE|  
|DATABASE|VIEW ANY COLUMN MASTER KEY DEFINITION|vWCM<br /><br /> Applies to [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] \([!INCLUDE[ssSQL15](../../Token\Other/ssSQL15_md.md)] through current\), [!INCLUDE[ssSDS](../../Token\Other/ssSDS_md.md)].|SERVER|VIEW SERVER STATE|  
...
> [!NOTE]  
>  You cannot grant, deny, or revoke permissions to sa, dbo, the entity owner, information\_schema, sys, or yourself.  
...
### A. Returning the complete list of grantable permissions  
 The following statement returns all [!INCLUDE[ssDE](../../Token\Other/ssDE_md.md)] permission by using the `fn_builtin_permissions` function. For more information, see [sys.fn_builtin_permissions &#40;Transact-SQL&#41;](../Topic/sys.fn_builtin_permissions%20\(Transact-SQL\).md).  
