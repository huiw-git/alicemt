...
|**TSQL Global Cursor**|Only the [!INCLUDE[tsql](../../Token\Other/tsql_md.md)] global cursor information.|  
|**TSQL Local Cursor**|Only the [!INCLUDE[tsql](../../Token\Other/tsql_md.md)] local cursor information.|  
