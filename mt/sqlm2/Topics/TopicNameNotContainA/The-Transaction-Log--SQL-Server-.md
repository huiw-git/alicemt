...
|5|DATABASE\_MIRRORING|Database mirroring is paused, or under high\-performance mode, the mirror database is significantly behind the principal database. \(Full recovery model only\)<br /><br /> For more information, see [Database Mirroring &#40;SQL Server&#41;](../../Topics\TopicNameNotContainA/Database-Mirroring--SQL-Server-.md).|  
