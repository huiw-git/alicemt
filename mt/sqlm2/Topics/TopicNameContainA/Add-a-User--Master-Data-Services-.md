---
title: Add a User (Master Data Services)
ms.custom: na
...
# Add a User (Master Data Services)
  Add a user to the **Users** list in [!INCLUDE[ssMDSmdm](../../Token\Other/ssMDSmdm_md.md)] to begin the process of assigning permission to the Web application. Before a user in the list can access [!INCLUDE[ssMDSmdm](../../Token\Other/ssMDSmdm_md.md)], you must give the user permission to one or more functional areas and model objects.  
...
3.  Type the user's name preceded by the Active Directory domain name or by the server computer's name, as in *domain*\\*user\_name* or *computer\\user\_name*.  
