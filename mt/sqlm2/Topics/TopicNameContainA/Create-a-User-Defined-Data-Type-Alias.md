...
# Create a User-Defined Data Type Alias
  This topic describes how to create a new user-defined data type alias in [!INCLUDE[ssCurrent](../../Token\Other/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Token\Other/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Token\Other/tsql_md.md)].  
...
7.  In the **Binding** area, complete the **Default** or **Rule** boxes if you want to bind a default or rule to the new data type alias. Defaults and rules cannot be created in [!INCLUDE[ssManStudioFull](../../Token\Other/ssManStudioFull_md.md)]. Use [!INCLUDE[tsql](../../Token\Other/tsql_md.md)]. Example code for creating defaults and rules are available in Template Explorer.  
