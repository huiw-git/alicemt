 ...
 **Enable Data Collection**  
 Select to enable data collection. This has the same effect as running the sp\_syscollector\_enable\_collector stored procedure. Clearing this check box disables data collection and has the same effect as running the sp\_syscollector\_disable\_collector stored procedure.  
