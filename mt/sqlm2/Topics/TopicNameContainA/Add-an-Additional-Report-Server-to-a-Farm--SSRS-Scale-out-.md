...
-   \(4\) Represents a software or hardware network load balancing solution \(NLB\)  
 ...
 ![Adding a Reporting Services application server](../../Images\Image\ImageContaina/rs_SharePointScale.gif "rs_SharePointScale")  
