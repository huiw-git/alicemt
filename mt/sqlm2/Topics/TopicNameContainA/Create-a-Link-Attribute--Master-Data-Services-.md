...
# Create a Link Attribute (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Token\Other/ssMDSshort_md.md)], create a link attribute when you want users to enter a hyperlink as an attribute value, such as http:\/\/www.contoso.com.  
