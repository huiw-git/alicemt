...
-   Specify backup information with the stored procedure [sp_addsubscription &#40;Transact-SQL&#41;](../Topic/sp_addsubscription%20\(Transact-SQL\).md). For more information about the parameters required by **sp\_addsubscription**, see [Initialize a Transactional Subscription from a Backup &#40;Replication Transact-SQL Programming&#41;](../../Topics\TopicNameContainA/Initialize-a-Transactional-Subscription-from-a-Backup--Replication-Transact-SQL-Programming-.md).  
