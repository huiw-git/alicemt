...
1.  In [!INCLUDE[ssBIDevStudioFull](../../Token\Other/ssBIDevStudioFull_md.md)], on the **Mining Models** tab of Data Mining Designer, right\-click the name of the mining model on which you want to enable drillthrough, and select **Properties**.  
...
1.  In [!INCLUDE[ssBIDevStudioFull](../../Token\Other/ssBIDevStudioFull_md.md)], on the **Mining Structure** tab of Data Mining Designer, right\-click the name of the mining structure.  
