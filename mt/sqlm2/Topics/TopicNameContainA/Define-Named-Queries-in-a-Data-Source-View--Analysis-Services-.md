 ...
 **Note** When defining a named query that queries a [!INCLUDE[ssVersion2000](../../Token\Other/ssVersion2000_md.md)] or [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] 7.0 data source, a named query that contains a correlated subquery and a GROUP BY clause will fail. For more information, see [Internal Error with SELECT Statement Containing Correlated Subquery and GROUP BY](http://support.microsoft.com/kb/274729) in the [!INCLUDE[msCoName](../../Token\Other/msCoName_md.md)] Knowledge Base.  
  
## Add or Edit a Named Query  
  
1.  In [!INCLUDE[ssBIDevStudioFull](../../Token\Other/ssBIDevStudioFull_md.md)], open the project or connect to the database that contains the data source view in which you want to add a named query.  
