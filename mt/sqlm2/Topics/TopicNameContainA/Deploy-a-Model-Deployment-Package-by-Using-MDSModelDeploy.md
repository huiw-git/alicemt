...
# Deploy a Model Deployment Package by Using MDSModelDeploy
  In [!INCLUDE[ssMDSshort](../../Token\Other/ssMDSshort_md.md)], use the MDSModelDeploy tool to deploy a package that contains either:  
  
-   Model objects only.  
  
-   Model objects and data.  
  
 If you want to deploy a package that contains model objects only, you can use the model deployment wizard in the [!INCLUDE[ssMDSmdm](../../Token\Other/ssMDSmdm_md.md)] web application instead. For more information, see [Deploy a Model Deployment Package by Using the Wizard](../../Topics\TopicNameContainA/Deploy-a-Model-Deployment-Package-by-Using-the-Wizard.md).  
  
> [!IMPORTANT]  
>  Packages can be deployed to the edition of [!INCLUDE[ssNoVersion](../../Token\Other/ssNoVersion_md.md)] they were created in only. This means that packages created in [!INCLUDE[ssSQL11](../../Token\Other/ssSQL11_md.md)] cannot be deployed to [!INCLUDE[ssSQL14](../../Token\Other/ssSQL14_md.md)] or higher.  
