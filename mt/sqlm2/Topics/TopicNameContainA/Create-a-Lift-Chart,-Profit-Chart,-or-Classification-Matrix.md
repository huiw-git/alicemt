...
# Create a Lift Chart, Profit Chart, or Classification Matrix
  You can create an accuracy chart for an [!INCLUDE[ssASnoversion](../../Token\Other/ssASnoversion_md.md)] data mining model in five basic steps:  
...
1.  On the **Mining Accuracy Chart** tab of Data Mining Designer in [!INCLUDE[ssBIDevStudioFull](../../Token\Other/ssBIDevStudioFull_md.md)], click the **Input Selection** tab.  
