...
-   Save the dataset directly to the report server or SharePoint site.  
 ...
 Use Report Designer in [!INCLUDE[ssBIDevStudioFull](../../Token\Other/ssBIDevStudioFull_md.md)] to do the following tasks:  
...
1.  Open Report Builder. The **New report or dataset pane** opens, as shown in the following figure:  
     ...
     ![rs_NewSharedDataset](../../Images\Image\ImageNotContaina/rs_NewSharedDataset.gif "rs_NewSharedDataset")  
