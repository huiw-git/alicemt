...
1.  Optionally, return to high-performance mode by using one of the following methods:  
    ...
    -   In [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)]: Use [ALTER DATABASE](../Topic/ALTER%20DATABASE%20Database%20Mirroring%20\(Transact-SQL\).md) to set transaction safety to OFF.  
