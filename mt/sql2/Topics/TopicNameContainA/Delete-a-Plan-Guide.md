...
---
# Delete a Plan Guide
  You can delete (drop) a plan guide in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/includes/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)]. Using [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)], you can also delete all of the plan guides in a database.  
