...
# Create a Database Mail Profile
  Use either the **Database Mail Configuration Wizard** or [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] to create Database Mail public and private profiles.  
...
-   In Object Explorer, connect to the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] instance you want to configure Database Mail on, and expand the server tree.  
...
-   Connect to the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] instance.  
