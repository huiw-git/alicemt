---
title: Save a Shortcut Query File (MDS Add-in for Excel)
H1: na
ms.custom: na
...
# Save a Shortcut Query File (MDS Add-in for Excel)
  In the [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/includes/ssMDSshort_md.md)][!INCLUDE[ssMDSXLS](../../Topics/TopicNameContainA/includes/ssMDSXLS_md.md)], save a shortcut query file when you frequently need to access the same set of data.  
