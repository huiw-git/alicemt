...
# Querying Data in a System-Versioned Temporal Table
 ...
 To perform any type of time-based analysis, use the new  **FOR SYSTEM_TIME** clause with four temporal-specific sub-clauses to query data across the current and history tables. For more information on these clauses, see [Temporal Tables](../../Topics/TopicNameNotContainA/Temporal-Tables.md) and [FROM &#40;Transact-SQL&#41;](../Topic/FROM%20\(Transact-SQL\).md)  
