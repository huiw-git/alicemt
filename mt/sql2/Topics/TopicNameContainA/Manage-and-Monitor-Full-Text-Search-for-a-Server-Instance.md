...
|--------------|-----------------|--------------|  
|**IsFullTextInstalled**|Whether the full-text component is installed with the current instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)].|[FULLTEXTSERVICEPROPERTY](../Topic/FULLTEXTSERVICEPROPERTY%20\(Transact-SQL\).md)<br /><br /> [SERVERPROPERTY](../Topic/SERVERPROPERTY%20\(Transact-SQL\).md)|  
||||  
