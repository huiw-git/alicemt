---
title: Create a Shared Dataset or Embedded Dataset (Report Builder and SSRS)
H1: na
ms.custom: na
...
-   Save the dataset directly to the report server or SharePoint site.  
 ...
 Use Report Designer in [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameContainA/includes/ssBIDevStudioFull_md.md)] to do the following tasks:  
...
1.  Open Report Builder. The **New report or dataset pane** opens, as shown in the following figure:  
     ...
     ![rs_NewSharedDataset](../../Topics/TopicNameContainA/media/rs_NewSharedDataset.gif "rs_NewSharedDataset")  
