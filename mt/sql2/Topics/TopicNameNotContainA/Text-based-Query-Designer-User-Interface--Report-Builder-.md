...
#### Example  
 ...
 When you enter the table name Person.ContactType, it is the equivalent of creating the [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statement `SELECT * FROM Person.ContactType`.  
