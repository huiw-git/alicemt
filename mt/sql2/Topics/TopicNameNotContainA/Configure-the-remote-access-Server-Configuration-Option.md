...
> [!IMPORTANT]  
>  [!INCLUDE[ssNoteDepNextDontUse](../../Topics/TopicNameNotContainA/includes/ssNoteDepNextDontUse_md.md)] Use [sp_addlinkedserver](../Topic/sp_addlinkedserver%20\(Transact-SQL\).md) instead.  
