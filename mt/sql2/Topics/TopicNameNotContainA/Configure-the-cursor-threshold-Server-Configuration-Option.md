...
-   [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] does not support generating keyset-driven or static [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] cursors asynchronously. [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] cursor operations such as OPEN or FETCH are batched, so there is no need for the asynchronous generation of [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] cursors. [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] continues to support asynchronous keyset-driven or static application programming interface (API) server cursors where low latency OPEN is a concern, due to client round trips for each cursor operation.  
