 ...
 **Connect All**  
 Click only if every instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] to which you need to connect is running as a service in the same user account.  
