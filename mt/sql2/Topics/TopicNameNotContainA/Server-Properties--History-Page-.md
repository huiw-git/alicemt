...
# Server Properties (History Page)
  Use this [!INCLUDE[ssRSnoversion_md](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] page in [!INCLUDE[ssManStudioFull_md](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)] to set a default value for the number of copies of report history to retain. The default value provides an initial setting that establishes report history limits for all reports. You can vary these settings for individual reports.  
