...
-   **Configure the subscriber database to support replication to memory-optimized tables**  
     ...
     Set the **@memory_optimized** property  to **true**, by using [sp_addsubscription &#40;Transact-SQL&#41;](../Topic/sp_addsubscription%20\(Transact-SQL\).md) or [sp_changesubscription &#40;Transact-SQL&#41;](../Topic/sp_changesubscription%20\(Transact-SQL\).md).  
