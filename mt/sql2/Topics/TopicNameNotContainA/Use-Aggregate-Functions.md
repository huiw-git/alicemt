...
##  <a name="AggFunction"></a> Aggregate Functions  
 ...
 The following table lists the aggregation functions in [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/includes/ssASnoversion_md.md)], and describes both the additivity and expected output of the function.  
