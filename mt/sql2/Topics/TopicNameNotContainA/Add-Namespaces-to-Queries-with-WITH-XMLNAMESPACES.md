...
```  
 ...
 This is the result. SQLXML users are familiar with this XML template. For more information, see [SQLXML 4.0 Programming Concepts](../Topic/SQLXML%204.0%20Programming%20Concepts.md).  
