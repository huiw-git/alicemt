...
# Managing Logins, Users, and Schemas How-to Topics
  This page provides links to topics that show you how to manage [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] logins, database users, and database schemas, as well as how to join a role and grant permissions to a principal.  
