...
# Differential Backups (SQL Server)
  This backup and restore topic is relevant for all [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] databases.  
...
##  <a name="Overview"></a> Overview of Differential Backups  
 ...
 ![Differential bitmap identifies changed extents](../../Topics/TopicNameNotContainA/media/BnR_How_Diff_Backups_Work.gif "BnR_How_Diff_Backups_Work")  
