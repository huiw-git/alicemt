...
3.  In Query Editor, type and execute a [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statement, such as the following:  
...
1.  In [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/includes/ssManStudio_md.md)], on the **Tools** menu, click **Options**.  
