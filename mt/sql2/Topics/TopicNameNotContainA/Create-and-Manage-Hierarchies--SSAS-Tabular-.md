---
title: Create and Manage Hierarchies (SSAS Tabular)
H1: na
ms.custom: na
...
# Create and Manage Hierarchies (SSAS Tabular)
  Hierarchies can be created and managed in the model designer, in Diagram View. To view the model designer in Diagram View, in [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameContainA/includes/ssBIDevStudioFull_md.md)], click the **Model** menu, then point to **Model View**, and then click **Diagram View**.  
