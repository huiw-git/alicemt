...
##  <a name="bkmk_create_subscription"></a> General requirements for subscriptions  
 The content in this topic explains how to create subscriptions on a native mode report server using [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] Report Manager. After you define a subscription, you can access it in Report Manager through the My Subscriptions page or the **Subscriptions** tab of a specific report.  
...
2.  Navigate to the report you want to subscribe to. Click the report menu and click **Subscribe**.  
     ...
     ![report menu](../../Topics/TopicNameNotContainA/media/ssrs_report_menu_report_manager.png "ssrs_report_menu_report_manager")  
...
10. Select a priority from the **Priority** list box. In [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)] Exchange, this setting sets a flag for the importance level of the e-mail message.  
