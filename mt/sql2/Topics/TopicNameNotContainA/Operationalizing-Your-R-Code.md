...
-   **Interact with R scripts using [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)].** Application and database developers, as well as analysts who author reports, can invoke an R script by calling it from a system stored procedure.  
