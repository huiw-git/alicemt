 ...
 **Destination Custom Properties**  
 ...
 The [!INCLUDE[vstecado](../../Topics/TopicNameContainA/includes/vstecado_md.md)] destination has both custom properties and the properties common to all data flow components.  
  
 The following table describes the custom properties of the [!INCLUDE[vstecado](../../Topics/TopicNameContainA/includes/vstecado_md.md)] destination. All properties are read/write. These properties are not available in the **ADO NET Destination Editor**, but can be set by using the **Advanced Editor**.  
