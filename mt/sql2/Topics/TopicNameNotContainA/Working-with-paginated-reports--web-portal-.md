...
2.  Select **Paginated Report**.  
    ...
    ![ssRSWebPortal-new-report](../../Topics/TopicNameNotContainA/media/ssRSWebPortal-new-report.png)  
...
1.  Select the **ellipse (…)** for the dataset you want to manage.  
    ...
    ![ssRSWebPortal-manage-report1](../../Topics/TopicNameNotContainA/media/ssRSWebPortal-manage-report1.png)  
  
2.  Select **Manage** which will take you to the edit screen.  
    
    ![ssRSWebPortal-manage-report2](../../Topics/TopicNameNotContainA/media/ssRSWebPortal-manage-report2.png)  
...
![ssRSWebPortal-report-properties](../../Topics/TopicNameNotContainA/media/ssRSWebPortal-report-properties.png)  
...
![ssRSWebPortal-report-parameters](../../Topics/TopicNameNotContainA/media/ssRSWebPortal-report-parameters.png)  
   
## Data Source  
You can point to a shared data source, or enter connection information for a custom data source.  
  
![ssRSWebPortal-report-datasource](../../Topics/TopicNameNotContainA/media/ssRSWebPortal-report-datasource.png)  
...
![ssRSWebPortal-report-subscription1](../../Topics/TopicNameNotContainA/media/ssRSWebPortal-report-subscription1.png)  
...
![ssRSWebPortal-report-caching1](../../Topics/TopicNameNotContainA/media/ssRSWebPortal-report-caching1.png)  
   
Selecting **Cache Copies of this report and use them when available** will present you with some more options.  
  
![ssRSWebPortal-report-caching2](../../Topics/TopicNameNotContainA/media/ssRSWebPortal-report-caching2.png)  
...
![ssRSWebPortal-report-caching3](../../Topics/TopicNameNotContainA/media/ssRSWebPortal-report-caching3.png)  
