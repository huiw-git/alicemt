...
# How Permissions Are Determined (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/includes/ssMDSshort_md.md)], the simplest way to configure security is to assign model object permissions to a group that the user is a member of.  
...
## Permissions assigned to a single group or user  
 ...
 ![mds_conc_security_no_overlap](../../Topics/TopicNameNotContainA/media/mds_conc_security_no_overlap.gif "mds_conc_security_no_overlap")  
...
-   Any nodes at higher levels that do not have permissions assigned are implicitly denied.  
 ...
 ![mds_conc_inheritance_hierarchy](../../Topics/TopicNameNotContainA/media/mds_conc_inheritance_hierarchy.gif "mds_conc_inheritance_hierarchy")  
...
## Permissions assigned to multiple groups  
 ...
 ![mds_conc_security_group_overlap](../../Topics/TopicNameNotContainA/media/mds_conc_security_group_overlap.gif "mds_conc_security_group_overlap")  
