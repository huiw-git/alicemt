...
# Performance Tuning for Oracle Publishers
  The Oracle publishing architecture is similar to the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)][!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] publishing architecture; therefore the first step in tuning Oracle replication for performance requires following the general tuning recommendations found in [Enhance General Replication Performance](../../Topics/TopicNameNotContainA/Enhance-General-Replication-Performance.md).  
