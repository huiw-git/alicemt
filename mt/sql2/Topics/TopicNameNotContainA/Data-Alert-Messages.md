 ...
 **Results message**  
 ...
 ![Data alert e-mail message with results](../../Topics/TopicNameNotContainA/media/rs_AlertMessageResults.gif "rs_AlertMessageResults")  
  
 **Error message**  
  
 ![Data alert message with error message](../../Topics/TopicNameNotContainA/media/rs_AlertMessageErrror.gif "rs_AlertMessageErrror")  
