 ...
 **Use full-text indexing**  
 This check box is checked and disabled because full-text indexing is always enabled in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/includes/ssCurrent_md.md)]. For more information, see [Full-Text Search](../../Topics/TopicNameNotContainA/Full-Text-Search.md).  
 ...
 **File Type**  
 ...
 To add files (containers) to a Filestream data filegroup, FILESTREAM must be enabled. You can enable FILESTREAM by using the [Server Properties (Advanced Page)](../../Topics/TopicNameNotContainA/Server-Properties--Advanced-Page-.md) dialog box.  
 ...
 **Path**  
 ...
 For FILESTREAM files, the path is a folder. The [!INCLUDE[ssDEnoversion](../../Topics/TopicNameContainA/includes/ssDEnoversion_md.md)] will create the underlying files in this folder.  
 ...
 **Remove**  
 ...
 For information about files, see [Database Files and Filegroups](../../Topics/TopicNameNotContainA/Database-Files-and-Filegroups.md).  
