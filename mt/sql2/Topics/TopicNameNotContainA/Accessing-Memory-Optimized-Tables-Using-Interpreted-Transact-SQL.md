...
Starting with [!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/includes/ssSQL15_md.md)], queries in interpreted [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] can scan memory-optimized tables in parallel, instead of just in serial mode.
...
For more information about table hints, see. [Table Hints &#40;Transact-SQL&#41;](../Topic/Table%20Hints%20\(Transact-SQL\).md). The SNAPSHOT was added to support [!INCLUDE[hek_2](../../Topics/TopicNameContainA/includes/hek_2_md.md)].  
