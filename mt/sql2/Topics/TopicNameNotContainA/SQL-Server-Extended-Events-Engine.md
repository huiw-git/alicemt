...
# SQL Server Extended Events Engine
  The [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] Extended Events engine is a collection of services and objects that:  
...
-   Maintain a list of Extended Events sessions and manage access to that list.  
 ...
 ![Detailed extended events architecture](../../Topics/TopicNameNotContainA/media/xeArchitectureDetailed.gif "xeArchitectureDetailed")  
