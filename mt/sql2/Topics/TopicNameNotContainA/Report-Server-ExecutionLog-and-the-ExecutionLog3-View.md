...
##  <a name="bkmk_sharepoint"></a> Configuration Settings for a SharePoint mode Report Server  
 You can turn report execution logging on or off from the system settings of a [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] service application.  
...
2.  Click the name of the [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] service application you want to configure.  
...
1.  From the **System Settings** page of your [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] services application, find the **User-defined** section.  
...
-   **ExternalImages**  
     ...
     Added in [!INCLUDE[ssSQL11](../../Topics/TopicNameContainA/includes/ssSQL11_md.md)]  
