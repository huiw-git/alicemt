...
# Control Transaction Durability
  [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] transaction commits can be either fully durable, the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] default, or delayed durable (also known as lazy commit).    
...
-   Your system cannot tolerate any data loss.     
    See the section [When can I lose data?](../../Topics/TopicNameNotContainA/Control-Transaction-Durability.md#bkmk_DataLoss) for information on when you can lose some of your data.    
...
-   Transaction durability is guaranteed only following a flush of the in-memory transaction log to disk. The in-memory transaction log is flushed to disk when:    
 ...
 The log may be flushed to disk periodically. However, [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] does not provide any durability guarantees other than durable transactions and sp_flush_log.    
 ...
 **ALLOWED**    
 With this setting, each transaction’s durability is determined at the transaction level – DELAYED_DURABILITY = { *OFF* | ON }. See [Atomic block level control – Natively Compiled Stored Procedures](../../Topics/TopicNameNotContainA/Control-Transaction-Durability.md#CompiledProcControl) and [COMMIT level control –Transact-SQL](../../Topics/TopicNameNotContainA/Control-Transaction-Durability.md#bkmk_T-SQLControl) for more information.    
...
###  <a name="bkmk_T-SQLControl"></a> COMMIT level control –[!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)]    
...
##  <a name="bkmk_OtherSQLFeatures"></a> Delayed durability and other [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] features    
