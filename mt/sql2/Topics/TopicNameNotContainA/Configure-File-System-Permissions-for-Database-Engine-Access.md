...
4.  In the **Enter the object names to select** box, type the name of the per-service SID name listed in the Books Online topic [**Configure Windows Service Accounts and Permissions**](../../Topics/TopicNameNotContainA/Configure-Windows-Service-Accounts-and-Permissions.md). (For the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/includes/ssDE_md.md)] per service SID name, use **NT SERVICE\MSSQLSERVER** for a default instance, or **NT SERVICE\MSSQL$InstanceName** for a named instance.)  
