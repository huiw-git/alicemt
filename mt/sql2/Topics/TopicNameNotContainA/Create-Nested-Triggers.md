...
> [!NOTE]  
>  Any reference to managed code from a [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] trigger counts as one level against the 32-level nesting limit. Methods invoked from within managed code do not count against this limit.  
