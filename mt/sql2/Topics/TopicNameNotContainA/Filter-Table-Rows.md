...
-   Use join filters to extend filters on merge table articles to related table articles.  
 ...
 For more information about filtering options, see [Filter Published Data](../../Topics/TopicNameNotContainA/Filter-Published-Data.md). Filtering can be changed in the **Filter Rows** page of the **Publication Properties** dialog box.  
 ...
 **Filter**  
 Contains the [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] definition for the filter selected in the filter pane.  
