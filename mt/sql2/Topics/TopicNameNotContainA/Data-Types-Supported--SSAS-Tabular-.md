---
title: Data Types Supported (SSAS Tabular)
H1: na
ms.custom: na
...
-   If you attempt to concatenate two numbers, the [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/includes/ssGemini_md.md)] add-in will present them as strings and then concatenate. The following expression returns "1234": = 12 & 34  
...
|BLANK AND BLANK|BLANK|Error|  
 ...
 For details on how a particular function or operator handles blanks, see the individual topics for each DAX function, in the section, [DAX Function Reference](assetId:///4dbb28a1-dd1a-4fca-bcd5-e90f74864a7b).  
