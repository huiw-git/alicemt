...
# Analysis Server Properties (Log On Tab)
  Use the **Log On** tab of the **Analysis Server Properties** dialog box to specify the account used by the [!INCLUDE[ssAS](../../Topics/TopicNameNotContainA/includes/ssAS_md.md)] service, and to start and stop the service.  
