...
# Formatting Lines, Colors, and Images (Report Builder and SSRS)
  [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] gives you the ability to format lines, colors, data regions, images, and other report items.  
