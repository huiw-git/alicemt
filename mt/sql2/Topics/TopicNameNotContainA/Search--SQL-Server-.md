...
---
# Search (SQL Server)
  [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] provides search features for text and documents that go beyond the functionality of the [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)]**LIKE** keyword.  
