...
2.  Select **Dataset**.  
    ...
    ![ssRSDataset-NewDataset](../../Topics/TopicNameNotContainA/media/ssRSDataset-NewDataset.png)  
...
1.  Select the **ellipse (…)** for the dataset you want to manage.  
    ...
    ![ssRSDataset-Ellipse](../../Topics/TopicNameNotContainA/media/ssRSDataset-Ellipse.png)  
  
2.  Select **Manage** which will take you to the edit screen.  
  
    ![ssRSDataset-Manage](../../Topics/TopicNameNotContainA/media/ssRSDataset-Manage.png)  
...
![ssRSdataset-Properties](../../Topics/TopicNameNotContainA/media/ssRSdataset-Properties.png)  
...
![ssRSDataset-Caching1](../../Topics/TopicNameNotContainA/media/ssRSDataset-Caching1.png)  
  
Selecting **Cache Copies of this report and use them when available** will present you with some more options.  
  
![ssRSDataset-Caching2](../../Topics/TopicNameNotContainA/media/ssRSDataset-Caching2.png)  
...
![ssRSDataset-Caching3](../../Topics/TopicNameNotContainA/media/ssRSDataset-Caching3.png)  
...
![ssRSDataset-Caching4](../../Topics/TopicNameNotContainA/media/ssRSDataset-Caching4.png)  
