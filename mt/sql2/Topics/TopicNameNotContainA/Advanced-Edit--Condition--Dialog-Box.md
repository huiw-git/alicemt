...
> [!IMPORTANT]  
>  The functions that you can use to create Policy-Based Management conditions do not always use [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] syntax. Make sure that you follow the example syntax. For example, when you use the **DateAdd** or **DatePart** functions, you must enclose the *datepart* argument in single quotes.  
