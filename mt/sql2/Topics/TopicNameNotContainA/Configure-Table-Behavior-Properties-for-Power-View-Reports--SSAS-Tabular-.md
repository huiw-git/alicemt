---
title: Configure Table Behavior Properties for Power View Reports (SSAS Tabular)
H1: na
ms.custom: na
...
> [!NOTE]  
>  Table behavior properties only affect tabular models used as data models in [!INCLUDE[ssCrescent](../../Topics/TopicNameContainA/includes/ssCrescent_md.md)]. Table behavior properties are not supported in Excel pivot reports.  
...
1.  In [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameContainA/includes/ssBIDevStudioFull_md.md)], click the table (tab) for which you are configuring a default field list.  
...
## Setting the Row Identifier property  
 ...
 In [!INCLUDE[ssCrescent](../../Topics/TopicNameContainA/includes/ssCrescent_md.md)], setting a row identifier enables the following additional properties: **Keep Unique Rows** property, **Default Label** property, and **Default Image** property.  
  
 You can also use **Row Identifier** by itself, as a standalone property, to enable the following:  
  
-   Use of binary images in a report. By removing ambiguity around row uniqueness, [!INCLUDE[ssCrescent](../../Topics/TopicNameContainA/includes/ssCrescent_md.md)] can determine how to assign default images and default labels for a given row.  
...
-   Remove unwanted subtotals from a matrix report. Default grouping at the field level creates a subtotal for each field. If you only want a single subtotal that is calculated at the row level, setting the Row Identifier produces this result.  
 ...
 You cannot set a Row Identifier for tables marked as date tables. For date tables, the row identifier is specified when you mark the table. For more information, see [Mark as Date Table Dialog Box &#40;SSAS&#41;](../../Topics/TopicNameNotContainA/Mark-as-Date-Table-Dialog-Box--SSAS-.md).  
...
### Tables are missing one or more rows  
 ...
 ![Default group consolidates 2 into 1](../../Topics/TopicNameNotContainA/media/SSAS_JonYang_NoRowID.gif "SSAS_JonYang_NoRowID")  
 ...
 ![Row data containing duplicates based on row ID](../../Topics/TopicNameNotContainA/media/SSAS_JonYang.gif "SSAS_JonYang")  
 ...
 **Before: Default grouping based on fields in matrix**  
 ...
 ![Matrix layout grouped on Row Identifier](../../Topics/TopicNameNotContainA/media/SSAS_RptProp_matrixRowID.gif "SSAS_RptProp_matrixRowID")  
 ...
 **Before: Default grouping based on fields in a chart**  
 ...
 ![Chart based on default grouping at field level](../../Topics/TopicNameNotContainA/media/SSAS_RptProp_chartfieldgroup.gif "SSAS_RptProp_chartfieldgroup")  
  
 **After: Grouping on row identifier (row identifier becomes the axis)**  
  
 ![Chart based on row ID grouping](../../Topics/TopicNameNotContainA/media/SSAS_Rptprop_chartRowId.gif "SSAS_Rptprop_chartRowId")  
