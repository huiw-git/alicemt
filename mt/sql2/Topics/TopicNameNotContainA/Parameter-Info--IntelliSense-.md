...
2.  Press the CTRL+SHIFT+SPACE keyboard shortcut.  
 ...
 For more information, see [Configure IntelliSense &#40;SQL Server Management Studio&#41;](../../Topics/TopicNameNotContainA/Configure-IntelliSense--SQL-Server-Management-Studio-.md).  
  
> [!NOTE]  
>  The **Parameter Info** option is available only for the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/includes/ssDE_md.md)] Query Editor and the XML Query Editor.  
