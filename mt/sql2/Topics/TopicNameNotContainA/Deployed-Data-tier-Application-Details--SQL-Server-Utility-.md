---
title: Deployed Data-tier Application Details (SQL Server Utility)
H1: na
ms.custom: na
...
-   Green check \- ![](../../Topics/TopicNameNotContainA/media/Well_utilized.gif "Well_utilized") - Number of data-tier application which are not violating resource utilization policies. Resources are well-utilized.  
...
-   Instance Name - Displays the name of the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] that hosts the data-tier application.  
