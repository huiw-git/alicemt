...
>  Most editions of [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/includes/ssCurrent_md.md)] support only synchronous database mirroring ("Safety Full Only"). For information about editions that fully support database mirroring, see "High Availability (Always On)" in [Features Supported by the Editions of SQL Server 2016](../../Topics/TopicNameNotContainA/Features-Supported-by-the-Editions-of-SQL-Server-2016.md).  
 ...
 ![Partner-only configuration of a session](../../Topics/TopicNameNotContainA/media/DBM_high_performance_mode.gif "DBM_high_performance_mode")  
...
###  <a name="HighSafetyWithOutAutoFailover"></a> High-Safety Mode Without Automatic Failover  
 ...
 ![Partners communicating without a witness](../../Topics/TopicNameNotContainA/media/DBM_high_protection_mode.gif "DBM_high_protection_mode")  
...
###  <a name="HighSafetyWithAutoFailover"></a> High-Safety Mode with Automatic Failover  
 ...
 ![The witness and two partners of a session](../../Topics/TopicNameNotContainA/media/DBM_high_availability_mode.gif "DBM_high_availability_mode")  
...
##  <a name="TsqlSettingsAndOpModes"></a> Transact-SQL Settings and Database Mirroring Operating Modes  
 This section describes a database mirroring session in terms of the ALTER DATABASE settings and states of the mirrored database and witness, if any. The section is aimed at users who manage database mirroring primarily or exclusively using [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)], rather than using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)].  
  
> [!TIP]  
>  As an alternative to using [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)], you can control the operating mode of a session in Object Explorer using the **Mirroring** page of the **Database Properties** dialog box. For more information, see [Establish a Database Mirroring Session Using Windows Authentication &#40;SQL Server Management Studio&#41;](../../Topics/TopicNameContainA/Establish-a-Database-Mirroring-Session-Using-Windows-Authentication--SQL-Server-Management-Studio-.md).  
