...
##  <a name="bkmk_modeling"></a> Modeling measures and measure groups on facts and fact tables  
 ...
 ![FactSalesQuota table with two dimension tables](../../Topics/TopicNameNotContainA/media/FactSalesQuota.gif "FactSalesQuota")  
