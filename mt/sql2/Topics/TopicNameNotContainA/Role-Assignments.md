...
---
# Role Assignments
  In [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)], *role assignments* determine access to stored items and to the report server itself. A role assignment has the following parts:  
...
-   Role definitions that define a set of tasks. Examples of role definitions include **System Administrator**, **Content Manager**, and **Publisher**.  
 ...
 ![Role assignments diagram](../../Topics/TopicNameNotContainA/media/report_securityArch.gif "report_securityArch")  
Role assignments diagram  
  
## System-Level and Item-Level Role Assignments  
 Role-based security in [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] is organized into the following levels:  
