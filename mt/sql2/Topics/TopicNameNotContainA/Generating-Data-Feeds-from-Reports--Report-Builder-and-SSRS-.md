...
# Generating Data Feeds from Reports (Report Builder and SSRS)
  The [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] Atom rendering extension generates an Atom service document that lists the data feeds available from a paginated report and the data feeds from the data regions in a report. You use this extension to generate Atom-compliant data feeds that are readable and exchangeable with applications that can consume data feeds generated from reports. For example, you can use the Atom rendering extension to generated data feeds that you can then use in the [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/includes/ssCurrent_md.md)] [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/includes/ssGemini_md.md)] client.  
  
 The Atom service document lists at least one data feed for each data region in a report. Depending on the type of data region and the data that the data region displays, [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] might generate multiple data feeds from a data region. For example, a matrix or chart can provide multiple data feeds. When the Atom rendering extension creates the Atom service document, a unique identifier is created for each data feed and you use the identifier in the URL to access the content of the data feed.  
 ...
 You can generate Atom service documents and data feeds using the [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] web portal, Report Server, or a SharePoint site that is integrated with [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)].  
...
##  <a name="AtomServiceDocument"></a> Atom Service Document (.atomsvc file)  
 ...
 ![RS_Atom_TableAndChartDataFeeds](../../Topics/TopicNameNotContainA/media/RS_Atom_TableAndChartDataFeeds.gif "RS_Atom_TableAndChartDataFeeds")  
 ...
 ![RS_Atom_PeerDynamicColumns](../../Topics/TopicNameNotContainA/media/RS_Atom_PeerDynamicColumns.gif "RS_Atom_PeerDynamicColumns")  
 ...
 ![RS_Atom_PeerDynamicDataFeeds](../../Topics/TopicNameNotContainA/media/RS_Atom_PeerDynamicDataFeeds.gif "RS_Atom_PeerDynamicDataFeeds")  
  
 ![Arrow icon used with Back to Top link](../../Topics/TopicNameContainA/media/UpArrow16x16.gif "UpArrow16x16") [Back to Top](#BackToTop)  
  
##  <a name="DataFeeds"></a> Data Feeds  
 The data feed is an XML file that has a consistent tabular format that does not change over time and variable data that can be different each time the report is run. The data feeds generated by [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] are in the same format as those generated by  that ADO.NET Data Services.  
...
### Data Section  
 ...
 ![RS_Atom_ProductSalesSummaryCircledValues](../../Topics/TopicNameNotContainA/media/RS_Atom_ProductSalesSummaryCircledValues.gif "RS_Atom_ProductSalesSummaryCircledValues")  
