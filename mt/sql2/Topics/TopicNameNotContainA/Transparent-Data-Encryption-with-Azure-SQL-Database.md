...
3.  To monitor the progress of encryption on [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/includes/ssSDS_md.md)], database users with the **VIEW DATABASE STATE** permission can query the **encryption_state** column of the [sys.dm_database_encryption_keys](../Topic/sys.dm_database_encryption_keys%20\(Transact-SQL\).md) view.  
