...
1.  Use the following step that is appropriate for your version of Microsoft Windows:  
    ...
    -   Select **Start**, point to **All Programs**, point to [!INCLUDE[ssCurrentUI](../../Topics/TopicNameContainA/includes/ssCurrentUI_md.md)], and then point to **Configuration Tools**.  
