...
# Access Data for the DQS Operations
  To use your source data for [!INCLUDE[ssDQSnoversion](../../Topics/TopicNameContainA/includes/ssDQSnoversion_md.md)] (DQS) operations, and export your processed data, you can do either of the following:  
