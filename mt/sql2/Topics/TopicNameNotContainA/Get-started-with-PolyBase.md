...
1.  Run [sp_configure &#40;Transact-SQL&#41;](../Topic/sp_configure%20\(Transact-SQL\).md) ‘hadoop connectivity’ and set an appropriate value.  To find the value, see [PolyBase Connectivity Configuration &#40;Transact-SQL&#41;](../../Topics/TopicNameNotContainA/PolyBase-Connectivity-Configuration--Transact-SQL-.md).  
...
2.  You must restart  SQL Server using **services.msc**. Restarting SQL Server restarts these services:  
 ...
 ![stop and start PolyBase services in services.msc](../../Topics/TopicNameNotContainA/media/polybase-stop-start.png "polybase-stop-start")  
...
## Managing PolyBase objects in SSMS  
 ...
 ![PolyBase objects in SSMS](../../Topics/TopicNameNotContainA/media/polybase_management.png "polybase_management")  
