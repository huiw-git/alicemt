...
## Event Class Column Mapping  
 ...
 ![Event class column mapping](../../Topics/TopicNameNotContainA/media/EventClassMappings.gif "EventClassMappings")  
...
|SubmitTime|**datetime**|The time when the event was submitted to [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)].|6|  
...
|LoginName|**nvarchar**|The user login name. This can be either a [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] security login or the Microsoft Windows login credentials, in the format *domain_name*\\*user_name*.|14|  
...
|ApplicationName|**nvarchar**|The name of the client application that created the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] connection during capture.|17|  
