...
# Modify Unique Constraints
  You can modify a unique constraint in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/includes/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)].  
...
##  <a name="TsqlProcedure"></a> **To modify a unique constraint**  
 ...
 To modify a UNIQUE constraint using Transact-SQL, you must first delete the existing UNIQUE constraint and then re-create it with the new definition. For more information, see [Delete Unique Constraints](../../Topics/TopicNameNotContainA/Delete-Unique-Constraints.md) and [Create Unique Constraints](../../Topics/TopicNameNotContainA/Create-Unique-Constraints.md).  
