...
The right-hand portion of the diagram visualizes row versions on time axis and what are the rows you select with different types of querying on temporal table with or without SYSTEM_TIME clause.  
 ...
 ![TemporalUsageScenario1](../../Topics/TopicNameNotContainA/media/TemporalUsageScenario1.png "TemporalUsageScenario1")  
...
Examples of the real-world scenarios that fit well into this category are inventory management or currency trading, among others.  
 ...
 ![TemporalUsageInMemory](../../Topics/TopicNameNotContainA/media/TemporalUsageInMemory.png "TemporalUsageInMemory")  
...
```  
 ...
 ![TemporalUsageInMemory2b](../../Topics/TopicNameNotContainA/media/TemporalUsageInMemory2b.png "TemporalUsageInMemory2b")  
...
```  
 ...
 ![ProductHistoryOverTime](../../Topics/TopicNameNotContainA/media/ProductHistoryOverTime.png "ProductHistoryOverTime")  
...
```  
 ...
 ![ASOFExecutionPlan](../../Topics/TopicNameNotContainA/media/ASOFExecutionPlan.png "ASOFExecutionPlan")  
...
```  
 ...
 ![TemporalAnomalyDetection](../../Topics/TopicNameNotContainA/media/TemporalAnomalyDetection.png "TemporalAnomalyDetection")  
...
```  
 ...
 ![TemporalSCD](../../Topics/TopicNameNotContainA/media/TemporalSCD.png "TemporalSCD")  
...
```  
 ...
 ![TemporalUsageRepair1](../../Topics/TopicNameNotContainA/media/TemporalUsageRepair1.png "TemporalUsageRepair1")  
  
```  
EXEC sp_RepairEmployeeRecord @EmployeeID = 1, @versionNumber = 1  
```  
  
 ![TemporalUsageRepair2](../../Topics/TopicNameNotContainA/media/TemporalUsageRepair2.png "TemporalUsageRepair2")  
...
```  
 ...
 ![TemporalUsageRepair3](../../Topics/TopicNameNotContainA/media/TemporalUsageRepair3.png "TemporalUsageRepair3")  
...
If a newly updated value is not correct then, in many scenarios, restoring the previous version from history is good enough mitigation. The following diagram shows how this process can be automated:  
 ...
 ![TemporalUsageRepair4](../../Topics/TopicNameNotContainA/media/TemporalUsageRepair4.png "TemporalUsageRepair4")  
