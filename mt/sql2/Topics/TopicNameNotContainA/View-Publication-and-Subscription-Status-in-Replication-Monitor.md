...
# View Publication and Subscription Status in Replication Monitor
  [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] Replication Monitor displays status information for publications and subscriptions:  
...
|Status|Icon|  
|------------|----------|  
|Error|![UI icon: error](../../Topics/TopicNameNotContainA/media/repl_icon_error.gif "repl_icon_error")|  
|Performance critical|![UI icon: warning](../../Topics/TopicNameNotContainA/media/repl_icon_warn.gif "repl_icon_warn")|  
|Retrying failed command|![UI icon: replication agent retry](../../Topics/TopicNameNotContainA/media/repl_icon_retry.gif "repl_icon_retry")|  
|OK|none|  
...
|Error|![UI icon: error](../../Topics/TopicNameNotContainA/media/repl_icon_error.gif "repl_icon_error")|  
|Performance critical|![UI icon: warning](../../Topics/TopicNameNotContainA/media/repl_icon_warn.gif "repl_icon_warn")|  
|Expiring soon/Expired|![UI icon: warning](../../Topics/TopicNameNotContainA/media/repl_icon_warn.gif "repl_icon_warn")|  
|Uninitialized subscription|![UI icon: warning](../../Topics/TopicNameNotContainA/media/repl_icon_warn.gif "repl_icon_warn")|  
|Retrying failed command|![UI icon: replication agent retry](../../Topics/TopicNameNotContainA/media/repl_icon_retry.gif "repl_icon_retry")|  
|Not running|![UI icon: replication agent stopped](../../Topics/TopicNameNotContainA/media/repl_icon_stopped.gif "repl_icon_stopped")|  
|Running|![UI icon: replication agent running](../../Topics/TopicNameNotContainA/media/repl_icon_running.gif "repl_icon_running")|  
...
|Error|![UI icon: error](../../Topics/TopicNameNotContainA/media/repl_icon_error.gif "repl_icon_error")|  
|Performance critical|![UI icon: warning](../../Topics/TopicNameNotContainA/media/repl_icon_warn.gif "repl_icon_warn")|  
|Long-running merge|![UI icon: warning](../../Topics/TopicNameNotContainA/media/repl_icon_warn.gif "repl_icon_warn")|  
|Expiring soon/Expired|![UI icon: warning](../../Topics/TopicNameNotContainA/media/repl_icon_warn.gif "repl_icon_warn")|  
|Uninitialized subscription|![UI icon: warning](../../Topics/TopicNameNotContainA/media/repl_icon_warn.gif "repl_icon_warn")|  
|Retrying failed command|![UI icon: replication agent retry](../../Topics/TopicNameNotContainA/media/repl_icon_retry.gif "repl_icon_retry")|  
|Synchronizing|![UI icon: replication agent running](../../Topics/TopicNameNotContainA/media/repl_icon_running.gif "repl_icon_running")|  
|Not Synchronizing|![UI icon: replication agent stopped](../../Topics/TopicNameNotContainA/media/repl_icon_stopped.gif "repl_icon_stopped")|  
