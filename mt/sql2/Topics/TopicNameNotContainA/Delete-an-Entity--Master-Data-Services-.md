---
title: Delete an Entity (Master Data Services)
H1: na
ms.custom: 
  - SQL2016_New_Updated
...
# Delete an Entity (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/includes/ssMDSshort_md.md)], delete an entity to delete all members and attributes for the entity.  
