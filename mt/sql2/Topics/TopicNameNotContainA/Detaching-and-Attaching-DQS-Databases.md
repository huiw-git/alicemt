...
-   Ensure that there are no users logged on the [!INCLUDE[ssDQSServer](../../Topics/TopicNameContainA/includes/ssDQSServer_md.md)].  
...
5.  Repeat steps 3 and 4 with the DQS_PROJECTS and DQS_STAGING_DATA databases to detach them.  
 ...
 You can also detach DQS databases using the Transact-SQL statements by using the sp_detach_db stored procedure. For more information about detaching databases using Transact-SQL statements, see [Using Transact-SQL](../../Topics/TopicNameContainA/Detach-a-Database.md#TsqlProcedure) in [Detach a Database](../../Topics/TopicNameContainA/Detach-a-Database.md).  
  
##  <a name="Attach"></a> Attach DQS Databases  
 Use the following instructions to attach a DQS database to the same SQL Server instance (from where you detached) or a different SQL Server instance where [!INCLUDE[ssDQSServer](../../Topics/TopicNameContainA/includes/ssDQSServer_md.md)] is installed.  
...
11. Connect to the Data Quality Server using the Data Quality Client to verify if you can connect successfully.  
 ...
 You can also attach DQS databases using the Transact-SQL statements. For more information about attaching databases using Transact-SQL statements, see [Using Transact-SQL](../../Topics/TopicNameContainA/Attach-a-Database.md#TsqlProcedure) in [Attach a Database](../../Topics/TopicNameContainA/Attach-a-Database.md).  
