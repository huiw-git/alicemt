...
## Conflict Detection  
 The way in which conflicts are detected for logical records is determined by two article properties: **column_tracking** and **logical_record_level_conflict_detection**. [!INCLUDE[ssVersion2005](../../Topics/TopicNameContainA/includes/ssVersion2005_md.md)] and later versions also support logical record-level detection.  
  
 The **logical_record_level_conflict_detection** article property can be set to TRUE or FALSE. The value should only be set for the top-level parent article and will be ignored by child articles. If this value is FALSE, merge replication detects conflicts as in previous versions of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)], based solely on the value of the **column_tracking** property for the article. If this value is TRUE, merge replication will ignore the **column_tracking** property of the article, and detect a conflict if changes are made anywhere in the logical record. For example, consider this scenario:  
  
 ![Three table logical record with values](../../Topics/TopicNameNotContainA/media/Logical_Records_05.gif "Logical_Records_05")  
...
-   **logical_record_level_conflict_resolution** is TRUE  
 ...
 ![Series of tables showing changes to related rows](../../Topics/TopicNameNotContainA/media/Logical_Records_06.gif "Logical_Records_06")  
...
-   **logical_record_level_conflict_resolution** is TRUE  
 ...
 ![Series of tables showing changes to related rows](../../Topics/TopicNameNotContainA/media/Logical_Records_07.gif "Logical_Records_07")  
...
-   **logical_record_level_conflict_resolution** is TRUE  
 ...
 ![Series of tables showing changes to related rows](../../Topics/TopicNameNotContainA/media/Logical_Records_08.gif "Logical_Records_08")  
