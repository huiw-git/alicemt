---
title: Notification Events Data Columns
H1: na
ms.custom: na
...
# Notification Events Data Columns
  Notification events are events that are not directly caused by users of [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/includes/ssASnoversion_md.md)]. For example, notifications occur because of users updating underlying tables for proactive caching.  
...
|ServerName|43|8|Contains the name of the [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/includes/ssASnoversion_md.md)] instance on which the notification event occurred.|  
