 ...
 *Database mirroring* is a solution for increasing the availability of a [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] database. Mirroring is implemented on a per-database basis and works only with databases that use the full recovery model.  
...
###  <a name="OperatingModes"></a> Operating Modes  
 ...
 ![Partners in a database mirroring session](../../Topics/TopicNameNotContainA/media/DBM_2-way_session_intro.gif "DBM_2-way_session_intro")  
...
|`SSInstance_3`|Partner|Partner|Witness|Witness|  
 ...
 ![Two server instances in two concurrent sessions](../../Topics/TopicNameNotContainA/media/DBM_concurrent_sessions.gif "DBM_concurrent_sessions")  
...
###  <a name="ClientConnections"></a> Client Connections  
 Client-connection support for database mirroring sessions is provided by the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)] .NET Data Provider for [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)]. For more information, see [Connect Clients to a Database Mirroring Session &#40;SQL Server&#41;](../../Topics/TopicNameContainA/Connect-Clients-to-a-Database-Mirroring-Session--SQL-Server-.md).  
...
##  <a name="InThisSection"></a> In This Section  
 ...
 Discusses physical, operating system, and [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] problems, including hard errors and soft errors, that can cause a failure in a database mirroring session. Discusses how the mirroring time-out mechanism responds to soft errors.  
