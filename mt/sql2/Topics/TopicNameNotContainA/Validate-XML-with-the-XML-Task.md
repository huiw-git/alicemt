...
# Validate XML with the XML Task
 ...
 ![XML task properties in the XML Task Editor](../../Topics/TopicNameNotContainA/media/XMLTaskProperties.jpg "XMLTaskProperties")  
...
## Analyze XML validation output with a Transact-SQL query  
 If the output of XML validation contains a large number of errors, you can use a [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] query to load the output in [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)]. Then you can analyze the error list with all the capabilities of the T-SQL language including WHERE, GROUP BY, ORDER BY, JOIN, and so forth.  
...
```  
 ...
 Here is the result in [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/includes/ssManStudio_md.md)] of the second sample query shown in the preceding text.  
  
 ![Query to group XML errors in Management Studio](../../Topics/TopicNameNotContainA/media/QueryForXMLErrors.jpg "QueryForXMLErrors")  
