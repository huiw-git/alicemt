...
# Move System Databases
  This topic describes how to move system databases in [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)]. Moving system databases may be useful in the following situations:  
...
5.  Verify the file change by running the following query.  
 ...
 If the msdb database is moved and the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] is configured for [Database Mail](../../Topics/TopicNameNotContainA/Database-Mail.md), complete these additional steps.  
  
1.  Verify that [!INCLUDE[ssSB](../../Topics/TopicNameContainA/includes/ssSB_md.md)] is enabled for the msdb database by running the following query.  
    ...
    ```  
     ...
     For more information about enabling [!INCLUDE[ssSB](../../Topics/TopicNameContainA/includes/ssSB_md.md)], see [ALTER DATABASE &#40;Transact-SQL&#41;](../Topic/ALTER%20DATABASE%20\(Transact-SQL\).md).  
...
5.  Stop the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)]. For example, run `NET STOP MSSQLSERVER`.  
  
6.  Move the file or files to the new location.  
  
7.  Restart the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)]. For example, run `NET START MSSQLSERVER`.  
...
2.  In the **SQL Server Services** node, right-click the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] (for example, **SQL Server (MSSQLSERVER)**) and choose **Properties**.  
...
6.  Stop the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] by right-clicking the instance name and choosing **Stop**.  
  
7.  Move the master.mdf and mastlog.ldf files to the new location.  
  
8.  Restart the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)].  
...
3.  Stop and restart the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)].  
