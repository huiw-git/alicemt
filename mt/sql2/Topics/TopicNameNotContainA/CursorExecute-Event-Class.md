...
# CursorExecute Event Class
  The **CursorExecute** event class describes cursor execute events that occur in application programming interface (API) cursors. Cursor execute events occur when [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)] [!INCLUDE[ssDE](../../Topics/TopicNameContainA/includes/ssDE_md.md)] creates and populates a cursor from the execution plan created by a cursor prepare event.  
