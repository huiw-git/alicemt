...
# Execute T-SQL Statement Task (Maintenance Plan)
  Use the **Execute T-SQL Statement Task** dialog to customize your maintenance plan by adding [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statements of your choice to this maintenance plan.  
 ...
 **T-SQL statement**  
 [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statements to execute.  
 ...
 **Use Windows integrated security**  
 Connect to an instance of the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)] [!INCLUDE[ssDEnoversion](../../Topics/TopicNameContainA/includes/ssDEnoversion_md.md)] with [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)] Windows Authentication.  
