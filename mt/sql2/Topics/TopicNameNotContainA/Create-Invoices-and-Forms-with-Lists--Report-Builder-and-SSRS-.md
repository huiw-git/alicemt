...
# Create Invoices and Forms with Lists (Report Builder and SSRS)
  A list data region repeats with each group or row in the [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] paginated report dataset. A list can be used to create free-form reports or forms, such as invoices, or in conjunction with other data regions. You can define lists that contain any number of report items. A list can be nested wit  
...
##  <a name="AddingList"></a> Adding a List to Your Report  
 ...
 ![New List report item on the design surface](../../Topics/TopicNameNotContainA/media/rs_ListTemplateNew.gif "rs_ListTemplateNew")  
...
##  <a name="DisplayingLayout"></a> Displaying Data in a Free-form Layout  
 ...
 ![List in design view, 4 fields and an image](../../Topics/TopicNameNotContainA/media/rs_BasicListFormDesign.gif "rs_BasicListFormDesign")  
  
 In Preview, the list repeats to display the field data in the free-form format, as shown in the following figure:  
  
 ![Preview for List with 4 fields and one image](../../Topics/TopicNameNotContainA/media/rs_BasicListFormPreview.gif "rs_BasicListFormPreview")  
...
##  <a name="DisplayingGrouping"></a> Displaying Data with One Level of Grouping  
 ...
 ![A list with 2 tables, one with nested chart](../../Topics/TopicNameNotContainA/media/rs_BasicListGroupDesign.gif "rs_BasicListGroupDesign")  
 ...
 ![Preview, 2 tables, one with nested chart](../../Topics/TopicNameNotContainA/media/rs_BasicListGroupPreview.gif "rs_BasicListGroupPreview")  
