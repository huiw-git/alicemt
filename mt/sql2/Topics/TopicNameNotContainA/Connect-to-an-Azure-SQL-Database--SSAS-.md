...
# Connect to an Azure SQL Database (SSAS)
  This page of the **Table Import Wizard** enables you to connect to a [!INCLUDE[ssSDSFull](../../Topics/TopicNameContainA/includes/ssSDSfull_md.md)]. To access the wizard from the [!INCLUDE[ssBIDevStudio](../../Topics/TopicNameContainA/includes/ssBIDevStudio_md.md)], on the **Model** menu, click **Import from Data Source**.  
  
> [!NOTE]  
>  If you are connecting to an Azure DataMarket dataset, see [Connect to a Report or Data Feed &#40;SSAS&#41;](../../Topics/TopicNameContainA/Connect-to-a-Report-or-Data-Feed--SSAS-.md).  
  
 The [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/includes/ssSDS_md.md)] is a hosted, relational database that you connect to by using SQL Server Authentication. For more information about [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/includes/ssSDS_md.md)], see the web site [SQL Database](http://go.microsoft.com/fwlink/?LinkID=157856). To connect to a data source, you must have the appropriate provider installed on your computer.  
