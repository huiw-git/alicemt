---
title: Create or Edit Named Query Dialog Box (Analysis Services - Multidimensional Data)
H1: na
ms.custom: na
...
# Create or Edit Named Query Dialog Box (Analysis Services - Multidimensional Data)
  Use the **Create/Edit Named Query** dialog box in [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameContainA/includes/ssBIDevStudioFull_md.md)] to create or edit a named query in **Data Source View Designer**. A named query can be treated as a table, on which you can base other [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/includes/ssASnoversion_md.md)] objects. You can display the **Create/Edit Named Query** dialog box by:  
