...
# External data access and security for processing and queries in DirectQuery models (SSAS - Tabular)
  Tabular models in DirectQuery mode query data directly from the connected relational database.  Any DAX or MDX queries are translated by [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/includes/ssASnoversion_md.md)] into equivalent SQL statements issued against the RDBMS.  
