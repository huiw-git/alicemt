 ...
 **-i**  
 Specifies a local report server instance. This argument is optional if you installed the report server on the default [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] instance (the default value for **-i** is MSSQLSERVER). If you installed the report server as a named instance, **-i** is required.  
 ...
 **-n**  
 Specifies the name of the report server instance on a remote computer. This argument is optional if you installed the report server on the default [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] instance (the default value for **-n** is MSSQLSERVER). If you installed the report server as a named instance, **-n** is required.  
