...
# Translations in Tabular models (Analysis Services)
  [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/includes/ssCurrent_md.md)] adds translation string support for Tabular models created at the 1200 compatibility level. A single object in the model can have multiple translations of a name or description, making it possible to support multi-language versions within the model definition.  
...
## Create an empty translation file  
 Use [!INCLUDE[ssBIDevStudio](../../Topics/TopicNameContainA/includes/ssBIDevStudio_md.md)] to add translations.  
...
4.  Click **Export Language File**.  Provide a file name and location.  
 ...
 ![ssas-tabular-translate-export](../../Topics/TopicNameNotContainA/media/ssas-tabular-translate-export.png "ssas-tabular-translate-export")  
...
|translatedDescription|Less common than captions, a description appears as model information in a modeling tool like SSDT.|  
 ...
 ![ssas-tabular-translate-json](../../Topics/TopicNameNotContainA/media/ssas-tabular-translate-json.png "ssas-tabular-translate-json")  
...
2.  In the Excel connection dialog box, choose the culture for which string translations exist in your model. Excel detects cultures defined in the model and populates the drop-down list accordingly.  
     ...
     ![ssas-tabular-translations-excel](../../Topics/TopicNameNotContainA/media/ssas-tabular-translations-excel.png "ssas-tabular-translations-excel")  
