...
-   [A. Maintenance Instructions for SQL Server Connector](../Topic/SQL%20Server%20Connector%20Maintenance%20&%20Troubleshooting.md#AppendixA)  
  
-   [C. Error Code Explanations for SQL Server Connector](../Topic/SQL%20Server%20Connector%20Maintenance%20&%20Troubleshooting.md#AppendixC)  
  
  
## Part IV: Configure [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)]  
 Please refer to [B. Frequently Asked Questions](../Topic/SQL%20Server%20Connector%20Maintenance%20&%20Troubleshooting.md#AppendixB) to see a note about the minimum permission levels needed for each action in this section.  
