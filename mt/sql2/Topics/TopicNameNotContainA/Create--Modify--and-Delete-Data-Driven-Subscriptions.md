...
3.  Select the subscription you want to modify. The following icon indicates a data\-driven subscription: ![Data-driven subscription icon](../../Topics/TopicNameNotContainA/media/hlp_16subscriptiondd.gif "hlp_16subscriptiondd")  
