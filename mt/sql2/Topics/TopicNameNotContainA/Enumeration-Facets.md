...
---
# Enumeration Facets
  [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] rejects XML schemas with types that have pattern facets or enumerations that violate those facets.  
