...
## Options  
 ...
 To switch to the design pane, click the ![Design icon](../../Topics/TopicNameNotContainA/media/SSIS_DesignIcon.gif "SSIS_DesignIcon") icon.  
  
 To switch to the query pane, click the ![SQL icon](../../Topics/TopicNameNotContainA/media/SSIS_QueryIcon.gif "SSIS_QueryIcon") icon.  
