...
>  One aspect of data modeling is to formalize the patterns and relationships that already exist within the data itself. When working with data that falls into a natural hierarchy, as is the case with countries-regions-cities, you can formalize that relationship by creating an **attribute relationship**. An attribute relationship is a one-to-many relationship between attributes, for example a relationship between a state and a city – a state has many cities, but a city belongs to just one state. Creating attribute relationships in the model speeds up query performance, so it’s a best practice to create them if the data supports it. You can create an attribute relationship in Dimension Designer in SQL Server Data Tools. See [Define Attribute Relationships](../../Topics/TopicNameNotContainA/Define-Attribute-Relationships.md).  
 ...
 ![PivotTable field list](../../Topics/TopicNameNotContainA/media/SSAS_KeyConcepts_PTFieldList.png "SSAS_KeyConcepts_PTFieldList")  
...
-   The (All) member for Pacific is $1,594,335.38  
 ...
 ![PivotTable with all member called out](../../Topics/TopicNameNotContainA/media/SSAS_KeyConcepts_Pivot2_AllMember.png "SSAS_KeyConcepts_Pivot2_AllMember")  
 ...
 ![PivotTable with leaf member calle dout](../../Topics/TopicNameNotContainA/media/SSAS_KeyConcepts_Pivot3_LeafParent.PNG "SSAS_KeyConcepts_Pivot3_LeafParent")  
...
## Key Attributes  
 ...
 ![Model showing the granularity attribute](../../Topics/TopicNameNotContainA/media/SSAS_KeyConcepts_GranularityAttrib.png "SSAS_KeyConcepts_GranularityAttrib")  
