...
6.  In the details pane, right-click **SQL Server Agent***(server_name)*, where *server_name* is the name of the [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Agent instance for which you want to change the service startup account, and select **Properties**.  
