...
> [!NOTE]  
>  The JDBC driver does not currently call the sp\_reset\_connection stored procedure when it returns the connection to the pool. Instead, the driver relies on third\-party Java Application Servers to return the connections back to their original states.  
