...
-   To load database objects into [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] and to migrate data to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)], the minimum permission requirement is membership in the **db_owner** database role in the target database.  
