...
You cannot enter any other option or password as the command line parameter. Otherwise, it results in an error. For more information, refer to the [Managing Passwords](assetId:///9b6a70f9-6840-4140-a059-bb7bd7ccc67c) section.  
...
For a tabular display of the SSMA Console command line options, refer to [Appendix - 1 &#40;SybaseToSQL&#41;](../content/Appendix---1--SybaseToSQL-.md).  
