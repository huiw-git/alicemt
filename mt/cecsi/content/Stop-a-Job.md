...
---
# Stop a Job
This topic describes how to stop a [!INCLUDE[msCoName](../content/includes/msCoName_md.md)] [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Agent job. A job is a specified series of actions that SQL Server Agent performs.  
