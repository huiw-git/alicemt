...
Use this tab to view or specify options when connecting to [!INCLUDE[msCoName](../content/includes/msCoName_md.md)] [!INCLUDE[ssASnoversion](../content/includes/ssASnoversion_md.md)] or registering [!INCLUDE[ssAS](../content/includes/ssAS_md.md)] in **Registered Servers**. **Connect** and **Options** only appear in this dialog box when connecting. **Test** and **Save** only appear in this dialog box when registering [!INCLUDE[ssAS](../content/includes/ssAS_md.md)].  
...
**Test**  
When registering [!INCLUDE[ssAS](../content/includes/ssAS_md.md)] in **Registered Servers**, click to test the connection.  
