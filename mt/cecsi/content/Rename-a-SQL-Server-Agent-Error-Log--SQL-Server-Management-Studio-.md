...
This topic describes how to rename the file where [!INCLUDE[msCoName](../content/includes/msCoName_md.md)] [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Agent errors are written in [!INCLUDE[ssCurrent](../content/includes/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../content/includes/ssManStudioFull_md.md)].  
...
-   [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Agent will not write to the new log file until the [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Agent service is restarted.  
...
1.  In **Object Explorer**, click the plus sign to expand the server that contains the [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Agent error log that you want to rename.  
