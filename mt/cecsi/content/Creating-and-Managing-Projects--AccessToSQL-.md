...
SSMA starts without loading a default project. To migrate data from Access databases to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] or SQL Azure, you must create a project.  
...
2.  To reconnect to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)], on the **File** menu, select **Reconnect to SQL Server**.  
