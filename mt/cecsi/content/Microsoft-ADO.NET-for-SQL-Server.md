---
title: Microsoft ADO.NET for SQL Server
ms.custom: na
ms.date: 07/12/2016
...
## Getting Started  
* [Step 1: Configure development environment for ADO.NET development](Step%201:%20Configure%20development%20environment%20for%20ADO.NET%20development.md)  
* [Step 2: Create a SQL database for ADO.NET development](Step%202:%20Create%20a%20SQL%20database%20for%20ADO.NET%20development.md)  
* [Step 3: Proof of concept connecting to SQL using ADO.NET](Step%203:%20Proof%20of%20concept%20connecting%20to%20SQL%20using%20ADO.NET.md)  
* [Step 4: Connect resiliently to SQL with ADO.NET](Step%204:%20Connect%20resiliently%20to%20SQL%20with%20ADO.NET.md)  
