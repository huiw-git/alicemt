...
This section includes Help topics for [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Migration Assistant (SSMA) for Sybase.  
...
|[Assessment Report &#40;SybaseToSQL&#41;](../content/Assessment-Report--SybaseToSQL-.md)|Use the Assessment Report to view the results of the conversion of Sybase Adaptive Server Enterprise (ASE) objects to [!INCLUDE[tsql](../content/includes/tsql_md.md)] syntax, and to estimate the time and complexity of a migration to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] or SQL Azure.|  
|[Connect to SQL Server &#40;SybaseToSQL&#41;](../content/Connect-to-SQL-Server--SybaseToSQL-.md)|Use the **Connect to SQL Server** dialog box to connect to the instance of [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] to which you want to migrate.|  
...
|[Data Migration Report &#40;SybaseToSQL&#41;](../content/Data-Migration-Report--SybaseToSQL-.md)|Displays the results of migrating data from ASE to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] or SQL Azure.|  
...
|[Project Settings &#40;Migration&#41; &#40;SybaseToSQL&#41;](../content/Project-Settings--Migration---SybaseToSQL-.md)|Use the Migration page of the **Project Settings** dialog box to customize how SSMA for Sybase migrates data from ASE to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] or SQL Azure.|  
|[Project Settings &#40;Synchronization&#41; &#40;SybaseToSQL&#41;](../content/Project-Settings--Synchronization---SybaseToSQL-.md)|Use the Synchronization page of the **Project Settings** dialog box to customize how SSMA for Sybase creates or alters migrated database objects in [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] or SQL Azure.|  
