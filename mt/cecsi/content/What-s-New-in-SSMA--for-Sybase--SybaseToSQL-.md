...
-   Consolidated “SSMA for Sybase” product, which supports [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] 2005, [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] 2008, [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] “Denali” and SQL Azure.  
...
-   SSMA for Sybase Extension Pack can now be installed on [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] clusters.  
...
-   Improvements in object conversion:  
    ...
    -   New [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] 2008 datetime types are supported.  
...
-   A new migration option lets you specify how SSMA should handle dates that are outside the [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] date range.  
