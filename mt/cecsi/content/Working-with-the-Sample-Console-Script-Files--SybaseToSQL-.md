...
-   **ServersConnectionFileSample.xml:**  
    ...
    -   For more information on connecting to the source and target server, see [Creating the Server Connection Files &#40;SybaseToSQL&#41;](../content/Creating-the-Server-Connection-Files--SybaseToSQL-.md).  
...
-   **VariableValueFileSample.xml:**  
    ...
    For more information on Variable Value File, see [Creating Variable Value Files &#40;SybaseToSQL&#41;](../content/Creating-Variable-Value-Files--SybaseToSQL-.md).  
...
-   **AssessmentReportGenerationSample.xml:**  
    ...
    For more information on generating reports, see [Generating Reports &#40;SybaseToSQL&#41;](../content/Generating-Reports--SybaseToSQL-.md).  
