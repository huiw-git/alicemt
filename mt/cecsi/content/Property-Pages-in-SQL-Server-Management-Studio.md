...
Property page dialog boxes in [!INCLUDE[msCoName](../content/includes/msCoName_md.md)] [!INCLUDE[ssManStudioFull](../content/includes/ssManStudioFull_md.md)] all use a common format displaying information with expanding and collapsing categories. The fields shown depend on the particular property. Properties shown in gray are read\-only. Categorized and Alphabetic buttons are near the top of each property page.  
  
The following table describes the common elements of [!INCLUDE[ssManStudio](../content/includes/ssManStudio_md.md)] property page dialog boxes.  
