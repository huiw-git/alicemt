...
-   For Oracle Client connection string information, see [Connecting to the Oracle Database](http://go.microsoft.com/fwlink/?LinkId=85641) on the Oracle Web site.  
