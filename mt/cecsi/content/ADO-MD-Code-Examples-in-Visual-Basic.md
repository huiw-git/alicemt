...
<developerReferenceWithoutSyntaxDocument xmlns="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://ddue.schemas.microsoft.com/authoring/2003/5 http://dduestorage.blob.core.windows.net/ddueschema/developer.xsd">
  <introduction>
    <para>The following examples require Microsoft Visual Basic version 5.0 with Service Pack 3 or Visual Basic version 6.0.</para>
  </introduction>
  <section>
    <content>
      <alert class="note">
      ...
      <list class="bullet">
        <listItem>
          <para>
            <legacyLink xlink:href="2666ad1c-b48e-4b2c-b269-5a9f4e4a7810">Cellset Example</legacyLink>
          </para>
        </listItem>
        <listItem>
          <para>
            <legacyLink xlink:href="3aae1107-2f81-413c-8eda-ef96c3df1b8a">Catalog Example</legacyLink>
          </para>
        </listItem>
      </list>
    </content>
