...
-   Severity 19 or higher sysmessages errors.  
    ...
    If you also want to log specific sysmessages errors that have a severity lower than 19, use the sp\_altermessage stored procedure to designate such errors as "always logged".  
...
-   Any application event that is logged by using xp\_logevent.  
