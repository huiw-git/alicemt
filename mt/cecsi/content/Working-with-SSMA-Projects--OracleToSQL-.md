...
-   Metadata about the Oracle databases you want to migrate to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)].  
...
5.  Repeat Steps 1-3 for the Migration, Synchronization, Loading System Objects, GUI, and Type Mapping pages.  
    ...
    -   For information about settings for synchronization to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)], see [Project Settings&#40;Synchronization&#41; &#40;OracleToSQL&#41;](../content/Project-Settings-Synchronization---OracleToSQL-.md).  
...
To migrate data from Oracle databases to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)], you must first create a project.  
