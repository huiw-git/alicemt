...
Use this page to view and change the properties of a [!INCLUDE[msCoName](../content/includes/msCoName_md.md)] [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Agent job step, or to define a new job step.  
  
To navigate to this page, in [!INCLUDE[ssManStudioFull](../content/includes/ssManStudioFull_md.md)] Object Explorer, expand [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Agent, right\-click **Jobs**, click **New Jobs**, select the **Steps** page, and click **New**. You can also navigate to this page by right\-clicking a job in Object Explorer, clicking **Properties**, selecting the **Steps** page, and clicking **New**, **Insert**, or **Edit**.  
...
**VBScript**  
Specify [!INCLUDE[msCoName](../content/includes/msCoName_md.md)] Visual Basic Scripting Edition as the language for the job steps.  
...
### General Tab  
Specify where the [!INCLUDE[ssISnoversion](../content/includes/ssISnoversion_md.md)] ([!INCLUDE[ssIS](../content/includes/ssIS_md.md)]) package is located and what authentication method to use. The following options are available when you select this tab.  
  
**Package source**  
Specify where the [!INCLUDE[ssIS](../content/includes/ssIS_md.md)] package is stored. Choose one of the following:  
...
**Server**  
Type the server name where the [!INCLUDE[ssIS](../content/includes/ssIS_md.md)] package is stored. This option is only available when **SQL Server** or **SSIS Package Store** is specified for **Package Source**.  
  
**Use Windows Authentication**  
Logins to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] use [!INCLUDE[msCoName](../content/includes/msCoName_md.md)] Windows Authentication.  
  
**Use SQL Server Authentication**  
Logins to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] use [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Authentication. If this method of authentication is selected, enter the appropriate **User name** and **Password**.  
...
> [!IMPORTANT]  
> For password\-protected [!INCLUDE[ssIS](../content/includes/ssIS_md.md)] packages, click the **Configurations** tab to enter the password in the **Package Password** dialog box. Otherwise, the [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Agent job that executes the password\-protected package will fail.  
  
### Configurations Tab  
Specify configuration options for the [!INCLUDE[ssIS](../content/includes/ssIS_md.md)] package. The following options are available when this tab is selected.  
