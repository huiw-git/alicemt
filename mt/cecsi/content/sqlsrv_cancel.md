...
---
# sqlsrv_cancel
Cancels a statement. This means that any pending results for the statement are discarded. After this function is called, the statement can be re\-executed if it was prepared with [sqlsrv_prepare](../content/sqlsrv_prepare.md). Calling this function is not necessary if all the results associated with the statement have been consumed.  
...
## Comments  
A statement that is prepared and executed using the combination of [sqlsrv_prepare](../content/sqlsrv_prepare.md) and [sqlsrv_execute](../content/sqlsrv_execute.md) can be re\-executed with **sqlsrv\_execute** after calling **sqlsrv\_cancel**. A statement that is executed with [sqlsrv_query](../content/sqlsrv_query.md) cannot be re\-executed after calling **sqlsrv\_cancel**.  
