...
## Comments  
A statement that is prepared and executed using the combination of [sqlsrv_prepare](../content/sqlsrv_prepare.md) and [sqlsrv_execute](../content/sqlsrv_execute.md) can be re-executed with **sqlsrv_execute** after calling **sqlsrv_cancel**. A statement that is executed with [sqlsrv_query](../content/sqlsrv_query.md) cannot be re-executed after calling **sqlsrv_cancel**.  
