...
|Disabled|Disables Always Encrypted for the query.|  
 ...
 The statement level setting for AE are added to the SQLServerConnection class and the following methods are overloaded with the new setting.  
