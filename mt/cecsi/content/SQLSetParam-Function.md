  ...
  <section>
    <content>
      <definitionTable>
        ...
        <definition>
          <para>In ODBC 2.0, the ODBC 1.0 function <legacyBold>SQLSetParam</legacyBold> has been replaced by <legacyBold>SQLBindParameter</legacyBold>. For more information, see <link xlink:href="38349d4b-be03-46f9-9d6a-e50dd144e225">SQLBindParameter</link>.</para>
          <alert class="note">
