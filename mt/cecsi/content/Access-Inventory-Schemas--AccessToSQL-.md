...
## Tables  
Table metadata is exported to the **SSMA\_Access\_InventoryTables** table. This table contains the following columns:  
...
## Columns  
Column metadata is exported to the **SSMA\_Access\_InventoryColumns** table. This table contains the following columns:  
...
## Indexes  
Index metadata is exported to the **SSMA\_Access\_InventoryIndexes** table. This table contains the following columns:  
