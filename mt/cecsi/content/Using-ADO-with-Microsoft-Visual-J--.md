...
<developerReferenceWithoutSyntaxDocument xmlns="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://ddue.schemas.microsoft.com/authoring/2003/5 http://dduestorage.blob.core.windows.net/ddueschema/developer.xsd">
  <introduction>
    <para>You can implement ADO using Visual J++ in the following ways:  </para>
    <list class="bullet">
      <listItem>
        <para>With Visual J++ 6.0 (or later), use ADO for Windows Foundation Classes.</para>
      </listItem>
      <listItem>
        <para>With Visual J++ 1.x, use the Java Type Library Wizard.</para>
      </listItem>
      <listItem>
        <para>Use the Microsoft SDK for Java utilities.</para>
      </listItem>
    </list>
    <para>This section contains the following topics.  </para>
    <list class="bullet">
      <listItem>
        <para>             <legacyLink xlink:href="1fdfa42e-897e-4770-b320-ab3720adabcc">ADO/WFC Programming</legacyLink>           </para>
      </listItem>
      <listItem>
        <para>             <legacyLink xlink:href="f9737a65-4b2f-47fa-b026-1494dca158eb">Using the Java Type Library Wizard</legacyLink>           </para>
      </listItem>
      <listItem>
        <para>             <legacyLink xlink:href="2d7cb5b5-8307-49dd-b07e-c07069bb1626">Using the Microsoft SDK for Java</legacyLink>           </para>
      </listItem>
      <listItem>
        <para>             <legacyLink xlink:href="1fc09dc1-9e32-412e-9f43-b8eb8bb483ca">ADO Java Class Wrappers</legacyLink>           </para>
      </listItem>
    </list>
  </introduction>
  <relatedTopics>
