...
> [!NOTE]  
>  This method is not currently implemented by the [!INCLUDE[jdbcNoVersion](../content/includes/jdbcNoVersion_md.md)]. Therefore, it will always return FETCH_UNKNOWN.  
