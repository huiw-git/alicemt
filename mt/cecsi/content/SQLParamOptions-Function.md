  ...
  <section>
    <content>
      <definitionTable>
        ...
        <definition>
          <para>The ODBC 2.0 function <legacyBold>SQLParamOptions</legacyBold> has been replaced in ODBC 3.<legacyItalic>x</legacyItalic> by calls to <legacyLink xlink:href="7abc5260-733a-48d4-9974-2d1a6a9ea5f6">SQLSetStmtAttr</legacyLink>.</para>
          <alert class="note">
