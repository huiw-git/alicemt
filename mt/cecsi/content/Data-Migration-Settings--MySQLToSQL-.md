...
-   This tab is available when **Extended data migration options** is set to **Show** and is hidden when the setting is set to **Hide** in Project Settings. For more information about Project Migration Settings, see [Project Settings (Migration)](assetId:///2a3cba9e-cd54-4a8b-b858-8fc4cf2580d9) .  
...
## See Also  
[Migrating MySQL Data to SQL Server/SQL Azure](assetId:///a6a7f4d6-68aa-4a38-93bf-53eba0d7dc82)  
