...
You can launch any [!INCLUDE[msCoName](../content/includes/msCoName_md.md)] Windows or [!INCLUDE[msCoName](../content/includes/msCoName_md.md)] [!INCLUDE[dnprdnshort](../content/includes/dnprdnshort_md.md)] application from [!INCLUDE[ssManStudioFull](../content/includes/ssManStudioFull_md.md)]. External applications can be added to, and run from, the **Tools** menu.  
