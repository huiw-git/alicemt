...
## Remarks  
When binding null data to server columns of type varbinary, binary, or varbinary\(max\) you should specify binary encoding \(PDO::SQLSRV\_ENCODING\_BINARY\) using the $*driver\_options*. See [Constants](../content/Constants--Microsoft-Drivers-for-PHP-for-SQL-Server-.md) for more information about encoding constants.  
