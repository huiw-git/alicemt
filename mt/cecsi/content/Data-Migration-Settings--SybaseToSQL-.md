...
-   This tab is available when **Extended data migration options** is set to **Show** and is hidden when the setting is set to **Hide** in Project Settings. For more information about Project Migration Settings, see [Project Settings (Migration)](assetId:///82f8857f-7ab1-4738-ab6e-b1e95ea94924) .  
...
## See Also  
[Migrating Sybase Data to SQL Server/SQL Azure](assetId:///54a39f5e-9250-4387-a3ae-eae47c799811)  
