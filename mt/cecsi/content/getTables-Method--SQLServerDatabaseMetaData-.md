...
|REMARKS|**String**|The description of the table.<br /><br /> **Note:**  [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] does not return a value for this column.|  
|TYPE\_CAT|**String**|Not supported by the JDBC driver.|  
|TYPE\_SCHEM|**String**|Not supported by the JDBC driver.|  
|TYPE\_NAME|**String**|Not supported by the JDBC driver.|  
|SELF\_REFERENCING\_COL\_NAME|**String**|Not supported by the JDBC driver.|  
|REF\_GENERATION|**String**|Not supported by the JDBC driver.|  
  
> [!NOTE]  
>  For more information about the data returned by the getTables method, see "sp\_tables \(Transact\-SQL\)" in [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Books Online.  
  
## Example  
 The following example demonstrates how to use the getTables method to return the table description information for the Person.Contact table in the [!INCLUDE[ssSampleDBnormal](../content/includes/ssSampleDBnormal_md.md)] sample database.  
