...
You cannot enter any other option or password as the command line parameter. Otherwise, it results in an error. For more information, refer to the [Managing Passwords](assetId:///8c7d9f8e-06bb-476c-bbd2-15b61d5bba3c) section.  
...
For a tabular display of the SSMA Console command line options, refer to [Appendix - 1 &#40;OracleToSQL&#41;](../content/Appendix---1--OracleToSQL-.md).  
