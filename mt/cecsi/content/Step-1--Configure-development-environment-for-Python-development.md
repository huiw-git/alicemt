---
title: Step 1: Configure development environment for Python development
ms.custom: na
ms.date: 07/11/2016
...
manager: jhubbard
---
# Step 1: Configure development environment for Python development
...
Note that the Python Driver uses the TDS protocol, which is enabled by default in SQL Server and Azure SQL Database.  No additional configuration is required.  
