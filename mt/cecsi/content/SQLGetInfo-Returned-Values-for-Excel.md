      ...
      <table xmlns:caps="http://schemas.microsoft.com/build/caps/2013/11">
        ...
        <tbody>
          ...
          <tr>
            ...
            <TD>
              <para>255</para>
              <para>When using the Microsoft Excel Driver, a CREATE TABLE statement might allow 256 columns, but the 255-column limit is still valid and an insert into column 256 will fail.</para>
            </TD>
          </tr>
          <tr>
            <TD>
