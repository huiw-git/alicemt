...
<developerReferenceWithoutSyntaxDocument xmlns="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://ddue.schemas.microsoft.com/authoring/2003/5 http://dduestorage.blob.core.windows.net/ddueschema/developer.xsd">
  <introduction>
    <definitionTable>
      ...
      <definition>
        <para>In ODBC 3.<legacyItalic>x</legacyItalic>, the ODBC 2.<legacyItalic>x</legacyItalic> function <legacyBold>SQLAllocConnect</legacyBold> has been replaced by <legacyBold>SQLAllocHandle</legacyBold>. For more information, see <legacyLink xlink:href="6e7fe420-8cf4-4e72-8dad-212affaff317">SQLAllocHandle Function</legacyLink>.</para>
        <alert class="note">
