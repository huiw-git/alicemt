    ...
    <table xmlns:caps="http://schemas.microsoft.com/build/caps/2013/11">
      ...
      <tbody>
        <tr>
          ...
          <TD>
            <para>The only valid argument for <legacyItalic>szTableOwner</legacyItalic> is NULL because none of the drivers supports owner names. With <legacyItalic>szTableOwner</legacyItalic> set to NULL, all tables are returned. NULL is returned in the TABLE_OWNER column.</para>
          </TD>
        </tr>
        <tr>
          <TD>
        ...
        <tr>
          ...
          <TD>
            <para>For dBASE files, "TABLE" is the only table type supported.</para>
          </TD>
        </tr>
      </tbody>
    </table>
