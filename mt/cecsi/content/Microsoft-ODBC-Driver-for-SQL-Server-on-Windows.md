...
# Microsoft ODBC Driver for SQL Server on Windows
  The Microsoft ODBC Driver 13.1 and 11 for [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] are  stand-alone drivers that provide an application programming interface (API) that implements the standard ODBC interfaces to Microsoft [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)].  
