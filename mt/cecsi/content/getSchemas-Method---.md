...
|----------|----------|-----------------|  
|TABLE\_SCHEM|**String**|The name of the schema.|  
|TABLE\_CATALOG|**String**|The catalog name for the schema.|  
  
 The results are ordered by TABLE\_CATALOG, and then TABLE\_SCHEM. Each row has TABLE\_SCHEM as the first column and TABLE\_CATALOG as the second column.  
