...
|COLUMN_DEF|**String**|The default value of the column.<br /><br /> **Note:** This information is available with [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] and is JDBC driver-specific.|  
|SQL_DATA_TYPE|**smallint**|This column is the same as the **DATA_TYPE** column, except for the **datetime** and ISO **interval** data types.<br /><br /> **Note:** This information is available with [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] and is JDBC driver-specific.|  
