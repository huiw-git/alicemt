...
Lists the editors available in [!INCLUDE[msCoName](../content/includes/msCoName_md.md)] Visual Studio for the selected type of file. Choose the editor with which to open the document from the list displayed, or click **Add** to include a new editor in the list.  
