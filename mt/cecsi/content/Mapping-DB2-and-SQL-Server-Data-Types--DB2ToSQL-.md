...
DB2 database types differ from [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] database types. When you convert DB2 database objects to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] objects, you must specify how to map data types from DB2 to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)]. You can accept the default data type mappings, or you can customize the mappings as shown in the following sections.  
...
2.  To add a new mapping, do the following:  
    ...
    4.  Under **Target type**, select the target [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] data type.  
...
3.  To modify a data type mapping, do the following:  
    ...
    4.  Under **Target type**, select the target [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] data type.  
        ...
        Some types require a target data type length. If it is required, enter the new data length in the **Replace with** box, and then [!INCLUDE[clickOK](../content/includes/clickOK_md.md)]  
