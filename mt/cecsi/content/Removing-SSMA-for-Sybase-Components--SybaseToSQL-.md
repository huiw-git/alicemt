...
If you are sure your migrated databases do not use objects in the **sysdb.ssma\_syb** schema, you can remove the extension pack by using **Add or Remove Programs**.  
