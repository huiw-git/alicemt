...
2.  In the **Server Name** box, type the name of your [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] instance.  
  
3.  Click **Options**. The **Connect to Server** dialog box displays additional options.  
  
4.  Click the **Connection Properties** tab to configure the additional settings. The settings that are available vary depending upon the server type. The following settings are available for the [!INCLUDE[ssDE](../content/includes/ssDE_md.md)].  
