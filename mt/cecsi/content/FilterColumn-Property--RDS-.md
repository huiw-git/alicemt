  ...
  <parameters>
    <content>
      <definitionTable>
        ...
        <definition>
          <para>A <languageKeyword>String</languageKeyword> value that specifies the column on which to evaluate the filter criteria. The filter criteria are specified in the <legacyLink xlink:href="24eb03ba-ccfd-4353-b6af-03586b2da6fd">FilterCriterion</legacyLink> property.</para>
        </definition>
      </definitionTable>
    </content>
  </parameters>
