...
-   To use a string literal for PRINT and RAISERROR functions, select **Create new string**.  
    ...
    ```  
    When it uses **Create new string** mode, SSMA assumes that the [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] option CONCAT_NULL_YIELDS_NULL is OFF. Therefore, SSMA does not check for null arguments.  
...
-   In Optimistic mode, SSMA assumes that the [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] option CONCAT_NULL_YIELDS_NULL is off, and makes no checks for null arguments.  
...
**INDEX_COL function**  
ASE supports an optional *user_id* argument to the INDEX_COL function; however, [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)]/ SQL Azure does not support this argument. If you use the *user_id* argument, this function cannot be converted to [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)]/ SQL Azure syntax.  
...
[!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)]/ SQL Azure does not have an INDEX_COLORDER system function.  
...
[!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)]/ SQL Azure does not have an NEXT_IDENTITY system function.  
