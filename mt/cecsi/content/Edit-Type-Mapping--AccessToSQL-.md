...
## Options  
**Source type**  
Select the source data type to map to a [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] data type.  
...
**Target type**  
Select the [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] data type to which the source data type is mapped. When SSMA creates the table or stored procedure in [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)], the source data type will change to this data type.  
