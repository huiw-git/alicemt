...
---
# Start a Job
This topic describes how to start running a [!INCLUDE[msCoName](../content/includes/msCoName_md.md)] [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Agent job in [!INCLUDE[ssCurrent](../content/includes/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../content/includes/ssManStudioFull_md.md)], [!INCLUDE[tsql](../content/includes/tsql_md.md)] or SQL Server Management Objects.  
  
A job is a specified series of actions that [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Agent performs. [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] Agent jobs can run on one local server or on multiple remote servers.  
