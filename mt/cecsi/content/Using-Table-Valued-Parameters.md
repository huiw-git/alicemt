...
> [!NOTE]  
>  Support for Table\-Valued Parameters is available starting with  Microsoft JDBC Driver 6.0 for SQL Server \(Preview\)  
...
## Limitations of Microsoft JDBC Driver 6.0 for SQL Server \(Preview\)  
 The preview driver does not support Streaming of large objects in a table\-valued parameter.  
