...
By default, the SQLSRV driver treats warnings as errors; a call to a **sqlsrv** function that generates an error or a warning will return **false**. To disable this behavior, use the [sqlsrv\_configure](../content/sqlsrv_configure.md) function. When the following line of code is included at the beginning of a script, a **sqlsrv** function that generates only warnings \(no errors\) will not return **false**:  
