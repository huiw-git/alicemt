...
4.  Right\-click the alert that has the information you want to view and select **Properties**.  
    ...
    For more information on the available options contained in the *alert\_name***alert properties** dialog box, see:  
