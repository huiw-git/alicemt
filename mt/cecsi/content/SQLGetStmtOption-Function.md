  ...
  <section>
    <content>
      <definitionTable>
        ...
        <definition>
          <para>In ODBC 3.<legacyItalic>x</legacyItalic>, the ODBC 2.0 function <legacyBold>SQLGetStmtOption</legacyBold> has been replaced by <legacyBold>SQLGetStmtAttr</legacyBold>. For more information, see <legacyLink xlink:href="e321d460-e997-4527-aee6-207cf5a498e9">SQLGetStmtAttr</legacyLink>.</para>
          <alert class="note">
