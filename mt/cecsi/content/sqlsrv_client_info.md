...
|ExtensionVer|php_sqlsrv.dll version:<br /><br />3.2.xxxx.x (for [!INCLUDE[ssDriverPHP](../content/includes/ssDriverPHP_md.md)] version 3.2)<br /><br />3.1.xxxx.x (for [!INCLUDE[ssDriverPHP](../content/includes/ssDriverPHP_md.md)] version 3.1)|  
...
|ExtensionVer|php_sqlsrv.dll version:<br /><br />2.0.xxxx.x ([!INCLUDE[ssDriverPHP](../content/includes/ssDriverPHP_md.md)] version 2.0)|  
