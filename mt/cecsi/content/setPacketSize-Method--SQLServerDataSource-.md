...
# setPacketSize Method (SQLServerDataSource)
  Sets the current network packet size used to communicate with [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)], specified in bytes.  
