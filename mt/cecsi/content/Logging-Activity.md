...
---
# Logging Activity
By default, errors and warnings that are generated by the [!INCLUDE[ssDriverPHP](../content/includes/ssDriverPHP_md.md)] are not logged. This topic discusses how to configure logging activity.  
  
## Logging Activity Using the PDO\_SQLSRV Driver  
The only configuration that is available for the PDO\_SQLSRV driver is the pdo\_sqlsrv.log\_severity entry in the php.ini file.  
...
|SQLSRV\_LOG\_SYSTEM\_OFF \(0\)|Turns logging off. This is the default.|  
...
|SQLSRV\_LOG\_SEVERITY\_ERROR \(1\)|Specifies that errors will be logged. This is the default.|  
