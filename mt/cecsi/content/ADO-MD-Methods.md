  ...
  <introduction>
    <table xmlns:caps="http://schemas.microsoft.com/build/caps/2013/11">
      <tbody>
        <tr>
          <TD>
            <para>             <legacyLink xlink:href="a3aa594d-f9d4-4654-8625-ec20153ff5d9">Close</legacyLink>           </para>
          </TD>
          <TD>
        ...
        <tr>
          <TD>
            <para>             <legacyLink xlink:href="36b754b4-6b17-4dd1-a925-bca46938b7c4">GetSchemaObject</legacyLink>           </para>
          </TD>
          <TD>
            <para>Retrieves an ADO MD schema object (dimension, hierarchy, level, or member) by its unique name.</para>
          </TD>
        </tr>
        <tr>
          <TD>
            <para>             <legacyLink xlink:href="a87d8080-a238-45e5-bc80-9a8625b3810f">Open</legacyLink>           </para>
          </TD>
          <TD>
            <para>Retrieves the results of a multidimensional query and returns the results to a cellset.</para>
          </TD>
        </tr>
      </tbody>
    </table>
