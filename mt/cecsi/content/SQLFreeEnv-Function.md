  ...
  <section>
    <content>
      <definitionTable>
        ...
        <definition>
          <para>In ODBC 3<legacyItalic>.x</legacyItalic>, the ODBC 2.0 function <legacyBold>SQLFreeEnv</legacyBold> has been replaced by <legacyBold>SQLFreeHandle</legacyBold>. For more information, see <legacyLink xlink:href="17a6fcdc-b05a-4de7-be93-a316f39696a1">SQLFreeHandle</legacyLink>. </para>
          <alert class="note">
