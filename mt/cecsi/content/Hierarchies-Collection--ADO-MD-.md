...
<developerReferenceWithoutSyntaxDocument xmlns="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://ddue.schemas.microsoft.com/authoring/2003/5 http://dduestorage.blob.core.windows.net/ddueschema/developer.xsd">
  <introduction>
    <para>Contains the set of <legacyLink xlink:href="034af340-ac79-494e-ba5e-2b57da1cb9de">Hierarchy</legacyLink> objects from a dimension.</para>
  </introduction>
  <languageReferenceRemarks>
    <content>
      <para>
        <legacyBold>Hierarchies</legacyBold> is a standard ADO collection. With the properties and methods of a collection, you can do the following:  </para>
      <list class="bullet">
        <listItem>
      ...
      <list class="bullet">
        <listItem>
          <para>
            <legacyLink xlink:href="326dc32a-30e5-4f91-85ab-84663db41279">Properties, Methods, and Events</legacyLink>
          </para>
        </listItem>
      </list>
    </content>
