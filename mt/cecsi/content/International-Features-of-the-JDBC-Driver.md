...
# International Features of the JDBC Driver
  The internationalization features of the [!INCLUDE[jdbcNoVersion](../content/includes/jdbcNoVersion_md.md)] include the following:  
  
-   Support for a fully localized experience in the same languages as [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)]  
  
-   Support for the Java language conversions for locale sensitive [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] data  
