...
In the Oracle object tree located on the left side of the window, check the objects you want to invoke during the testing process. See the full list of testable objects in the [Testing Migrated Database Objects &#40;OracleToSQL&#41;](../content/Testing-Migrated-Database-Objects--OracleToSQL-.md) topic.  
