...
If you know or have previously deployed Active Directory Rights Management Services (AD RMS), you might be wondering how ---
translation.priority.ht: 
  - es-es
  - fr-fr
  - it-it
...
> [!NOTE]
> To make this comparison easier, some information here is repeated from [Requirements for Azure Rights Management](../../ems/AADRightsMgmt/Requirements-for-Azure-Rights-Management.md). Use that topic for more specific support and version information for ---
translation.priority.ht: 
  - es-es
  - fr-fr
  - it-it
...
translation.priority.mt: 
  ...
  - ja-jp
---
Azure Rights Management(Azure RMS) <br /> <br />|Active Directory Rights Management Services (AD RMS) <br /> <br />|
|--------------------------------------------------------------------------------------|--------------------------------------------------------|
...
|Enables implicit trust between organizations and users in any organization. This means that protected content can be shared between users within the same organization or across organizations when users have ---
translation.priority.ht: 
  - es-es
  - fr-fr
  - it-it
...
translation.priority.mt: 
  ...
  - ja-jp
---
Azure Rights Management, or users sign up for RMS for individuals. <br /> <br />|Trusts must be explicitly defined in a direct point-to-point relationship between two organizations by using either trusted user domains (TUDs) or federated trusts that you create by using Active Directory Federation Services (AD FS). <br /> <br />|
...
translation.priority.mt: 
  ...
  - ja-jp
---
Azure Rights Management and AD RMS use AES 128 for symmetric encryption.
