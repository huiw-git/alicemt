...
Use one of the following procedures to deactivate [!INCLUDE[aad_rightsmanagement_1](Azure Rights Management)].

> [!TIP]
> You can also use the Windows PowerShell cmdlet, [Disable-Aadrm](http://msdn.microsoft.com/library/windowsazure/dn629422.aspx), to deactivate [!INCLUDE[aad_rightsmanagement_2](Rights Management)].
...
4.  Select the directory to manage for [!INCLUDE[aad_rightsmanagement_2](Rights Management)], click **DEACTIVATE**, and then confirm your action.
