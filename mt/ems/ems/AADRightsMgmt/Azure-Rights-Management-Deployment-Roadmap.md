...
translation.priority.mt: 
  ...
  - ja-jp
---
Rights Management, do the following preparation:
...
3. Install the Windows PowerShell module for ---
translation.priority.ht: 
  - es-es
  - fr-fr
  - it-it
...
translation.priority.mt: 
  ...
  - ja-jp
---
Rights Management on at least one computer that has Internet access. You can do this step now, or later. For more information, see [Installing Windows PowerShell for Azure Rights Management](../../ems/AADRightsMgmt/Installing-Windows-PowerShell-for-Azure-Rights-Management.md).
...
translation.priority.mt: 
  ...
  - ja-jp
---
Rights Management, you might find the ---
translation.priority.ht: 
  - es-es
  - fr-fr
  - it-it
...
translation.priority.mt: 
  ...
  - ja-jp
---
Rights Management module for Windows PowerShell useful to help script or automate administrative changes. For more information, see [Administering Azure Rights Management by Using Windows PowerShell](../../ems/AADRightsMgmt/Administering-Azure-Rights-Management-by-Using-Windows-PowerShell.md).
