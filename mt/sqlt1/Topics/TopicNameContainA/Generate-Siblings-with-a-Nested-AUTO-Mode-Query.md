...
-   Sales order header information, `SalesOrderID`, `SalesPersonID`, and `OrderDate`. [!INCLUDE[ssSampleDBobject](../../Token/Other/ssSampleDBobject_md.md)] stores this information in the `SalesOrderHeader` table.  
