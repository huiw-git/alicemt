...
-   [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] stores the files created here in **C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA** by default. Your file names and locations might be different.  
...
5.  Create a database master key on the destination instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)]. For more information, see **Using Transact-SQL** below.  
...
7.  In Object Explorer in [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)], right-click the **Databases** folder and select **Attach…**.  
...
3.  Copy and paste the following example into the query window and click **Execute**.  
    ...
    ( FILENAME = N'C:Program FilesMicrosoft SQL ServerMSSQL13.MSSQLSERVERMSSQLDATACustRecords.mdf' ),  
    ( FILENAME = N'C:Program FilesMicrosoft SQL ServerMSSQL13.MSSQLSERVERMSSQLDATACustRecords_log.LDF' )  
    FOR ATTACH ;  
    GO  
    ```  
