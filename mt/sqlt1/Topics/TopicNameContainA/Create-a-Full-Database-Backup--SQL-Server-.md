...
2.  Optionally, specify one or more WITH options. A few basic WITH options are described here. For information about all the WITH options, see [BACKUP &#40;Transact-SQL&#41;](../Topic/BACKUP%20\(Transact-SQL\).md).  
    ...
    -   Basic backup set WITH options:  
         ...
         In [!INCLUDE[ssEnterpriseEd10](../../Token/Other/ssEnterpriseEd10_md.md)] and later only, specifies whether [backup compression](../../Topics/TopicNameNotContainA/Backup-Compression--SQL-Server-.md) is performed on this backup, overriding the server\-level default.  
