---
title: Add a Nested Table to a Mining Structure
ms.custom: na
...
6.  Click **OK**.  
     ...
     A new table column that contains the key column is added to the mining structure. For information about how to add additional columns, see [Add Columns to a Mining Structure](../../Topics/TopicNameContainA/Add-Columns-to-a-Mining-Structure.md).  
