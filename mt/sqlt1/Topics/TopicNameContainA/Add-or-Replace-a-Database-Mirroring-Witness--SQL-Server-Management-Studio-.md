...
# Add or Replace a Database Mirroring Witness (SQL Server Management Studio)
  If the database mirroring endpoints use Windows Authentication,, you can use [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] to add or replace a witness. Adding a witness in [!INCLUDE[ssManStudio](../../Token/Other/ssManStudio_md.md)] also changes the operating mode to high-safety mode with automatic failover.  
