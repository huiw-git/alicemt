...
1.  In Report Manager, browse to the report that has the document map.  
     ...
     For example, for the [!INCLUDE[ssSampleDBUserInputNonLocal](../../Token/Other/ssSampleDBUserInputNonLocal_md.md)] sample reports, the following URL specifies the report named Product Catalog.  
...
> [!NOTE]  
>  For more information about downloading sample reports, see [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)][Report Builder and Report Designer sample reports](http://go.microsoft.com/fwlink/?LinkId=198283).  
>   
