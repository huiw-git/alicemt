...
# Add, Delete, Change Scope of User-Defined Variable in a Package
 ...
 [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] also provides system variables that make system information available at run time and can be used in containers such as packages and event handlers. You cannot delete system variables.  
  
### To add a variable  
  
1.  In [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)], open the [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] package you want to work with.  
