 ...
 **Use full-text indexing**  
 This check box is checked and disabled because full-text indexing is always enabled in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)]. For more information, see [Full-Text Search](../../Topics/TopicNameNotContainA/Full-Text-Search.md).  
 ...
 **Path**  
 ...
 For FILESTREAM files, the path is a folder. The [!INCLUDE[ssDEnoversion](../../Token/Other/ssDEnoversion_md.md)] will create the underlying files in this folder.  
