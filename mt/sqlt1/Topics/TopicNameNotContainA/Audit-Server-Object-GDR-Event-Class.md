...
|**LoginName**|**nvarchar**|Name of the login of the user \(either a [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] security login or the [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] Windows login credentials in the form of DOMAIN\\username\).|11|Yes|  
