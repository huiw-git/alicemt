---
title: FORE_COLOR and BACK_COLOR Contents (MDX)
ms.custom: na
...
# FORE_COLOR and BACK_COLOR Contents (MDX)
  The **FORE\_COLOR** and **BACK\_COLOR** cell properties store color information for the text and the background of a cell, respectively, in the Microsoft Windows operating system red\-green\-blue \(RGB\) format.  
