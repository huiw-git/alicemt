...
##  <a name="bkmk_detailedsamples"></a> Detailed Reporting Services PowerShell Samples  
 In addition to the following samples, see the section “Windows PowerShell Script” in the topic [Windows PowerShell script for Steps 1–4](../../Topics/TopicNameNotContainA/Install-The-First-Report-Server-in-SharePoint-Mode.md).  
