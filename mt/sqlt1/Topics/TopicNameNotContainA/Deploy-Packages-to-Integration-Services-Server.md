...
3.  Complete the wizard. Follow the remaining steps described in [Package Deployment Model](../../Topics/TopicNameNotContainA/Integration-Services-Deployment-Wizard.md).  
...
5.  Complete the wizard. Follow the remaining steps described in [Package Deployment Model](../../Topics/TopicNameNotContainA/Integration-Services-Deployment-Wizard.md).  
