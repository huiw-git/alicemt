...
-   In the **Data Flow** screen of your [!INCLUDE[ssISCurrent](../../Token/Other/ssISCurrent_md.md)] project, right click the ODBC destination and select **Show Advanced Editor**.  
