...
---
# Drop XML Indexes
  The [DROP INDEX &#40;Transact-SQL&#41;](../Topic/DROP%20INDEX%20\(Transact-SQL\).md)[!INCLUDE[tsql](../../Token/Other/tsql_md.md)] statement can be used to drop existing primary or secondary XML and non\-XML indexes. However, no options of DROP INDEX apply to XML indexes. If you drop the primary XML index, any secondary indexes that are present are also deleted.  
...
## Example: Creating an XML Index by Using the DROP\_EXISTING Index Option  
