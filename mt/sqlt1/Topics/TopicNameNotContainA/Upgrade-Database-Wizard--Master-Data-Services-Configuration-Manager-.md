...
# Upgrade Database Wizard (Master Data Services Configuration Manager)
  Use the **Upgrade Database Wizard** to upgrade a [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)] database.  
...
|------------------|-----------------|  
|**SQL Server instance**|The name of the currently selected [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)][!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] instance.|  
|**Master Data Services database**|The name of the currently selected [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)] database.|  
