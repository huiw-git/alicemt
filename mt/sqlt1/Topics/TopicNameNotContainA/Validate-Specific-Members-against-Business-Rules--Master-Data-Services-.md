...
# Validate Specific Members against Business Rules (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)], apply business rules selectively when you want to update or validate subsets of members against business rules.  
...
1.  On the [!INCLUDE[ssMDSmdm](../../Token/Other/ssMDSmdm_md.md)] home page, from the **Model** drop\-down list, select a model.  
