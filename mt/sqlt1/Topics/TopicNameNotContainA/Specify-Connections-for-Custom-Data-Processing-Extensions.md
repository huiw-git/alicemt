...
-   Custom [!INCLUDE[dnprdnshort](../../Token/Other/dnprdnshort_md.md)] data providers \(if you are accessing data from DB2.NET, Oracle, ODP.NET, or Teradata data sources, you might be using a custom .NET data provider\)  
