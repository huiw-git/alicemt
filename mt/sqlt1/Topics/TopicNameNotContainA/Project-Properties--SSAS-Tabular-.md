...
1.  In [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)], in **Solution Explorer**, right\-click the project, and then click **Properties**.  
