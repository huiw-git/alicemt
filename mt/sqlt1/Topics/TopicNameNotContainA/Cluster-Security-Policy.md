...
## Options  
 Specify global or local domain groups for clustered services. All resource permissions are controlled by domain\-level groups that include [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] service accounts as group members. For more information about service security IDs \(SID\) functionality on [!INCLUDE[nextref_longhorn](../../Token/Other/nextref_longhorn_md.md)], see [Configure Windows Service Accounts and Permissions](../../Topics/TopicNameNotContainA/Configure-Windows-Service-Accounts-and-Permissions.md).  
