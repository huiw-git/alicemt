...
# Use the Object Explorer Details to Monitor Availability Groups (SQL Server Management Studio)
  This topic describes how to use the **Object Explorer Details** pane of [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] to monitor and manage existing Always On availability groups, availability replicas, and availability databases.  
...
###  <a name="Prerequisites"></a> Prerequisites  
 You must be connected to the instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] (server instance) that hosts either the primary replica or a secondary replica.  
...
2.  In Object Explorer, connect to the instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] on which you want to monitor an availability group, and click the server name to expand the server tree.  
 ...
 **Role**  
 Indicates the current role of the availability replica, either **Primary** or **Secondary**. For information about [!INCLUDE[ssHADR](../../Token/Other/ssHADR_md.md)] roles, see [Overview of Always On Availability Groups &#40;SQL Server&#41;](../../Topics/TopicNameNotContainA/Overview-of-Always-On-Availability-Groups--SQL-Server-.md).  
