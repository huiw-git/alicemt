...
##  <a name="bkmk_sharepoint"></a> Configuration Settings for a SharePoint mode Report Server  
 You can turn report execution logging on or off from the system settings of a [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] service application.  
...
2.  Click the name of the [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] service application you want to configure.  
...
1.  From the **System Settings** page of your [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] services application, find the **User\-defined** section.  
...
-   **ExternalImages**  
     ...
     Added in [!INCLUDE[ssSQL11](../../Token/Other/ssSQL11_md.md)]  
