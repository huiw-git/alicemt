...
# OLEDB DataRead Event Class
  The OLEDB DataRead event class occurs when [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] calls an OLE DB provider for distributed queries and remote stored procedures. Include this event class in traces that monitor when [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] makes a data request call to the OLE DB provider.  
