...
---
# MSReportServer_ConfigurationSetting Methods
  The MSReportServer\_ConfigurationSetting class of the Report Server WMI Provider provides the following public methods.  
...
|[ListInstalledSharePointVersions Method &#40;WMI&#41;](../../Topics/TopicNameNotContainA/ListInstalledSharePointVersions-Method--WMI-.md)|Returns a set of tokens that represent the versions of Microsoft [!INCLUDE[winSPServ](../../Token/Other/winSPServ_md.md)] [!INCLUDE[offSPServ](../../Token/Other/offSPServ_md.md)], [!INCLUDE[SPF2010](../../Token/Other/SPF2010_md.md)], or [!INCLUDE[SPS2010](../../Token/Other/SPS2010_md.md)] that are installed on the same computer as the report server.|  
