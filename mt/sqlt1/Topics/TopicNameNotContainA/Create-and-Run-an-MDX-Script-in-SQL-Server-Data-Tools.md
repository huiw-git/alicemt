...
# Create and Run an MDX Script in SQL Server Data Tools
  To create and run an MDX Script in  [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)], you need to be in [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)] with a cube already created and ready for editing.  
