...
>  Users access data sources when they create and run queries. You should grant minimal permissions on the data sources, such as read-only permissions.  
 ...
 For more information about working with a [!INCLUDE[extEssbase](../../Token/Other/extEssbase_md.md)] multidimensional data source, see [Hyperion Essbase Connection Type &#40;SSRS&#41;](../../Topics/TopicNameNotContainA/Hyperion-Essbase-Connection-Type--SSRS-.md).  
