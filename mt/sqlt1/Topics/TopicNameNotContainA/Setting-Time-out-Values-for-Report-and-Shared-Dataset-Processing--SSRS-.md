...
# Setting Time-out Values for Report and Shared Dataset Processing (SSRS)
  You can [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] specify time\-out values to set limits on how system resources are used. Report server supports two time\-out values:  
