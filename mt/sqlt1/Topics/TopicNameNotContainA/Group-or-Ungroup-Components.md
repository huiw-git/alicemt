...
-   When a package is saved, [!INCLUDE[ssIS](../../Token/Other/ssIS_md.md)] Designer saves the grouping, but the grouping has no effect on package execution. The ability to group components is a design\-time feature; it does not affect the run\-time behavior of the package.  
