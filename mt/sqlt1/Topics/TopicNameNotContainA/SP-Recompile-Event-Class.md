...
|SqlHandle|**varbinary**|64\-bit hash based on the text of an ad hoc query or the database and object ID of an SQL object. This value can be passed to sys.dm\_exec\_sql\_text to retrieve the associated SQL text.|63|Yes|  
