...
-   Green check \- ![](../../Images/Image/ImageNotContaina/Well_utilized.gif "Well_utilized") \- Number of data\-tier application which are not violating resource utilization policies. Resources are well\-utilized.  
...
-   Instance Name \- Displays the name of the instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] that hosts the data\-tier application.  
