...
##  <a name="bkmk_ssdt"></a> Batch Processing in SQL Server Data Tools  
 Before objects can be processed in [!INCLUDE[ssBIDevStudio](../../Token/Other/ssBIDevStudio_md.md)], the project that contains the objects must be deployed. For more information, see [Deploy Analysis Services Projects &#40;SSDT&#41;](../../Topics/TopicNameNotContainA/Deploy-Analysis-Services-Projects--SSDT-.md).  
