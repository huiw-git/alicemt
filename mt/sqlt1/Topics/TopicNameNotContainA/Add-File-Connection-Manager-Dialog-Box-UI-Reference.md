...
> [!NOTE]  
>  The built\-in tasks and data flow components in [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] do not use the Multiple Files connection manager. However, you can use this connection manager in the Script task or Script component.  
