...
## Changing the View Mode  
 [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] features a view mode called **Tabbed Documents**, which allows you to open multiple editors and documents simultaneously and access them through tabs at the top of the Editor. You can alternatively open the [!INCLUDE[ssManStudio](../../Token/Other/ssManStudio_md.md)] environment in Multiple Document Interface \(MDI\) mode, which joins windows without the tabs, and allows each window to be tiled, minimized, and so on.  
...
3.  Click **Tabbed documents** or **MDI environment**.  
    ...
    > [!NOTE]  
    >  The changes will not take effect until [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] is restarted.  
