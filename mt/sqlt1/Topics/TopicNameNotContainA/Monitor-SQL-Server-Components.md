...
# Monitor SQL Server Components
  Monitoring is important because [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] provides a service in a dynamic environment. The data in the application changes. The type of access that users require changes. The way that users connect changes. The types of applications accessing [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] may even change, but [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] automatically manages system\-level resources, such as memory and disk space, to minimize the need for extensive system\-level manual tuning. Monitoring lets administrators identify performance trends to determine if changes are necessary.  
  
 To monitor any component of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] effectively:  
...
## Determine Your Monitoring Goals  
 To monitor [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] effectively you should clearly identify your reason for monitoring. Reasons can include the following:  
...
## Select the Appropriate Tool  
 After determining why you are monitoring, you should select the appropriate tools for that type of monitoring. The Windows operating system and [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] provide a complete set of tools to monitor servers in transaction\-intensive environments. These tools clearly reveal the condition of an instance of the SQL Server Database Engine or an instance of SQL Server Analysis Services.  
...
-   Task Manager  
 ...
 [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] provides the following tools for monitoring components of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)]:  
...
-   [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] Activity Monitor  
  
-   [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] Graphical Showplan  
...
-   Trace flags  
 ...
 For more information about [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] monitoring tools, see [Performance Monitoring and Tuning Tools](../../Topics/TopicNameNotContainA/Performance-Monitoring-and-Tuning-Tools.md).  
  
## Identify the Components to Monitor  
 The third step to monitoring an instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] is to identify the components that you monitor. For example, if you are using [!INCLUDE[ssSqlProfiler](../../Token/Other/ssSqlProfiler_md.md)] to trace a server you can define the trace to collect data about specific events. You can also exclude events that do not apply to your situation.  
