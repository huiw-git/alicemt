...
|-------------------------------|-----------------------------------------|------------------------------------------------------|-------------------------------------------------------|--------------------------------------|--------------------------------------|----------------------------|-------------------------|-------------------------|  
|[!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] relational database|[Microsoft SQL Server](#MicrosoftSQLServer)|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|Extends System.Data.SqlClient|Y|Y|[!INCLUDE[ssVersion2005](../../Token/Other/ssVersion2005_md.md)] and later.|Y|Y|  
|[!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] relational database|OLEDB|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|Extends System.Data.OledbClient|Y|Y|[!INCLUDE[ssVersion2005](../../Token/Other/ssVersion2005_md.md)] and later.|Y|Y|  
|[!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] relational database|[ODBC](#ODBC)|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|Extends System.Data.OdbcClient|Y|Y|[!INCLUDE[ssVersion2005](../../Token/Other/ssVersion2005_md.md)] and later.|Y|Y|  
|[!INCLUDE[ssSDS](../../Token/Other/ssSDS_md.md)]|[Windows Azure SQL Database](#Azure)|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|Extends System.Data.SqlClient|N\/A|N\/A|[!INCLUDE[ssSDS](../../Token/Other/ssSDS_md.md)]|Y|Y|  
|[!INCLUDE[ssDW](../../Token/Other/ssDW_md.md)] appliance|[Microsoft Parallel Data Warehouse](#PWD)|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|N\/A|N\/A|N\/A|[!INCLUDE[ssDWfull](../../Token/Other/ssDWfull_md.md)]|Y|Y|  
|[!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] multidimensional database|[Microsoft SQL Server Analysis Services](#AnalysisServices)|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|Uses ADOMD.NET|Y|Y|[!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] and later<br /><br /> [!INCLUDE[ssVersion2005](../../Token/Other/ssVersion2005_md.md)] and later|Y|Y|  
|[!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] multidimensional database|OLEDB|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|Extends System.Data.OledbClient<br /><br /> Version 10.0|Y|Y|[!INCLUDE[ssKatmai](../../Token/Other/ssKatmai_md.md)] [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)]|Y|Y|  
|[!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] multidimensional database|OLEDB|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|Extends System.Data.OledbClient<br /><br /> Version 9.0|Y|Y|[!INCLUDE[ssVersion2005](../../Token/Other/ssVersion2005_md.md)] [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)]|Y|Y|  
|[!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] multidimensional database|OLEDB|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|Extends System.Data.OledbClient<br /><br /> Version 8.0|Y|N|N\/A|Y|N|  
|SharePoint lists|[Microsoft SharePoint List](#SharePointList)|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|Gets data from Lists.asmx or the SharePoint object model API interfaces.<br /><br /> See [Note](#SharePointList).|N|Y|SharePoint 2013 Products<br /><br /> SharePoint 2010 Products|Y|Y|  
|SharePoint lists|[Microsoft SharePoint List](#SharePointList)|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|Gets data from Lists.asmx or the SharePoint object model API interfaces.<br /><br /> See [Note](#SharePointList).|Y|Y|[!INCLUDE[winSPServ](../../Token/Other/winSPServ_md.md)] 3.0 and [!INCLUDE[offSPServ](../../Token/Other/offSPServ_md.md)] 2007|Y|Y|  
|XML|[XML](#XML)|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|XML data sources do not have platform dependencies.|N\/A|N\/A|[!INCLUDE[vstecwebservices](../../Token/Other/vstecwebservices_md.md)] or documents|Y|Y|  
|Report Server Model|Report Model|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension for a published SMDL file|Data sources for a model use Built\-in data processing extensions.<br /><br /> Oracle\-based models requires Oracle client components.<br /><br /> Teradata\-based models require .NET Data Provider for Teradata from Teradata.<br /><br /> See Teradata documentation for platform support.|N\/A|N\/A|Models can be created from:[!INCLUDE[ssVersion2005](../../Token/Other/ssVersion2005_md.md)] and later.<br /><br /> [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)]<br /><br /> Oracle 9.2.0.3 or later<br /><br /> Teradata V14, v13, v12, and v6.2|Y|Y|  
|SAP multidimensional database|Sap BI NetWeaver|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|See SAP documentation for platform support.|N\/A|N\/A|SAP BI NetWeaver 3.5|Y|N\/A|  
|[!INCLUDE[extEssbase](../../Token/Other/extEssbase_md.md)]|[Hyperion Essbase](#Hyperion)|Built\-in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] data processing extension|See Hyperion documentation for platform support.|Y|N\/A|[!INCLUDE[extEssbase](../../Token/Other/extEssbase_md.md)] 9.3.1|Y|N\/A|  
