---
title: Text Box Properties Dialog Box, Alignment (Report Builder and SSRS)
ms.custom: na
...
## Options  
 **Horizontal**  
 Specify where the value is positioned horizontally within a selected cell or data region. By default, **Default** is selected. The value for Default is **General**. For more information about how general text alignment is calculated, see [Formatting Text and Placeholders &#40;Report Builder and SSRS&#41;](../../Topics/TopicNameNotContainA/Formatting-Text-and-Placeholders--Report-Builder-and-SSRS-.md). Click the **Expression** \(*fx*\) button to edit the expression.  
