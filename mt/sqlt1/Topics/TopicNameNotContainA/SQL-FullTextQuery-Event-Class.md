...
# SQL:FullTextQuery Event Class
  The SQL:FullTextQuery event class occurs when [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] executes a full text query. Include this event class in traces that are monitoring problems associated with full text catalogs.  
...
|TextData|**nvarchar**|The full text portion of the query submitted to [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)].|1|No|  
