...
# Create Instances of XML Data
 ...
 In [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)], you can generate XML instances in the following ways:  
...
```  
 ...
 [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] internally represents XML in an efficient binary representation that uses UTF\-16 encoding. User\-provided encoding is not preserved, but is considered during the parse process.  
