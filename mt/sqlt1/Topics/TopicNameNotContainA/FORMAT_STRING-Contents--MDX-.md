...
# FORMAT_STRING Contents (MDX)
  The **FORMAT\_STRING** cell property formats the **VALUE** cell property, creating the value for the **FORMATTED\_VALUE** cell property. The **FORMAT\_STRING** cell property handles both string and numeric raw values, applying a format expression against the value to return a formatted value for the **FORMATTED\_VALUE** cell property. The following tables detail the syntax and formatting characters used to handle string and numeric values.  
