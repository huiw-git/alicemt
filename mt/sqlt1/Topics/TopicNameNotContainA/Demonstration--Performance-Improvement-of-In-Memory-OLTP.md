...
### Step 1a: Prerequisite If Using [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)]  
 The steps in this first subsection applies only if you are running in [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)], and does not apply if you are running in [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)]. Do the following:  
  
1.  Use SQL Server Management Studio \(SSMS.exe\) to connect to your [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)]. Or any tool similar to SSMS.exe is fine.  
...
### Step 1b: Prerequisite If Using [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)]  
 This subsection applies only if you are using [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)]. Do the following:  
