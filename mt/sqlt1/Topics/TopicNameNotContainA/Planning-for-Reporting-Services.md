...
# Planning for Reporting Services
  Use these topics to better understand [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)]. Learn how to install and configure the [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] environment to best fit your needs.  
  
 ![Small File Folder Icon](../../Images/Image/ImageNotContaina/filefolder_small.png "filefolder_small") **General Reporting Services Feature Planning and Architecture**  
 ...
 ![Small File Folder Icon](../../Images/Image/ImageNotContaina/filefolder_small.png "filefolder_small") **Reporting Services setup**  
