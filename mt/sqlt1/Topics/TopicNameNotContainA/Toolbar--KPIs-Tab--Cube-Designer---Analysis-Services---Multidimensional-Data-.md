 ...
 **Reconnect**  
 Click to reconnect the **KPIs** tab to the [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] instance and database that contains the cube, if the session for the **KPIs** tab is disconnected due to connection loss or timeout.  
