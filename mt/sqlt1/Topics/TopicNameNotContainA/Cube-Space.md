...
```  
 ...
 Each of these three previous queries demonstrates the effect of the auto\-exists behavior in [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)].  
...
> [!NOTE]  
>  Notice that the **WITH** keyword is used with the [CurrentMember \(MDX\)](../Topic/CurrentMember%20\(MDX\).md) and [Name \(MDX\)](../Topic/Name%20\(MDX\).md) functions to create a calculated member for use in the query. For more information, see [The Basic MDX Query &#40;MDX&#41;](../../Topics/TopicNameNotContainA/The-Basic-MDX-Query--MDX-.md).  
