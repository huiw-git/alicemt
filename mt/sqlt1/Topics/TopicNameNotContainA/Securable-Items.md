...
---
# Securable Items
  [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] uses role\-based security to control access to items that are stored on a report server. When you grant a user access to a report server, you typically do so by creating a pair of role assignments:  
