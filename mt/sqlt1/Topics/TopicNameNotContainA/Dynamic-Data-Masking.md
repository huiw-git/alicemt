...
# Dynamic Data Masking
  ![Dynamic data masking](../../Images/Image/ImageNotContaina/Dynamic-data-masking.png "Dynamic data masking")  
  
 **Topic Status:** Some information in this topic is preview and subject to change in future releases. Preview information describes new features or changes to existing features in [!INCLUDE[ssSQL15](../../Token/Other/ssSQL15_md.md)].  
