...
## Options  
 **Connection manager**  
 Select from the list of existing [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] connections, or create a new [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] connection by using the **New** button described as follows.  
