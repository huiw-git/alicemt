...
![ssrs_project_properties](../../Images/Image/ImageNotContaina/ssrs_project_properties.png)
 ...
 **Configuration Manager**  
 Manage configurations for the entire solution or to add additional configurations. For more information, see the [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[vsprvs](../../Token/Other/vsprvs_md.md)] documentation.  
 ...
 **TargetServerVersion**  
 Select either the appropriate version of [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] or select **Detect Version** to automatically determine the version installed on the server identified by the **TargetServer URL** property. The default value is **[!INCLUDE[ssCurrent_md](../../Token/Other/ssCurrent_md.md)]**.  
