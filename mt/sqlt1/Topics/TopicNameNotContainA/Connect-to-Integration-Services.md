...
# Connect to Integration Services
  Before you connect to the [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] service, the administrator must grant you access to the service. For more information, see [Grant Permissions to Integration Services Service](../../Topics/TopicNameNotContainA/Grant-Permissions-to-Integration-Services-Service.md).  
