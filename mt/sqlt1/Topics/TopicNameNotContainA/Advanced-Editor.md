...
---
# Advanced Editor
  Use the **Advanced Editor** dialog box to configure to configure properties for the selected [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] object.  
  
 The **Advanced Editor** is available for most [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] objects that have configurable properties. It is the only editor available for those objects that do not expose a custom user interface.  
  
 [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] data flow objects have properties that can be set at the component level, the input and output level, and the input and output column level. The **Advanced Editor** enumerates all the common and custom properties of the selected object and displays them on up to four of the following five tabs as applicable:  
...
-   [Path Properties](../../Topics/TopicNameNotContainA/Path-Properties.md)  
 ...
 For more information about the specific component that you are editing, see the description of the component in the Data Flow Elements section of the [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] Objects and Concepts documentation:  
