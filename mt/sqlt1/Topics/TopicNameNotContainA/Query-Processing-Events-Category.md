---
title: Query Processing Events Category
ms.custom: na
...
|VertiPaq SE Query End|83|VertiPaq SE query|  
 ...
 For information about the columns associated with each of the Query Processing event classes, see [Query Processing Events Data Columns](../../Topics/TopicNameNotContainA/Query-Processing-Events-Data-Columns.md).  
