...
## Example  
 The following `SELECT` query retrieves product category and subcategory information in the [!INCLUDE[ssSampleDBobject](../../Token/Other/ssSampleDBobject_md.md)] database. There is no nested FOR XML in the query.  
...
```  
 ...
 The following query is just an extension of the previous query. It shows the full product hierarchy in the [!INCLUDE[ssSampleDBobject](../../Token/Other/ssSampleDBobject_md.md)] database. This includes the following:  
...
-   Products in each model  
 ...
 You might find the following query useful in understanding the [!INCLUDE[ssSampleDBobject](../../Token/Other/ssSampleDBobject_md.md)] database:  
