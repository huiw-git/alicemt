...
|-------------|------------------------|  
|[!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Distributed Replay controller service account|`<Controller_Installation_Path>\DReplayController` \(Read, Write, Delete\)<br /><br /> `DReplayServer.xml` file \(Read, Write\)|  
...
|Distributed Replay client|[!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Distributed Replay client service account|Local Access<br /><br /> Remote Access<br /><br /> Local Launch<br /><br /> Remote Launch<br /><br /> Local Activation<br /><br /> Remote Activation|  
