...
# OLE Automation Sample Script
  This topic contains an example of a [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] statement batch that uses the OLE Automation stored procedures to create and use an SQL\-DMO SQLServer object in the local instance of the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)]. Parts of the code are used as examples in the reference topics for the OLE Automation system stored procedures.  
