...
```  
 ...
 For more information about Database and Server Keys in [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)], see [SQL Server and Database Encryption Keys &#40;Database Engine&#41;](../../Topics/TopicNameNotContainA/SQL-Server-and-Database-Encryption-Keys--Database-Engine-.md).  
