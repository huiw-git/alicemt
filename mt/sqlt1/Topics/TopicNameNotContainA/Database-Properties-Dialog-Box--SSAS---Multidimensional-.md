...
# Database Properties Dialog Box (SSAS - Multidimensional)
  Use the **Database Properties** dialog box in [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] to set the properties of a database in an [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] database. You can display the **Database Properties** dialog box by right\-clicking a database in Object Explorer and selecting **Properties**.  
