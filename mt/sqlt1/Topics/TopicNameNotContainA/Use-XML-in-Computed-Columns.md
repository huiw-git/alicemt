...
|Topic|Description|  
|-----------|-----------------|  
|[Promote Frequently Used XML Values with Computed Columns](../../Topics/TopicNameNotContainA/Promote-Frequently-Used-XML-Values-with-Computed-Columns.md)|Describes how to use property promotion with computed columns and property tables.|  
