...
# Add Copy of Existing Package
  Use the **Add Copy of Existing Package** dialog box to add a copy of a package stored in [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)], the file system, or the SSIS Package Store to an [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] project.  
 ...
 **Server**  
 If copying from [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] or the SSIS Package Store, type a server name or select a server from the list.  
  
 **Authentication type**  
 If copying from [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)], select an authentication type.  
