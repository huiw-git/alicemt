...
[!INCLUDE[om12long](../../om/manage//om12long_md.md)] provides monitoring of UNIX and Linux computers similar to monitoring of Windows computers. You can monitor health, performance, obtain reports, run tasks, and implement needed customizations.  
