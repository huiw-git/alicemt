...
> [!IMPORTANT]  
> After you import and configure the IntelliTrace Profiling management pack, the IntelliTrace tasks are not available until you restart the [!INCLUDE[omblue_2](../../om/manage//omblue_2_md.md)] console.  
...
2.  In the [!INCLUDE[omblue_2](../../om/manage//omblue_2_md.md)] console, click **Monitoring**, open an alert view, and then click the alert that you want to investigate.  
...
2.  In the [!INCLUDE[omblue_2](../../om/manage//omblue_2_md.md)] console, click **Monitoring**, expand **Application Monitoring**, and then expand **.NET Monitoring**.  
...
16. To see the IntelliTrace snapshots, in the [!INCLUDE[omblue_2](../../om/manage//omblue_2_md.md)] console, click **Monitoring**, expand **IntelliTrace Profiling**, and then click **New Alerts**. The **New Traces** pane shows an alert for each snapshot that you have collected.  
