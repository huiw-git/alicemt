...
Use the following keyboard shortcuts to perform actions in [!INCLUDE[ise_1](../../Tokens/ise_1_md.md)]. [!INCLUDE[ise_2](../../Tokens/ise_2_md.md)] is available as part of the Windows Server and Windows client operating systems, but can also be installed on some older Windows operating systems as part of the [Windows Management Framework 4.0 download package](http://go.microsoft.com/fwlink/?LinkID=293881).
...
You can use the following keyboard shortcuts to start the Windows PowerShell console (PowerShell.exe) or to exit [!INCLUDE[ise_2](../../Tokens/ise_2_md.md)].
