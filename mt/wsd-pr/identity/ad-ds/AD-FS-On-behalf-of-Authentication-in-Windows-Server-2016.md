...
This walkthrough provides instruction for implementing an on-behalf-of (OBO) authentication using AD FS in Windows Server 2016 TP5.  o learn more about OBO authentication please read [AD FS Scenarios for Developers](AD%20FS%20Scenarios%20for%20Developers.md)  
...
![OBO Flow](../../identity/ad-ds/media/ADFS_OBO28.png)  
...
![Create an application group](../../identity/ad-ds/media/ADFS_OBO2.PNG)  
...
![Add application group](../../identity/ad-ds/media/ADFS_OBO11.PNG)  
...
![Properties](../../identity/ad-ds/media/ADFS_OBO16.PNG)  
  
![Configure Web API](../../identity/ad-ds/media/ADFS_OBO18.PNG)  
...
![Choose Access Control Policy](../../identity/ad-ds/media/ADFS_OBO1.PNG)  
...
![Configure Application Permissions](../../identity/ad-ds/media/ADFS_OBO12.PNG)  
...
![Properties](../../identity/ad-ds/media/ADFS_OBO10.PNG)  
...
![Add Application](../../identity/ad-ds/media/ADFS_OBO15.PNG)  
...
![Add a new application](../../identity/ad-ds/media/ADFS_OBO19.PNG)  
...
![Additional details](../../identity/ad-ds/media/ADFS_OBO20.PNG)  
...
![Configure application credentials](../../identity/ad-ds/media/ADFS_OBO17.PNG)  
...
![Visual Studio](../../identity/ad-ds/media/ADFS_OBO4.PNG)  
...
![Work and School Accounts](../../identity/ad-ds/media/ADFS_OBO9.PNG)  
...
![Web API 2 Controller](../../identity/ad-ds/media/ADFS_OBO3.PNG)  
  
* Give appropriate controller name  
  
![Add Controller](../../identity/ad-ds/media/ADFS_OBO13.PNG)  
...
![Add application](../../identity/ad-ds/media/ADFS_OBO6.PNG)  
...
![SSL URL](../../identity/ad-ds/media/ADFS_OBO8.PNG)  
  
![Configure Web API](../../identity/ad-ds/media/ADFS_OBO7.PNG)  
...
![Properties](../../identity/ad-ds/media/ADFS_OBO5.PNG)  
...
![Run the Solution](../../identity/ad-ds/media/ADFS_OBO14.PNG)  
  
Hit F5 and execute the solution  
  
![Hit F5](../../identity/ad-ds/media/ADFS_OBO24.PNG)  
  
Click on the sign-in button. You will be prompted to sign-in using AD FS  
  
![Click on the sign-in button](../../identity/ad-ds/media/ADFS_OBO25.PNG)  
...
![Add a ToDo item](../../identity/ad-ds/media/ADFS_OBO26.PNG)  
...
![Success](../../identity/ad-ds/media/ADFS_OBO27.PNG)  
...
![Fiddler](../../identity/ad-ds/media/ADFS_OBO22.PNG)  
...
![Fiddler](../../identity/ad-ds/media/ADFS_OBO23.PNG)