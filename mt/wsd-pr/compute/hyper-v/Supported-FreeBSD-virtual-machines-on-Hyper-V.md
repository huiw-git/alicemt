...
|**[Core](../../compute/hyper-v/Feature-Descriptions-for-Linux-and-FreeBSD-virtual-machines-on-Hyper-V.md#BKMK_core)**|2016, 2012 R2, 2012, 2008 R2|**√**|**√**|**√**|**√** Note 3|**√** Note 3|  
...
1.  To install BIS on FreeBSD 9.x, you need to add UUIDs for all devices listed in fstab before installation. For more information, see [Add UUIDs for all devices listed in fstab](../Topic/Best%20practices%20for%20running%20FreeBSD%20on%20Hyper-V.md#BKMK_UUID).  
  
2.  To install BIS on FreeBSD 8.x, you need to disable the fast IDE driver or create GEOM labels. For more information, see [Disable the Fast IDE Driver](../Topic/Best%20practices%20for%20running%20FreeBSD%20on%20Hyper-V.md#BKMK_IDE) or [Create GEOM labels on FreeBSD 8.x](../Topic/Best%20practices%20for%20running%20FreeBSD%20on%20Hyper-V.md#BKMK_GEOM).  
  
3.  The virtual DVD drive will not be recognized when BIS drivers are loaded on FreeBSD 8.x and 9.x unless you disable the fast IDE driver. For more information, see [Disable the Fast IDE Driver](../Topic/Best%20practices%20for%20running%20FreeBSD%20on%20Hyper-V.md#BKMK_IDE).  
