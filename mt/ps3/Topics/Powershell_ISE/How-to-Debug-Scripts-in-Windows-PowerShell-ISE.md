...
This topic describes how to debug scripts on a local computer by using the [!INCLUDE[ise_1](../../Tokens/ise_1_md.md)] visual debugging features.
...
Displays all breakpoints in the current [!INCLUDE[wps_1](../../Tokens/wps_1_md.md)] session.
