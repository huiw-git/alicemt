...
|**Hardware 09A - Search for computers**|Displays an asset manager summary of computers matching keyword filters on computer name, [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] site, domain, top console user, operating system, manufacturer, or model.|  
...
|**Certificate issues on mobile devices that are managed by the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client for Windows CE and that are not healthy**|Displays detailed information about certificate issues on mobile devices that are managed by the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client for Windows CE.|  
|**Client deployment failure for mobile devices that are managed by the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client for Windows CE**|Displays detailed information about deployment failure for mobile devices that are managed by the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client for Windows CE.|  
|**Client deployment status details for mobile devices that are managed by the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client for Windows CE**|Displays information about the status of mobile devices that are managed by the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client for Windows CE.|  
|**Client deployment success for mobile devices that are managed by the Configuration Manager client for Windows CE**|Displays detailed information about deployment success for mobile devices that are managed by the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client for Windows CE.|  
|**Communication issues on mobile devices that are managed by the Configuration Manager client for Windows CE and that are not healthy**|This report contains detailed information about communication issues on mobile devices that are managed by the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client for Windows CE.|  
...
|**Health information for mobile devices that are managed by the Configuration Manager client for Windows CE**|Displays detailed health information for mobile devices that are managed by the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client for Windows CE.|  
|**Health summary for mobile devices that are managed by the Configuration Manager client for Windows CE**|Displays health summary information for mobile devices that are managed by the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client for Windows CE.|  
...
|**List of Devices enrolled per user in Microsoft Intune**|Displays all devices a user has enrolled with [!INCLUDE[mit_first](../System Center Configuration Manager/itokens/mit_first_md.md)].|  
...
|**Local client issues on mobile devices that are managed by the Configuration Manager client for Windows CE and that are not healthy**|This report contains detailed information about local client issues on mobile devices that are managed by the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client for Windows CE.|  
...
|**Computers with a specific Configuration Manager client version**|Displays a list of computers running a specified version of the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client software.|  
...
|**Count of clients for each site**|Displays the number of [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] clients installed by site code.|  
|**Count of Configuration Manager clients by client versions**|Displays the number of computers discovered by [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] client version.|  
...
|**Computers that might share the same Configuration Manager unique identifier**|Displays a list of computers that have changed their names. A change in name is a possible symptom that a computer shares a [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] Unique Identifier with another computer.|  
...
|**Status of Configuration Manager update within hierarchy**|Displays information about [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] site updates for the  hierarchy.|  
...
|**Component messages for the last hour**|Displays a list of the status messages created in the last hour by a specified component on a specified computer in a specified [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] site.|  
...
|Report name|Description|  
|-----------------|-----------------|  
|**All audit messages for a specific user**|Displays a summary of all audit status messages for a specified user. Audit messages describe actions taken in the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] console that add, modify, or delete objects in [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)].|  
