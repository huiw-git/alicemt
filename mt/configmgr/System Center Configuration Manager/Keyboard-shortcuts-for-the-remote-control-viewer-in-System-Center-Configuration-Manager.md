...
When you use the [!INCLUDE[cm6long](../System Center Configuration Manager/itokens/cm6long_md.md)] remote control viewer, you can use the following keyboard shortcuts to control the client computer that is being administered.  
