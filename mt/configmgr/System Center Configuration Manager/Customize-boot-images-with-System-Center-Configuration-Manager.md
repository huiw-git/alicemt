...
1.  Install the Windows ADK on a computer that does not have another version of Windows AIK or Windows ADK, and does not have any [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] components installed.  
...
8.  Add the updated boot image to [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] to make it available to use in your task sequences. Use the following steps to import the updated boot image:  
...
1.  Install the Windows AIK on a computer that does not have another version of Windows AIK or Windows ADK, and does not have any [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] components installed. Download Windows AIK from the [Microsoft Download Center](http://www.microsoft.com/download/details.aspx?id=5753).  
