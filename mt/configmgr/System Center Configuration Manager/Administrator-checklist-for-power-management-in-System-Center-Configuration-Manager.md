...
This administrator checklist provides the recommended steps for using [!INCLUDE[cm6long](../System Center Configuration Manager/itokens/cm6long_md.md)] power management in your organization.  
...
|Task|Details|  
|----------|-------------|  
|Review the power management concepts in the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] documentation library.|See [Introduction to power management in System Center Configuration Manager](../System Center Configuration Manager/Introduction-to-power-management-in-System-Center-Configuration-Manager.md).|  
|Review the power management prerequisites in the [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] documentation library.|See [Prerequisites for power management in System Center Configuration Manager](../System Center Configuration Manager/Prerequisites-for-power-management-in-System-Center-Configuration-Manager.md).|  
|Review the best practices information for power management.|See [Best practices for power management in System Center Configuration Manager](../System Center Configuration Manager/Best-practices-for-power-management-in-System-Center-Configuration-Manager.md).|  
...
|Enable power management.|Before you can begin to use power management, you must enable it and configure the required client settings. For more information, see [Configuring power management in System Center Configuration Manager](../System Center Configuration Manager/Configuring-power-management-in-System-Center-Configuration-Manager.md).|  
|Collect power management information from client computers.|Power management data is reported by clients through [!INCLUDE[cmshort](../System Center Configuration Manager/itokens/cmshort_md.md)] hardware inventory. Depending on the hardware inventory schedule that you have configured, it might take some time to retrieve inventory from all client computers.|  
...
|Exclude any required collections of computers from power management.|See [Configuring power management in System Center Configuration Manager](../System Center Configuration Manager/Configuring-power-management-in-System-Center-Configuration-Manager.md).|  
...
|Task|Details|  
|----------|-------------|  
|Select existing power plans or create new power plans for collections of computers in your organization.|See [How to create and apply power plans in System Center Configuration Manager](../System Center Configuration Manager/How-to-create-and-apply-power-plans-in-System-Center-Configuration-Manager.md).|  
|Apply these power plans to computers.|See [How to create and apply power plans in System Center Configuration Manager](../System Center Configuration Manager/How-to-create-and-apply-power-plans-in-System-Center-Configuration-Manager.md).|  
