...
>  Windows does not enable **Extended Protection** by default. For information about how to enable **Extended Protection** in Windows, see the Knowledge Base article, [Extended Protection for Authentication](http://go.microsoft.com/fwlink/?LinkId=178431).  
 ...
 For more information about how to configure other [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] services, and a complete description of **Extended Protection**, see more recent information on [Microsoft.com](http://go.microsoft.com/fwlink/?LinkId=177752).  
  
 **Extended Protection** is fully supported by the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Native Client beginning with [!INCLUDE[ssKilimanjaro](../../Token/Other/ssKilimanjaro_md.md)]. Support for **Extended Protection** for other [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] client providers is not currently supported.  
