...
# Degree of Parallelism (7.0 Insert) Event Class
  The **Degree of Parallelism \(7.0 Insert\)** event class occurs each time [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] executes a SELECT, INSERT, UPDATE, or DELETE statement.  
...
|**LoginName**|**nvarchar**|Name of the login of the user \(either the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] security login or the Windows login credentials in the form of DOMAIN\\*username*\).|11|Yes|  
