...
# Installation Prerequisites
  For [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] to install successfully, the following software components are required on the installation computer. They will be installed by [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Setup:  
  
-   [!INCLUDE[dnprdnshort](../../Token/Other/dnprdnshort_md.md)] version 4.0 for all editions of [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)]  
