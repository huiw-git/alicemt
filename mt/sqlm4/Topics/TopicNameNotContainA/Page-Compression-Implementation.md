...
# Page Compression Implementation
  This topic summarizes how the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] implements page compression. This summary provides basic information to help you plan the storage space that you need for your data.  
...
3.  The repeated prefix values in the column are replaced by a reference to the corresponding prefix. If the value in a row does not exactly match the selected prefix value, a partial match can still be indicated.  
 ...
 ![Page before prefix compression](../../Images/Image/ImageNotContaina/skt_TblCompression1c.gif "skt_TblCompression1c")  
 ...
 ![Page after prefix compression](../../Images/Image/ImageNotContaina/TblCompression2.gif "TblCompression2")  
...
## Dictionary Compression  
 ...
 ![Page after dictionary compression](../../Images/Image/ImageNotContaina/TblCompression3.gif "TblCompression3")  
