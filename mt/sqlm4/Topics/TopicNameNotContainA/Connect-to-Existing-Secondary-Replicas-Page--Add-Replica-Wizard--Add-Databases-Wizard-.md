---
title: Connect to Existing Secondary Replicas Page (Add Replica Wizard: Add Databases Wizard)
ms.custom: na
...
# Connect to Existing Secondary Replicas Page (Add Replica Wizard: Add Databases Wizard)
  This help topic describes the options of the **Connect to Existing Secondary Replicas** page. This topic is used by the [!INCLUDE[ssAoAddRepWiz](../../Token/Other/ssAoAddRepWiz_md.md)] and [!INCLUDE[ssAoAddDbWiz](../../Token/Other/ssAoAddDbWiz_md.md)] of [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)].  
 ...
 **Connect All**  
 Click only if every instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] to which you need to connect is running as a service in the same user account.  
