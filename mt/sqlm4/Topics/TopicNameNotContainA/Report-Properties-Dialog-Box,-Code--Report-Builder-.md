...
## Options  
 **Custom Code**  
 Type the methods to be used within the report. Code must be written in [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[vbprvb](../../Token/Other/vbprvb_md.md)].  
