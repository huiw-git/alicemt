...
## Multiple Flows  
 ...
 ![Data flows](../../Images/Image/ImageNotContaina/MW_DTS_09.gif "MW_DTS_09")  
  
## Log Entries  
 [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] provides a set of log events that are available to all tasks. [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] also provides custom log entries to many tasks. For more information, see [Integration Services &#40;SSIS&#41; Logging](../../Topics/TopicNameNotContainA/Integration-Services--SSIS--Logging.md) and [Custom Messages for Logging](../../Topics/TopicNameNotContainA/Custom-Messages-for-Logging.md). The Data Flow task includes the following custom log entries:  
