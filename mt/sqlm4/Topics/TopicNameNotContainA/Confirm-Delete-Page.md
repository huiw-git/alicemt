...
---
# Confirm Delete Page
  Use the **Confirm Delete** page to indicate whether [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] displays a confirmation message when you delete certain components.  
