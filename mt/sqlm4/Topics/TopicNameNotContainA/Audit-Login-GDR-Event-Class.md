...
# Audit Login GDR Event Class
  The **Audit Login GDR** event class occurs whenever a [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] Windows login right is added or removed. This event class is for the **sp\_grantlogin**, **sp\_revokelogin**, and **sp\_denylogin** stored procedures.  
