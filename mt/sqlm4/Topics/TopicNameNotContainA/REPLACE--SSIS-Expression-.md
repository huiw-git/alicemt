...
## Remarks  
 ...
 REPLACE works only with the DT\_WSTR data type. *character\_expression1, character\_expression2,* and *character\_expression3* arguments that are string literals or data columns with the DT\_STR data type are implicitly cast to the DT\_WSTR data type before REPLACE performs its operation. Other data types must be explicitly cast to the DT\_WSTR data type. For more information, see [Cast &#40;SSIS Expression&#41;](../../Topics/TopicNameNotContainA/Cast--SSIS-Expression-.md).  
