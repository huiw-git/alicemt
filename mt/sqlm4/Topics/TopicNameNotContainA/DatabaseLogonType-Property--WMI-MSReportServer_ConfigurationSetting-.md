...
-   2 to log in as a service  
 ...
 If you specify 1 \(SQL Server\), make sure the value of the [DatabaseLogonAccount](../../Topics/TopicNameNotContainA/DatabaseLogonAccount-Property--WMI-MSReportServer_ConfigurationSetting-.md) corresponds to a valid [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] login.  
