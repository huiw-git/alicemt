...
---
# Code Outlining
  You can use the outlining feature in the [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] query editors to selectively hide code when you edit queries. This enables you to more easily view the code you are working on, especially in large query files.  
...
## System Outline Regions  
 Each [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] editor generates a set of default, system\-defined outline regions.  
...
### Analysis Services XMLA Query Editor Regions  
 The [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] XMLA Query Editor generates an outline region for each multiline XML attribute. The editor nests the outline regions for nested tags. For example, the XMLA Editor creates three outline regions for the following document.  
  
 ![XML code showing outlining](../../Images/Image/ImageNotContaina/EditOutlineXMLFull.gif "EditOutlineXMLFull")  
  
 When you click the minus sign on the \<InnerTag\> line, just the InnerTag is collapsed, as shown in the following illustration.  
  
 ![XML code with inner node hidden](../../Images/Image/ImageNotContaina/EditOutlineXMLInnerCol.gif "EditOutlineXMLInnerCol")  
 ...
 ![XML code with tooltip showing hidden code](../../Images/Image/ImageNotContaina/EditOutlineXMLMouse.gif "EditOutlineXMLMouse")  
 ...
 ![XML code with inner and middle tags hidden](../../Images/Image/ImageNotContaina/EditOutlineXMLMiddleCol.gif "EditOutlineXMLMiddleCol")  
  
 When you click the minus sign on the \<OuterTag\> line, all three lines are collapsed, as shown in the following illustration.  
  
 ![XML code showing all three tags hidden](../../Images/Image/ImageNotContaina/EditOutlineXMLOuterCol.gif "EditOutlineXMLOuterCol")  
  
### Database Engine Query Editor Regions  
 The [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] Query Editor generates outline regions for each element in the following hierarchy:  
...
3.  Multiline statements.  
 ...
 For example, the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] Query Editor creates three outline regions for the following query:  
