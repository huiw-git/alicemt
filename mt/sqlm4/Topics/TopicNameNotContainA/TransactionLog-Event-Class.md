...
# TransactionLog Event Class
  Use the TransactionLog event class to monitor activity in the transaction logs in an instance of the [!INCLUDE[ssDEnoversion](../../Token/Other/ssDEnoversion_md.md)].  
