...
# Configure Outputs Using the Slowly Changing Dimension Wizard
 ...
 To open the Slowly Changing Dimension Wizard in [!INCLUDE[ssIS](../../Token/Other/ssIS_md.md)] Designer, double\-click the Slowly Changing Dimension transformation.  
...
8.  Review the configurations that the Slowly Changing Dimension Wizard builds. Depending on which change types are supported, different sets of data flow components are added to the package.  
     ...
     ![Data flow from Slowly Changing Dimension Wizard](../../Images/Image/ImageNotContaina/DimensionWizard.gif "DimensionWizard")  
