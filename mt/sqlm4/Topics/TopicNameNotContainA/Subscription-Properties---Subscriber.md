 ...
 **Use Windows Synchronization Manager**  
 Determines whether this subscription can be synchronized using [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] Windows Synchronization Manager.  
