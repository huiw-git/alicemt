---
title: Backup-ASDatabase cmdlet
ms.custom: na
...
```  
PS SQLSERVER:SQLASLocalhostdefault >backup-asdatabase awdb-20110930.abf “Adventure Works” -AllowOverwrite -ApplyCompression  
```  
...
```  
PS SQLSERVER:SQLASLocalhostdefault >$AWDB = get-item “databasesAdventure Works”   
PS SQLSERVER:SQLASLocalhostdefault >Backup-asdatabase –database:$AWDB –AllowOverwrite  
```  
...
```  
PS SQLSERVER:SQLASLocalhostdefaultdatabases >dir * | backup-asdatabase  
```  
...
PS SQLSERVER:SQLASLocalhostdefault > backup-asdatabase –backupfile test.abf –name contoso_retail –filepassword:$pwd server myremoteserver  
