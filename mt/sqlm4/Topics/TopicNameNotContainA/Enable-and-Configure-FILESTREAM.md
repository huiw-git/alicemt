...
# Enable and Configure FILESTREAM
  Before you can start to use FILESTREAM, you must enable FILESTREAM on the instance of the [!INCLUDE[ssDEnoversion](../../Token/Other/ssDEnoversion_md.md)]. This topic describes how to enable FILESTREAM by using SQL Server Configuration Manager.  
  
##  <a name="enabling"></a> Enabling FILESTREAM  
  
#### To enable and change FILESTREAM settings  
  
1.  On the **Start** menu, point to **All Programs**, point to [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)], point to **Configuration Tools**, and then click **SQL Server Configuration Manager**.  
  
2.  In the list of services, right\-click **SQL Server Services**, and then click **Open**.  
  
3.  In the **SQL Server Configuration Manager** snap\-in, locate the instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] on which you want to enable FILESTREAM.  
...
10. In [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)], click **New Query** to display the Query Editor.  
  
11. In Query Editor, enter the following [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] code:  
...
13. Restart the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] service.  
...
-   For performance reasons, FILESTREAM filegroups and containers should reside on volumes other than the operating system, [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] database, [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] log, tempdb, or paging file.  
