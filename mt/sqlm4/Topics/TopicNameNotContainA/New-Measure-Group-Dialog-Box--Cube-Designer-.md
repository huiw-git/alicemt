...
# New Measure Group Dialog Box (Cube Designer)
  Use the **New Measure Group** dialog box in [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)] to add a new measure group to a cube in Cube Designer. You can display the **New Measure Group** dialog box by:  
