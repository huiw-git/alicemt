...
-   Use the WITH STOPATMARK \= **'***\<mark\_name\>***'** clause to specify that the marked transaction is the recovery point.  
  
     STOPATMARK rolls forward to the mark and includes the marked transaction in the roll forward.  
  
-   Use the WITH STOPBEFOREMARK \= **'***\<mark\_name\>***'** clause to specify that the log record that is immediately before the mark is the recovery point.  
