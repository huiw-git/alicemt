...
# Formatting Report Items (Report Builder and SSRS)
 ...
 ![rs_FormattingReporttItems](../../Images/Image/ImageNotContaina/rs_FormattingReporttItems.gif "rs_FormattingReporttItems")  
...
## In This Section  
 ...
 Describes how to use standard and custom formatting strings that are supported by [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)].  
