 ...
 *scope*  
 \(**String**\) Optional. The name of a group or data region, or null \(**Nothing** in [!INCLUDE[vbprvb](../../Token/Other/vbprvb_md.md)]\), that specifies the scope from which to retrieve the previous value specified by *expression*.  
