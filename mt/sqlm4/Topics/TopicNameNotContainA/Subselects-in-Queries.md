...
-   By default calculated members are not allowed in subselects; however, this restriction can be changed, in a per session basis, by assigning a value to the **SubQueries** connection string property in [ConnectionString](assetId:///P:Microsoft.AnalysisServices.AdomdClient.AdomdConnection.ConnectionString) or **DBPROP\_MSMD\_SUBQUERIES** property in [Supported XMLA Properties &#40;XMLA&#41;](../Topic/Supported%20XMLA%20Properties%20\(XMLA\).md). See [Calculated Members in Subselects and Subcubes](../../Topics/TopicNameNotContainA/Calculated-Members-in-Subselects-and-Subcubes.md) for a detailed explanation of the behavior of calculated members depending on the values of **SubQueries** or **DBPROP\_MSMD\_SUBQUERIES**.  
