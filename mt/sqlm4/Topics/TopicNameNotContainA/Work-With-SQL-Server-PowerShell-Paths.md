...
# Work With SQL Server PowerShell Paths
  After you have navigated to a node in a [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] provider path, you can perform work or retrieve information by using the methods and properties from the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] management object associated with the node.  
 ...
 **Using SMO Methods and Properties**  
 ...
 To perform work on objects from a [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] provider path, you can use SMO methods and properties.  
