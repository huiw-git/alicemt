...
|**LoginName**|**nvarchar**|Name of the login of the user \(either [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] security login or the [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] Windows login credentials in the form of DOMAIN\\username\). The value is always "sa" for this event class.|11|Yes|  
