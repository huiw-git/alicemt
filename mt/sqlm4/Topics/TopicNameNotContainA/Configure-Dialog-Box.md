...
##  <a name="references"></a> Set the options on the References page  
 ...
 An environment specifies runtime values for packages contained in the projects you’ve deployed to [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] server.  
