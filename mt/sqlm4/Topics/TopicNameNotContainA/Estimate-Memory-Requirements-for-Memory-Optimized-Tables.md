...
- [Example memory-optimized table](../../Topics/TopicNameNotContainA/Estimate-Memory-Requirements-for-Memory-Optimized-Tables.md)  
  
- [Memory for the table](../../Topics/TopicNameNotContainA/Estimate-Memory-Requirements-for-Memory-Optimized-Tables.md)  
  
- [Memory for indexes](../../Topics/TopicNameNotContainA/Estimate-Memory-Requirements-for-Memory-Optimized-Tables.md)  
  
- [Memory for row versioning](../../Topics/TopicNameNotContainA/Estimate-Memory-Requirements-for-Memory-Optimized-Tables.md)  
  
- [Memory for table variables](../../Topics/TopicNameNotContainA/Estimate-Memory-Requirements-for-Memory-Optimized-Tables.md)  
  
- [Memory for growth](../../Topics/TopicNameNotContainA/Estimate-Memory-Requirements-for-Memory-Optimized-Tables.md)  
...
Memory needs for stale rows is then estimated by multiplying the number of stale rows by the size of a memory\-optimized table row \(See [Memory for the table](../../Topics/TopicNameNotContainA/Estimate-Memory-Requirements-for-Memory-Optimized-Tables.md) above\).  
