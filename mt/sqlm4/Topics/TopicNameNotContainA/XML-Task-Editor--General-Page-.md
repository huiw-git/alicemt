---
title: XML Task Editor (General Page)
ms.custom: na
...
# XML Task Editor (General Page)
 ...
 To learn about this task, see [XML Task](../../Topics/TopicNameNotContainA/XML-Task.md) and [Validate XML with the XML Task](../../Topics/TopicNameNotContainA/Validate-XML-with-the-XML-Task.md). For information about working with XML documents and data, see "[Employing XML in the .NET Framework](http://go.microsoft.com/fwlink/?LinkId=56214)" in the MSDN Library.  
 ...
 **ValidationDetails**  
 Provides rich error output when the value of this property is true. For more info, see [Validate XML with the XML Task](../../Topics/TopicNameNotContainA/Validate-XML-with-the-XML-Task.md).  
