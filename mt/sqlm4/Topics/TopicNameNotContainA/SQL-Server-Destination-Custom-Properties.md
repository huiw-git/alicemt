...
# SQL Server Destination Custom Properties
  The [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] destination has both custom properties and the properties common to all data flow components.  
  
 The following table describes the custom properties of the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] destination. All properties are read\/write.  
...
|BulkInsertTableName|String|The [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] table or view in the database to which the data is copied.|  
...
|Timeout|Integer|A value that specifies the number of seconds the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] destination waits before termination if there is no data available for insertion. A value of 0 means that the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] destination will not time out. The default value of this property is 30.|  
  
 The input and the input columns of the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] destination have no custom properties.  
