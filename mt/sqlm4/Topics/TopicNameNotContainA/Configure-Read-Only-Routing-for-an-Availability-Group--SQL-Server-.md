...
### If Read\-Only Routing is Not Working Correctly  
 For information about troubleshooting a read\-only routing configuration, see [Read-Only Routing is Not Working Correctly](../../Topics/TopicNameNotContainA/Troubleshoot-Always-On-Availability-Groups-Configuration--SQL-Server-.md).  
