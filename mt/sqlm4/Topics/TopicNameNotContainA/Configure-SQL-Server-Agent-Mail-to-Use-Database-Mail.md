...
# Configure SQL Server Agent Mail to Use Database Mail
  This topic describes how to configure [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent to use Database Mail to send notification and alerts in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)].  
...
-   Create a Database Mail account for the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent service account to use.  
  
-   Create a Database Mail profile for the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent service account to use and add the user to the **DatabaseMailUserRole** in the **msdb** database.  
...
-   In Object Explorer, expand a [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] instance.  
