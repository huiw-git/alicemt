...
> [!NOTE]  
>  The **Parameter Info** option is available only for the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] Query Editor and the XML Query Editor.  
