...
|----------|-------------------------|  
|View the list of CDC Services and Instances using the associated [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] instance.|`db_datareader` role on MSXDBCDC|  
