 ...
 **Credentials stored securely in the report server**  
 ...
 Select **Impersonate the authenticated user after a connection has been made to the data source** to allow delegation of credentials, but only if a data source supports impersonation. For [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] databases, this option sets the SETUSER function.  
  
> [!TIP]  
>  [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)]only supports Windows account credentials. Therefore select both options "Use as Windows credentials when connecting to the data source" and "Impersonate the authenticated user after a connection has been made to the data source" for an [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] data source.  
