...
1.  [Prerequisites](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md)  
  
2.  [Configure SSIS support for Always On](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md)  
  
3.  [Upgrading SSISDB in an availability group](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md)  
...
-   [Step 1: Create Integration Services Catalog](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md)  
  
-   [Step 2: Add SSISDB to an Always On Availability Group](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md)  
  
-   [Step 3: Enable SSIS support for Always On](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md)  
...
4.  Follow the instructions in [Step 2: Add SSISDB to an Always On Availability Group](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md) to add the SSISDB back to an availability group.  
  
5.  Follow the instructions in [Step 3: Enable SSIS support for Always On](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md).  
