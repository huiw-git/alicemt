...
# Business Rules Extension (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)], you can apply user\-defined SQL scripts as an extension of  pre\-defined conditions and actions.  
...
```  
 ...
 Script actions will be executed as mds\_br\_user which has following permissions  
...
-   User defined scripts had been added to the [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)] database.  
