...
1.  Use [!INCLUDE[ssBIDevStudio](../../Token/Other/ssBIDevStudio_md.md)]. Select the Analysis Services Tabular project template and set the compatibility level to **SQL Server 2016 RTM \(1200\)**.  
