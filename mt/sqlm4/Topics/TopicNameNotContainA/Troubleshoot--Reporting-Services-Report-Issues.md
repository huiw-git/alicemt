...
This topic helps you troubleshoot problems with [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion.md)] report design, previewing a report, publishing a report to a report server in native mode or SharePoint mode, viewing a report on the report server, or exporting a report to a different file format.  
...
## Use [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull.md)] to Verify Queries and Credentials  
You can use [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull.md)] to validate complex queries before you include them in your report.   
...
To control whether [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull.md)] can only use cached data, add the following section to devenv.exe.config in the [!INCLUDE[ssBIDevStudio](../../Token/Other/ssBIDevStudio.md)]. The location of the default directory is: `<drive>:Program Files\Microsoft Visual Studio 10.0\Common7\IDE`.   
