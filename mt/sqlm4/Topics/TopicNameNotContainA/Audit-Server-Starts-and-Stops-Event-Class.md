...
# Audit Server Starts and Stops Event Class
  The **Audit Server Starts and Stops** event class occurs when the [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] service state is modified.  
