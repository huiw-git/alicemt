...
# Add an Item to an Integration Services Project
  This procedure describes how to add new and existing items to an [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] project.  
  
### To add an item to an Integration Services project  
  
1.  In [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)], open the solution that contains the [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] project to which you want to add an item.  
