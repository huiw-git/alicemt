...
1.  In the **Security Role** section, **Name** field enter a name for the capture instance. By default, the name entered in the field is the name of the current capture instance with **\_NEW** added to the end of the name \(for example, **old\_instance\_NEW**\).  
