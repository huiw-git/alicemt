---
title: About URL Reservations and Registration  (SSRS Configuration Manager)
ms.custom: na
...
> [!NOTE]  
>  HTTP.SYS is an operating system component that listens for network requests and routes them to a request queue. In this release of [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)], HTTP.SYS establishes and maintains the request queue for the Report Server Web service and Report Manager. Internet Information Services \(IIS\) is no longer used to host or access [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] applications. For more information about HTTP.SYS functionality, see [HTTP Server API](http://go.microsoft.com/fwlink/?LinkId=92652) on MSDN.  
  
##  <a name="ReportingServicesURLs"></a> URLs in Reporting Services  
 In a [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] installation, you can access the following tools, applications, and items through URLs:  
...
##  <a name="DefaultURLs"></a> Default URLs  
 If you install [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] in the default configuration, Setup will reserve URLs for the Report Server Web service and the [!INCLUDE[ssRSWebPortal](../../Token/Other/ssRSWebPortal.md)]. You can also accept these default values when you define URL reservations in the [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] Configuration tool. Default URLs will include an instance name if you install [!INCLUDE[ssExpress](../../Token/Other/ssExpress_md.md)] or if you install [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] as a named instance.  
...
-   [!INCLUDE[win8srv](../../Token/Other/win8srv_md.md)] R2  
  
-   [!INCLUDE[win8srv](../../Token/Other/win8srv_md.md)]  
  
-   [!INCLUDE[winserver2008r2](../../Token/Other/winserver2008r2_md.md)]  
  
-   [!INCLUDE[firstref_longhorn](../../Token/Other/firstref_longhorn_md.md)]  
  
-   [!INCLUDE[win7](../../Token/Other/win7_md.md)]  
  
-   [!INCLUDE[wiprlhlong](../../Token/Other/wiprlhlong_md.md)]  
...
|Named instance|Report Server Web service|http:\/\/\<servername\>\/reportserver\_\<instancename\>|http:\/\/\<servername\>:80\/reportserver\_\<instancename\>|  
|Named instance|Web portal|http:\/\/\<servername\>\/reports\_\<instancename\>|http:\/\/\<servername\>:80\/reports\_\<instancename\>|  
|SQL Server Express|Report Server Web service|http:\/\/\<servername\>\/reportserver\_SQLExpress|http:\/\/\<servername\>:80\/reportserver\_SQLExpress|  
|SQL Server Express|Web portal|http:\/\/\<servername\>\/reports\_SQLExpress|http:\/\/\<servername\>:80\/reports\_SQLExpress|  
  
##  <a name="URLPermissionsAccounts"></a> Authentication and Service Identity for Reporting Services URLs  
 [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] URL reservations specify the service account of the Report Server service. The account under which the service runs is used for all URLs that are created for the [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] applications that run in the same instance. The service identity of the report server instance is stored in the RSReportServer.config file.  
 ...
 Anonymous access is disabled because the default security is **RSWindowsNegotiate**. For intranet access, report server URLs use network computer names. If you want to configure [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] for Internet connections, you must use different settings. For more information about authentication, see [Authentication with the Report Server](../../Topics/TopicNameNotContainA/Authentication-with-the-Report-Server.md) in [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Books Online.  
