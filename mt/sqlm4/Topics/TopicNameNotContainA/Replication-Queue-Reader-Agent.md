 ...
 **\-PollingInterval** *polling\_interval*  
 Is relevant only for updating subscriptions that use [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] based queues. Specifies how often, in seconds, the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] queue is polled for pending queued transactions. The value can be between 0 and 240 seconds. The default is 5 seconds.  
 ...
 **\-ProfileName** *agent\_profile\_name*  
