...
# Custom Messages for Logging
  [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] provides a rich set of custom events for writing log entries for packages and many tasks. You can use these entries to save detailed information about execution progress, results, and problems by recording predefined events or user\-defined messages for later analysis. For example, you can record when a bulk insert begins and ends to identify performance issues when the package runs.  
 ...
 The following [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] objects have custom log entries:  
...
|Log entry|Description|  
|---------------|-----------------|  
|**ScriptTaskLogEntry**|Reports the results of implementing logging in the script. A log entry is written for each call to the **Log** method of the **Dts** object. The entry is written when the code is run. For more information, see [Logging in the Script Task](../Topic/Logging%20in%20the%20Script%20Task.md).|  
...
|Log entry|Description|  
|---------------|-----------------|  
|**TransferJobsTaskFinishedTransferringObjects**|Indicates that the task finished transferring [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent jobs.|  
|**TransferJobsTaskStartTransferringObjects**|Indicates that the task started to transfer [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent jobs.|  
...
###  <a name="TransferSQLServerObjects"></a> Transfer SQL Server Objects Task  
 The following table lists the custom log entries for the Transfer [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Objects task.  
  
|Log entry|Description|  
|---------------|-----------------|  
|**TransferSqlServerObjectsTaskFinishedTransferringObjects**|Indicates that the task finished transferring [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] database objects.|  
|**TransferSqlServerObjectsTaskStartTransferringObjects**|Indicates that the task started to transfer [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] database objects.|  
