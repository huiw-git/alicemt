...
|IndexID|**int**|ID for the index on the object affected by the event. To determine the index ID for an object, use the index\_id column of the sys.indexes catalog view.|24|Yes|  
