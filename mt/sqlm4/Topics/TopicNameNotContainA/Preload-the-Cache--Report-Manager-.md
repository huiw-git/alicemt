...
2.  Use a data\-driven subscription to preload the cache with instances of parameterized reports. This was the only way to preload the cache in versions of [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] earlier than [!INCLUDE[ssKilimanjaro](../../Token/Other/ssKilimanjaro_md.md)]. For more information, see [Caching Reports &#40;SSRS&#41;](../../Topics/TopicNameNotContainA/Caching-Reports--SSRS-.md).  
