...
> [!NOTE]  
>  [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] provides a progression of increasingly granular roles for processing and querying at server, database, and object levels. See [Roles and Permissions &#40;Analysis Services&#41;](../../Topics/TopicNameNotContainA/Roles-and-Permissions--Analysis-Services-.md) for instructions on how to use these roles.  
