...
> [!NOTE]  
>  The Cache connection manager does not support the Binary Large Object \(BLOB\) data types DT\_TEXT, DT\_NTEXT, and DT\_IMAGE. If the reference dataset contains a BLOB data type, the component will fail when you run the package. You can use the **Cache Connection Manager Editor** to modify column data types.  
...
-   [General Tab](../../Topics/TopicNameNotContainA/Cache-Connection-Manager-Editor.md)  
  
-   [Columns Tab](../../Topics/TopicNameNotContainA/Cache-Connection-Manager-Editor.md)  
 ...
 **Connection manager name**  
 Provide a unique name for the cache connection in the workflow. The name provided will be displayed within [!INCLUDE[ssIS](../../Token/Other/ssIS_md.md)] Designer.  
