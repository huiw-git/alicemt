...
# Report Server Properties (Advanced Tab)
  This service is the [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)]. If custom properties are defined, they appear on this tab, with their values.  
