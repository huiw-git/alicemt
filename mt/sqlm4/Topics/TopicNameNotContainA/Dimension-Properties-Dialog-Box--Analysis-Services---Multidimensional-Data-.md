...
# Dimension Properties Dialog Box (Analysis Services - Multidimensional Data)
  Use the **Dimension Properties** dialog box in [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] to set the properties of a dimension in an [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] database. You can display the **Dimension Properties** dialog box by right\-clicking a dimension in Object Explorer and selecting **Properties**.  
