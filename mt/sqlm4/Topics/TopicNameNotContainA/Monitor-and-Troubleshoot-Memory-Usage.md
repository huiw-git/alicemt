...
# Monitor and Troubleshoot Memory Usage
  [!INCLUDE[hek_1](../../Token/Other/hek_1_md.md)] consumes memory in different patterns than disk-based tables. You can monitor the amount of memory allocated and used by memory-optimized tables and indexes in your database using the DMVs or performance counters provided for memory and the garbage collection subsystem.  This gives you visibility at both the system and database level and lets you prevent problems due to memory exhaustion.  
  
 This topic covers monitoring your [!INCLUDE[hek_2](../../Token/Other/hek_2_md.md)] memory usage.  
  
## Sections in this topic  
  
-   [Create a sample database with memory-optimized tables](../../Topics/TopicNameNotContainA/Monitor-and-Troubleshoot-Memory-Usage.md)  
  
-   [Monitoring Memory Usage](../../Topics/TopicNameNotContainA/Monitor-and-Troubleshoot-Memory-Usage.md)  
  
    -   [Using SQL Server Management Studio](../../Topics/TopicNameNotContainA/Monitor-and-Troubleshoot-Memory-Usage.md)  
  
    -   [Using DMVs](../../Topics/TopicNameNotContainA/Monitor-and-Troubleshoot-Memory-Usage.md)  
  
-   [Managing memory consumed by memory-optimized objects](../../Topics/TopicNameNotContainA/Monitor-and-Troubleshoot-Memory-Usage.md)  
  
-   [Troubleshooting Memory Issues](../../Topics/TopicNameNotContainA/Monitor-and-Troubleshoot-Memory-Usage.md)  
...
1.  Launch [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)].  
...
3.  Paste this code into the new query window and execute each section.  
    ...
    ALTER DATABASE IMOLTP_DB ADD FILE( NAME = 'IMOLTP_DB_xtp' , FILENAME = 'C:DataIMOLTP_DB_xtp') TO FILEGROUP IMOLTP_DB_xtp_fg;  
    GO  
...
###  <a name="bkmk_UsingSSMS"></a> Using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)]  
 [!INCLUDE[ssSQL14](../../Token/Other/ssSQL14_md.md)] ships with built-in standard reports to monitor the memory consumed by in-memory tables. You can access these reports using Object Explorer as described [here](http://blogs.msdn.com/b/managingsql/archive/2006/05/16/ssms-reports-1.aspx). You can also use the object explorer to monitor memory consumed by individual memory-optimized tables.  
  
#### Consumption at the database level  
 You can monitor memory use at the database level as follows.  
  
1.  Launch [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] and connect to a server.  
...
3.  In the context menu select, **Reports** -> **Standard Reports** -> **Memory Usage By Memory Optimized Objects**  
 ...
 ![HK_MM_SSMS](../../Images/Image/ImageNotContaina/HK_MM_SSMS_StdRpt_MemUse.gif "HK_MM_SSMS_StdRpt_MemUse")  
  
 This report shows memory consumption by the database we created above.  
  
 ![HK_MM_SSMS](../../Images/Image/ImageNotContaina/HK_MM_SSMS_StdRpt_MemUseRpt.gif "HK_MM_SSMS_StdRpt_MemUseRpt")  
...
#### Memory consumed by [!INCLUDE[hek_2](../../Token/Other/hek_2_md.md)] engine across the instance  
 Memory allocated to the [!INCLUDE[hek_2](../../Token/Other/hek_2_md.md)] engine and the memory-optimized objects is managed the same way as any other memory consumer within a [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] instance. The clerks of type MEMORYCLERK_XTP accounts for all the memory allocated to [!INCLUDE[hek_2](../../Token/Other/hek_2_md.md)] engine. Use the following query to find all the memory used by the [!INCLUDE[hek_2](../../Token/Other/hek_2_md.md)] engine.  
