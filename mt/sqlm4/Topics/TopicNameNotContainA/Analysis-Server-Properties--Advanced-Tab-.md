...
# Analysis Server Properties (Advanced Tab)
  This service is the Microsoft [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)]. If custom properties are defined, they appear on this tab, with their values.  
