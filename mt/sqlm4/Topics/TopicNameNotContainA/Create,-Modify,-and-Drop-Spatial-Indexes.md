...
11. On the **Spatial** page, specify the values that you want to use for the spatial properties of the index.  
     ...
     Optionally, you can specify nondefault values for the **Cells Per Object** field and for the grid density at any level of the tessellation scheme. The default number of cells per object is 16 for [!INCLUDE[ssKatmai](../../Token/Other/ssKatmai_md.md)] or 8 for [!INCLUDE[ssSQL11](../../Token/Other/ssSQL11_md.md)] or higher, and the default grid density is **Medium** for [!INCLUDE[ssKatmai](../../Token/Other/ssKatmai_md.md)].  
  
     You can select GEOMETRY\_AUTO\_GRID or GEOGRAPHY\_AUTO\_GRID for tessellation scheme in [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)]. When GEOMETRY\_AUTO\_GRID or GEOGRAPHY\_AUTO\_GRID is selected, then Level 1, Level 2, Level 3, and Level 4 grid density options are disabled.  
...
-   [ALTER INDEX &#40;Transact-SQL&#41;](../Topic/ALTER%20INDEX%20\(Transact-SQL\).md)  
    ...
    > [!IMPORTANT]  
    >  To change options that are specific to a spatial index, such as BOUNDING\_BOX or GRID, you can either use a CREATE SPATIAL INDEX statement that specifies DROP\_EXISTING \= ON, or drop the spatial index and create a new one. For an example, see [CREATE SPATIAL INDEX &#40;Transact-SQL&#41;](../Topic/CREATE%20SPATIAL%20INDEX%20\(Transact-SQL\).md).  
...
### Version Restrictions  
 Spatial tessellations introduced in [!INCLUDE[ssSQL11](../../Token/Other/ssSQL11_md.md)] cannot be replicated to [!INCLUDE[ssKilimanjaro](../../Token/Other/ssKilimanjaro_md.md)] or [!INCLUDE[ssKatmai](../../Token/Other/ssKatmai_md.md)]. You must use [!INCLUDE[ssKilimanjaro](../../Token/Other/ssKilimanjaro_md.md)] or [!INCLUDE[ssKatmai](../../Token/Other/ssKatmai_md.md)] spatial tessellations for spatial indexes when backward compatibility with [!INCLUDE[ssKilimanjaro](../../Token/Other/ssKilimanjaro_md.md)] or [!INCLUDE[ssKatmai](../../Token/Other/ssKatmai_md.md)] databases is a requirement.  
