...
|[sys.external_file_formats &#40;Transact-SQL&#41;](../Topic/sys.external_file_formats%20\(Transact-SQL\).md)|Identifies external file formats.|  
...
2.  **Find the longest running step of the distributed query**  
     ...
     Check the location\_type of longest running step:  
...
2.  Click the **Execution plan** tab.  
     ...
     ![PolyBase query plan](../../Images/Image/ImageNotContaina/PolyBase-query-plan.png "PolyBase query plan")  
...
2.  Run the DMV [sys.dm_exec_compute_nodes &#40;Transact-SQL&#41;](../Topic/sys.dm_exec_compute_nodes%20\(Transact-SQL\).md) to view all the nodes in the PolyBase Group.  
  
3.  Run the DMV [sys.dm_exec_compute_node_status &#40;Transact-SQL&#41;](../Topic/sys.dm_exec_compute_node_status%20\(Transact-SQL\).md) to view the status of all the nodes in the PolyBase Group.  
