...
1.  In [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)], double\-click the package in Solution Explorer to open the package in [!INCLUDE[ssIS](../../Token/Other/ssIS_md.md)] Designer, and then click the **Data Flow** tab.  
