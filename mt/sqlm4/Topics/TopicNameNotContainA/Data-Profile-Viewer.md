...
-   Right\-click the **Data Profiling** task in the [!INCLUDE[ssIS](../../Token/Other/ssIS_md.md)] Designer, and then click **Edit**. Click **Open Profile Viewer** on the **General** page of the **Data Profiling Task Editor**.  
