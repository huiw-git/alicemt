...
```  
 ...
 The CREATE SUBCUBE syntax is fairly simple. The *Subcube\_Identifier* parameter identifies the cube on which the subcube will be based. The *Subcube\_Expression* parameter selects the part of the cube that will become the subcube  
