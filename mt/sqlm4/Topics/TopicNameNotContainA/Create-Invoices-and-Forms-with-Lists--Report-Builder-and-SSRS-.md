...
# Create Invoices and Forms with Lists (Report Builder and SSRS)
  A list data region repeats with each group or row in the report dataset. A list can be used to create free\-form reports or forms, such as invoices, or in conjunction with other data regions. You can define lists that contain any number of report items. A list can be nested wit  
  
 To quickly get started with lists, see [Tutorial: Creating a Free Form Report &#40;Report Builder&#41;](../Topic/Tutorial:%20Creating%20a%20Free%20Form%20Report%20\(Report%20Builder\).md).  
...
##  <a name="AddingList"></a> Adding a List to Your Report  
 ...
 ![New List report item on the design surface](../../Images/Image/ImageNotContaina/rs_ListTemplateNew.gif "rs_ListTemplateNew")  
...
##  <a name="DisplayingLayout"></a> Displaying Data in a Free\-form Layout  
 ...
 ![List in design view, 4 fields and an image](../../Images/Image/ImageNotContaina/rs_BasicListFormDesign.gif "rs_BasicListFormDesign")  
  
 In Preview, the list repeats to display the field data in the free\-form format, as shown in the following figure:  
  
 ![Preview for List with 4 fields and one image](../../Images/Image/ImageNotContaina/rs_BasicListFormPreview.gif "rs_BasicListFormPreview")  
...
##  <a name="DisplayingGrouping"></a> Displaying Data with One Level of Grouping  
 ...
 ![A list with 2 tables, one with nested chart](../../Images/Image/ImageContaina/rs_BasicListGroupDesign.gif "rs_BasicListGroupDesign")  
 ...
 ![Preview, 2 tables, one with nested chart](../../Images/Image/ImageNotContaina/rs_BasicListGroupPreview.gif "rs_BasicListGroupPreview")  
