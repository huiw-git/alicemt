...
####  <a name="Permissions"></a> Permissions  
 You must have the dqs\_administrator role on the DQS\_MAIN database to configure log severity settings.  
