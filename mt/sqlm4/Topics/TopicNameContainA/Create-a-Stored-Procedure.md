...
# Create a Stored Procedure
  This topic describes how to create a [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] stored procedure by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] and by using the [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] CREATE PROCEDURE statement.  
...
2.  Expand **Databases**, expand the [!INCLUDE[ssSampleDBobject](../../Token/Other/ssSampleDBobject_md.md)] database, and then expand **Programmability**.  
...
5.  In the **Specify Values for Template Parameters** dialog box, enter the following values for the parameters shown.  
    ...
    |Procedure\_name|HumanResources.uspGetEmployeesTest|  
    |@Param1|@LastName|  
    |@Datatype\_For\_Param1|**nvarchar**\(50\)|  
    |Default\_Value\_For\_Param1|NULL|  
    |@Param2|@FirstName|  
    |@Datatype\_For\_Param2|**nvarchar**\(50\)|  
    |Default\_Value\_For\_Param2|NULL|  
