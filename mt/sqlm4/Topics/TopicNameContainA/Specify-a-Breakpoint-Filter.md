...
##  <a name="BKMK_ActionConsiderations"></a> Filter Considerations  
 Breakpoint filters are not typically used with the [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] debugger because [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] scripts and stored procedures are not parallel applications.  
...
2.  In the **Breakpoint Filters** dialog box, use the **Filter** box to specify computers by name, or operating system processes and threads by either name or ID number:  
    ...
    -   **ThreadID** and **ThreadName** are the operating system thread running the [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] batch, procedure, or function in the instance of the Database Engine.  
