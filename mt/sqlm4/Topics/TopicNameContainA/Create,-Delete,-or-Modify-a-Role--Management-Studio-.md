...
# Create, Delete, or Modify a Role (Management Studio)
 ...
 To create, modify, or delete roles, use [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)]. You can only delete roles that are not used.  
...
5.  Optionally type a description. In [!INCLUDE[ssManStudio](../../Token/Other/ssManStudio_md.md)] this description is visible only on this page. Users who view this item through Report Manager can see this description in that tool.  
...
3.  To delete or modify an item\-level role definition, expand the Roles folder. Perform one of the following:  
    ...
    1.  To delete a role definition, right\-click the item and click **Delete**. The **Delete Object** dialog box is displayed. [!INCLUDE[clickOK](../../Token/Other/clickOK_md.md)]  
...
4.  To delete or modify a system\-level role definition, expand the **System Roles** folder. Perform one of the following:  
    ...
    1.  To delete a system role definition, right\-click the item and click **Delete**. The **Delete Object** dialog box is displayed. [!INCLUDE[clickOK](../../Token/Other/clickOK_md.md)]  
