...
```  
 ...
 ![Get-PhysicalDisk](../../Images/Image/ImageNotContaina/Get-PhysicalDisk.png "Get-PhysicalDisk")  
...
```  
 ...
 ![Select FriendlyName](../../Images/Image/ImageNotContaina/Select-FriendlyName.png "Select FriendlyName")  
...
```  
 ...
 ![New-StoragePool](../../Images/Image/ImageNotContaina/New-StoragePool.png "New-StoragePool")  
...
```  
 ...
 ![New-Volume](../../Images/Image/ImageNotContaina/New-Volume.png "New-Volume")  
 ...
 ![Get-VirtualDisk](../../Images/Image/ImageNotContaina/Get-VirtualDisk.png "Get-VirtualDisk")  
  
 You can now view this new volume visible in your server. You can now use this drive for your SQL Server transaction log.  
  
 ![Log_Space Drive](../../Images/Image/ImageNotContaina/Log_Space-Drive.png "Log_Space Drive")  
