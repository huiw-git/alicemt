...
### Permissions  
 This section summarizes the permission levels required to use each of the methods for both Native and SharePoint mode [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)]. The scripts in this topic use the following [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] methods:  
 ...
 **Tested environments**  
 ...
 The scripts in this topic were tested on PowerShell version 3 and with the following versions of [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)]:  
