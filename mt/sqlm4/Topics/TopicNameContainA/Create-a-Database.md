...
---
# Create a Database
  This topic describes how to create a database in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Token/Other/tsql_md.md)].  
...
-   A maximum of 32,767 databases can be specified on an instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)].  
...
####  <a name="Permissions"></a> Permissions  
 ...
 To maintain control over disk use on an instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)], permission to create databases is typically limited to a few login accounts.  
...
5.  To change the owner name, click (**…**) to select another owner.  
    ...
    > [!NOTE]  
    >  The **Use full-text indexing** option is always checked and dimmed because, beginning in [!INCLUDE[ssKatmai](../../Token/Other/ssKatmai_md.md)], all user databases are full-text enabled.  
