...
# Encrypt a Column of Data
  This topic describes how to encrypt a column of data by using symmetric encryption in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] using [!INCLUDE[tsql](../../Token/Other/tsql_md.md)]. This is sometimes known as column\-level encryption, or cell\-level encryption.  
