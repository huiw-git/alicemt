...
|-----------------------------|-----------------------------------------------|-----------------------------------------------|  
|A report that runs as a report snapshot.|On the Contents page. For more information, see [Contents Page &#40;Report Manager&#41;](../../Topics/TopicNameNotContainA/Contents-Page--Report-Manager-.md).|1\) Locate the folder that contains the report.<br /><br /> 2\) Set the folder in Details view.<br /><br /> 3\) Note the date and time in the **When Run** column.|  
|A snapshot in report history.|On the History Properties page. For more information, see [Snapshot Options Properties Page &#40;Report Manager&#41;](../../Topics/TopicNameNotContainA/Snapshot-Options-Properties-Page--Report-Manager-.md).|1\) Open the report.<br /><br /> 2\) Click the **Properties** page.<br /><br /> 3\) Click the **History** tab.<br /><br /> 4\) Note the date and time in the **When Run** column.|  
