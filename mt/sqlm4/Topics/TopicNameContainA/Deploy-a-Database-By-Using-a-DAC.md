...
# Deploy a Database By Using a DAC
  Use the **Deploy a Database to SQL Azure** Wizard to deploy a database between an instance of the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] and a [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)] server, or between two [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)]servers.  
...
###  <a name="DBOptSettings"></a> Database Options and Settings  
 ...
 Database options, such as TRUSTWORTHY, DB\_CHAINING and HONOR\_BROKER\_PRIORITY, cannot be adjusted as part of the deployment process. Physical properties, such as the number of filegroups, or the numbers and sizes of files cannot be altered as part of the deployment process. After the deployment completes, you can use the ALTER DATABASE statement, [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)], or [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] PowerShell to tailor the database.  
  
###  <a name="LimitationsRestrictions"></a> Limitations and Restrictions  
 The **Deploy Database** wizard supports deploying a database:  
  
-   From an instance of the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] to [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)].  
  
-   From [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)] to an instance of the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)].  
  
-   Between two [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)] servers.  
  
 The wizard does not support deploying databases between two instances of the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)].  
  
 An instance of the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] must be running [!INCLUDE[ssVersion2005](../../Token/Other/ssVersion2005_md.md)] Service Pack 4 \(SP4\) or later to work with the wizard. If a database on an instance of the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] contains objects not supported on [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)], you cannot use the wizard to deploy the database to [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)]. If a database on [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)] contains objects not supported by [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)], you cannot use the wizard to deploy the database to instances of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)].  
...
1.  Connect to the location of the database you want to deploy. You can specify either an instance of [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] or a [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)] server.  
 ...
 **[!INCLUDE[ssSDS](../../Token/Other/ssSDS_md.md)] database settings:**  
  
-   **[!INCLUDE[ssSDS](../../Token/Other/ssSDS_md.md)] edition** – Select the edition of [!INCLUDE[ssSDS](../../Token/Other/ssSDS_md.md)] from the drop\-down menu.  
