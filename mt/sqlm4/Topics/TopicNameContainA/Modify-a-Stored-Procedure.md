...
##  <a name="Top"></a> This topic describes how to modify a stored procedure in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Token/Other/tsql_md.md)].  
...
###  <a name="Restrictions"></a> Limitations and Restrictions  
 [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] stored procedures cannot be modified to be CLR stored procedures and vice versa.  
...
7.  To save the updated procedure definition as a [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] script, on the **File** menu, click **Save As**. Accept the file name or replace it with a new name, and then click **Save**.  
...
2.  Expand **Databases**, expand the database in which the procedure belongs. Or, from the tool bar, select the database from the list of available databases. For this example, select the [!INCLUDE[ssSampleDBobject](../../Token/Other/ssSampleDBobject_md.md)] database.  
  
3.  On the **File** menu, click **New Query**.  
  
4.  Copy and paste the following example into the query editor. The example creates the `uspVendorAllInfo` procedure, which returns the names of all the vendors in the [!INCLUDE[ssSampleDBCoFull](../../Token/Other/ssSampleDBCoFull_md.md)] database, the products they supply, their credit ratings, and their availability.  
...
8.  To save the updated procedure definition as a [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] script, on the **File** menu, click **Save As**. Accept the file name or replace it with a new name, and then click **Save**.  
