...
# Restore a Database Master Key
  This topic describes how to restore the database master key in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] by using [!INCLUDE[tsql](../../Token/Other/tsql_md.md)].  
