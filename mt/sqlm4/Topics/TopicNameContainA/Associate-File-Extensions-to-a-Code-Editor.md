...
# Associate File Extensions to a Code Editor
  Associating file extensions to a specific code editor allows you to open a file with the appropriate [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] code editor when you double\-click a file in Windows Explorer. The extensions commonly used by [!INCLUDE[ssManStudio](../../Token/Other/ssManStudio_md.md)], such as .sql and .mdx, are associated during installation. New file extensions must also be associated to [!INCLUDE[ssManStudio](../../Token/Other/ssManStudio_md.md)] in the file system. You can use this feature to open files created with other editors, or to open files you have renamed, such as backups of .sql files that were renamed .bak.  
  
 There are two steps in the process. First associate the extension with [!INCLUDE[ssManStudio](../../Token/Other/ssManStudio_md.md)], and then associate the extension with a specific code editor.  
...
1.  In [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)], from the **Tools** menu, click **Options**.  
