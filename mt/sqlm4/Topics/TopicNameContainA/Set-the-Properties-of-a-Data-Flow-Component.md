...
-   The component editors that [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] provides. These editors include only the custom properties of each data flow component.  
...
4.  In the data flow designer, right\-click the data flow component, and then click **Show Advanced Editor**.  
    ...
    > [!NOTE]  
    >  In [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)], data flow components that support multiple inputs cannot use the **Advanced Editor**.  
