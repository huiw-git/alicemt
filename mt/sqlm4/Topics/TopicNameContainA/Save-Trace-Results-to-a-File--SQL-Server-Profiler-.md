...
# Save Trace Results to a File (SQL Server Profiler)
  This topic describes how to save trace results to a file by using [!INCLUDE[ssSqlProfiler](../../Token/Other/ssSqlProfiler_md.md)].  
...
6.  Optionally, specify the following options:  
    ...
    -   Select the **Enable file rollover** check box to have [!INCLUDE[ssSqlProfiler](../../Token/Other/ssSqlProfiler_md.md)] create new files for trace data once the maximum file size is reached. This option is selected by default.  
