...
# Create a Cross-Domain Rule
 ...
 Apart from just letting you know about the validity of a cross\-domain rule, the definitive *Then* clause in a cross\-domain rule, **Value is equal to**, also corrects the data during the data\-cleansing activity. For more information, see [Data Correction using Definitive Cross-Domain Rules](../../Topics/TopicNameContainA/Cleanse-Data-in-a-Composite-Domain.md) in [Cleanse Data in a Composite Domain](../../Topics/TopicNameContainA/Cleanse-Data-in-a-Composite-Domain.md).  
