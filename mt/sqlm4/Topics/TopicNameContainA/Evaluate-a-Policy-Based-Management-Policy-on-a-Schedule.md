...
# Evaluate a Policy-Based Management Policy on a Schedule
  This topic describes how to evaluate a Policy\-Based Management policy on a schedule in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)].  
...
6.  On the **Open Policy –***policy\_name* dialog box, in the **Evaluation Mode** list, select **On schedule**.  
