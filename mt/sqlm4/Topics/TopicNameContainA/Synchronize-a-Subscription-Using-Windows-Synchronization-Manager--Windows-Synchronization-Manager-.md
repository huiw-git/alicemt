...
# Synchronize a Subscription Using Windows Synchronization Manager (Windows Synchronization Manager)
  [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] Windows Synchronization Manager can only be used to synchronize subscriptions to Microsoft [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] publications if [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] is running on the same computer as Synchronization Manager \(it can also be used to synchronize offline files and Web pages\). To use Synchronization Manager:  
...
2.  In the **Items to Synchronize** dialog box, select the subscriptions to synchronize. Subscriptions are listed under the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] instances installed on the computer.  
