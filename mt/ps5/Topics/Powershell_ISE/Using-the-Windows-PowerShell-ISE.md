...
This topics in this document describe how you can use features of the [!INCLUDE[ise_1](../../Tokens/ise_1_md.md)] to be more productive.
...
Provides the steps to create a Windows PowerShell tab in [!INCLUDE[ise_2](../../Tokens/ise_2_md.md)].
...
Provides steps for debugging scripts in [!INCLUDE[mshgraphicalhostshort](../../Tokens/mshgraphicalhostshort_md.md)]

[How to Use Profiles in Windows PowerShell ISE](../../Topics/Powershell_ISE/How-to-Use-Profiles-in-Windows-PowerShell-ISE.md)
Provides information about and steps for creating and using profiles in [!INCLUDE[ise_2](../../Tokens/ise_2_md.md)].
