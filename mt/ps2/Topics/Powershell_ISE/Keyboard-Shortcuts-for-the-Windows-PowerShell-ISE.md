...
You can use the following keyboard shortcuts to start the Windows PowerShell console (PowerShell.exe) or to exit [!INCLUDE[ise_2](../../Topics/Powershell_ISE/includes/ise_2_md.md)].
