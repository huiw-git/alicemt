...
-   RDL backward compatibility mode for [!INCLUDE[ssRSversion2005](../../Token/Other/ssRSversion2005_md.md)] custom report items.  
...
-   The [!INCLUDE[vbprvb](../../Token/Other/vbprvb_md.md)] **New** method.  
...
-   Add that new class to the allow list.  
 ...
 To add [!INCLUDE[vbprvb](../../Token/Other/vbprvb_md.md)] .NET Framework functions to the allow list, add the corresponding types from the Microsoft.VisualBasic namespace to the allow list.  
  
 To add [!INCLUDE[vbprvb](../../Token/Other/vbprvb_md.md)] .NET Framework type keywords to the allow list, add the corresponding CLR type to the allow list. For example, to use the [!INCLUDE[vbprvb](../../Token/Other/vbprvb_md.md)] .NET Framework keyword **Integer**, add the following XML fragment to the **<RDLSandboxing>** element:  
  
```  
<Allow Namespace="System">Int32</Allow>  
```  
  
 To add a generic or a [!INCLUDE[vbprvb](../../Token/Other/vbprvb_md.md)] .NET Framework nullable type to the allow list, you must do the following:  
  
-   Create a proxy type for the generic or [!INCLUDE[vbprvb](../../Token/Other/vbprvb_md.md)] .NET Framework nullable type.  
...
-   When you update the [!INCLUDE[dnprdnshort](../../Token/Other/dnprdnshort_md.md)] on the report server.  
  
-   When you upgrade the report server to a later version of [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)].  
...
### Working with Operators and New  
 By default, [!INCLUDE[vbprvb](../../Token/Other/vbprvb_md.md)] .NET Framework language operators, except for **New**, are always allowed. The **New** operator is controlled by the **AllowNew** attribute on the **<Allow>** element. Other language operators, such as the default collection accessor operator **!** and [!INCLUDE[vbprvb](../../Token/Other/vbprvb_md.md)] .NET Framework cast macros such as **CInt**, are always allowed.  
