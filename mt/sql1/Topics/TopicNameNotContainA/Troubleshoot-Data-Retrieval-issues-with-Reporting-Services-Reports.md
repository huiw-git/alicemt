...
> [!NOTE]  
>It is recommended that you do not add login information such as passwords to the connection string. Report Designer provides a **Credentials** page on the [Data Source Properties](../../Topics/TopicNameNotContainA/Data-Source-Properties-Dialog-Box--General--Report-Builder-.md) or the [Shared Data Source Properties dialog boxes](../../Topics/TopicNameNotContainA/Shared-Data-Source-Properties-Dialog-Box--Credentials.md) that you can use to enter credentials. These credentials are stored securely on the report authoring computer.  
...
* Run the query in the query pane of the **Dataset Properties** dialog box. For more information, see [Report Datasets (Report Builder 3.0 and SSRS)](../../Topics/TopicNameNotContainA/Report-Datasets--SSRS-.md).  
* Add fields manually. For more information, see [How to: Add, Edit, Refresh Fields in the Report Data Pane (Report Builder 3.0 and SSRS)](../../Topics/TopicNameNotContainA/Add--Edit--Refresh-Fields-in-the-Report-Data-Pane--Report-Builder-and-SSRS-.md).   
