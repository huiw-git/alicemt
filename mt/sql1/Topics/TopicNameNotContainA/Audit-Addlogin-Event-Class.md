...
# Audit Addlogin Event Class
  The **Audit Addlogin** event class occurs when a [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] login is added or removed.  
