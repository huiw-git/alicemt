...
The **Audit Addlogin** event class occurs when a [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] login is added or removed.  
 ...
 This event class may be removed in a future version of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)]. It is recommended that you use the **Audit Server Principal Management** event class instead.  
...
## See Also  
 ...
 [sp_droplogin (Transact-SQL)](assetId:///e58684d1-c394-48de-906e-da6ee91100c3)   
