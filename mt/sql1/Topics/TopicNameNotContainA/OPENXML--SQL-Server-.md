...
---
# OPENXML (SQL Server)
OPENXML, a [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] keyword, provides a rowset over in-memory XML documents that is similar to a table or a view. OPENXML allows access to XML data as though it is a relational rowset. It does this by providing a rowset view of the internal representation of an XML document. The records in the rowset can be stored in database tables.  
  
 OPENXML can be used in SELECT and SELECT INTO statements wherever rowset providers, a view, or OPENROWSET can appear as the source. For information about the syntax of OPENXML, see [Sample XML Applications](assetId:///8088b114-7d01-435a-8e0d-b81abacc86d6).  
...
> [!NOTE]  
>  **sp_xml_preparedocument** uses a SQL-updated version of the MSXML parser, Msxmlsql.dll. This version of the MSXML parser was designed to support [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] and remain backward compatible with MSXML version 2.6.  
 ...
 ![Parsing XML with OPENXML](../../Topics/TopicNameNotContainA/images/xmlsp.gif "xmlsp")  
  
 Note that to understand OPENXML, familiarity with XPath queries and an understanding of XML is required. For more information about XPath support in SQL Server, see [Using XPath Queries](assetId:///7814d099-81ec-4fb8-894a-729cdbb5015a).  
...
```  
 ...
 ![Parsed XML tree](../../Topics/TopicNameNotContainA/images/xmlparsedtree.gif "xmlparsedtree")  
...
## See Also  
 ...
 [sp_xml_removedocument (Transact-SQL)](assetId:///f9dca50a-8baf-4170-90bc-e72783ce5b73)   
