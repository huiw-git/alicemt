...
> [!NOTE]  
>  **sp_xml_preparedocument** uses a SQL-updated version of the MSXML parser, Msxmlsql.dll. This version of the MSXML parser was designed to support [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] and remain backward compatible with MSXML version 2.6.  
 ...
 ![Parsing XML with OPENXML](../../Topics/TopicNameNotContainA/media/xmlsp.gif "xmlsp")  
...
```  
 ...
 ![Parsed XML tree](../../Topics/TopicNameNotContainA/media/xmlparsedtree.gif "xmlparsedtree")  
