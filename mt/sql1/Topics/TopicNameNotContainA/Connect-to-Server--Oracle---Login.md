...
-   You must be currently logged in with the same [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] Windows account you specified for the replication administrative user schema.  
