...
This topic helps you troubleshoot problems with [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion.md)] report design, previewing a report, publishing a report to a report server in native mode or SharePoint mode, viewing a report on the report server, or exporting a report to a different file format.  
...
## Use [!INCLUDE[ssManStudioFull](../../Topics/TopicNameNotContainA/tokens/ssManStudioFull.md)] to Verify Queries and Credentials  
You can use [!INCLUDE[ssManStudioFull](../../Topics/TopicNameNotContainA/tokens/ssManStudioFull.md)] to validate complex queries before you include them in your report.   
