...
##  <a name="ComparingImages"></a> Comparing External, Embedded, and Data-Bound Images  
 ...
 ![rs&#95;DataboundBikes](../../Topics/TopicNameNotContainA/images/rs_DataboundBikes.gif "rs_DataboundBikes")  
...
##  <a name="ImagesReportParts"></a> Images as Report Parts  
 You can save images separately from a report as report parts. [!INCLUDE[ssRBrptparts](../../Topics/TopicNameContainA/tokens/ssRBrptparts_md.md)]  
