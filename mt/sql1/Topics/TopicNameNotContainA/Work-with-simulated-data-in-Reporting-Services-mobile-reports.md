...
When you place a gallery element on the design surface, [!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameContainA/tokens/SS_MobileReptPub_Short.md)] immediately generates simulated data for that element. This data serves a number of useful purposes when creating mobile reports.   
  
![SS_MRP_SimDataTreeMapProps](../../Topics/TopicNameNotContainA/images/SS_MRP_SimDataTreeMapProps.png)  
...
[!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameContainA/tokens/SS_MobileReptPub_Short.md)] generates an Excel document containing the simulated data, allowing for quick substitution of actual data, ready for import.   
...
As mentioned previously, you can export simulated data to an Excel file, creating a perfect data template for the associated mobile report. You can  swap in your own real data into the Excel file and import it back into the [!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameContainA/tokens/SS_MobileReptPub_Short.md)].   
