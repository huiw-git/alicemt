...
2.  In **Solution Explorer**, right-click the [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] project, click **Edit Database**, and then click the **Warnings** tab.  
