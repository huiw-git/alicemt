...
### Using [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)]  
 See [CREATE COLUMN MASTER KEY (Transact-SQL)](assetId:///f8926b95-e146-4e3f-b56b-add0c0d0a30e) for how to provision a new column master key programmatically or from command line, and for how to define it in the database by using [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)].  
  
### Using [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/tokens/ssManStudio_md.md)]  
 You can provision and define a new column master key using [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/tokens/ssManStudio_md.md)] using the New Column Master Key dialog. To open the dialog, in Object Explorer, navigate to the Security/Always Encrypted Keys folder under your database, right-click on Column Master Keys and select New Column Master Key.  
...
### Using [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)]  
 Use the [DROP COLUMN MASTER KEY (Transact-SQL)](assetId:///fd5e77c8-a3ae-4795-bb46-b322c0500041) statement to remove the old column master key.  
