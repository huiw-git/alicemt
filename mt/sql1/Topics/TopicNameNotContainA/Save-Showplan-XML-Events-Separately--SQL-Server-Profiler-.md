...
# Save Showplan XML Events Separately (SQL Server Profiler)
  This topic describes how to save **Showplan XML** events that are captured in traces into separate .SQLPlan files by using [!INCLUDE[ssSqlProfiler](../../Token/Other/ssSqlProfiler_md.md)]. You can open the **Showplan XML** event files in [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)], which enables you to view the graphical execution plan for each event.  
