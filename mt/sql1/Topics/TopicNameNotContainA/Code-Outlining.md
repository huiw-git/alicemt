...
---
# Code Outlining
  You can use the outlining feature in the [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)] query editors to selectively hide code when you edit queries. This enables you to more easily view the code you are working on, especially in large query files.  
...
## System Outline Regions  
 Each [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)] editor generates a set of default, system-defined outline regions.  
...
### Analysis Services XMLA Query Editor Regions  
 The [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/includes/ssASnoversion_md.md)] XMLA Query Editor generates an outline region for each multiline XML attribute. The editor nests the outline regions for nested tags. For example, the XMLA Editor creates three outline regions for the following document.  
  
 ![XML code showing outlining](../../Topics/TopicNameNotContainA/media/EditOutlineXMLFull.gif "EditOutlineXMLFull")  
  
 When you click the minus sign on the <InnerTag\> line, just the InnerTag is collapsed, as shown in the following illustration.  
  
 ![XML code with inner node hidden](../../Topics/TopicNameNotContainA/media/EditOutlineXMLInnerCol.gif "EditOutlineXMLInnerCol")  
 ...
 ![XML code with tooltip showing hidden code](../../Topics/TopicNameNotContainA/media/EditOutlineXMLMouse.gif "EditOutlineXMLMouse")  
 ...
 ![XML code with inner and middle tags hidden](../../Topics/TopicNameNotContainA/media/EditOutlineXMLMiddleCol.gif "EditOutlineXMLMiddleCol")  
  
 When you click the minus sign on the <OuterTag\> line, all three lines are collapsed, as shown in the following illustration.  
  
 ![XML code showing all three tags hidden](../../Topics/TopicNameNotContainA/media/EditOutlineXMLOuterCol.gif "EditOutlineXMLOuterCol")  
  
### Database Engine Query Editor Regions  
 The [!INCLUDE[ssDE](../../Topics/TopicNameContainA/includes/ssDE_md.md)] Query Editor generates outline regions for each element in the following hierarchy:  
...
3.  Multiline statements.  
 ...
 For example, the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/includes/ssDE_md.md)] Query Editor creates three outline regions for the following query:  
