...
-   Reporting actions, which return a report from [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] that is associated with the selected section of the cube where the action occurs.  
...
## Types of Actions  
 The following table lists the types of actions that are included in [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)]:  
