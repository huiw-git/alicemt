...
---
# Duplicate Tables
  You can duplicate an existing table in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] by creating a new table and then copying column information from an existing table.  
