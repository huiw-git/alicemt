---
title: View Collection Set Logs (SQL Server Management Studio)
ms.custom: na
...
# View Collection Set Logs (SQL Server Management Studio)
  You can view all the collection set logs or individual collection set logs from [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)].  
