...
```  
 ...
 You can also enable change tracking in [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] by using the [Database Properties &#40;ChangeTracking Page&#41;](../../Topics/TopicNameNotContainA/Database-Properties--ChangeTracking-Page-.md) dialog box.  
...
```  
 ...
 You can also enable change tracking for a table in [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] by using the [Database Properties &#40;ChangeTracking Page&#41;](../../Topics/TopicNameNotContainA/Database-Properties--ChangeTracking-Page-.md) dialog box.  
