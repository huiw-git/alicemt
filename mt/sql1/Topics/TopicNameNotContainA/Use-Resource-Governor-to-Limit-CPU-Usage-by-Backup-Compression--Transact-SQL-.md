...
### Example C: Creating a Compressed Backup (Transact-SQL)  
 The following [BACKUP](../Topic/BACKUP%20\(Transact-SQL\).md) example creates a compressed full backup of the [!INCLUDE[ssSampleDBnormal](../../Topics/TopicNameContainA/includes/ssSampleDBnormal_md.md)] database in a newly formatted backup file, `Z:\SQLServerBackups\AdvWorksData.bak`.  
