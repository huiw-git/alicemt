...
|**TSQL Global Cursor**|Only the [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] global cursor information.|  
|**TSQL Local Cursor**|Only the [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] local cursor information.|  
