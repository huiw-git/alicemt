...
3.  Show Attributes in a **Grid**. Display the attributes in grid format. The grid displays the following columns:  
 ...
 In [!INCLUDE[ssBIDevStudio](../../Topics/TopicNameContainA/tokens/ssBIDevStudio_md.md)], the icons shown in the following table mark attributes according to their usage.  
  
|Icon|Attribute Usage|  
|----------|---------------------|  
|![Attribute icon](../../Topics/TopicNameNotContainA/images/as_icon_attribute.gif "as_icon_attribute")|Regular or AccountType|  
|![Key attribute icon](../../Topics/TopicNameNotContainA/images/as_icon_key_attribute.gif "as_icon_key_attribute")|Key|  
|![Parent attribute icon](../../Topics/TopicNameNotContainA/images/as_icon_parent_attribute.gif "as_icon_parent_attribute")|Parent|  
