...
```  
 ...
 The SQL Server Agent job could execute [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statements similar to the following before each Merge Agent run:  
...
```  
 ...
 The first line resets the **Replicate** column to **0**, and the second line sets the column to **1** for events that occur in the next seven days. If this [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statement runs on 10/07/2006, the table is updated to:  
...
## See Also  
 [GETDATE (Transact-SQL)](assetId:///bebe3b65-2b3e-4c73-bf80-ff1132c680a7)   
