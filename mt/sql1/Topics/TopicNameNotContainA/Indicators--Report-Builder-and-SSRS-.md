...
-   Ratings by using common recognized shapes and symbols that show progress such number of quadrants in a square and stars.  
 ...
 ![rs&#95;IndicatorTableTrafficLight](../../Topics/TopicNameNotContainA/images/rs_IndicatorTableTrafficLight.gif "rs_IndicatorTableTrafficLight")  
  
 [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] provides built-in indicator sets and indicator icons to use as is, but you can also customize individual indicator icons and indicators sets to suit your needs.  
  
 For more information about using indicators as KPIs, see [Tutorial: Adding a KPI to Your Report (Report Builder)](assetId:///1bf77859-0b33-4f40-abaf-ebeeb6ebb1f8).  
  
> [!NOTE]  
>  You can publish indicators separately from a report as report parts. [!INCLUDE[ssRBrptparts](../../Topics/TopicNameContainA/tokens/ssRBrptparts_md.md)]  
...
##  <a name="ComparingIndicatorsToGauges"></a> Comparing Indicators to Gauges  
 ...
 ![rs&#95;GaugePanelWithIndicator](../../Topics/TopicNameNotContainA/images/rs_GaugePanelWithIndicator.gif "rs_GaugePanelWithIndicator")  
...
|-------------------|--------------------|  
|![Rs&#95;DirectionalIcons](../../Topics/TopicNameNotContainA/images/Rs_DirectionalIcons.gif "Rs_DirectionalIcons")|Directional: indicates trends using up, down, flat (no change), up-trending, or down-trending arrows.|  
|![Rs&#95;SymbolIcons](../../Topics/TopicNameNotContainA/images/Rs_SymbolIcons.gif "Rs_SymbolIcons")|Symbols: indicates states using commonly recognized symbols such as checkmarks and exclamation marks.|  
|![Rs&#95;ShapeIcons](../../Topics/TopicNameNotContainA/images/Rs_ShapeIcons.gif "Rs_ShapeIcons")|Shape: indicates conditions using commonly shapes such as traffic signs and diamond shapes.|  
|![rs&#95;RatingIcons](../../Topics/TopicNameNotContainA/images/rs_RatingIcons.gif "rs_RatingIcons")|Ratings: indicates ratings by using common recognized shapes and symbols that show progressive values such as number of quadrants in a square.|  
...
##  <a name="UsingIndicatorsInTablesMatrices"></a> Using Indicators in Tables and Matrices  
 ...
 ![rs&#95;IndicatorReportBlueArrows](../../Topics/TopicNameNotContainA/images/rs_IndicatorReportBlueArrows.gif "rs_IndicatorReportBlueArrows")  
...
##  <a name="IncludingIndicatorsInGauges"></a> Including Indicators and Gauges in Gauge Panels  
 ...
 ![rs&#95;GaugePanelWithIndicatorAndGauge](../../Topics/TopicNameNotContainA/images/rs_GaugePanelWithIndicatorAndGauge.gif "rs_GaugePanelWithIndicatorAndGauge")  
