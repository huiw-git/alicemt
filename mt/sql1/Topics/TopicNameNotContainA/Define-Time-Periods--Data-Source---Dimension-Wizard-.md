...
## Options  
 **Time Property Name**  
 Displays the attribute types used to indicate time periods within time dimensions. For more information about attribute types, see [Designing Dimensions](assetId:///64fce1f5-39b7-4d0a-ae60-21203a03bd0d).  
