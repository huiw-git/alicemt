...
-   BLOB columns \(DT\_TEXT, DT\_NTEXT, DT\_IMAGE\) are not supported for either parameter.  
...
> [!NOTE]  
>  The following example shows how it was done in [!INCLUDE[ssISversion2005](../../Token/Other/ssISversion2005_md.md)]\/[!INCLUDE[ssISversion10](../../Token/Other/ssISversion10_md.md)].  
