...
> [!NOTE]  
>  Any reference to managed code from a [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] trigger counts as one level against the 32-level nesting limit. Methods invoked from within managed code do not count against this limit.  
...
-   [Setting Database Options](assetId:///d18b251d-b37a-4f5f-b50c-502d689594c8)  
