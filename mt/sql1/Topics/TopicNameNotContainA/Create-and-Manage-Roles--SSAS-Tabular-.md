...
7.  To add members to the role, click the **Members** tab, and then click **Add**.  
    ...
    > [!NOTE]  
    >  Role members can also be added to a deployed model by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)]. For more information, see [Manage Roles by using SSMS &#40;SSAS Tabular&#41;](../../Topics/TopicNameNotContainA/Manage-Roles-by-using-SSMS--SSAS-Tabular-.md).  
