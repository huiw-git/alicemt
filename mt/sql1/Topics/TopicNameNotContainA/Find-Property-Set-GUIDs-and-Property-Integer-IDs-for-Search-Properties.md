...
-   Generic properties defined by [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)].  
  
-   Category\-specific properties defined by [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)].  
...
##  <a name="filtdump"></a> Finding Information about Available Properties by using FILTDUMP.EXE  
 To learn what properties are discovered and extracted by an installed IFilter, you can install and run the **filtdump.exe** utility, which is part of the [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] Windows SDK.  
