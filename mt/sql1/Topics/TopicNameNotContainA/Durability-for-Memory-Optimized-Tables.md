...
### The Delta File  
 ...
 Size: Each data file is sized approximately to 128MB for computers with memory greater than 16GB, and 16MB for computers with less than or equal to 16GB. In [!INCLUDE[ssSQL15](../../Token/Other/ssSQL15_md.md)] SQL Server can use large checkpoint mode if it deems the storage subsystem is fast enough. In large checkpoint mode, data files are sized at 1GB. This allows for greater efficiency in the storage subsystem for high\-throughput workloads.  
...
## Populating Data and Delta Files  
 ...
 ![Read log records for memory-optimized tables.](../../Images/Image/ImageNotContaina/read_logs_hekaton.gif "read_logs_hekaton")  
...
## Accessing Data and Delta Files  
 ...
 This thread appends inserts and deletes to memory\-optimized data rows, to the corresponding data and delta file pairs. In [!INCLUDE[ssSQL14](../../Token/Other/ssSQL14_md.md)] there is one offline checkpoint worker; starting [!INCLUDE[ssSQL15](../../Token/Other/ssSQL15_md.md)] there are multiple checkpoint workers.  
...
## Merging Data and Delta Files  
 ...
 ![Diagram shows memory optimized table file group](../../Images/Image/ImageNotContaina/StorageDiagram_Hekaton.png "StorageDiagram_Hekaton")  
...
### [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Merge Policy  
 [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] implements the following merge policy:  
