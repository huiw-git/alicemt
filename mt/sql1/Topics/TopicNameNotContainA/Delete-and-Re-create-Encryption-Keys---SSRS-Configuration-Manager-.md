...
3.  On the Encryption Keys page, click **Change**. [!INCLUDE[clickOK](../../Topics/TopicNameContainA/tokens/clickOK_md.md)]  
...
2.  Click **Encryption Keys**, and then click **Delete**. [!INCLUDE[clickOK](../../Topics/TopicNameContainA/tokens/clickOK_md.md)]  
