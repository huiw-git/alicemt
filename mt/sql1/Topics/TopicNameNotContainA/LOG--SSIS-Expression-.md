...
```  
 ...
 This example uses the variable **Length**. The variable must have a numeric data type or the expression must include an explicit cast to a numeric [!INCLUDE[ssIS](../../Topics/TopicNameContainA/includes/ssIS_md.md)] data type. If **Length** is 234.567, the function returns 2.370266913465859.  
