...
# Business Rules Extension (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/includes/ssMDSshort_md.md)], you can apply user-defined SQL scripts as an extension of  pre-defined conditions and actions.  
...
-   User defined scripts had been added to the [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/includes/ssMDSshort_md.md)] database.  
