...
-   Availability Groups must be created with the **CREATE AVAILABILITY GROUP** command and the **WITH DTC\_SUPPORT \= PER\_DB** clause. You cannot currently alter an existing Availability Group.  
