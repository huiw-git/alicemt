...
This topic describes how to configure severity levels for various activities and modules in [!INCLUDE[ssDQSnoversion](../../Topics/TopicNameContainA/tokens/ssDQSnoversion_md.md)] (DQS) by using [!INCLUDE[ssDQSClient](../../Topics/TopicNameContainA/tokens/ssDQSClient_md.md)]. Severity levels define the intensity of events that occur in DQS. DQS events have the following severity levels, in the decreasing order of severity:  
