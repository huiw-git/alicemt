---
title: Toolbar (Actions Tab, Cube Designer) (Analysis Services - Multidimensional Data)
ms.custom: na
...
|**Reconnect**|Click to reconnect the **Actions** tab to the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/includes/ssASnoversion_md.md)] instance and database that contains the cube, if the session for the **Actions** tab is disconnected due to connection loss or timeout.|  
