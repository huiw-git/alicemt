...
# Assign Functional Area Permissions (Master Data Services)
  Assign functional area permission to grant users or groups access to the functional areas of [!INCLUDE[ssMDSmdm](../../Topics/TopicNameContainA/includes/ssMDSmdm_md.md)].  
