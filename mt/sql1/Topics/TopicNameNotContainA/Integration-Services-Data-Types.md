...
When data enters a data flow in a package, the source that extracts the data converts the data to an [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] data type. Numeric data is assigned a numeric data type, string data is assigned a character data type, and dates are assigned a date data type. Other data, such as GUIDs and Binary Large Object Blocks (BLOBs), are also assigned appropriate [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] data types. If data has a data type that is not convertible to an [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] data type, an error occurs.  
  
 Some data flow components convert data types between the [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] data types and the managed data types of the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] [!INCLUDE[dnprdnshort](../../Topics/TopicNameContainA/tokens/dnprdnshort_md.md)]. For more information about the mapping between [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] and managed data types, see [Mapping Data Types in the Data Flow](assetId:///941260d0-4ec3-4bf0-ab48-2b26733e6b24).  
  
 The following table lists the [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] data types. Some of the data types in the table have precision and scale information that applies to them. For more information about precision and scale, see [Precision, Scale, and Length (Transact-SQL)](assetId:///fbc9ad2c-0d3b-4e98-8fdd-4d912328e40a).  
...
|DT_STR|A null-terminated [!INCLUDE[vcpransi](../../Topics/TopicNameNotContainA/tokens/vcpransi_md.md)]/MBCS character string with a maximum length of 8000 characters. (If a column value contains additional null terminators, the string will be truncated at the occurrence of the first null.)|  
...
|DT_TEXT|An [!INCLUDE[vcpransi](../../Topics/TopicNameNotContainA/tokens/vcpransi_md.md)]/MBCS character string with a maximum length of 2^31-1 (2,147,483,647) characters.|  
...
|DT_DBTIME2|Removes the fractional second value when its scale is greater than the number of fractional second digits that the destination DT_DBTIME2 data type can contain. After removing the fractional second value, generates a report about this data truncation. For more information, see [Error Handling in Data](../../Topics/TopicNameNotContainA/Error-Handling-in-Data.md).|  
|DT_DBTIMESTAMP|Set the date field in the DT_DBTIMESTAMP data type to the current date.<br /><br /> Removes the fractional second value when its scale is greater than the number of fractional second digits that the DT_DBTIMESTAMP data type can contain. After removing the fractional second value, generates a report about this data truncation. For more information, see [Error Handling in Data](../../Topics/TopicNameNotContainA/Error-Handling-in-Data.md).|  
...
|--------------------------------|------------|  
|DT_FILETIME|Converts the data type.|  
|DT_DATE|If a value represented by the DT_DBTIMESTAMP data type overflows the range of the DT_DATE data type, returns the DB_E_DATAOVERFLOW error. For more information, see [Error Handling in Data](../../Topics/TopicNameNotContainA/Error-Handling-in-Data.md).|  
...
|DT_DATE|||||||  
|DT_DBDATE|[date (Transact-SQL)](assetId:///c963e8b4-5a85-4bd0-9d48-3f8da8f6516b)|[date (Transact-SQL)](assetId:///c963e8b4-5a85-4bd0-9d48-3f8da8f6516b)||date|date|date|  
|DT_DBTIME||||timestamp|time|time|  
|DT_DBTIME2|[time (Transact-SQL)](assetId:///30a6c681-8190-48e4-94d0-78182290a402)(p)|[time (Transact-SQL)](assetId:///30a6c681-8190-48e4-94d0-78182290a402) (p)|||||  
|DT_DBTIMESTAMP|[datetime (Transact-SQL)](assetId:///9bd1cc5b-227b-4032-95d6-7581ddcc9924), [smalldatetime (Transact-SQL)](assetId:///68b74610-d54c-4c8e-b4b2-7e3747546ee0)|[datetime (Transact-SQL)](assetId:///9bd1cc5b-227b-4032-95d6-7581ddcc9924), [smalldatetime (Transact-SQL)](assetId:///68b74610-d54c-4c8e-b4b2-7e3747546ee0)|DateTime|TIMESTAMP, DATE, INTERVAL|TIME, TIMESTAMP, DATE|TIME, TIMESTAMP, DATE|  
|DT_DBTIMESTAMP2|[datetime2 (Transact-SQL)](assetId:///868017f3-214f-43ef-8536-cc1632a2288f)|[datetime2 (Transact-SQL)](assetId:///868017f3-214f-43ef-8536-cc1632a2288f)||timestamp|timestamp|timestamp|  
|DT_DBTIMESTAMPOFFSET|[datetimeoffset (Transact-SQL)](assetId:///a0455b71-ca25-476e-a7a8-0770f1860bb7)(p)|[datetimeoffset (Transact-SQL)](assetId:///a0455b71-ca25-476e-a7a8-0770f1860bb7) (p)||timestampoffset|timestamp,<br /><br /> varchar|timestamp,<br /><br /> varchar|  
|DT_DECIMAL|||||||  
|DT_FILETIME|||||||  
