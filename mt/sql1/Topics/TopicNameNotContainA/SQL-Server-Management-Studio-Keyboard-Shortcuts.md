...
[!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] offers users two keyboard schemes. By default, it uses the [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] scheme, with keyboard shortcuts based on [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] [!INCLUDE[vsprvs](../../Topics/TopicNameContainA/tokens/vsprvs_md.md)] 2010. [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/tokens/ssManStudio_md.md)] also offers a keyboard scheme similar to the standard scheme from [!INCLUDE[ssKilimanjaro](../../Topics/TopicNameContainA/tokens/ssKilimanjaro_md.md)]. To change the keyboard scheme or add additional keyboard shortcuts, on the **Tools** menu, click **Options**. Select the desired keyboard scheme on the **Environment**, **Keyboard** page.  
...
|Action|[!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)]|[!INCLUDE[ssKilimanjaro](../../Topics/TopicNameContainA/tokens/ssKilimanjaro_md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Move to the [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] menu bar|ALT|ALT|  
...
|Move to the next tool window|ALT+F6<br /><br /> or<br /><br /> F6 in the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor|ALT+F6|  
...
|Move to the previously selected window|SHIFT+ALT+F6<br /><br /> or<br /><br /> SHIFT+F6 in the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor|SHIFT+ALT+F6|  
...
|Display the Error List Window ([!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] Editor only)|CRTL+\\, CTRL+E<br /><br /> or<br /><br /> CTRL+\\, E|CRTL+\\, CTRL+E|  
|Move to the next entry in the Error List window ([!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] Editor only)|CTRL+SHIFT+F12|CTRL+SHIFT+F12|  
...
|Move to the next active window in [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/tokens/ssManStudio_md.md)]|ALT+F6|ALT+F6|  
|Open [!INCLUDE[ssSqlProfiler](../../Topics/TopicNameContainA/tokens/ssSqlProfiler_md.md)]|CTRL+ALT+P|CTRL+ALT+P|  
