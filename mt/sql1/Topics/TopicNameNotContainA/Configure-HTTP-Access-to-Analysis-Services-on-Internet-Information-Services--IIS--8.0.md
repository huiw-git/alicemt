---
title: "Configure HTTP Access to Analysis Services on Internet Information Services (IIS) 8.0"
ms.custom: na
ms.date: 08/09/2016
...
##  <a name="bkmk_overview"></a> Overview  
 ...
 ![Diagram showing connections between components](../../Topics/TopicNameNotContainA/images/SSAS.gif "SSAS")  
...
2.  Open **Web Server** &#124; **Application Development** and choose **CGI** and **ISAPI Extensions**.  
     ...
     ![ISAPI and CGI features in Web Server Role](../../Topics/TopicNameNotContainA/images/ssas_httpaccess_ISAPCGI.png "ssas_httpaccess_ISAPCGI")  
...
> [!NOTE]  
>  Remember to unblock the ports in Windows Firewall to allow client connections to a remote Analysis Services server. For more information, see [Configure the Windows Firewall to Allow Analysis Services Access](../../Topics/TopicNameNotContainA/Configure-the-Windows-Firewall-to-Allow-Analysis-Services-Access.md).  
...
1.  Copy the following files, found at <drive\>:\Program Files\Microsoft SQL Server\\<instance\>\OLAP\bin\isapi: MSMDPUMP.DLL, MSMDPUMP.INI, and a Resources folder.  
     ...
     ![Folder structure of MSMDPUMP files](../../Topics/TopicNameNotContainA/images/ssas_httpaccess_msmdpumpfilecopy.PNG "ssas_httpaccess_msmdpumpfilecopy")  
...
2.  Open the server folder, right-click **Application Pools** and then click **Add Application Pool**. Create an application pool named **OLAP**, using the .NET Framework, with Managed pipeline mode set to **Classic**.  
     ...
     ![Screenshot of Add Application Pool dialog](../../Topics/TopicNameNotContainA/images/SSAS_HttpAccess_.PNG "SSAS_HttpAccess_")  
...
3.  By default, IIS creates application pools using **ApplicationPoolIdentity** as the security identity, which is a valid choice for HTTP access to Analysis Services. If you have specific reasons for changing the identity, right-click **OLAP**, and then select **Advanced Settings**. Select **ApplicationPoolIdentity**. Click the **Change** button for this property to replace the built-in account with the custom account you want to use.  
     ...
     ![Screenshot of Advanced Settings property page](../../Topics/TopicNameNotContainA/images/SSAS_HttpAccess_AdvSettings.PNG "SSAS_HttpAccess_AdvSettings")  
...
1.  In IIS Manager, open **Sites**, open **Default Web Site**. You should see a folder named **Olap**. This is a reference to the OLAP folder you created under \inetpub\wwwroot.  
     ...
     ![OLAP folder before converted to an app](../../Topics/TopicNameNotContainA/images/ssas_httpaccess_ConvertFolderBefore.png "ssas_httpaccess_ConvertFolderBefore")  
...
3.  In Add Application, enter **OLAP** for the alias. Click **Select** to choose the OLAP application pool. Physical Path should be set to C:\inetpub\wwwroot\OLAP  
     ...
     ![Settings for converting application](../../Topics/TopicNameNotContainA/images/ssas_httpaccess_ConvertedApp.png "ssas_httpaccess_ConvertedApp")  
...
4.  Click **OK**. Refresh the web site and notice that the OLAP folder is now an application under the default web site. The virtual path to the MSMDPUMP file is now established.  
     ...
     ![OLAP folder after conversion to an application](../../Topics/TopicNameNotContainA/images/ssas_httpaccess_ConvertFolderAfter.png "ssas_httpaccess_ConvertFolderAfter")  
...
2.  Double-click **Authentication** in the IIS section of the main page.  
     ...
     ![Screenshot of IIS Manager main page](../../Topics/TopicNameNotContainA/images/SSAS_HttpAccess_IIS.png "SSAS_HttpAccess_IIS")  
  
3.  Enable **Windows Authentication** if you are using Windows integrated security.  
  
     ![Screenshot of Vdir Authentication settings](../../Topics/TopicNameNotContainA/images/SSAS_HttpAccess_IISAuth.png "SSAS_HttpAccess_IISAuth")  
...
6.  Click the **OLAP** virtual directory to open the main page. Double-click **Handler Mappings**.  
     ...
     ![Handler Mapping feature icon](../../Topics/TopicNameNotContainA/images/ssas_httpaccess_HandlerMapping.png "ssas_httpaccess_HandlerMapping")  
...
7.  Right-click anywhere on the page and then select **Add Script Map**. In the Add Script Map dialog box, specify **\*.dll** as the request path, specify c:\inetpub\wwwroot\OLAP\msmdpump.dll as the executable, and type **OLAP** as the name. Keep all of the default restrictions associated with this script map.  
     ...
     ![Screenshot of Add Script Map dialog box](../../Topics/TopicNameNotContainA/images/SSAS_HttpAccess_AddScript.png "SSAS_HttpAccess_AddScript")  
  
8.  When prompted to allow the ISAPI extension, click **Yes**.  
  
     ![Screenshot of confirmation to add ISAPI extension](../../Topics/TopicNameNotContainA/images/SSAS_HttpAccess_ISAPIPrompt.png "SSAS_HttpAccess_ISAPIPrompt")  
...
```  
 ...
 By default, Analysis Services listens on TCP/IP port 2383. If you installed Analysis Services as the default instance, you do not need to specify any port in <ServerName\> because Analysis Services knows how to listen on port 2383 automatically. However, you do need to allow inbound connections to that port in Windows Firewall. For more information, see [Configure the Windows Firewall to Allow Analysis Services Access](../../Topics/TopicNameNotContainA/Configure-the-Windows-Firewall-to-Allow-Analysis-Services-Access.md).  
...
1.  In Management Studio, in the Connect to Server dialog box, select **Analysis Services** as the server type. In Server name, enter the HTTP address of the msmdpump extension: `http://my-web-srv01/OLAP/msmdpump.dll`.  
     ...
     ![HTTP connection shown in SSMS](../../Topics/TopicNameNotContainA/images/ssas_httpaccess_ssms.PNG "ssas_httpaccess_ssms")  
 ...
 **Test connections using AMO**  
 ...
 For more information about setting up the connection programmatically, see [Establishing Secure Connections in ADOMD.NET](assetId:///b084d447-1456-45a4-8e0e-746c07d7d6fd).  
