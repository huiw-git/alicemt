...
The Unprepare SQL event class indicates that the SqlClient, ODBC, OLE DB, or DB-Library has unprepared (deleted) a prepared [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statement or statements.  
