...
```  
 ...
 After the assembly is registered and a user-defined [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] function is created, **SqlXslTransform()** corresponding to **TransformXml()**, the function can be invoked from Transact-SQL as shown in the following query:  
