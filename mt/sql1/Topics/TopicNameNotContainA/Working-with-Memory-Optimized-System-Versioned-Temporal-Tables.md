...
## Discovering Metadata  
 To discover metadata about a memory-optimized system-versioned temporal table, you need to combine information from [sys.tables &#40;Transact-SQL&#41;](../Topic/sys.tables%20\(Transact-SQL\).md) and [sys.internal_tables &#40;Transact-SQL&#41;](../Topic/sys.internal_tables%20\(Transact-SQL\).md). A system-versioned temporal table is presented as parent_object_id of the internal in-memory history table  
