 ...
 **Results message**  
 ...
 ![Data alert e-mail message with results](../../Images/Image/ImageNotContaina/rs_AlertMessageResults.gif "rs_AlertMessageResults")  
  
 **Error message**  
  
 ![Data alert message with error message](../../Images/Image/ImageNotContaina/rs_AlertMessageErrror.gif "rs_AlertMessageErrror")  
