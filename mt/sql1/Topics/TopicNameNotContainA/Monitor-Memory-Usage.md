...
# Monitor Memory Usage
  Monitor an instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] periodically to confirm that memory usage is within typical ranges.  
...
-   **SQL Server: Memory Manager: Total Server Memory \(KB\)**  
 ...
 The **WorkingSet** counter shows the amount of memory that is used by a process. If this number is consistently below the amount of memory that is set by the **min server memory** and **max server memory** server options, [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] is configured to use too much memory.  
