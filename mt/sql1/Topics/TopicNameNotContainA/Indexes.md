...
---
# Indexes
  The following table lists the types of indexes available in [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] and provides links to additional information.  
