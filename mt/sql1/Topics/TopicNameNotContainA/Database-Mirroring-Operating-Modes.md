...
>  Most editions of [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] support only synchronous database mirroring ("Safety Full Only"). For information about editions that fully support database mirroring, see "High Availability (Always On)" in [Features Supported by the Editions of SQL Server 2016](../../Topics/TopicNameNotContainA/Features-Supported-by-the-Editions-of-SQL-Server-2016.md).  
 ...
 ![Partner&#45;only configuration of a session](../../Topics/TopicNameNotContainA/images/DBM_high_performance_mode.gif "DBM_high_performance_mode")  
...
###  <a name="HighSafetyWithOutAutoFailover"></a> High-Safety Mode Without Automatic Failover  
 ...
 ![Partners communicating without a witness](../../Topics/TopicNameNotContainA/images/DBM_high_protection_mode.gif "DBM_high_protection_mode")  
...
###  <a name="HighSafetyWithAutoFailover"></a> High-Safety Mode with Automatic Failover  
 ...
 ![The witness and two partners of a session](../../Topics/TopicNameNotContainA/images/DBM_high_availability_mode.gif "DBM_high_availability_mode")  
...
##  <a name="TsqlSettingsAndOpModes"></a> Transact-SQL Settings and Database Mirroring Operating Modes  
 This section describes a database mirroring session in terms of the ALTER DATABASE settings and states of the mirrored database and witness, if any. The section is aimed at users who manage database mirroring primarily or exclusively using [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)], rather than using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)].  
  
> [!TIP]  
>  As an alternative to using [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)], you can control the operating mode of a session in Object Explorer using the **Mirroring** page of the **Database Properties** dialog box. For more information, see [Establish a Database Mirroring Session Using Windows Authentication (SQL Server Management Studio)](../../Topics/TopicNameContainA/Establish-a-Database-Mirroring-Session-Using-Windows-Authentication--SQL-Server-Management-Studio-.md).  
...
-   SAFETY OFF  
 ...
 The transaction safety setting of the database is recorded on each partner in the **sys.database_mirroring** catalog view in the **mirroring_safety_level** and **mirroring_safety_level_desc** columns. For more information, see [sys.database_mirroring](assetId:///480de2b0-2c16-497d-a6a3-bf7f52a7c9a0).  
...
-   When the witness exists but is not connected to a partner, the witness is in the UNKOWN or DISCONNECTED state relative to that partner. In this case, the witness lacks quorum with that partner, and if the partners are not connected to each other, the database becomes unavailable.  
 ...
 The state of each witness on a server instance is recorded in the **sys.database_mirroring** catalog view in the **mirroring_witness_state** and **mirroring_witness_state_desc** columns. For more information, see [sys.database_mirroring](assetId:///480de2b0-2c16-497d-a6a3-bf7f52a7c9a0).  
...
```  
 ...
 For more information about this catalog view, see [sys.database_mirroring](assetId:///480de2b0-2c16-497d-a6a3-bf7f52a7c9a0).  
