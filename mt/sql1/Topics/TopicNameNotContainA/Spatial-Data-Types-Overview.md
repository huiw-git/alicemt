...
There are two types of spatial data. The **geometry** data type supports planar, or Euclidean (flat-earth), data. The **geometry** data type both conforms to the Open Geospatial Consortium (OGC) Simple Features for SQL Specification version 1.1.0 and is compliant with SQL MM (ISO standard).  
 ...
 In addition, [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] supports the **geography** data type, which stores ellipsoidal (round-earth) data, such as GPS latitude and longitude coordinates.  
  
> [!IMPORTANT]  
>  For a detailed description and examples of spatial features introduced in [!INCLUDE[ssSQL11](../../Topics/TopicNameContainA/tokens/ssSQL11_md.md)], including enhancements to the spatial data types, download the white paper, [New Spatial Features in SQL Server Code-Named "Denali"](http://go.microsoft.com/fwlink/?LinkId=226407).  
...
##  <a name="objects"></a> Spatial Data Objects  
 ...
 ![Hierarchy of the geometry type](../../Topics/TopicNameNotContainA/images/geom_hierarchy.gif "geom_hierarchy")  
...
### Orientation of spatial data  
 ...
 When the compatibility level is 100 or below in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] then the **geography** data type has the following restrictions:  
...
-   The **geography** data type methods that require the input of two **geography** instances, such as **STIntersection()**, **STUnion()**, **STDifference()**, and **STSymDifference()**, will return null if the results from the methods do not fit inside a single hemisphere. **STBuffer()** will also return null if the output exceeds a single hemisphere.  
 ...
 In [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)], **FullGlobe** is a special type of Polygon that covers the entire globe. **FullGlobe** has an area, but no borders or vertices.  
  
### Outer and inner rings not important in geography data type  
 The OGC Simple Features for SQL Specification discusses outer rings and inner rings, but this distinction makes little sense for the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] **geography** data type; any ring of a polygon can be taken to be the outer ring.  
...
### LineString and CircularString comparison  
 ...
 ![](../../Topics/TopicNameNotContainA/images/7e382f76-59da-4b62-80dc-caf93e637c14.gif "7e382f76-59da-4b62-80dc-caf93e637c14")  
...
```  
 ...
 ![](../../Topics/TopicNameNotContainA/images/e52157b5-5160-4a4b-8560-50cdcf905b76.gif "e52157b5-5160-4a4b-8560-50cdcf905b76")  
...
## See Also  
 ...
 [geometry Data Type Reference](assetId:///d88e632b-6b2f-4466-a15f-9fbef1a347a7)   
 [geography Data Type Reference](assetId:///028e6137-7128-4c74-90a7-f7bdd2d79f5e)   
 [STNumCurves (geometry Data Type)](assetId:///20c2fa0b-656b-4519-b34c-cc8f094290d4)   
 [STNumCurves (geography Data Type)](assetId:///e98a56c2-8496-4dfd-9b37-7f3c4ca9b2b5)   
