...
3.  Locate [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] Report Builder in the **Name** list and click it.  
...
3.  In the command prompt window, navigate to the folder with ReportBuilder3\_x86.msi.  
