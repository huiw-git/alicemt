 ...
 **ActionAtEvent**  
 Specify whether the WMI event logs the event and initiates an [!INCLUDE[ssIS](../../Token/Other/ssIS_md.md)] action, or only logs the event.  
 ...
 **ActionAtTimeout**  
 Specify whether the task logs a WMI query time-out and initiates an [!INCLUDE[ssIS](../../Token/Other/ssIS_md.md)] event in response, or only logs the time-out.  
