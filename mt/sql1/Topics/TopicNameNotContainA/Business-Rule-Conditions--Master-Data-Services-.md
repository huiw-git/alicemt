...
In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/tokens/ssMDSshort_md.md)], business rule conditions determine the conditions that must be true for one or more actions to be taken.  
