...
Use the **Receive** page of the **Message Queue Task Editor** dialog box to configure a Message Queue task to receive [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] Message Queuing (MSMQ) messages.  
