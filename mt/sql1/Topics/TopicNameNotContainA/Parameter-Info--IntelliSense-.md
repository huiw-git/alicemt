...
> [!NOTE]  
>  The **Parameter Info** option is available only for the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor and the XML Query Editor.