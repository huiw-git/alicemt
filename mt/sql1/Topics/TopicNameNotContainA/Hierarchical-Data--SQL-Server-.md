...
-   A graph of links between Web pages  
 ...
 Use [hierarchyid](assetId:///69b756e0-a1df-45b3-8a24-6ded8658aefe) as a data type to create tables with a hierarchical structure, or to describe the hierarchical structure of data that is stored in another location. Use the [hierarchyid functions](assetId:///01a050f5-7580-4d5f-807c-7f11423cbb06) in [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] to query and manage hierarchical data.  
...
### XML  
 An XML document is a tree, and therefore a single XML data type instance can represent a complete hierarchy. In [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] when an XML index is created, **hierarchyid** values are used internally to represent the position in the hierarchy.  
...
-   **Breadth-first**  
 ...
 Whether to have depth-first, breadth-first, or both, and which to make the clustering key (if any), depends on the relative importance of the above types of queries, and the relative importance of SELECT vs. DML operations. For a detailed example of indexing strategies, see [Tutorial: Using the hierarchyid Data Type](assetId:///5a7f7cfd-7faf-439f-8085-8fd6bf7db355).  
...
###  <a name="findclr"></a> Finding Ancestors by Using the CLR  
 A common operation involving two nodes in a hierarchy is to find the lowest common ancestor. This can be written in either [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] or CLR, because the **hierarchyid** type is available in both. CLR is recommended because performance will be faster.  
...
```  
 ...
 To use the **ListAncestor** and **CommonAncestor** methods in the following [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] examples, build the DLL and create the **HierarchyId_Operations** assembly in [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] by executing code similar to the following:  
...
###  <a name="lowestcommon"></a> Finding the Lowest Common Ancestor  
 Using the **HierarchyId_Operations** class defined above, create the following [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] function to find the lowest common ancestor involving two nodes in a hierarchy:  
...
## See Also  
 [hierarchyid Data Type Method Reference](assetId:///01a050f5-7580-4d5f-807c-7f11423cbb06)   
 [Tutorial: Using the hierarchyid Data Type](assetId:///5a7f7cfd-7faf-439f-8085-8fd6bf7db355)   
 [hierarchyid (Transact-SQL)](assetId:///69b756e0-a1df-45b3-8a24-6ded8658aefe)