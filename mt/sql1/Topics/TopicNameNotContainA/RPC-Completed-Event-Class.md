...
|CPU|**int**|Amount of CPU time used by the event. In microseconds beginning with [!INCLUDE[ssSQL11](../../Topics/TopicNameContainA/tokens/ssSQL11_md.md)]. In milliseconds in earlier versions.|18|Yes|  
...
|Duration|**bigint**|Amount of time taken by the event. In microseconds beginning with [!INCLUDE[ssKilimanjaro](../../Topics/TopicNameContainA/tokens/ssKilimanjaro_md.md)]. In milliseconds in earlier versions.|13|Yes|  
