...
##  <a name="BasicsCreate"></a> Creating a FileTable  
 ...
 You can create a new FileTable by using Transact-SQL or [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)]. Since a FileTable has a fixed schema, you do not have to specify a list of columns. The simple syntax for creating a FileTable lets you specify:  
