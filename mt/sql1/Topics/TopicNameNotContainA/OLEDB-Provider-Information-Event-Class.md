...
-   DBPROPSET\_DATASOURCEINFO  
  
-   SQLPROPSET\_OPTHINTS  
  
-   DBPROPSET\_SQLSERVERDATASOURCEINFO \([!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] only\)  
  
-   DBPROPSET\_SQLSERVERDBINIT \([!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] only\)  
