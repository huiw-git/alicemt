...
---
# Previewing Reports
When you design a     [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] report, you may want to view it before publishing it to a production environment. You can do this in several ways: by switching to Preview mode in Report Designer, by using the preview window in Report Designer, and by publishing the report to a report server in a test environment.  
...
-   By clicking the **Start** button on the [!INCLUDE[vsprvs](../../Topics/TopicNameContainA/tokens/vsprvs_md.md)] standard toolbar ![ssrs&#95;ssdt&#95;startdebug](../../Topics/TopicNameNotContainA/images/ssrs_ssdt_startdebug.png "ssrs_ssdt_startdebug").  
