...
# Modify Foreign Key Relationships
  You can modify the foreign key side of a relationship in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/includes/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)]. Modifying a table’s foreign key changes which columns are related to columns in the primary key table.  
 ...
 **To modify a foreign key**  
 ...
 To modify a FOREIGN KEY constraint by using Transact-SQL, you must first delete the existing FOREIGN KEY constraint and then re-create it with the new definition. For more information, see [Delete Foreign Key Relationships](../../Topics/TopicNameNotContainA/Delete-Foreign-Key-Relationships.md) and [Create Foreign Key Relationships](../../Topics/TopicNameNotContainA/Create-Foreign-Key-Relationships.md).  
