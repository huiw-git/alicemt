...
|**Number of Deadlocks\/sec**|Number of lock requests per second that resulted in a deadlock.|  
 ...
 [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] can lock these resources.  
...
|**Object**|A lock on table, stored procedure, view, etc, including all data and indexes. The object can be anything that has an entry in **sys.all\_objects**.|  
