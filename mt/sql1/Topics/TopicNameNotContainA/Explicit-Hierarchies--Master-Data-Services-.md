...
# Explicit Hierarchies (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)], an explicit hierarchy organizes members from a single entity in any way you specify. The structure can be ragged and unlike derived hierarchies, explicit hierarchies are not based on domain\-based attribute relationships.  
...
## Explicit Hierarchy Example  
 ...
 ![Mountain Bike Explicit Hierarchy Example](../../Images/Image/ImageNotContaina/mds_conc_explicit_hierarchy.gif "mds_conc_explicit_hierarchy")  
