...
# Values for &lt;xsd:simpleType&gt; Declarations
 ...
 Also, [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] does not support the NaN value in **<xsd:simpleType>** declarations. Schemas that include NaN values are rejected by the server.  
