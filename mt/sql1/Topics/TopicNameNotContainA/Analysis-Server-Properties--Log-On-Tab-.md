...
Use the **Log On** tab of the **Analysis Server Properties** dialog box to specify the account used by the [!INCLUDE[ssAS](../../Topics/TopicNameNotContainA/tokens/ssAS_md.md)] service, and to start and stop the service.  
