...
-   Hadoop cluster. For supported versions see [Supported external data sources](#supported).  
...
1.  Run [sp_configure (Transact-SQL)](assetId:///d18b251d-b37a-4f5f-b50c-502d689594c8) ‘hadoop connectivity’ and set an appropriate value.  To find the value, see [PolyBase Connectivity Configuration (Transact-SQL)](../../Topics/TopicNameNotContainA/PolyBase-Connectivity-Configuration--Transact-SQL-.md).  
...
2.  You must restart  SQL Server using **services.msc**. Restarting SQL Server restarts these services:  
 ...
 ![stop and start PolyBase services in services.msc](../../Topics/TopicNameNotContainA/images/polybase-stop-start.png "polybase-stop-start")  
...
3.  Add other instances as compute nodes by running [sp_polybase_join_group](assetId:///48066431-fed2-4a8a-85af-ac704689e183).  
...
## Managing PolyBase objects in SSMS  
 ...
 ![PolyBase objects in SSMS](../../Topics/TopicNameNotContainA/images/polybase_management.png "polybase_management")  
...
## See Also  
 ...
 [PolyBase stored procedures](assetId:///a522b303-bd1b-410b-92d1-29c950a15ede)   
