...
# Database Snapshots with Always On Availability Groups (SQL Server)
 ...
 Some [!INCLUDE[ssHADR](../../Topics/TopicNameContainA/includes/ssHADR_md.md)] conditions cause both the source database and its database snapshots to be restarted, temporarily disconnecting users. These conditions are as follows:  
