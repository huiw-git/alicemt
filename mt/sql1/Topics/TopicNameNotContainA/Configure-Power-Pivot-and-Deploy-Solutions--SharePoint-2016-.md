...
This topics describes the deployment and configuration of middle-tier enhancements to the [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] features in [!INCLUDE[SPS2016](../../Topics/TopicNameNotContainA/tokens/SPS2016_md.md)] including [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] Gallery, Schedule data refresh, Management Dashboard, and data providers. Run **[!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] for SharePoint 2016 Configuration** tool to complete the following:  
...
-   For information on backend services and installing a [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] server in [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] mode, see [Install Analysis Services in Power Pivot Mode](../../Topics/TopicNameNotContainA/Install-Analysis-Services-in-Power-Pivot-Mode.md).  
  
 For information on installing the [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] for SharePoint 2016 Configuration tool, see [Install or Uninstall the Power Pivot for SharePoint Add-in (SharePoint 2016)](../../Topics/TopicNameNotContainA/Install-or-Uninstall-the-Power-Pivot-for-SharePoint-Add-in--SharePoint-2016-.md)  
...
1.  On the **Start** menu, select **All Programs**, and then select [!INCLUDE[ssCurrentUI](../../Topics/TopicNameContainA/tokens/ssCurrentUI_md.md)], select **Configuration Tools**, and then select **[!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] For SharePoint 2016 Configuration**. Tools is listed only when [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] for SharePoint is installed on the local server.  
  
2.  Select **Configure or Repair [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] for SharePoint** and then select **OK**.  
...
2.  Verify that **SQL Server [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] System Service** is started.  
...
1.  Browse to your site URL that was created by the Configuration tool.  
     ...
     Select **Settings**![SharePoint Settings](../../Topics/TopicNameContainA/images/AS_SharePoint2013_settings_gear.gif "AS_SharePoint2013_settings_gear"), and then click **Site Settings**.  
...
2.  Verify the service application status is **started**. The default name is **Default [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] Service Application**.  
     ...
     Select the name of the services application to open the [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] Management Dashboard for the service application opens. On first use, the dashboard takes several minutes to load.  
...
3.  Verify the following events are selected:  
    ...
    -   [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] Connections  
