...
## How Change Data Capture Works in Integration Services  
 ...
 ![Change Data Capture Package Creation Steps](../../Topics/TopicNameNotContainA/media/CDC_package_creation.gif "CDC_package_creation")  
...
-   Calculate the starting and ending **datetime** values for the interval of changes to the source data that you want to retrieve.  
     ...
     To calculate these values, use an Execute SQL task or [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/includes/ssISnoversion_md.md)] expressions with **datetime** functions. You then store these endpoints in package variables for use later in the package.  
 ...
 **Step 2: Setting Up the Query for Change Data**  
 ...
 Use [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)] to develop and save the query.  
...
## Samples of Change Data Capture Packages  
 [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/includes/ssISnoversion_md.md)] provides two samples that demonstrate how to use change data capture in packages. For more information, see the following topics:  
