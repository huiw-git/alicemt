...
# View Availability Group Listener Properties (SQL Server)
  This topic describes how to view the properties of an Always On *availability group listener* by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/includes/ssCurrent_md.md)].  
...
> [!NOTE]  
>  For more information about using [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] to monitor your [!INCLUDE[ssHADR](../../Topics/TopicNameContainA/includes/ssHADR_md.md)] environment, see [Monitor Availability Groups &#40;Transact-SQL&#41;](../../Topics/TopicNameNotContainA/Monitor-Availability-Groups--Transact-SQL-.md).  
