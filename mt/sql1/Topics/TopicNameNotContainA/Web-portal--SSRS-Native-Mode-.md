...
The Reporting Services [!INCLUDE[ssRSWebPortal](../../Topics/TopicNameNotContainA/tokens/ssRSWebPortal.md)] is a web-based experience which allows you to view reports, mobile reports, KPIs, and navigate through the elements that are in your report server instance. You can also use the [!INCLUDE[ssRSWebPortal](../../Topics/TopicNameNotContainA/tokens/ssRSWebPortal.md)] to administer a single report server instance.  
  
![ssRSPortal](../../Topics/TopicNameNotContainA/images/ssRSPortal.png)  
...
<a name="whatisportal"/>  
## What is the [!INCLUDE[ssRSWebPortal](../../Topics/TopicNameNotContainA/tokens/ssRSWebPortal.md)]?  
  
You can use the [!INCLUDE[ssRSWebPortal](../../Topics/TopicNameNotContainA/tokens/ssRSWebPortal.md)] to perform the following tasks:  
...
You can use the [!INCLUDE[ssRSWebPortal](../../Topics/TopicNameNotContainA/tokens/ssRSWebPortal.md)] to browse the report server folders or search for specific reports. You can view a report, its general properties and past copies of the report that are captured in report history. Depending on your permissions, you might also be able to subscribe to reports for delivery to an e-mail inbox or a shared folder on the file system.  
...
The [!INCLUDE[ssRSWebPortal](../../Topics/TopicNameNotContainA/tokens/ssRSWebPortal.md)] is used only for a report server that runs in native mode. It is not supported for a report server that you configure for SharePoint integrated mode.  
  
Some [!INCLUDE[ssRSWebPortal](../../Topics/TopicNameNotContainA/tokens/ssRSWebPortal.md)] features are only available in specified editions of [!INCLUDE[ssNoVersion](../../Topics/TopicNameNotContainA/tokens/ssNoVersion.md)]. For more information, see [Features supported by the Editions of SQL Server 2016](../../Topics/TopicNameNotContainA/Features-Supported-by-the-Editions-of-SQL-Server-2016.md).  
...
### Start the [!INCLUDE[ssRSWebPortal](../../Topics/TopicNameNotContainA/tokens/ssRSWebPortal.md)]  
To start the [!INCLUDE[ssRSWebPortal](../../Topics/TopicNameNotContainA/tokens/ssRSWebPortal.md)] from a browser, do the following:  
...
2.  In the address bar of the web browser, type the [!INCLUDE[ssRSWebPortal](../../Topics/TopicNameNotContainA/tokens/ssRSWebPortal.md)] URL.  
...
The [!INCLUDE[ssRSWebPortal](../../Topics/TopicNameNotContainA/tokens/ssRSWebPortal.md)] will group items into different categories. The available categories are the following.  
...
![ssRSWebPortal-view](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-view.png)  
   
If you select Show Hidden, those items will be displayed in a lighter color.  
  
![ssRSWebPortal-hidden](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-hidden.png)  
...
![ssRSWebPortal-view-pbi-and-excel](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-view-pbi-and-excel.png)  
...
![ssRSWebPortal-Search](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-Search.png)  
