...
## Options  
 ...
 [!INCLUDE[ssEW](../../Topics/TopicNameContainA/tokens/ssEW_md.md)]  
 The publication requires snapshot files to be in character format (this is handled automatically by the Snapshot Agent). [!INCLUDE[ssEW](../../Topics/TopicNameContainA/tokens/ssEW_md.md)] also has a number of restrictions not related to compatibility level.  
