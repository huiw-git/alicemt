...
## INFORMATION_SCHEMA and sys  
 Every database includes two entities that appear as users in catalog views: INFORMATION_SCHEMA and sys. These entities are required by [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)]. They are not principals, and they cannot be modified or dropped.  
