...
A [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/tokens/ssMDSshort_md.md)] derived hierarchy is derived from the domain-based attribute relationships that already exist between entities in a model.  
...
> [!NOTE]  
>  Explicit Hierarchies are deprecated in this release of [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/tokens/ssMDSshort_md.md)].  
...
## Derived Hierarchy Example  
 ...
 ![Hierarchy Derived from Model Structure](../../Topics/TopicNameNotContainA/images/mds_conc_derived_hierarchy_structure.gif "mds_conc_derived_hierarchy_structure")  
 ...
 ![Mountain Bike Derived Hierarchy Example](../../Topics/TopicNameNotContainA/images/mds_conc_derived_hierarchy_example.gif "mds_conc_derived_hierarchy_example")  
