...
## Remarks  
 A workload is a set of [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statements that execute against a database or databases that you want to tune. The Database Engine Tuning Advisor can use [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] scripts, trace files, and trace tables as workloads.  
