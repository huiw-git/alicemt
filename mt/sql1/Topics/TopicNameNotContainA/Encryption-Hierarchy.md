...
# Encryption Hierarchy
  [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] encrypts data with a hierarchical encryption and key management infrastructure. Each layer encrypts the layer below it by using a combination of certificates, asymmetric keys, and symmetric keys. Asymmetric keys and symmetric keys can be stored outside of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] in an Extensible Key Management \(EKM\) module.  
 ...
 ![Displays some encryption combinations in a stack.](../../Images/Image/ImageContaina/Encryption_Hierarchy_Stack.gif "Encryption_Hierarchy_Stack")  
...
-   Database master keys are protected by the Service Master Key. The Service Master Key is created by [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] setup and is encrypted with the Windows Data Protection API \(DPAPI\).  
...
-   The Service Master Key and all Database Master Keys are symmetric keys.  
 ...
 ![Displays some encryption combinations in a wheel.](../../Images/Image/ImageContaina/Encryption_Hierarchy_Wheel.gif "Encryption_Hierarchy_Wheel")  
...
-   Symmetric and asymmetric keys in the EKM can protect access to the symmetric and asymmetric keys stored in [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)]. The dotted line associated with EKM indicates that keys in the EKM could replace the symmetric and asymmetric keys stored in [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)].  
  
## Encryption Mechanisms  
 [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] provides the following mechanisms for encryption:  
  
-   [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] functions  
...
### Transact\-SQL Functions  
 Individual items can be encrypted as they are inserted or updated using [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] functions. For more information, see [ENCRYPTBYPASSPHRASE &#40;Transact-SQL&#41;](../Topic/ENCRYPTBYPASSPHRASE%20\(Transact-SQL\).md) and [DECRYPTBYPASSPHRASE &#40;Transact-SQL&#41;](../Topic/DECRYPTBYPASSPHRASE%20\(Transact-SQL\).md).  
...
-   The digital signature of the issuer.  
 ...
 The self\-signed certificates created by [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] follow the X.509 standard and support the X.509 v1 fields.  
