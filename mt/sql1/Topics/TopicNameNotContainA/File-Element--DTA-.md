...
---
# File Element (DTA)
Specifies the workload file. A workload is a set of [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statements that execute against a database or databases that you want to tune. Workload files can be [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] scripts (.sql) or trace files (.trc). For more information, see[Start and Use the Database Engine Tuning Advisor](../../Topics/TopicNameNotContainA/Start-and-Use-the-Database-Engine-Tuning-Advisor.md).  
