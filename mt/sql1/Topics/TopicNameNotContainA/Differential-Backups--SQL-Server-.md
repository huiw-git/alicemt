...
This backup and restore topic is relevant for all [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] databases.  
...
-   [Overview of Differential Backups](#Overview)  
  
-   [Differential Backups of Read-Only Databases](#ReadOnlyDbs)  
...
##  <a name="Overview"></a> Overview of Differential Backups  
 ...
 ![Differential bitmap identifies changed extents](../../Topics/TopicNameNotContainA/images/BnR_How_Diff_Backups_Work.gif "BnR_How_Diff_Backups_Work")  
