...
In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/tokens/ssMDSshort_md.md)], apply business rules selectively when you want to update or validate subsets of members against business rules.  
...
1.  On the [!INCLUDE[ssMDSmdm](../../Topics/TopicNameContainA/tokens/ssMDSmdm_md.md)] home page, from the **Model** drop-down list, select a model.  
