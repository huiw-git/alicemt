...
![PBI_SSMRP_Gauges](../../Topics/TopicNameNotContainA/media/PBI_SSMRP_Gauges.png)  
  
*Gauge visualizations in the Layout tab*  
  
In [!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameNotContainA/includes/PRODUCT_NAME.md)], all gauges have at least one property in common: a main value, set to a numeric field in one of the data tables in the mobile report.  
...
2. Under Filtered by, select the navigator you want to filter the gauge.
   ...
   ![mobile-report-gauge-navigator](../../Topics/TopicNameNotContainA/media/mobile-report-gauge-navigator.png)
