...
![PBI_SSMRP_Gauges](../../Topics/TopicNameNotContainA/images/PBI_SSMRP_Gauges.png)  
  
*Gauge visualizations in the Layout tab*  
  
In [!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameNotContainA/tokens/PRODUCT_NAME.md)], all gauges have at least one property in common: a main value, set to a numeric field in one of the data tables in the mobile report.  
...
2. Under Filtered by, select the navigator you want to filter the gauge.
   ...
   ![mobile-report-gauge-navigator](../../Topics/TopicNameNotContainA/images/mobile-report-gauge-navigator.png)
