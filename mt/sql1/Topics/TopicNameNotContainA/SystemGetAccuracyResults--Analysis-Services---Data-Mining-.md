...
> [!NOTE]  
>  This stored procedure is not supported for models that are built by using the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] Time Series algorithm or the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] Sequence Clustering algorithm. Also, for clustering models, use the separate stored procedure, [SystemGetClusterAccuracyResults (Analysis Services - Data Mining)](../../Topics/TopicNameNotContainA/SystemGetClusterAccuracyResults--Analysis-Services---Data-Mining-.md).  
...
## See Also  
 ...
 [SystemGetAccuracyResults](../../Topics/TopicNameNotContainA/SystemGetAccuracyResults--Analysis-Services---Data-Mining-.md)   
