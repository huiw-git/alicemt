...
## Terms  
 **Local database**. The on-premises [!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/tokens/ssSQL15_md.md)] database.  
  
 **Remote endpoint**. The location in Microsoft Azure that contains the database’s remote data. In [!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/tokens/ssSQL15_md.md)], this is an Azure SQL Database server. This is subject to change in the future.  
...
## Architecture  
 ...
 ![Stretch Database architecture](../../Topics/TopicNameNotContainA/images/StretchDBConcepts1.png "StretchDBConcepts1")  
...
### Data access  
 ...
 ![Stretch Database data access model](../../Topics/TopicNameNotContainA/images/StretchDBConcepts2.png "StretchDBConcepts2")  
...
## Backup and restore  
 ...
 ![Stretch Database backup diagram](../../Topics/TopicNameNotContainA/images/StretchDBConcepts3.png "StretchDBConcepts3")  
 ...
 ![Stretch Database after backup](../../Topics/TopicNameNotContainA/images/StretchDBConcepts4.png "StretchDBConcepts4")  
 ...
 ![Restoring connection to remote data after restore](../../Topics/TopicNameNotContainA/images/StretchDBConcepts5.png "StretchDBConcepts5")  
 ...
 ![Remote data reconciled after restore](../../Topics/TopicNameNotContainA/images/StretchDBConcepts6.png "StretchDBConcepts6")