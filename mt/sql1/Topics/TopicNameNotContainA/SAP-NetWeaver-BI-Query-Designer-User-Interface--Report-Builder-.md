...
## Graphical Query Designer in Design Mode  
 When you edit a dataset query that uses a [!INCLUDE[SAP_DPE_BW_1](../../Topics/TopicNameNotContainA/tokens/SAP_DPE_BW_1_md.md)] data source, the graphical query designer opens in the Design mode.  
