 ...
 **Metadata**  
 ...
 Drag selected items to the filter, data, row, or column areas of the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] Office 11.0 PivotTable control in the **Report** pane to display the data for the selected item.  
