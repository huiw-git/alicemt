...
# Transaction Log Backups (SQL Server)
  This topic is relevant only for [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] databases that are using the full or bulk\-logged recovery models. This topic discusses backing up the transaction log of a [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] database.  
