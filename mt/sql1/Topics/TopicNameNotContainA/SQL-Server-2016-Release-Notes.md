...
caps.latest.revision: 262
caps.handback.revision: 0
manager: jhubbard
---
# SQL Server 2016 Release Notes
This topic describes limitations and issues with [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] .  
...
-   To get the latest version of SQL Server Management Studio, see **[Download SQL Server Management Studio (SSMS)](https://msdn.microsoft.com/library/mt238290.aspx)**![download](../../Topics/TopicNameNotContainA/images/download.png "download").  
 ...
 For information on what's new, see [What's New in SQL Server 2016](../../Topics/TopicNameNotContainA/What-s-New-in-SQL-Server-2016.md).  
 ...
 **Workaround:** Use one of the following:  
 ...
 ![Manage Help Settings for SQL Server](../../Topics/TopicNameNotContainA/images/docs_sql2016_managehelpsettings.png "docs_sql2016_managehelpsettings")  
 ...
 **F1 Help:** By design when you press F1 in [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)], the online version of the F1 Help topic is displayed in the browser. This occurs even when you have installed local Help.  
...
-   Uninstall PolyBase. In the **Control Panel**, click **Uninstall a program**, click [!INCLUDE[ssCurrentUI](../../Topics/TopicNameContainA/tokens/ssCurrentUI_md.md)], click **Remove**.  In the **Remove SQL Server 2016** wizard select the instance with the failed PolyBase installation  and click **Next**. On **Features**, click **PolyBase Query Service for External Data**. It is not necessary to remove other features that were successfully installed. Complete the steps of  **Remove SQL Server 2016**.  
...
#### Date values from Analysis Services treated as text<br />with [!INCLUDE[SS_MobileReptPub_Short](../../Topics/TopicNameNotContainA/tokens/SS_MobileReptPub_Short_md.md)]  
 **Issue and customer impact:**  
  
 Date values from SQL Server Analysis Services data sources, in shared datasets, are treated as text values when imported into [!INCLUDE[SS_MobileReptPub_Short](../../Topics/TopicNameNotContainA/tokens/SS_MobileReptPub_Short_md.md)].  
 ...
 **Issue and customer impact:** In RC0 there is an issue that prevents deployment of multidimensional models created in [SSDT for Visual Studio 2015 Preview](https://msdn.microsoft.com/en-us/library/mt204009.aspx) to a pre-2016 version of Analysis Services. This will be resolved in an upcoming RC.  
...
#### Always Encrypted breaking changes  
 ...
 The COLUMN MASTER KEY argument of [CREATE COLUMN ENCRYPTION KEY (Transact-SQL)](assetId:///517fe745-d79b-4aae-99a7-72be45ea6acb) has been renamed to COLUMN_MASTER_KEY.  
  
###  <a name="bkmk_ctp30_ssrs"></a> Reporting Services (SSRS) CTP 3.0  
  
#### SharePoint Integration is not supported  
 [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] CTP2 [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] is not supported in SharePoint integrated mode.  
  
#### Supported versions of SharePoint  
 [!INCLUDE[ssRSCurrent](../../Topics/TopicNameContainA/tokens/ssRSCurrent_md.md)] SharePoint mode was only tested with SharePoint 2013.  
...
#### SSAS SharePoint Integration is not supported  
 [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] CTP2 [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] SharePoint integration is not supported.  
...
-   Uncaught CLR exception crossing the Interop boundary: Microsoft.AnalysisServices.Streaming.ServerNotFoundException: **There are no servers available or actively being initialized**.  
 ...
 A [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)][!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] server in [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] mode cannot use the default instance name **MSSQLSERVER**. The [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] installation will complete successfully, and you see no errors when you configure Excel Services “Data Model Settings” to use the Analysis Services server. However, Excel services is not able to use the [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] server with the default instance name.  
  
 **Workaround:** Install a new instance of [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)][!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] in [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] mode. On the **Instance Configuration** page of the SQL Server setup wizard, click **Named Instance** and type “POWERPIVOT”  
  
 **More Information:**  
  
1.  This is issue does not occur when upgrading an existing SharePoint 2013 and Power Pivot for SharePoint deployment to [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] Power Pivot for SharePoint . The issue does not occur because the [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] instance is already a named instance “POWERPIVOT”.  
  
     ![use named instance for ssas](../../Topics/TopicNameNotContainA/images/ssas_setup_instance_configuration.png "ssas_setup_instance_configuration")  
  
2.  Use the SQL Server Configuration Manager to verify if the [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] instance name is the default name MSSQLSERVER.  
  
     ![verify SSAS name in configuration manager](../../Topics/TopicNameNotContainA/images/SSAS_verify_instance_name.png "SSAS_verify_instance_name")  
...
-   [Product Documentation CTP2.0](#bkmk_ctp20_docs)  
...
### No Production Support  
 [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] CTP 2.0 is not supported in production environments.  
  
###  <a name="bkmk_ctp20_supported_scenarios"></a> Supported setup and upgrade scenarios CTP 2.0  
 Side- by-side support is provided for the following [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] versions with [!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/tokens/ssSQL15_md.md)].  
  
1.  [!INCLUDE[ssKatmai](../../Topics/TopicNameContainA/tokens/ssKatmai_md.md)]  
  
2.  [!INCLUDE[ssKilimanjaro](../../Topics/TopicNameContainA/tokens/ssKilimanjaro_md.md)]  
  
3.  [!INCLUDE[ssSQL11](../../Topics/TopicNameContainA/tokens/ssSQL11_md.md)]  
  
4.  [!INCLUDE[ssSQL14](../../Topics/TopicNameContainA/tokens/ssSQL14_md.md)]  
  
5.  SQL Server 2016 CTP 1.4+  
  
 Upgrade to [!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/tokens/ssSQL15_md.md)] is supported from the following [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] versions:  
  
1.  [!INCLUDE[ssKatmai](../../Topics/TopicNameContainA/tokens/ssKatmai_md.md)] SP4  
  
2.  [!INCLUDE[ssKilimanjaro](../../Topics/TopicNameContainA/tokens/ssKilimanjaro_md.md)] SP3  
  
3.  [!INCLUDE[ssSQL11](../../Topics/TopicNameContainA/tokens/ssSQL11_md.md)] SP2  
  
4.  [!INCLUDE[ssSQL14](../../Topics/TopicNameContainA/tokens/ssSQL14_md.md)] RTM  
  
5.  [!INCLUDE[ssSQL14](../../Topics/TopicNameContainA/tokens/ssSQL14_md.md)] SP1  
  
6.  SQL Server 2016 CTP 1.4+  
  
 [!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/tokens/ssSQL15_md.md)] is supported with the following operating systems:  
  
1.  [!INCLUDE[win8](../../Topics/TopicNameContainA/tokens/win8_md.md)]  
  
2.  [!INCLUDE[win8srv](../../Topics/TopicNameContainA/tokens/win8srv_md.md)]  
  
3.  [!INCLUDE[winblue_client_2](../../Topics/TopicNameContainA/tokens/winblue_client_2_md.md)]  
  
4.  [!INCLUDE[win8srv](../../Topics/TopicNameContainA/tokens/win8srv_md.md)] R2  
...
> [!WARNING]  
>  You can only upgrade to [!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/tokens/ssSQL15_md.md)] Evaluation Edition from an earlier version of Evaluation Edition. If you are upgrading from a SKU to another SKU, you require a product key.  
...
###  <a name="bkmk_ctp20_docs"></a> Product Documentation CTP 2.0  
 [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Books Online is available for the [!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/tokens/ssSQL15_md.md)] release.  
  
 **Issue:**  Managed reference content will not publish with CTP2 Books Online. Any links in conceptual topics in the [!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/tokens/ssSQL15_md.md)] content that point to managed reference content will be broken links.  
  
 **Workaround:**  
  
 Refer to the content in the previous release, [!INCLUDE[ssSQL14](../../Topics/TopicNameContainA/tokens/ssSQL14_md.md)]. [Developer Reference for SQL Server 2014](https://technet.microsoft.com/en-us/library/dd206988.aspx). For example:  
  
-   [Microsoft.AnalysisServices.AdomdClient Namespace](https://technet.microsoft.com/en-us/library/microsoft.analysisservices.adomdclient.aspx)  
  
-   [Microsoft.SqlServer.Types Namespace](https://technet.microsoft.com/en-us/library/microsoft.sqlserver.types.aspx)  
  
 **More Information:**  
  
 The following links point to some keys topics in the [!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/tokens/ssSQL15_md.md)] Books Online content:  
 ...
 **More Information:** For more info, see [ALTER TABLE (Transact-SQL)](assetId:///f1745145-182d-4301-a334-18f799d361d1) and [Lock Escalation (Database Engine)](https://technet.microsoft.com/en-us/library/ms184286.aspx).  
  
##### sp_spaceused cannot be used with INSERT INTO EXEC if @mode = N'ALL' or @mode = N'REMOTE_ONLY'  
 **Issue:** On a database configured for Stretch Database, sp_spaceused cannot be used in an INSERT INTO EXEC statement if the value of the **@mode** parameter is N'ALL' or N'REMOTE_ONLY'. [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] doesn't support the nesting of INSERT INTO EXEC statements that results from this usage.  
 ...
 **Workaround:** You can mitigate the risk of a man-in-the-middle attack by forcing the encryption of client connections and the validation of server certificates. To check or change these properties, open the SQL Native Client 11.0 Configuration Properties in SQL Server Configuration Manager. Set the **Force Protocol Encryption** option to **Yes** and the **Trust Server Certificate** option to **No** on the computer on which you're using the Stretch Database feature.  
 ...
 ![SQL Native Client configuration properties](../../Topics/TopicNameNotContainA/images/StretchDBEncryptionIssue.png "StretchDBEncryptionIssue")  
  
 **More Information:** [Using Encryption without Validation](assetId:///f4c63206-80bb-4d31-84ae-ccfcd563effa).  
 ...
 **More Information:** See [Get started with PolyBase](../../Topics/TopicNameNotContainA/Get-started-with-PolyBase.md) and [CREATE EXTERNAL DATA SOURCE (Transact-SQL)](assetId:///75d8a220-0f4d-4d91-8ba4-9d852b945509)  
 ...
 **More information:** See [ALTER INDEX (Transact-SQL)](assetId:///b796c829-ef3a-405c-a784-48286d4fb2b9) and use the REBUILD option.  
 ...
 **Issue:**  When you try to create [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] subscriptions, the operation fails and you see an error message similar to the following:  
 ...
 This issue is caused when the [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] Native mode windows service is configured to log on as NT Service account and also configured to connecting to catalog database with Service account as well.  
  
 **Workaround:** Complete one of the following workarounds:  
  
-   Run [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] under a Windows Account.  
  
-   Change credentials that [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] uses to connect to ReportServer database to either a Windows account or a SQL Server account.  
...
-   **Applies to:** [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] Native mode only  
  
###  <a name="bkmk_ctp20_ssas"></a> Analysis Services (SSAS) CTP 2.0  
  
#### DBCC for SSAS is not fully operational in CTP 2.0  
 [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] adds a new Database Consistency Checker (DBCC) for tabular and multidimensional databases. However, there are known issues with this feature that won’t be fully resolved until CTP 3.0.  For now, we recommend that you avoid using this feature.  
 ...
 **Issue:**  In [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)], under the Management\Extended Events node of an [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] server, if you right-click and select **New Session** you see an error message. The details of the error message are different depending on what mode the [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] server instance was installed.  
  
 **Workaround:** There is no work around to use the [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] extended events in [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/tokens/ssManStudio_md.md)]. However you can use Extended events in the same way as past releases. For more information, see [Use SQL Server Extended Events (XEvents) to Monitor Analysis Services](https://msdn.microsoft.com/en-us/library/gg492139.aspx) and [Tracing Analysis Services (SSAS) with Extended Events – Yes it works and this is how](http://www.insidesql.org/blogs/andreaswolter/2013/04/tracing-analysis-services-with-extended).  
  
###  <a name="bkmk_ctp20_ssis"></a> Integration Services (SSIS) CTP 2.0  
  
#### SSIS Incremental deployment  
 **Issue:** In [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] CTP2, the Incremental Package Deployment feature is not available in SQL Server Data Tools for BI (SSDT-BI).  
