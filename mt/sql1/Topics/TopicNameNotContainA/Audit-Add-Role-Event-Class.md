...
The **Audit Add Role** event class occurs when a database role is added to or removed from a database. This event class is used by the **sp_addrole** and **sp_droprole** stored procedures.  
 ...
 This event class may be removed from a future version of [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)]. It is recommended that you use the **Audit Database Principal Management** event class instead.  
...
## See Also  
 ...
 [sp_addrole (Transact-SQL)](assetId:///e8a21642-8440-419a-8585-93d3d9d44f00)   
 [sp_droprole (Transact-SQL)](assetId:///889ee074-00f8-40a9-bddb-d7d3ef0cbc19)   
