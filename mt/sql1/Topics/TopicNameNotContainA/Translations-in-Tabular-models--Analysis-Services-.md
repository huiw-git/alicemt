...
[!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] adds translation string support for Tabular models created at the 1200 compatibility level. A single object in the model can have multiple translations of a name or description, making it possible to support multi-language versions within the model definition.  
...
## Create an empty translation file  
 Use [!INCLUDE[ssBIDevStudio](../../Topics/TopicNameContainA/tokens/ssBIDevStudio_md.md)] to add translations.  
...
4.  Click **Export Language File**.  Provide a file name and location.  
 ...
 ![ssas&#45;tabular&#45;translate&#45;export](../../Topics/TopicNameNotContainA/images/ssas-tabular-translate-export.png "ssas-tabular-translate-export")  
...
|translatedDescription|Less common than captions, a description appears as model information in a modeling tool like SSDT.|  
 ...
 ![ssas&#45;tabular&#45;translate&#45;json](../../Topics/TopicNameNotContainA/images/ssas-tabular-translate-json.png "ssas-tabular-translate-json")  
...
2.  In the Excel connection dialog box, choose the culture for which string translations exist in your model. Excel detects cultures defined in the model and populates the drop-down list accordingly.  
     ...
     ![ssas&#45;tabular&#45;translations&#45;excel](../../Topics/TopicNameNotContainA/images/ssas-tabular-translations-excel.png "ssas-tabular-translations-excel")  
