...
# SP:StmtCompleted Event Class
  The SP:StmtCompleted event class indicates that a [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statement within a stored procedure has completed.  
