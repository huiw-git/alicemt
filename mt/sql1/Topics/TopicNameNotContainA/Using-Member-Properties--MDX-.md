...
> [!NOTE]  
>  In [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)][!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)], member properties are know as attribute relationships. For more information, see [Creating and Using Property Values (MDX)](assetId:///2491422a-4cf5-4b23-b6ab-289222b22ce8).  
