...
# Notification Events Data Columns
  Notification events are events that are not directly caused by users of [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)]. For example, notifications occur because of users updating underlying tables for proactive caching.  
...
|ServerName|43|8|Contains the name of the [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] instance on which the notification event occurred.|  
