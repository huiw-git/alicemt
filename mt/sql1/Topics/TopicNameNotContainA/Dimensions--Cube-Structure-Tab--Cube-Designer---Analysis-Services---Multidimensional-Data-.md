 ...
 **Properties**  
 Click to display the **Properties** window of [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)] for the selected cube dimension, cube hierarchy, or cube attribute.  
