...
-   In [!INCLUDE[ssBIDevStudio](../../Token/Other/ssBIDevStudio_md.md)], open the [!INCLUDE[ssISCurrent](../../Token/Other/ssISCurrent_md.md)] package that has the ODBC destination.  
