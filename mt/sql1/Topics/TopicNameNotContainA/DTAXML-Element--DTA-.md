...
|------------------|--------------|  
|**Parent element**|None|  
|**Child elements**|[DTAInput Element (DTA)](../../Topics/TopicNameNotContainA/DTAInput-Element--DTA-.md)<br /><br /> **DTAOutput** Element (see [Database Engine Tuning Advisor XML schema](http://schemas.microsoft.com/sqlserver/) for information)|  
...
## Example  
 For examples of typical **DTAXML** elements, see [XML Input File Samples (DTA)](../../Topics/TopicNameNotContainA/XML-Input-File-Samples--DTA-.md).  
