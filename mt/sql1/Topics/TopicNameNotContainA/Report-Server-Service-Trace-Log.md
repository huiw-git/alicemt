...
##  <a name="bkmk_view_log"></a> Where are the Report Server log files?  
 ...
 View a short video that demonstrates the use of Microsoft Power Query to view [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] log files.  
  
 ![view a video about Power Query and SSRS logs](../../Topics/TopicNameNotContainA/images/generic_video_thumbnail.png "generic_video_thumbnail")  
...
```  
 ...
 For more information, see [Knowledge Base Article 913046](http://support.microsoft.com/?kbid=913046) on the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] Web site.  
...
-   [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] component and version information.  
