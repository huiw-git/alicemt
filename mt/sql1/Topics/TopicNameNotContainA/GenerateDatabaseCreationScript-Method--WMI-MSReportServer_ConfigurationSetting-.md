...
> [!IMPORTANT]  
>  Beginning in [!INCLUDE[ssSQL11](../../Topics/TopicNameContainA/tokens/ssSQL11_md.md)], *IsSharePointMode*=**True** is not supported because in SharePoint mode, [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] is a SharePoint shared service and is not controlled by the WMI provider. You should always set this parameter to **False**.  
...
## Remarks  
 ...
 The value supplied in the *DatabaseName* parameter must conform to [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] database naming conventions.  
