...
## Storage IOPS  
 [!INCLUDE[hek_2](../../Topics/TopicNameContainA/tokens/hek_2_md.md)] can significantly increase your workload throughput. Therefore, it is important to ensure that IO is not a bottleneck.  
...
## Encryption  
 In [!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/tokens/ssSQL15_md.md)], the storage for memory-optimized tables will be encrypted as part of enabling TDE on the database. For more information, see [Transparent Data Encryption (TDE)](../../Topics/TopicNameNotContainA/Transparent-Data-Encryption--TDE-.md).  
