...
## Performance  
 The process of creating itemsets and counting correlations can be time\-consuming. Although the [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] Association Rules algorithm uses optimization techniques to save space and make processing faster, you should know that performance issues can occur under conditions such as the following:  
