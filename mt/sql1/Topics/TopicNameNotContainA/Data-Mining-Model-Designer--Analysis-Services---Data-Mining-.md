...
# Data Mining Model Designer (Analysis Services - Data Mining)
  This section contains the F1 Help topics for the Data Mining Model Designer in [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameContainA/includes/ssBIDevStudioFull_md.md)]. You will use this design space to create, manage, and work with data mining models.  
