...
If you specified that you wanted to save the SSIS package created by the wizard,  the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Import and Export Wizard shows **Save SSIS Package**. On this page, you specify additional options for saving the package.  
...
## Screen shots  
 ...
 ![Save SSIS Package page of the Import and Export Wizard](../../Topics/TopicNameNotContainA/images/Save-package2.png "Save)  
 ...
 ![Save SSIS Package page of the Import and Export Wizard](../../Topics/TopicNameNotContainA/images/Save-package1.png "Save)  
 ...
 **Target**  
 View the target ([!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] or file) that was previously specified for the destination file.  
  
## Save the package in SQL Server  
 **Server name**  
 When you have selected a [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] destination, type or select the destination server name.  
  
 The wizard saves the package  in the **sysssispackages** table of the **msdb** database.  
  
 **Use Windows Authentication**  
 When you have selected a [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] destination, specify whether to connect to the server by using Windows Integrated Authentication. This is the preferred authentication method.  
  
 **Use SQL Server Authentication**  
 When you have selected a [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] destination, specify whether to connect to the server by using SQL Server Authentication.  
  
 **User name**  
 When you have selected a [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] destination, and have specified SQL Server Authentication, type the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] user name.  
  
 **Password**  
 When you have selected a [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] destination, and have specified SQL Server Authentication, type the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] password.  
