...
> [!NOTE]  
>  Mirrored backup media sets are supported only in the Enterprise edition of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)].  
...
##  <a name="OverviewofMirroredMediaSets"></a> Overview of Mirrored Media Sets  
 ...
 ![Mirrored media set: two families with two mirrors](../../Topics/TopicNameNotContainA/images/BNR_backup_media_mirror.gif "BNR_backup_media_mirror")  
 ...
 The [!INCLUDE[ssDEnoversion](../../Topics/TopicNameContainA/tokens/ssDEnoversion_md.md)] guarantees that the mirrored media have identical contents by synchronizing writes to the devices. When any one of the mirrors fills, all the mirrors are spanned at one time.  
