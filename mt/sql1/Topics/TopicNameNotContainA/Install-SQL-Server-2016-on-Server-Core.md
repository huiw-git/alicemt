...
|Integration Services Server|Yes|For more information about the new Integration Services Server and its features in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)], see [Integration Services &#40;SSIS&#41; Server](../../Topics/TopicNameNotContainA/Integration-Services--SSIS--Server.md).|  
