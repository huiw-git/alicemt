...
## Event Class Column Mapping  
 ...
 ![Event class column mapping](../../Images/Image/ImageNotContaina/EventClassMappings.gif "EventClassMappings")  
...
|SubmitTime|**datetime**|The time when the event was submitted to [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)].|6|  
...
|LoginName|**nvarchar**|The user login name. This can be either a [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] security login or the Microsoft Windows login credentials, in the format *domain\_name*\\*user\_name*.|14|  
