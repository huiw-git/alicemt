...
The [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Extended Events engine is a collection of services and objects that:  
...
-   Maintain a list of Extended Events sessions and manage access to that list.  
 ...
 ![Detailed extended events architecture](../../Topics/TopicNameNotContainA/images/xeArchitectureDetailed.gif "xeArchitectureDetailed")  
