...
1.  In the **Publish and Validate** group, click **Apply Rules**.  
    ...
    > [!NOTE]  
    >  The number of members \(rows\) that are validated at one time depends on a setting in [!INCLUDE[ssMDScfgmgr](../../Token/Other/ssMDScfgmgr_md.md)]. For more information, see [Business Rule Settings](../../Topics/TopicNameNotContainA/System-Settings--Master-Data-Services-.md#BusinessRules).  
