...
> [!NOTE]  
>  As an alerting administrator, you can grant permission to information workers to access the [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] data alerts features. For more information about the required permissions, see [Reporting Services Data Alerts](../../Topics/TopicNameNotContainA/Reporting-Services-Data-Alerts.md).  
...
##  <a name="ViewingAlerts"></a> Viewing Data Alert Information  
 ...
 ![Reporting Services section of Site Settings page](../../Topics/TopicNameNotContainA/images/rs_SiteSettings.gif "rs_SiteSettings")  
