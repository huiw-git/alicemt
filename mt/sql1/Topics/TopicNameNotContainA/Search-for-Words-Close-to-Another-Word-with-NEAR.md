 ...
 *search\_term* \[ ,…*n* \]  
 ...
 \(*search\_term* \[ ,…*n* \] \) \[, \<maximum\_distance\> \[, \<match\_order\> \] \]  
...
> [!NOTE]  
>  For more information about the \<custom\_proximity\_term\> syntax, see [CONTAINS &#40;Transact-SQL&#41;](../Topic/CONTAINS%20\(Transact-SQL\).md).  
...
```  
 ...
 Note that for a language that reads from right to left, such as Arabic or Hebrew, the Full\-Text Engine applies the specified terms in reverse order. Also, Object Explorer in [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] automatically reverses the display order of words specified in right\-to\-left languages.  
...
> [!IMPORTANT]  
>  [!INCLUDE[ssNoteDepFutureAvoid](../../Token/Other/ssNoteDepFutureAvoid_md.md)] We recommend that you use the [custom proximity term](#Custom_NEAR).  
 ...
 { *search\_term* { NEAR | ~ } *search\_term* } \[ ,…*n* \]  
...
> [!NOTE]  
>  For information about the \<generic\_proximity\_term\> syntax, see [CONTAINS &#40;Transact-SQL&#41;](../Topic/CONTAINS%20\(Transact-SQL\).md).  
