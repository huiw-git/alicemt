...
|[ListInstalledSharePointVersions Method (WMI)](../../Topics/TopicNameNotContainA/ListInstalledSharePointVersions-Method--WMI-.md)|Returns a set of tokens that represent the versions of [!INCLUDE[winSPServ](../../Topics/TopicNameContainA/tokens/winSPServ_md.md)] [!INCLUDE[offSPServ](../../Topics/TopicNameContainA/tokens/offSPServ_md.md)], [!INCLUDE[SPF2010](../../Topics/TopicNameContainA/tokens/SPF2010_md.md)], or [!INCLUDE[SPS2010](../../Topics/TopicNameContainA/tokens/SPS2010_md.md)] that are installed on the same computer as the report server.|  
