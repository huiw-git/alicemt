...
<a name="Top"></a>  
  ...
  This help topic describes the options of the **Summary** page. This topic applies to the [!INCLUDE[ssAoNewAgWiz](../../Token/Other/ssAoNewAgWiz_md.md)], [!INCLUDE[ssAoAddRepWiz](../../Token/Other/ssAoAddRepWiz_md.md)], [!INCLUDE[ssAoAddDbWiz](../../Token/Other/ssAoAddDbWiz_md.md)] and [!INCLUDE[ssAoFoAgWiz](../../Token/Other/ssAoFoAgWiz_md.md)] of [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)]. Use the grid on this page to review your choices for the new availability group. To make one or more changes, click **Previous** to return to the relevant page or pages. When you are ready, click **Next** to return to the **Summary** page. Once you are satisfied with your choices, click **Finish**.  
  
##  <a name="PageOptions"></a> Summary Page Options  
 **Script**  
 Click to generate a [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] script for the actions listed in the summary grid. You will be prompted to specify a destination for the script.  
