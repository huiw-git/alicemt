...
## User Options  
 When enabling contained databases, the [user options Option](../../Topics/TopicNameNotContainA/Configure-the-user-options-Server-Configuration-Option.md) must be set to 0 for the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)].  
