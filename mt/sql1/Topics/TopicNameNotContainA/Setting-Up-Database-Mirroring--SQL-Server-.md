...
2.  You can set up mirroring by using either [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] or the Database Mirroring Wizard. For more information, see one of the following:  
...
> [!NOTE]  
>  For an example of using [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] to set up database mirroring using Microsoft Windows Authentication, see [Example: Setting Up Database Mirroring Using Windows Authentication (Transact-SQL)](../Topic/Example:%20Setting%20Up%20Database%20Mirroring%20Using%20Windows%20Authentication%20\(Transact-SQL\).md).  
>   
>  For an example of using [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] to set up database mirroring using certificate-based security, see [Example: Setting Up Database Mirroring Using Certificates (Transact-SQL)](../Topic/Example:%20Setting%20Up%20Database%20Mirroring%20Using%20Certificates%20\(Transact-SQL\).md).  
...
##  <a name="InThisSection"></a> In This Section  
 ...
 [Establish a Database Mirroring Session Using Windows Authentication (Transact-SQL)](../../Topics/TopicNameContainA/Establish-a-Database-Mirroring-Session-Using-Windows-Authentication--Transact-SQL-.md)  
 Describes the [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] steps for setting up database mirroring.  
