...
3.  Use the **Get\-ClusterResource** cmdlet to find the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] resource, then use **Set\-ClusterParameter** cmdlet to set the **HealthCheckTimeout** property for the failover cluster instance.  
  
> [!TIP]  
>  Every time you open a new PowerShell window, you need to import the **FailoverClusters** module.  
  
### Example \(PowerShell\)  
 The following example changes the HealthCheckTimeout setting on the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] resource "`SQL Server (INST1)`" to 60000 milliseconds.  
...
##  <a name="TsqlProcedure"></a> Using Transact\-SQL  
 Using the [ALTER SERVER CONFIGURATION](../Topic/ALTER%20SERVER%20CONFIGURATION%20\(Transact-SQL\).md)[!INCLUDE[tsql](../../Token/Other/tsql_md.md)] statement, you can specify the HealthCheckTimeOut property value.  
