...
# SQL Server Audit Records
  The [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Audit feature enables you to audit server\-level and database\-level groups of events and events. For more information, see [SQL Server Audit &#40;Database Engine&#41;](../../Topics/TopicNameNotContainA/SQL-Server-Audit--Database-Engine-.md). [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)].  
