...
14. On the **File** menu, click **Save***table\_name*.  
...
8.  In the **Select Columns from***table\_name* dialog box, select the check box or check boxes of the table column or columns to be added to the unique index.  
