...
The **Audit Fulltext** event class occurs when [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] connects to and communicates with the full-text filter daemon process.  
  
## Audit Fulltext Event Class Data Columns  
  
|Data column name|Data type|Description|Column ID|Filterable|  
|----------------------|---------------|-----------------|---------------|----------------|  
|**Error**|**int**|The [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] error number, if this event reports an error.|31|Yes|  
...
|**TextData**|**ntext**|Text information about the Full-Text event. Typically this field provides information about the connection between the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] process and the full-text filter daemon process|1|Yes|  
