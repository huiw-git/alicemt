...
|**SQMSupportEnabled**|1|A Boolean property that indicates whether error and feature usage reports are sent to [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] automatically.|  
