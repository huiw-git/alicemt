...
Sometimes the best visualization is the data itself. Learn about the three *data grids*, or tables, for displaying data in [!INCLUDE[SS_MobileReptPub_Long](../../Topics/TopicNameContainA/tokens/SS_MobileReptPub_Long.md)]:
* Simple data grid
* Indicator data grid
* Chart data grid
...
![mobile-report-simple-data-grid](../../Topics/TopicNameNotContainA/images/mobile-report-simple-data-grid.png)
...
![mobile-report-indicator-data-grid](../../Topics/TopicNameNotContainA/images/mobile-report-indicator-data-grid.png)
...
![mobile-report-chart-data-grid](../../Topics/TopicNameNotContainA/images/mobile-report-chart-data-grid.png)
