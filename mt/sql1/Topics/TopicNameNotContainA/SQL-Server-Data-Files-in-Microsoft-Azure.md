...
![Data files on Azure](../../Topics/TopicNameNotContainA/images/Data-files-on-Azure.png "Data)  
 ...
 For a practical hands-on experience on how to use this new feature, see [Tutorial: SQL Server Data Files in Microsoft Azure Storage service](assetId:///e69be67d-da1c-41ae-8c9a-6b12c8c2fb61).  
...
### SQL Server Management Studio support  
 SQL Server Management Studio allows you to use this feature via several dialog windows. For example, you can type the URL path of the storage container, such as `https://teststorageaccnt.blob.core.windows.net/testcontainer/` as a **Path** in several dialog windows, such as **New Database**, **Attach Database**, and **Restore Database**. For more information, see [Tutorial: Integrating SQL Server with Windows Azure Storage service](assetId:///e69be67d-da1c-41ae-8c9a-6b12c8c2fb61).  
  
### SQL Server Management Objects support  
 When using the SQL Server Data Files in Windows Azure feature, all SQL Server Management Objects (SMO) are supported. If an SMO object requires a file path, use the BLOB URL format instead of a local file path, such as `https://teststorageaccnt.blob.core.windows.net/testcontainer/`. For more information about SQL Server Management Objects (SMO), see [SQL Server Management Objects (SMO)](assetId:///4cde2b85-2a31-4cac-8d16-7a4196066193) in SQL Server Books Online.  
...
-   *Shared Access Signature has not been created on the container correctly.*   
     Resolution: Make sure that you have created a Shared Access Signature on the container correctly. Review the instructions given in Lesson 2 in [Tutorial: Integrating SQL Server with Windows Azure Storage service](assetId:///e69be67d-da1c-41ae-8c9a-6b12c8c2fb61).  
  
-   *SQL Server credential has not been not created correctly.*   
    Resolution: Make sure that you have used 'Shared Access Signature' for the **Identity** field and created a secret correctly. Review the instructions given in Lesson 3 in [Tutorial: Integrating SQL Server with Windows Azure Storage service](assetId:///e69be67d-da1c-41ae-8c9a-6b12c8c2fb61).  
...
1.  *Errors when creating a database*   
    Resolution: Review the instructions given in Lesson 4 in [Tutorial: Integrating SQL Server with Windows Azure Storage service](assetId:///e69be67d-da1c-41ae-8c9a-6b12c8c2fb61).  
  
2.  *Errors when running the Alter statement*   
    Resolution: Make sure to execute the Alter Database statement when the database is online. When copying the data files to Windows Azure Storage, always create a page blob not a block blob. Otherwise, ALTER Database will fail. Review the instructions given in Lesson 7 in [Tutorial: Integrating SQL Server with Windows Azure Storage service](assetId:///e69be67d-da1c-41ae-8c9a-6b12c8c2fb61).  
...
## See Also  
 [Tutorial: Integrating SQL Server with Windows Azure Storage service](assetId:///e69be67d-da1c-41ae-8c9a-6b12c8c2fb61)