...
# Web Service URL  - Reporting Services Native mode (Configuration Manager)
 ...
 If you reinstalled [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] and find that you get errors when attempting to use the default IP address value of All Assigned and port 80, you can usually resolve the error by re\-creating the URL after restarting the service.  
