...
|Maroon|[!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] stored procedure|  
|Dark gray|Operators|  
  
## Status Bar  
 You can configure registered servers or [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] servers in Object Explorer to have different colors in the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor status bar. This helps you identify which server each editor window is connected to when you have many windows open at the same time. For more information about setting status bar colors, see [Status Bar (Database Engine Query Editor)](../../Topics/TopicNameNotContainA/Status-Bar--Database-Engine-Query-Editor-.md).  
