---
title: "Create Invoices and Forms with Lists (Report Builder and SSRS)"
ms.custom: na
ms.date: 06/29/2016
...
> [!NOTE]  
>  You can publish lists separately from a report as report parts. [!INCLUDE[ssRBrptparts](../../Topics/TopicNameContainA/tokens/ssRBrptparts_md.md)]  
  
 To quickly get started with lists, see [Tutorial: Creating a Free Form Report (Report Builder)](assetId:///87288b59-faf2-4b1d-a8e4-a7582baedf2f).  
  
 The [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] sample reports include a report that uses a list. You can learn about lists by exploring the report definition of the sample report in Report Builder or Report Designer or by previewing the rendered report in Report Builder or Report Designer. For more information about downloading the sample reports, see [(SSRS) Reporting Services Samples](http://go.microsoft.com/fwlink/?LinkID=198283).  
...
##  <a name="AddingList"></a> Adding a List to Your Report  
 ...
 ![New List report item on the design surface](../../Topics/TopicNameNotContainA/images/rs_ListTemplateNew.gif "rs_ListTemplateNew")  
  
 When you select a list on the design surface, row and column handles appear, as shown in the following figure.  
  
 ![New List added from Toolbox, selected](../../Topics/TopicNameNotContainA/images/rs_ListTemplateNewSelected.gif "rs_ListTemplateNewSelected")  
  
 The list you start with is a template based on the tablix data region. After you add a list, you can continue to enhance the design by changing the content or appearance of the list by specifying filter, sort, or group expressions, or changing the way the list displays across report pages. For more information, see [Controlling the Tablix Data Region Display on a Report Page (Report Builder and SSRS)](../../Topics/TopicNameContainA/Controlling-the-Tablix-Data-Region-Display-on-a-Report-Page--Report-Builder-and-SSRS-.md). Although the list starts with a single column and row, you can further continue to develop your list design by adding nested or adjacent row groups or column groups, or adding additional detail rows. For more information, see [Exploring the Flexibility of a Tablix Data Region (Report Builder and SSRS)](../../Topics/TopicNameContainA/Exploring-the-Flexibility-of-a-Tablix-Data-Region--Report-Builder-and-SSRS-.md).  
...
##  <a name="DisplayingLayout"></a> Displaying Data in a Free-form Layout  
 ...
 ![List in design view, 4 fields and an image](../../Topics/TopicNameNotContainA/images/rs_BasicListFormDesign.gif "rs_BasicListFormDesign")  
  
 In Preview, the list repeats to display the field data in the free-form format, as shown in the following figure:  
  
 ![Preview for List with 4 fields and one image](../../Topics/TopicNameNotContainA/images/rs_BasicListFormPreview.gif "rs_BasicListFormPreview")  
...
##  <a name="DisplayingGrouping"></a> Displaying Data with One Level of Grouping  
 ...
 ![A list with 2 tables, one with nested chart](../../Topics/TopicNameNotContainA/images/rs_BasicListGroupDesign.gif "rs_BasicListGroupDesign")  
 ...
 ![Preview, 2 tables, one with nested chart](../../Topics/TopicNameNotContainA/images/rs_BasicListGroupPreview.gif "rs_BasicListGroupPreview")  
