---
title: "Edit an Existing Data Source Connection (SSAS Tabular)"
ms.custom: na
ms.date: 06/29/2016
...
1.  In [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameContainA/tokens/ssBIDevStudioFull_md.md)], click the **Model** menu, and then click **Existing Connections**.  
...
5.  In [!INCLUDE[ssBIDevStudio](../../Topics/TopicNameContainA/tokens/ssBIDevStudio_md.md)], click the **Model**, click **Process**, and then click **Process All**.  
