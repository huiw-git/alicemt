...
# Change Font Color, Size, and Style
  You can customize the way the text appears in the Editor as well as other places in [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)].  
