...
---
# Delete Statistics
You can delete (drop) statistics from tables and views in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)]  
...
3.  Copy and paste the following example into the query window and click **Execute**.  
 ...
 For more information, see [DROP STATISTICS (Transact-SQL)](assetId:///222806b7-4e45-445b-8cd0-bd5461f3ca4a).