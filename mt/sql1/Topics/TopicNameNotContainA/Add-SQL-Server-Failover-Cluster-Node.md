---
title: Add SQL Server Failover Cluster Node
H1: na
ms.custom: na
...
# Add SQL Server Failover Cluster Node
 ...
 The system configuration check generates a report which contains a short description for each executed rule, and the execution status. The system configuration check report is located at %programfiles%\\Microsoft SQL Server\\130\\Setup Bootstrap\\Log\\\<YYYYMMDD\_HHMM\>\\.  
