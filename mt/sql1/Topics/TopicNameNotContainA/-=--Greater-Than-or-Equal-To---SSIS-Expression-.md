...
## Expression Examples  
 This example evaluates to TRUE if the current date is July 4, 2003 or earlier. For more information, see [GETDATE (SSIS Expression)](../../Topics/TopicNameNotContainA/GETDATE--SSIS-Expression-.md).  
