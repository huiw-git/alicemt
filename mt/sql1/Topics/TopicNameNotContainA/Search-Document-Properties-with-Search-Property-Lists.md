...
### Internal Property IDs  
 ...
 ![Mapping of search property list to internal table](../../Topics/TopicNameNotContainA/images/iFTS_spl_w_Title_and_Keywords.gif "iFTS_spl_w_Title_and_Keywords")  
...
### Indexing of Registered Properties  
 ...
 ![Full&#45;text index that uses a search property list](../../Topics/TopicNameNotContainA/images/iFTS_spl_and_fti.gif "iFTS_spl_and_fti")  
 ...
 **To create a search property list with Transact-SQL**  
 ...
 Use the [CREATE SEARCH PROPERTY LIST (Transact-SQL)](assetId:///5440cbb8-3403-4d27-a2f9-8e1f5a1bc12b) statement and provide at least a name the list.  
...
7.  Select one of the following options:  
    ...
    -   **Create from an existing search property list**  
     ...
     For more information, see [New Search Property List](../../Topics/TopicNameNotContainA/New-Search-Property-List.md).  
 ...
 **To obtain values for a search property list**  
 ...
 See [Find Property Set GUIDs and Property Integer IDs for Search Properties](../../Topics/TopicNameNotContainA/Find-Property-Set-GUIDs-and-Property-Integer-IDs-for-Search-Properties.md).  
  
 **To add a property to a search property list with Transact-SQL**  
  
 Use the [ALTER SEARCH PROPERTY LIST (Transact-SQL)](assetId:///0436e4a8-ca26-4d23-93f1-e31e2a1c8bfb) statement with the values that you obtained by using one of the methods described in the topic, [Find Property Set GUIDs and Property Integer IDs for Search Properties](../../Topics/TopicNameNotContainA/Find-Property-Set-GUIDs-and-Property-Integer-IDs-for-Search-Properties.md).  
 ...
 **To associate a search property list with a full-text index with Transact-SQL**  
 ...
 Use the [ALTER FULLTEXT INDEX (Transact-SQL)](assetId:///b6fbe9e6-3033-4d1b-b6bf-1437baeefec3) statement with the `SET SEARCH PROPERTY LIST = <property_list_name>` clause.  
...
##  <a name="Ov_CONTAINS_using_PROPERTY"></a> Querying Search Properties with CONTAINS  
 The basic [CONTAINS](assetId:///996c72fc-b1ab-4c96-bd12-946be9c18f84) syntax for a property-scoped full-text query is as follows:  
 ...
 **To change a search property list with Transact-SQL**  
 ...
 Use the [ALTER SEARCH PROPERTY LIST (Transact-SQL)](assetId:///0436e4a8-ca26-4d23-93f1-e31e2a1c8bfb) statement to add or remove search properties.  
...
6.  In the **Search Property List Editor** dialog box, use the Properties grid to add or remove search properties:  
    ...
    2.  To add a document property, click in the empty row at the bottom of the list, to the right of the **\***, and enter the values for the new property.  
         ...
         For information about these values, see [Search Property List Editor](../../Topics/TopicNameNotContainA/Search-Property-List-Editor.md). For information about how to obtain these values for properties defined by Microsoft, see [Find Property Set GUIDs and Property Integer IDs for Search Properties](../../Topics/TopicNameNotContainA/Find-Property-Set-GUIDs-and-Property-Integer-IDs-for-Search-Properties.md). For information about properties defined by an independent software vendor (ISV), see the documentation of that vendor.  
 ...
 **To delete a search property list with Transact-SQL**  
 ...
 Use the [DROP SEARCH PROPERTY LIST (Transact-SQL)](assetId:///7c7ce52a-6b77-4a1c-9abf-d5feb664bea8) statement.  
