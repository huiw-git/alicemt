...
To capture XML data about LOGON events for use inside logon triggers, use the [EVENTDATA](assetId:///03a80e63-6f37-4b49-bf13-dc35cfe46c44) function. The LOGON event returns the following event data schema:  
