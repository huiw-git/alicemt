...
1.  In [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)], connect to the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] instance containing the service master key you wish to back up.  
...
5.  In **Object Explorer**, connect to an instance of [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)].  
