...
## Options  
 **Model Name**  
 Select the OLAP mining model on which the data mining dimension will be based from a list of OLAP mining models in the [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] project.  
