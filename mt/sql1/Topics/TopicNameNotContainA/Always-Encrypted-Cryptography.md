...
This document describes encryption algorithms and mechanisms to derive cryptographic material used in the [Always Encrypted](../../Topics/TopicNameNotContainA/Always-Encrypted--Database-Engine-.md) feature in [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] and [!INCLUDE[ssSDSfull](../../Topics/TopicNameContainA/tokens/ssSDSfull_md.md)].  
