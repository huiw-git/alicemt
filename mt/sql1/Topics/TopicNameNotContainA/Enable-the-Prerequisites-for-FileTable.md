...
-   When you upgrade an existing database to [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)], the value of **DIRECTORY_NAME** is null.  
