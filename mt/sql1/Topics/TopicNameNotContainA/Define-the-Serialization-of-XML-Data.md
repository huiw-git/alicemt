...
## Serializing a Typed xml Data Type  
 A typed **xml** data type instance contains values that are typed according to their XML schema types. These values are serialized according to their XML schema type in the same format as the XQuery cast to xs:string produces. For more information, see [CAST and CONVERT (Transact-SQL)](assetId:///f2e91306-2b1b-4e1c-b6d8-a34fb9980057).  
...
## See Also  
 [Type Casting Rules in XQuery](assetId:///f2e91306-2b1b-4e1c-b6d8-a34fb9980057)   
