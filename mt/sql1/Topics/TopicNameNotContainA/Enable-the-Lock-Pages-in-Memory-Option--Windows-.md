...
>  Locking pages in memory may boost performance when paging memory to disk is expected.  
 ...
 Use the Windows Group Policy tool \(gpedit.msc\) to enable this policy for the account used by [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)]. You must be a system administrator to change this policy.  
