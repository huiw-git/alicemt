...
## Benefits of Maintenance Plans  
 In [!INCLUDE[ssDECurrent](../../Token/Other/ssDECurrent_md.md)], maintenance plans create an [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] package, which is run by a [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent job. Maintenance plans can be run manually or automatically at scheduled intervals.  
  
 [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] maintenance plans provide the following features:  
  
-   Workflow creation using a variety of typical maintenance tasks. You can also create your own custom [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] scripts.  
...
-   Support for Windows Authentication and [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Authentication. [!INCLUDE[ssNoteWinAuthentication](../../Token/Other/ssNoteWinAuthentication_md.md)]  
...
-   Run [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent jobs. This can be used to create jobs that perform a variety of actions and the maintenance plans to run those jobs.  
...
|-|-|  
|**Description**|**Topic**|  
|Describes how to create a maintenance plan by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Token/Other/tsql_md.md)].|[Create a Maintenance Plan](../../Topics/TopicNameContainA/Create-a-Maintenance-Plan.md)|  
