...
##  <a name="InThisSection"></a> In This Section  
 [What's New in Reporting Services and Report Builder for SQL Server 2016](../../Topics/TopicNameNotContainA/What-s-New-in-Reporting-Services--SSRS-.md)  
  Describes the new features in this version of [!INCLUDE[ssRSnoversion_md](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] and [!INCLUDE[ssRBnoversion](../../Topics/TopicNameContainA/includes/ssRBnoversion_md.md)].  
