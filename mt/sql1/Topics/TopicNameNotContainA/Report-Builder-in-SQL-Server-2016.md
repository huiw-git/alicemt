...
-   **Start with a shared dataset**. Shared datasets are queries based on a shared data source and saved to a [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] report server in native mode or  in SharePoint integrated mode.  
...
-   **Start with the Map wizard** to create reports that display aggregated data against a geographic or geometric background. Map data can be spatial data from a [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] query or an Environmental Systems Research Institute, Inc. (ESRI) shapefile. You can also add a [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] Bing map tile background.  
...
##  <a name="InThisSection"></a> In This Section  
 ...
 Describes the new features in this version of [!INCLUDE[ssRBnoversion](../../Topics/TopicNameContainA/tokens/ssRBnoversion_md.md)], including maps.  
 ...
 Introduces [!INCLUDE[ssRBnoversion](../../Topics/TopicNameContainA/tokens/ssRBnoversion_md.md)] and the wizards available to help you create reports. The tutorial provides a set of data for you to work with so you do not need to connect to a data source to get started.  
 ...
 Defines key concepts used in throughout [!INCLUDE[ssRBnoversion](../../Topics/TopicNameContainA/tokens/ssRBnoversion_md.md)] documentation.  
 ...
 Outlines the shortcut keys available for navigating and designing reports in [!INCLUDE[ssRBnoversion](../../Topics/TopicNameContainA/tokens/ssRBnoversion_md.md)].  
