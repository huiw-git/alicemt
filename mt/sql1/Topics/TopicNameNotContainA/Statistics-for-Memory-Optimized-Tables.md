...
The query optimizer uses statistics about columns to create query plans that improve query performance. Statistics are collected from the tables in the database and stored in the database metadata.  
 ...
 You have the option of updating the statistics manually any time. You can use [UPDATE STATISTICS (Transact-SQL)](assetId:///919158f2-38d0-4f68-82ab-e1633bd0d308) for individual columns, indexes, or tables. Use [sp_updatestats (Transact-SQL)](assetId:///01184651-6e61-45d9-a502-366fecca0ee4) to update statistics for all user and internal tables in the database.  
...
5.  Run the workload, which can contain a mix of natively compiled and interpreted [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] stored procedures, as well as ad hoc batches.  
