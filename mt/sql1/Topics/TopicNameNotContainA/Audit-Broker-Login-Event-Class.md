...
# Audit Broker Login Event Class
  [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] creates an **Audit Broker Login** event to report audit messages related to Service Broker transport security.  
