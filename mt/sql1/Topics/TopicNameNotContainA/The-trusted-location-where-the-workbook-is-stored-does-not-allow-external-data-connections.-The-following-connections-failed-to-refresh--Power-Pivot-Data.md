...
|Message Text|The trusted location where the workbook is stored does not allow external data connections. The following connections failed to refresh: [!INCLUDE[ssGemini](../../Token/Other/ssGemini_md.md)] Data|  
