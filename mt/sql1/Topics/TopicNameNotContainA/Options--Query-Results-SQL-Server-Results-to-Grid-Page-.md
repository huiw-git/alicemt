---
title: "Options (Query Results/SQL Server/Results to Grid Page)"
ms.custom: 
  - SQL2016_New_Updated
ms.date: 2015-10-29
...
> [!NOTE]  
>  Specifying a large number of characters may cause data in the result set to appear truncated. The maximum number of characters displayed in each cell is dependent on the font size. When large result sets are returned, a high value in this box can cause [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] to run low on memory and hinder system performance.  
