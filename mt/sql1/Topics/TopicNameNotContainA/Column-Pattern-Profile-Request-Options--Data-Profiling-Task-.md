 ...
 **TagTableConnectionManager**  
 Select the existing [!INCLUDE[vstecado](../../Topics/TopicNameContainA/includes/vstecado_md.md)] connection manager that uses the .NET Data Provider for [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] (SqlClient) to connect to the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] database that contains the tag table.  
