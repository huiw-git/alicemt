 ...
 **TagTableConnectionManager**  
 Select the existing [!INCLUDE[vstecado](../../Token/Other/vstecado_md.md)] connection manager that uses the .NET Data Provider for [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] (SqlClient) to connect to the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] database that contains the tag table.  
