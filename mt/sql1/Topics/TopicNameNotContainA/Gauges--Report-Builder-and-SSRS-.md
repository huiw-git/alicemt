...
-   Use multiple gauges in a single gauge panel to compare data between fields.  
 ...
 ![Gauge elements diagram](../../Topics/TopicNameNotContainA/images/Gauge_Elements_Diagram.gif "Gauge_Elements_Diagram")  
...
> [!NOTE]  
>  You can publish gauges separately from a report as report parts. [!INCLUDE[ssRBrptparts](../../Topics/TopicNameContainA/tokens/ssRBrptparts_md.md)]  
  
> [!NOTE]  
>  [!INCLUDE[ssRBRDDup](../../Topics/TopicNameContainA/tokens/ssRBRDDup_md.md)]  
  
##  <a name="GaugeTypes"></a> Gauge Types  
 [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] provides two gauge types: radial and linear. The radial gauge is typically used when you want to express the data as a velocity. The linear gauge is used to express the data as a temperature or scale value.  
 ...
 **Radial Gauge**  
 ...
 ![rs&#95;RadialGauge](../../Topics/TopicNameNotContainA/images/rs_RadialGauge.gif "rs_RadialGauge")  
 ...
 **Linear Gauge**  
 ...
 ![rs&#95;LinearGauge](../../Topics/TopicNameNotContainA/images/rs_LinearGauge.gif "rs_LinearGauge")  
