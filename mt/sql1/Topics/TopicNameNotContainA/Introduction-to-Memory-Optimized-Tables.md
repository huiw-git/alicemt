...
Memory-optimized tables are tables, created using [CREATE TABLE](assetId:///1e068443-b9ea-486a-804f-ce7b6e048e8b).  
  
 Memory-optimized tables are fully durable by default, and, like transactions on (traditional) disk-based tables, fully durable transactions on memory-optimized tables are fully atomic, consistent, isolated, and durable (ACID). Memory-optimized tables and natively compiled stored procedures support a subset of [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)].  
 ...
 Besides the default durable memory-optimized tables, [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] also supports non-durable memory-optimized tables, which are not logged and their data is not persisted on disk. This means that transactions on these tables do not require any disk IO, but the data will not be recovered if there is a server crash or failover.  
  
 In-Memory OLTP is integrated with [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] to provide a seamless experience in all areas such as development, deployment, manageability, and supportability. A database can contain in-memory as well as disk-based objects.  
 ...
 ![Multi&#45;versioning.](../../Topics/TopicNameNotContainA/images/hekaton_tables_1.gif "hekaton_tables_1")  
...
-   Through interpreted [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)], outside of a natively-compiled stored procedure. These [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statements may be either inside interpreted stored procedures or they may be ad-hoc [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statements.  
  
## Accessing Data in Memory-Optimized Tables  
 Memory-optimized tables can be accessed most efficiently from natively compiled stored procedures ([Natively Compiled Stored Procedures](../../Topics/TopicNameNotContainA/Natively-Compiled-Stored-Procedures.md)). Memory-optimized tables can also be accessed with (traditional) interpreted [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)]. Interpreted [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] refers to accessing memory-optimized tables without a natively compiled stored procedure. Some examples of interpreted [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] access include accessing a memory-optimized table from a DML trigger, ad hoc [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] batch, view, and table-valued function.  
  
 The following table summarizes native and interpreted [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] access for various objects.  
  
|Feature|Access Using a Natively Compiled Stored Procedure|Interpreted [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] Access|CLR Access|  
|-------------|-------------------------------------------------------|-------------------------------------------|----------------|  
 ...
 *You cannot access a memory-optimized table or natively compiled stored procedure from the context connection (the connection from [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] when executing a CLR module). You can, however, create and open another connection from which you can access memory-optimized tables and natively compiled stored procedures.  
...
## Performance and Scalability  
 ...
 [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] Execution  
...
## Scenarios  
 For a brief discussion of typical scenarios where [!INCLUDE[hek_1](../../Topics/TopicNameContainA/tokens/hek_1_md.md)] can improve performance, see [In-Memory OLTP](https://msdn.microsoft.com/en-us/library/dn133186.aspx).  
