...
-   Send an e-mail message when an error or a warning occurs or when a task fails.  
 ...
 ![Package, For Loop, task host, and Execute SQL task](../../Topics/TopicNameNotContainA/images/MW_DTS_EventHandlerPkg.gif "MW_DTS_EventHandlerPkg")  
 ...
 ![Event handler flow](../../Topics/TopicNameNotContainA/images/MW_DTS_EventHandlers.gif "MW_DTS_EventHandlers")  
  
 Event handlers are members of an event handler collection, and all containers include this collection. If you create the package using [!INCLUDE[ssIS](../../Topics/TopicNameContainA/tokens/ssIS_md.md)] Designer, you can see the members of the event handler collections in the **Event Handlers** folders on the **Package Explorer** tab of [!INCLUDE[ssIS](../../Topics/TopicNameContainA/tokens/ssIS_md.md)] Designer.  
...
## Run-Time Events  
 The following table lists the event handlers that [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] provides, and describes the run-time events that cause the event handler to run.  
...
## Configuration of an Event Handler  
 ...
 For information about how to set these properties in [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameContainA/tokens/ssBIDevStudioFull_md.md)], see [Set the Properties of a Task or Container](../../Topics/TopicNameContainA/Set-the-Properties-of-a-Task-or-Container.md).  
