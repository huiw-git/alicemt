...
The Incremental Package Deployment feature introduced in  [!INCLUDE[ssISCurrent](../../Topics/TopicNameContainA/tokens/ssISCurrent_md.md)] lets you deploy one or more packages to an existing or new project without deploying the whole project.  
