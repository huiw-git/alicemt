...
Charts are an essential part of data visualization. Learn about the variety of charts that [!INCLUDE[ssRSnoversion_md](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] mobile reports offer to cover a range of scenarios. 

[!INCLUDE[SS_MobileReptPub_Short](../../Topics/TopicNameContainA/tokens/SS_MobileReptPub_Long.md)] has three basic chart types: time, category, and totals. These three chart types have corresponding comparison charts, which are useful for comparing two distinct sets of series.  
...
### Number format
You can assign a variety of formats to numbers in a chart in [!INCLUDE[SS_MobileReptPub_Short](../../Topics/TopicNameContainA/tokens/SS_MobileReptPub_Short.md)] -- for example, general, currency with or without decimals, percentages with and without decimals, and so on. In a chart, number formatting applies to axis annotations, as well as data point pop-ups. You set number formatting on each chart individually, not on the mobile report as a whole. 
...
The time chart is the most basic chart in [!INCLUDE[SS_MobileReptPub_Short](../../Topics/TopicNameContainA/tokens/SS_MobileReptPub_Short.md)]. The time (and date) axis of the chart is automatically set to the first valid date/time field in the data table.  

![mobile-report-time-chart](../../Topics/TopicNameNotContainA/images/mobile-report-time-chart.png)
...
![mobile-report-category-chart](../../Topics/TopicNameNotContainA/images/mobile-report-category-chart.png)   
...
![mobile-report-totals-chart](../../Topics/TopicNameNotContainA/images/mobile-report-totals-chart.png)
...
![mobile-report-comparison-time-chart](../../Topics/TopicNameNotContainA/images/mobile-report-comparison-time-chart.png)
...
* **Pie charts** in [!INCLUDE[ssRSnoversion_md](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] mobile reports can be pies, donuts, or donuts with a total in the center. Pie charts are good for showing the relative size of different parts of a whole. Too many slices make them hard to read.
* **Funnel charts** are often used to show stages in a process, such as sales.

![mobile-report-funnel-chart](../../Topics/TopicNameNotContainA/images/mobile-report-funnel-chart.png)
...
![mobile-report-group-treemap](../../Topics/TopicNameNotContainA/images/mobile-report-group-treemap.png)
