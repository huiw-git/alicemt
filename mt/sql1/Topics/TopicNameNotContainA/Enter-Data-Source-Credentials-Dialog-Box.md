...
Use the **Enter Data Source Credentials** dialog box to provide your [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] credentials so that you can retrieve data from the data source.  
