...
###  <a name="Matrix"></a> Matrix  
 ...
 ![Matrix, Category row and Geography column group](../../Topics/TopicNameContainA/images/rs_BasicMatrixDesign.gif "rs_BasicMatrixDesign")  
 ...
 ![Preview for rendered matrix with expanded groups](../../Topics/TopicNameContainA/images/rs_BasicMatrixPreview.gif "rs_BasicMatrixPreview")  
...
###  <a name="TableNoGroups"></a> Table with no row groups  
 ...
 ![Design, table with one static, one dynamic row](../../Topics/TopicNameNotContainA/images/rs_TableHeaderStaticDesign.gif "rs_TableHeaderStaticDesign")  
 ...
 ![Preview, table with one static, one dynamic row](../../Topics/TopicNameNotContainA/images/rs_TableHeaderStaticPreview.gif "rs_TableHeaderStaticPreview")  
 ...
 ![Row Groups, table with 1 static, 1 dynamic row](../../Topics/TopicNameNotContainA/images/rs_TableHeaderStaticGroupingPaneDefault.gif "rs_TableHeaderStaticGroupingPaneDefault")  
  
 In Advanced mode, the following figure shows the static and dynamic tablix members for the row groups in the table:  
  
 ![Row Groups, Advanced for default table](../../Topics/TopicNameNotContainA/images/rs_TableHeaderStaticGroupingPaneAdvanced.gif "rs_TableHeaderStaticGroupingPaneAdvanced")  
...
###  <a name="TableRowGroupsGroupHeader"></a> Table with row groups and a row group area  
 ...
 ![Design, table with one row group and details](../../Topics/TopicNameNotContainA/images/rs_TableHeaderDynamicwithGroupHeaderCellDesign.gif "rs_TableHeaderDynamicwithGroupHeaderCellDesign")  
 ...
 ![Preview, table with one row group and details](../../Topics/TopicNameNotContainA/images/rs_TableHeaderDynamicwithGroupHeaderCellPreview.gif "rs_TableHeaderDynamicwithGroupHeaderCellPreview")  
 ...
 ![Row Groups, Default with dynamic members](../../Topics/TopicNameNotContainA/images/rs_TableHeaderDynamicGroupingPaneDefault.gif "rs_TableHeaderDynamicGroupingPaneDefault")  
  
 Use the **Advanced** mode of the Row Groups pane to display the tablix members, as shown in the following figure:  
  
 ![Row Groups, Advanced mode with static members](../../Topics/TopicNameNotContainA/images/rs_TableHeaderDynamicwithGroupHeaderCellAdvanced.gif "rs_TableHeaderDynamicwithGroupHeaderCellAdvanced")  
...
-   Upgrade a report that was created for a previous RDL version, before tablix data regions were introduced.  
 ...
 ![Design, table has row group but no group header](../../Topics/TopicNameNotContainA/images/rs_TableHeaderDynamicwithNoGroupHeaderCellDesign.gif "rs_TableHeaderDynamicwithNoGroupHeaderCellDesign")  
 ...
 ![Preview, table has row group but no group header](../../Topics/TopicNameNotContainA/images/rs_TableHeaderDynamicwithNoGroupHeaderCellPreview.gif "rs_TableHeaderDynamicwithNoGroupHeaderCellPreview")  
 ...
 ![Row Groups, Advanced, no group header.](../../Topics/TopicNameNotContainA/images/rs_TableHeaderDynamicwithNoGroupHeaderCellAdvanced.gif "rs_TableHeaderDynamicwithNoGroupHeaderCellAdvanced")  
