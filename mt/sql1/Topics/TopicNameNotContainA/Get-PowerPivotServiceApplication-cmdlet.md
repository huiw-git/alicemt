...
Returns one or more [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] service applications.  
...
## Description  
 The Get-PowerPivotServiceApplication cmdlet returns the service application specified by the Identity parameter. If no parameter is specified, the cmdlet returns all [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] service applications in the farm. Each application is identified by its display name, application type, and GUID. To view additional properties of a [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] service application, add the format-list option to the cmdlet.  
...
```  
 ...
 This example returns all of the properties of a [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] service application.  
