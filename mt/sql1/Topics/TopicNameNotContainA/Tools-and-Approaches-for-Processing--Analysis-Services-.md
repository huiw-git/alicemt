...
# Tools and Approaches for Processing (Analysis Services)
 ...
 As an Analysis Services system administrator, you can execute and monitor the processing of [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] objects using these approaches:  
  
-   Run Impact Analysis to understand object dependencies and scope of operations  
  
-   Process individual objects in [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)]  
  
-   Process individual or multiple objects in [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)]  
  
-   Run Impact Analysis to review a list of related objects that will be unprocessed as result of the current action.  
  
-   Generate and run a script in an [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] XMLA Query window in [!INCLUDE[ssManStudio](../../Token/Other/ssManStudio_md.md)] to process individual or multiple objects  
  
-   Use [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] PowerShell cmdlets  
  
-   Use control flows and tasks in [!INCLUDE[ssIS](../../Token/Other/ssIS_md.md)] packages  
  
-   Monitor processing with SQL Server Profiler  
  
-   Program a custom solution using AMO. For more information, see [Programming AMO OLAP Basic Objects](../Topic/Programming%20AMO%20OLAP%20Basic%20Objects.md).  
...
1.  Start [!INCLUDE[ssManStudio](../../Token/Other/ssManStudio_md.md)] and connect to Analysis Services.  
...
1.  Start [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)] and open a project that has been deployed.  
...
1.  Before you process an [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] object in either [!INCLUDE[ssBIDevStudio](../../Token/Other/ssBIDevStudio_md.md)] or [!INCLUDE[ssManStudio](../../Token/Other/ssManStudio_md.md)], you can analyze the effect on related objects by clicking **Impact Analysis** in one of the **Process Objects** dialog boxes.  
  
2.  Right\-click a dimension, cube, measure group, or partition to open a **Process Objects** dialog box.  
  
3.  Click **Impact Analysis**. [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] scans the model and reports on reprocessing requirements for objects that are related to the one you selected for processing.  
...
4.  Click **Script** on the **Process Objects** screen.  
     ...
     This generates an XMLA script and opens an [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] XMLA Query window.  
...
1.  In [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)], create a package that uses the Analysis Services Processing Task to automatically populate objects with new data when you make regular updates to your source relational database.  
