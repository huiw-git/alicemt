...
The SP:StmtStarting event class indicates that a [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statement within a stored procedure has started.  
