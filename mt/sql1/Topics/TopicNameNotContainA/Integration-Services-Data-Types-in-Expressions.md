...
## Literals  
 In addition, expressions can include string, Boolean, and numeric literals. For more information about converting numeric literals to numeric [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] data types, see [Literals &#40;SSIS&#41;](../../Topics/TopicNameNotContainA/Literals--SSIS-.md).  
...
-   Inside an expression, use NULL\(DT\_WSTR, ...\) instead of NULL\(DT\_STR, ...\). For more info about this function, see [NULL &#40;SSIS Expression&#41;](../../Topics/TopicNameNotContainA/NULL--SSIS-Expression-.md).  
