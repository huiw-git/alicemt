...
-   Combine multiple [CONTAINS](../Topic/CONTAINS%20\(Transact-SQL\).md) predicates into one CONTAINS predicate. In [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] you can specify a list of columns in the CONTAINS query.  
