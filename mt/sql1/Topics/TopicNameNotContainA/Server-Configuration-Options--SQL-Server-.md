...
You can manage and optimize [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] resources through configuration options by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] or the sp_configure system stored procedure. The most commonly used server configuration options are available through [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)]; all configuration options are accessible through sp_configure. Consider the effects on your system carefully before setting these options. For more information, see [View or Change Server Properties (SQL Server)](../../Topics/TopicNameNotContainA/View-or-Change-Server-Properties--SQL-Server-.md).  
  
> [!IMPORTANT]  
>  Advanced options should be changed only by an experienced database administrator or certified [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] technician.  
...
-   After performing the above actions and restarting the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)].  
  
 Options that require [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] to restart will initially show the changed value only in the value column. After restart, the new value will appear in both the value column and the value_in_use column.  
...
-   A= Advanced options, which should be changed only by an experienced database administrator or a certified [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] technician, and which require setting show advanced options to 1.  
  
-   RR = Options requiring a restart of the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)].  
...
-   SC = Self-configuring options.  
    ...
    |[affinity64 I/O mask](../../Topics/TopicNameNotContainA/affinity64-Input-Output-mask-Server-Configuration-Option.md) (A, only available on 64-bit version of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)])|-2147483648|2147483647|0|  
    |[affinity mask](../../Topics/TopicNameNotContainA/affinity-mask-Server-Configuration-Option.md) (A)|-2147483648|2147483647|0|  
    |[affinity64 mask](../../Topics/TopicNameNotContainA/affinity64-mask-Server-Configuration-Option.md) (A, RR), only available on 64-bit version of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)]|-2147483648|2147483647|0|  
    |[Agent XPs](../../Topics/TopicNameNotContainA/Agent-XPs-Server-Configuration-Option.md) (A)|0|1|0<br /><br /> (Changes to 1 when [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Agent is started. Default value is 0 if [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Agent is set to automatic start during Setup.)|  
    ...
    |[external scripts enabled](../../Topics/TopicNameNotContainA/external-scripts-enabled-Server-Configuration-Option.md) (RR)<br /><br /> <br /><br /> **Applies to**: [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] ([!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/tokens/ssSQL15_md.md)] through [current version](http://go.microsoft.com/fwlink/p/?LinkId=299658).|0|1|0|  
    |[filestream_access_level](../../Topics/TopicNameNotContainA/filestream-access-level-Server-Configuration-Option.md)|0|2|0|  
    ...
    |[PolyBase Hadoop and Azure blob storage](../../Topics/TopicNameNotContainA/PolyBase-Connectivity-Configuration--Transact-SQL-.md)(RP)|0|7|0|  
    ...
    |[PH_timeout](../../Topics/TopicNameNotContainA/PH-timeout-Server-Configuration-Option.md) (A)|1|3600|60|  
