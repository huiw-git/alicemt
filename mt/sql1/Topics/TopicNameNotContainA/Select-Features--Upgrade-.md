...
Use the **Select Features** page of the [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] Installation Wizard to view the features to be upgraded to [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)].  
  
 It is not possible to change the features to be upgraded in this release. To add features to this instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)], complete the upgrade process, restart Setup and, click **New Installation or Add Features to an Existing Installation** on the installation center.  
