...
-   In [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)], open an [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] project, and then open the dimension that you want to view.  
