---
title: "Transfer Jobs Task Editor (General Page)"
ms.custom: na
ms.date: 08/09/2016
...
Use the **General** page of the **Transfer Jobs Task Editor** dialog box to name and describe the Transfer Jobs task. For more information about the Transfer Jobs task, see [Transfer Jobs Task](../../Topics/TopicNameNotContainA/Transfer-Jobs-Task.md).  
