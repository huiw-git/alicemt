...
Many [data providers](Data%20Source%20Types.md) are available for use within [!INCLUDE[PRODUCT_NAME](../../Token/Other/PRODUCT_NAME.md)]. The set of *built-in* data providers can be extended by providing additional *custom* data providers. Also, specific data providers can be administratively disabled so that they will not be available to data connection authors.  
