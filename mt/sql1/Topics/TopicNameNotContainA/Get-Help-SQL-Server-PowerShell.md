...
There are several sources of information about using the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] provider for Windows PowerShell and cmdlets. This includes the help that is available in the Windows PowerShell environment.  
...
## Before You Begin  
 ...
 For an overview of the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] cmdlets and provider, see [SQL Server PowerShell](../../Topics/TopicNameNotContainA/SQL-Server-PowerShell.md).  
...
-   [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statements. For more information about the [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] language, see [Transact-SQL Reference (Database Engine)](assetId:///dbba47d7-e08e-4435-b876-35dced1f325d).  
  
-   XQuery statements. For more information about the XQuery language supported by [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)], see [XQuery Language Reference (Database Engine)](assetId:///8a69344f-2990-4357-8160-cb26aac95b91).  
...
### Example: Get SQL Server Provider Help  
 This example returns basic information about the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] provider:  
