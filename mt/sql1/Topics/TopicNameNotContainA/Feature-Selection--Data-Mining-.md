...
-   If the data set is high-dimensional, most data mining algorithms require a much larger training data set.  
 ...
 ![Feature selection and engineering process](../../Topics/TopicNameNotContainA/images/ssdm_FeatureSelectionProcess.png "ssdm_FeatureSelectionProcess")  
...
### Feature Selection Scores  
 [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Data Mining supports these popular and well-established methods for scoring attributes. The specific method used in any particular algorithm or data set depends on the data types, and the column usage.  
