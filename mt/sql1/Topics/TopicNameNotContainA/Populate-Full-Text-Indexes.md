...
##  <a name="types"></a> Types of Population  
 [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] supports the following types of population: full population, change tracking-based automatic or manual population, and incremental timestamp-based population.  
...
-   [CREATE FULLTEXT INDEX](assetId:///8b80390f-5f8b-4e66-9bcc-cabd653c19fd) … WITH CHANGE_TRACKING OFF  
  
-   [ALTER FULLTEXT INDEX](assetId:///b6fbe9e6-3033-4d1b-b6bf-1437baeefec3) … SET CHANGE_TRACKING OFF  
...
1.  In the **Select a page** pane, select Schedules.  
    ...
    -   To change a schedule, select it and click **Edit**.  
        ...
        > [!NOTE]  
        >  For information about modifying a job, see [How to: Modify a Job (SQL Server Management Studio)](assetId:///dd5e5f20-20c4-4ab9-a19a-db87577dcd43).  
