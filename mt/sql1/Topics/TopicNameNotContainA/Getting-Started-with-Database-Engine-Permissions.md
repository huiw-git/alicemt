...
## List of Permissions  
 ...
 For a graphic showing the relationships among the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] principals and server and database objects,  see [Permissions Hierarchy &#40;Database Engine&#41;](../../Topics/TopicNameNotContainA/Permissions-Hierarchy--Database-Engine-.md).  
