...
# Trace Table Properties (Events Selection Tab)
 ...
 To view this window, use [!INCLUDE[ssSqlProfiler](../../Token/Other/ssSqlProfiler_md.md)] to open a trace table. Then on the **File** menu, click **Properties**, and then click the **Events Selection** tab.  
