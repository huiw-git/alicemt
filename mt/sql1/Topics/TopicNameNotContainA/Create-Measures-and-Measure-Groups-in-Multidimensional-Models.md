...
##  <a name="bkmk_modeling"></a> Modeling measures and measure groups on facts and fact tables  
 ...
 ![FactSalesQuota table with two dimension tables](../../Topics/TopicNameNotContainA/images/FactSalesQuota.gif "FactSalesQuota")  
...
##  <a name="bkmk_grain"></a> Granularity of a measure group  
 ...
 You can specify the granularity of a measure group with relation to a specific dimension by using the **Dimension Usage** tab of the Cube Designer. For more information about dimension relationships, see [Dimension Relationships](assetId:///de54c059-cb0f-4f66-bd70-8605af05ec4f).  
