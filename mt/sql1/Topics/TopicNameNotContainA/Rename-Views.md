...
---
# Rename Views
You can rename a view in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)].  
 ...
 **To rename a view**  
 ...
 For more information, see [CREATE VIEW (Transact-SQL)](assetId:///aecc2f73-2ab5-4db9-b1e6-2f9e3c601fb9) and [DROP VIEW (Transact-SQL)](assetId:///03cea355-e39c-46e1-b7db-8832038669dd).  
