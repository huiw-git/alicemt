...
|------------------|---------------------|  
|[Avg](../../Topics/TopicNameNotContainA/Avg-Function--Report-Builder-and-SSRS-.md)|Returns the average of all non-null numeric values specified by the expression, evaluated in the given scope.|  
|[Count](../../Topics/TopicNameNotContainA/Count-Function--Report-Builder-and-SSRS-.md)|Returns a count of non-null values specified by the expression, evaluated in the context of the given scope.|  
|[CountDistinct](../../Topics/TopicNameNotContainA/CountDistinct-Function--Report-Builder-and-SSRS-.md)|Returns a count of all distinct non-null values specified by the expression, evaluated in the context of the given scope.|  
|[Max](../../Topics/TopicNameNotContainA/Max-Function--Report-Builder-and-SSRS-.md)|Returns the maximum value of all non-null numeric values specified by the expression, in the context of the given scope. You can use this for specifying a chart axis maximum value to control the scale.|  
|[Min](../../Topics/TopicNameNotContainA/Min-Function--Report-Builder-and-SSRS-.md)|Returns the minimum value of all non-null numeric values specified by the expression, in the context of the given scope. You can use this for specifying a chart axis minimum value to control the scale.|  
|[StDev](../../Topics/TopicNameNotContainA/StDev-Function--Report-Builder-and-SSRS-.md)|Returns the standard deviation of all non-null numeric values specified by the expression, evaluated in the given scope.|  
|[StDevP](../../Topics/TopicNameNotContainA/StDevP-Function--Report-Builder-and-SSRS-.md)|Returns the population standard deviation of all non-null numeric values specified by the expression, evaluated in the context of the given scope.|  
|[Sum](../../Topics/TopicNameNotContainA/Sum-Function--Report-Builder-and-SSRS-.md)|Returns the sum of all the non-null numeric values specified by the expression, evaluated in the given scope.|  
|[Union](../../Topics/TopicNameNotContainA/Union-Function--Report-Builder-and-SSRS-.md)|Returns the union of all the non-null spatial data values of type **SqlGeometry** or **SqlGeography** that are specified by the expression, evaluated in the given scope.|  
|[Var](../../Topics/TopicNameNotContainA/Var-Function--Report-Builder-and-SSRS-.md)|Returns the variance of all non-null numeric values specified by the expression, evaluated in the given scope.|  
|[VarP](../../Topics/TopicNameNotContainA/VarP-Function--Report-Builder-and-SSRS-.md)|Returns the population variance of all non-null numeric values specified by the expression, evaluated in the context of the given scope.|  
  
 ![Arrow icon used with Back to Top link](../../Topics/TopicNameContainA/media/UpArrow16x16.gif "UpArrow16x16")Back to Top  
...
##  <a name="RetrievingServerAggregates"></a> Retrieving Server Aggregates  
 The following built-in function retrieves custom aggregates from the data provider. For example, using an [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/includes/ssASnoversion_md.md)] data source type, you can retrieve aggregates calculated on the data source server for use in a group header.  
