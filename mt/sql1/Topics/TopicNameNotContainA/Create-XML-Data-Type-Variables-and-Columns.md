...
The **xml** data type is a built-in data type in [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] and is somewhat similar to other built-in types such as **int** and **varchar**. As with other built-in types, you can use the **xml** data type as a column type when you create a table as a variable type, a parameter type, a function-return type, or in [CAST and CONVERT](assetId:///a87d0850-c670-4720-9ad5-6f5a22343ea8).  
...
```  
 ...
 [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] also supports NULL and NOT NULL constraints on columns of **xml** type. For example:  
