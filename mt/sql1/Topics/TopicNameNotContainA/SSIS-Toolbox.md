...
> [!NOTE]  
>  Unlike previous versions of [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)], you cannot remove installed components from the toolbox.  
