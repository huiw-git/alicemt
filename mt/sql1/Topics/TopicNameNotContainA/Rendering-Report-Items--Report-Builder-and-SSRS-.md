---
title: "Rendering Report Items (Report Builder and SSRS)"
ms.custom: na
ms.date: 06/29/2016
...
-   If the subreport is split by a page break, the **Omit border on page break** setting controls whether or not the borders on the subreport are closed or open.  
 ...
 For more information about subreports, see [Subreports (Report Builder and SSRS)](../../Topics/TopicNameNotContainA/Subreports--Report-Builder-and-SSRS-.md).  
