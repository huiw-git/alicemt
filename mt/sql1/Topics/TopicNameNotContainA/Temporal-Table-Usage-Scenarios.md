...
The right-hand portion of the diagram visualizes row versions on time axis and what are the rows you select with different types of querying on temporal table with or without SYSTEM_TIME clause.  
 ...
 ![TemporalUsageScenario1](../../Topics/TopicNameNotContainA/images/TemporalUsageScenario1.png "TemporalUsageScenario1")  
...
Examples of the real-world scenarios that fit well into this category are inventory management or currency trading, among others.  
 ...
 ![TemporalUsageInMemory](../../Topics/TopicNameNotContainA/images/TemporalUsageInMemory.png "TemporalUsageInMemory")  
...
```  
 ...
 ![TemporalUsageInMemory2b](../../Topics/TopicNameNotContainA/images/TemporalUsageInMemory2b.png "TemporalUsageInMemory2b")  
...
```  
 ...
 ![ProductHistoryOverTime](../../Topics/TopicNameNotContainA/images/ProductHistoryOverTime.png "ProductHistoryOverTime")  
...
```  
 ...
 ![ASOFExecutionPlan](../../Topics/TopicNameNotContainA/images/ASOFExecutionPlan.png "ASOFExecutionPlan")  
...
```  
 ...
 ![TemporalAnomalyDetection](../../Topics/TopicNameNotContainA/images/TemporalAnomalyDetection.png "TemporalAnomalyDetection")  
...
```  
 ...
 ![TemporalSCD](../../Topics/TopicNameNotContainA/images/TemporalSCD.png "TemporalSCD")  
...
```  
 ...
 ![TemporalUsageRepair1](../../Topics/TopicNameNotContainA/images/TemporalUsageRepair1.png "TemporalUsageRepair1")  
  
```  
EXEC sp_RepairEmployeeRecord @EmployeeID = 1, @versionNumber = 1  
```  
  
 ![TemporalUsageRepair2](../../Topics/TopicNameNotContainA/images/TemporalUsageRepair2.png "TemporalUsageRepair2")  
...
```  
 ...
 ![TemporalUsageRepair3](../../Topics/TopicNameNotContainA/images/TemporalUsageRepair3.png "TemporalUsageRepair3")  
...
If a newly updated value is not correct then, in many scenarios, restoring the previous version from history is good enough mitigation. The following diagram shows how this process can be automated:  
 ...
 ![TemporalUsageRepair4](../../Topics/TopicNameNotContainA/images/TemporalUsageRepair4.png "TemporalUsageRepair4")  
