---
title: "Piecemeal Restore of Databases With Memory-Optimized Tables"
ms.custom: na
ms.date: 08/09/2016
...
-   Piecemeal restore.  
    ...
    -   Using page repair, you can fix page corruption by specifically restoring the page. For more information, see [Restore Pages (SQL Server)](../../Topics/TopicNameNotContainA/Restore-Pages--SQL-Server-.md).  
