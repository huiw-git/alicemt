...
Besides [loading data from Excel files](../../Topics/TopicNameNotContainA/Prepare-Excel-data-for-Reporting-Services-mobile-reports.md), [!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameNotContainA/tokens/PRODUCT_NAME.md)] can also access data from almost any source. Accessing data requires a shared data source, configured on a [!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameContainA/tokens/ssRSnoversion.md)] [!INCLUDE[ssRSWebPortal](../../Topics/TopicNameNotContainA/tokens/ssRSWebPortal.md)]. Read more about [creating shared data sources](../../Topics/TopicNameNotContainA/Create--Modify--and-Delete-Shared-Data-Sources--SSRS-.md) and [creating shared datasets](../../Topics/TopicNameNotContainA/Manage-Shared-Datasets.md).  
  
After shared data sources and shared datasets are configured on the [!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameContainA/tokens/ssRSnoversion.md)] server, you can use them in mobile reports you create in [!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameContainA/tokens/SS_MobileReptPub_Short.md)].   
  
After you've connected to a [!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameContainA/tokens/ssRSnoversion.md)] server from the [!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameContainA/tokens/SS_MobileReptPub_Short.md)], connecting a mobile report to a shared dataset is straightforward.   
...
3.  If this is the first time connecting to the server, fill in the server name and your name and password. Put the server name in the Server address box in this format:  
    ...
    ![SSMRP_ConnectToServer](../../Topics/TopicNameNotContainA/images/SSMRP_ConnectToServer.png)  
      
  
4. When you select the [!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameContainA/tokens/ssRSnoversion.md)] server, you see the available datasets in folders. Select a dataset to import the data into [!INCLUDE[PRODUCT_NAME](../../Topics/TopicNameContainA/tokens/SS_MobileReptPub_Short.md)].  
  
   ![SS_MRP_ServerData](../../Topics/TopicNameNotContainA/images/SS_MRP_ServerData.png)  
...
1. In the upper-left corner, select **Connections**.  
   ...
   ![SSMRP_AddConnectionIcon](../../Topics/TopicNameNotContainA/images/SSMRP_AddConnectionIcon.png)  
     
   The Server Connection pane opens on the right.  
     
   ![SSMRP_ServerConnectnPane](../../Topics/TopicNameNotContainA/images/SSMRP_ServerConnectnPane.png)  
