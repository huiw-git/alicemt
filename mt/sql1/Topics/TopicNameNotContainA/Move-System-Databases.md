...
This topic describes how to move system databases in [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)]. Moving system databases may be useful in the following situations:  
...
-   Relocation for scheduled disk maintenance.  
 ...
 The following procedures apply to moving database files within the same instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)]. To move a database to another instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] or to another server, use the [backup and restore](../../Topics/TopicNameNotContainA/Back-Up-and-Restore-of-SQL-Server-Databases.md) or [detach and attach](../../Topics/TopicNameContainA/Move-a-Database-Using-Detach-and-Attach--Transact-SQL-.md) operations.  
...
2.  Stop the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] or shut down the system to perform maintenance. For more information, see [Start, Stop, Pause, Resume, Restart the Database Engine, SQL Server Agent, or SQL Server Browser Service](../../Topics/TopicNameNotContainA/Start--Stop--Pause--Resume--Restart-the-Database-Engine--SQL-Server-Agent--or-SQL-Server-Browser-Service.md).  
...
5.  Verify the file change by running the following query.  
 ...
 If the msdb database is moved and the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] is configured for [Database Mail](../../Topics/TopicNameNotContainA/Database-Mail.md), complete these additional steps.  
  
1.  Verify that [!INCLUDE[ssSB](../../Topics/TopicNameContainA/tokens/ssSB_md.md)] is enabled for the msdb database by running the following query.  
    ...
    ```  
     ...
     For more information about enabling [!INCLUDE[ssSB](../../Topics/TopicNameContainA/tokens/ssSB_md.md)], see [ALTER DATABASE (Transact-SQL)](assetId:///15f8affd-8f39-4021-b092-0379fc6983da).  
...
3.  For each file to be moved, use **sqlcmd** commands or [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] to run the following statement.  
...
4.  Exit the **sqlcmd** utility or [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)].  
  
5.  Stop the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)]. For example, run `NET STOP MSSQLSERVER`.  
  
6.  Move the file or files to the new location.  
  
7.  Restart the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)]. For example, run `NET START MSSQLSERVER`.  
...
2.  In the **SQL Server Services** node, right-click the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] (for example, **SQL Server (MSSQLSERVER)**) and choose **Properties**.  
...
6.  Stop the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] by right-clicking the instance name and choosing **Stop**.  
  
7.  Move the master.mdf and mastlog.ldf files to the new location.  
  
8.  Restart the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)].  
...
3.  Stop and restart the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)].  
