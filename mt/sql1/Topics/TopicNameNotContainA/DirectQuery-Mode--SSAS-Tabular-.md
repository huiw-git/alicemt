...
![DirectQuery import success](../../Topics/TopicNameNotContainA/media/DirectQuery-import-success.png)
...
[Define partitions in DirectQuery models](../../Topics/TopicNameNotContainA/Define-partitions-in-DirectQuery-models--SSAS-Tabular-.md)
  
[Test a model in DirectQuery mode](../../Topics/TopicNameContainA/Test-a-model-in-DirectQuery-mode.md)

[DAX Formula Compatibility in DirectQuery Mode](../../Topics/TopicNameNotContainA/DAX-Formula-Compatibility-in-DirectQuery-Mode--SSAS-2016-.md)
