...
# Broker:Forwarded Message Sent Event Class
  [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] generates a Broker:Forwarded Message Sent event when Service Broker forwards a message.  
