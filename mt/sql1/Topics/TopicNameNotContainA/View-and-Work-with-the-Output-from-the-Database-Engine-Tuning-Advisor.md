...
> [!NOTE]  
>  If you use the **dta** command-line utility and specify that output be written to an XML file by using the **-ox** argument, you can open and view the XML output file by clicking **Open File** on the **File** menu of [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)]. For more information, see [Use SQL Server Management Studio](assetId:///f289e978-14ca-46ef-9e61-e1fe5fd593be). For information about the **dta** command-line utility, see [dta Utility](../../Topics/TopicNameNotContainA/dta-Utility.md).  
...
3.  Open the XML file created in Step 2 in your favorite XML editor, text editor, or in [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)]. Scroll down to the **Configuration** element. Copy and paste the **Configuration** element section into an XML input file template after the **TuningOptions** element. Save this XML input file.  
 ...
 **Schedule for later**  
 Generate a script for the recommendations, and save the actions as a [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Agent job.  
  
 **Date**  
 Specify the date you want to run the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Agent job to apply the recommendations.  
  
 **Time**  
 Specify the time you want to run the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Agent job to apply the recommendations.  
 ...
 **Workload table**  
 Appears when the workload is a [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] table.  
  
 **Workload**  
 Appears when the workload has been imported from the Query Editor in [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)].  
