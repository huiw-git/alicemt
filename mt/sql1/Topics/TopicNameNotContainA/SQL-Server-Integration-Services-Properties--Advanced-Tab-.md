...
Microsoft [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] is implemented as the [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)]service. If custom properties are defined, they appear on this tab, with their values. This tab may have no properties listed.