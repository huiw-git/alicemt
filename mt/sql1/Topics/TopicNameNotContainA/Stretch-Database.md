...
-   If your table contains both historical and current data, you can specify a filter predicate to select the rows to migrate.  
 ...
 ![Stretch database overview](../../Images/Image/ImageNotContaina/Stretch_Overview.png "Stretch_Overview")  
 ...
 **Does Stretch Database work with *SQL Server feature name*?**  
 -   For a list of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] features that make a table ineligible for Stretch, see [Limitations for Stretch Database](../../Topics/TopicNameNotContainA/Limitations-for-Stretch-Database.md).  
 ...
 **Can I target another local SQL Server instance for Stretch Database?**  
 No. Stretch Database does not support another local [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] instance as the remote endpoint.  
