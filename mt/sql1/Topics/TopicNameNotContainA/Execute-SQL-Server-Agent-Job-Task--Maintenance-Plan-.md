...
# Execute SQL Server Agent Job Task (Maintenance Plan)
 ...
 This task uses the **.sp\_start\_job** statement.  
 ...
 **Use Windows integrated security**  
 Connect to an instance of the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] with Microsoft Windows Authentication.  
