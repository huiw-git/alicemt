...
# Complete Word (IntelliSense)
  The [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] IntelliSense Complete Word option types the rest of a variable, command, or function name once you have entered enough characters to uniquely identify the term.  
