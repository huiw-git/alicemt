...
# Broker:Activation Event Class
  [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] generates a **Broker:Activation** event when a queue monitor starts an activation stored procedure, sends a QUEUE\_ACTIVATION notification, or when an activation stored procedure started by a queue monitor exits.  
