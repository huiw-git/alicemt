...
### Topology That Has Two Participating Databases  
 ![Peer&#45;to&#45;peer replication, two nodes](../../Topics/TopicNameNotContainA/images/Repl_multinode_01.gif "Repl_multinode_01")  
...
### Topologies That Have Three or More Participating Databases  
 ![Peer&#45;to&#45;peer replication to dispersed locations](../../Topics/TopicNameNotContainA/images/Repl_multinode_02.gif "Repl_multinode_02")  
...
-   Higher availability in case of failure or to allow maintenance at one or more of the participating databases.  
     ...
     ![Peer&#45;to&#45;peer replication, three and four nodes](../../Topics/TopicNameNotContainA/images/Repl_multinode_04.gif "Repl_multinode_04")  
...
-   Peer-to-peer replication is available only in Enterprise versions of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)].  
...
-   Non-[!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Publishers and Subscribers.  
...
-   Attachable subscriptions and transformable subscriptions. (Both of these options were deprecated in [!INCLUDE[ssVersion2005](../../Topics/TopicNameContainA/tokens/ssVersion2005_md.md)].)  
...
|Adding a node to the topology|2 nodes in complete topology: No quiescing required. Use `sync_type = 'initialize with backup'`.|More than 2 nodes: Quiescing required.|`sync_type = 'replication support only'`: Quiescing required.|`sync_type = 'initialize with backup'` and `'initialize from lsn'`: No quiescing required.|  
 ...
 Changing the article properties by using  [sp_changearticle](assetId:///24c33ca5-f03a-4417-a267-131ca5ba6bb5) never requires quiescing. Allowable changes (for P2P) are the `description`, `ins_cmd`, `upd_cmd`, and `del_cmd` properties.  
