---
title: "Always On for SSIS Catalog (SSISDB)"
ms.custom: 
  - SQL2016_New_Updated
ms.date: 08/09/2016
...
1.  [Prerequisites](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md#prereq)  
  
2.  [Configure SSIS support for Always On](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md#Firsttime)  
  
3.  [Upgrading SSISDB in an availability group](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md#Upgrade)  
...
-   [Step 1: Create Integration Services Catalog](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md#Step1)  
  
-   [Step 2: Add SSISDB to an Always On Availability Group](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md#Step2)  
  
-   [Step 3: Enable SSIS support for Always On](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md#Step3)  
...
###  <a name="Step2"></a> Step 2: Add SSISDB to an Always On Availability Group  
 ...
 ![New Availability Group](../../Topics/TopicNameNotContainA/images/SSIS-NewAvailabilityGroup.png "SSIS-NewAvailabilityGroup")  
...
###  <a name="Step3"></a> Step 3: Enable SSIS support for Always On  
 ...
 ![Enable Support for AlwaysOn](../../Topics/TopicNameNotContainA/images/SSIS-EnableSupportForAlwaysOn.png "SSIS-EnableSupportForAlwaysOn")  
...
1.  Remove the SSISDB database from the availability group. For more info, see [Remove a Secondary Database from an Availability Group (SQL Server)](../../Topics/TopicNameContainA/Remove-a-Secondary-Database-from-an-Availability-Group--SQL-Server-.md) and [Remove a Primary Database from an Availability Group (SQL Server)](../../Topics/TopicNameContainA/Remove-a-Primary-Database-from-an-Availability-Group--SQL-Server-.md).  
...
4.  After you have upgraded all the nodes, add the SSISDB database back to the Always On availability group. For more info, see [Add a Database to an Availability Group (SQL Server)](../../Topics/TopicNameContainA/Add-a-Database-to-an-Availability-Group--SQL-Server-.md).  
...
4.  Follow the instructions in [Step 2: Add SSISDB to an Always On Availability Group](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md#Step2) to add the SSISDB back to an availability group.  
  
5.  Follow the instructions in [Step 3: Enable SSIS support for Always On](../../Topics/TopicNameNotContainA/Always-On-for-SSIS-Catalog--SSISDB-.md#Step3).