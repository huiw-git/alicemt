...
This topic is relevant only for [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] databases that are using the full or bulk-logged recovery models.  
...
## Forcing a Mark to Spread to Other Servers  
 ...
 For example, consider a partitioned database that exists on multiple instances of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)]. On each instance is a database named `coyote`. First, in every database, create a stored procedure, for example, `sp_SetMark`.  
...
## See Also  
 [BEGIN DISTRIBUTED TRANSACTION (Transact-SQL)](assetId:///c3bc2716-39d3-4061-8c6a-8734899231ac)   
