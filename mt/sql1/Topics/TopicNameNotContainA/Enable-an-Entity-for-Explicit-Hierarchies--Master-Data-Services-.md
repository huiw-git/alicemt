...
In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/tokens/ssMDSshort_md.md)], enable an entity for explicit hierarchies so that you can create explicit hierarchies and for the entity.  
