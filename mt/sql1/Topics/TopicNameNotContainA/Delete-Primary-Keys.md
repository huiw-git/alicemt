...
---
# Delete Primary Keys
  You can delete \(drop\) a primary key in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Token/Other/tsql_md.md)]. When the primary key is deleted, the corresponding index is deleted.  
