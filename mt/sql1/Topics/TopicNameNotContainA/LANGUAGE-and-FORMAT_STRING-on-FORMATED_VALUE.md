...
### Examples  
 ...
 The results, transposed, when the above MDX query was run using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)] over a server and client with locale 1033 are as follows:  
