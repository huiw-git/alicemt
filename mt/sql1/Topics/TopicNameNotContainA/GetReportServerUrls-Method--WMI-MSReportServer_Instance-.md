...
## Remarks  
 Methods exposed by WMI management objects are called through the **InvokeMethod** function. For more information, please see "Executing Methods on Management Objects" in the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] .NET Framework WMI documentation.  
