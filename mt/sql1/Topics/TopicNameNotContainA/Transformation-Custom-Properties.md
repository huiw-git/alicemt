...
# Transformation Custom Properties
  In addition to the properties that are common to most data flow objects in the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] object model, many data flow objects have custom properties that are specific to the object. These custom properties are available only at run time, and are not documented in the [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] Managed Programming Reference Documentation.  
...
|ASConnectionString|String|The connection string to an [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] project or an [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] database.|  
|CatalogName|String|The name of an [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] database.|  
...
|ReferenceMetadataXML|String|[!INCLUDE[ssInternalOnly](../../Token/Other/ssInternalOnly_md.md)]|  
|ReferenceTableName|String|The name of the lookup table. The name must be a valid [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] identifier name. For example, if the name contains spaces, the name must be enclosed in brackets.|  
...
|TreatNullsAsEqual|Boolean|A value that specifies whether the transformation handles null values as equal values. The default value of this property is **True**. If the property value is **False**, the transformation handles null values like [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] does.|  
