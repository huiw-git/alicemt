---
title: Backup History and Header Information (SQL Server)
ms.custom: na
...
# Backup History and Header Information (SQL Server)
  A complete history of all [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] backup and restore operations on a server instance is stored in the **msdb** database. This topic introduces the backup and restore history tables and also the [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statements that are used to access backup history. The topic also discusses when listing database and transaction log files is useful and when to use media-header information compared to when to use backup-header information.  
  
> [!IMPORTANT]  
>  To manage the risk of losing recent changes to your backup and restore history, back up **msdb** frequently. For information about which of the system databases you must back up, see [Back Up and Restore of System Databases &#40;SQL Server&#41;](../../Topics/TopicNameNotContainA/Back-Up-and-Restore-of-System-Databases--SQL-Server-.md).  
...
### Which Backup Set to Restore  
 ...
 ![Backup media containing SQL Server backup sets](../../Topics/TopicNameNotContainA/media/BNR_media_backup_sets.gif "BNR_media_backup_sets")  
...
##  <a name="CompareMediaHeaderBackupHeader"></a> Comparison of Media-Header and Backup-Header Information  
 ...
 ![Media set containing three SQL Server backup sets](../../Topics/TopicNameNotContainA/media/BNR_media_label.gif "BNR_media_label")  
...
-   [ReadFileList](assetId:///M:Microsoft.SqlServer.Management.Smo.Restore.ReadFileList(Microsoft.SqlServer.Management.Smo.Server)) (SMO)  
...
-   [ReadMediaHeader](assetId:///M:Microsoft.SqlServer.Management.Smo.Restore.ReadMediaHeader(Microsoft.SqlServer.Management.Smo.Server)) (SMO)  
...
-   [ReadBackupHeader](assetId:///M:Microsoft.SqlServer.Management.Smo.Restore.ReadBackupHeader(Microsoft.SqlServer.Management.Smo.Server)) (SMO)  
...
-   [SqlVerify](assetId:///M:Microsoft.SqlServer.Management.Smo.Restore.SqlVerify(Microsoft.SqlServer.Management.Smo.Server)) (SMO)  
