...
# Backup History and Header Information (SQL Server)
  A complete history of all [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] backup and restore operations on a server instance is stored in the **msdb** database. This topic introduces the backup and restore history tables and also the [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statements that are used to access backup history. The topic also discusses when listing database and transaction log files is useful and when to use media-header information compared to when to use backup-header information.  
...
### Which Backup Set to Restore  
 ...
 ![Backup media containing SQL Server backup sets](../../Topics/TopicNameNotContainA/images/BNR_media_backup_sets.gif "BNR_media_backup_sets")  
...
##  <a name="CompareMediaHeaderBackupHeader"></a> Comparison of Media-Header and Backup-Header Information  
 ...
 ![Media set containing three SQL Server backup sets](../../Topics/TopicNameNotContainA/images/BNR_media_label.gif "BNR_media_label")  
