...
-   The [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Utility must operate within a single Windows domain, or domains with two\-way trust relationships.  
...
-   The [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] instance to enroll cannot be SQL Azure.  
...
-   We recommend that if the UCP is hosted by a case\-insensitive instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)], then managed instances of SQL Server should also be case\-insensitive.  
...
-   FILESTREAM data are not supported for [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Utility monitoring.  
 ...
 For more information about [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Utility concepts, see [SQL Server Utility Features and Tasks](../../Topics/TopicNameNotContainA/SQL-Server-Utility-Features-and-Tasks.md).  
...
##  <a name="Instance_name"></a> Specify the Instance of SQL Server  
 To select an instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] from the connection dialog box, click **Connect…**. Provide the computer name and the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] instance name in the format ComputerName\\InstanceName. For more information, see [Connect to Server &#40;Database Engine&#41;](../Topic/Connect%20to%20Server%20\(Database%20Engine\).md).  
...
> [!NOTE]  
>  If the connection is encrypted, the encrypted connection is used. If the connection is not encrypted, [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Utility reconnects using an encrypted connection.  
...
##  <a name="Validation_rules"></a> SQL Server Instance Validation  
 In this release, the following conditions must be true on the instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] to be enrolled into the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Utility:  
  
|Condition|Corrective Action|  
|---------------|-----------------------|  
|You must have administrator privileges on the specified instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] and on the UCP.|Log on with an account that has administrator privileges on the specified instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] and on the UCP.|  
|The [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] edition must support instance enrollment.|For a list of features that are supported by the editions of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)], see [Features Supported by the Editions of SQL Server 2016](../../Topics/TopicNameNotContainA/Features-Supported-by-the-Editions-of-SQL-Server-2016.md).|  
|The [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] UCP should have TCP\/IP enabled.|Enable TCP\/IP on the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] UCP.|  
|The instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] cannot already be enrolled with any other [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] UCP.|If the instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] you specify is already managed as part of an existing [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Utility, you cannot enroll it with a different UCP.|  
|The instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] cannot already be a UCP.|If the instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] you specify is already a UCP that is different than the UCP you are connected to, you cannot enroll it in this UCP.|  
|The instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] must have [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Utility collection sets installed.|Re\-install the instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)].|  
...
|The [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent service on the specified instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] must be started.|Start the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent service on the specified instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)]. If the specified instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] is a [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] failover cluster instance, configure the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent service to start manually. Otherwise, configure the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent service to start automatically.|  
|The [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent service on the UCP must be started.|Start the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent service on the UCP. If the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] UCP is a [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] failover cluster instance, configure the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent service to start manually. Otherwise, configure the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent service to start automatically.|  
...
|The [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent proxy account must be a valid Windows domain account on the UCP.|Specify a valid Windows domain account. To ensure that the account is valid, logon to the UCP using the Windows domain account.|  
|If you select the proxy account option, the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent proxy account must be a valid Windows domain account on the specified instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)].|Specify a valid Windows domain account. To ensure that the account is valid, logon to the specified instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] using the Windows domain account.|  
|The [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent service account cannot be a built\-in account, like Network Service.|Re\-assign the account to a Windows domain account. To ensure that the account is valid, logon to the specified instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] using the Windows domain account.|  
|The [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent service account must be a valid Windows domain account on the UCP.|Specify a valid Windows domain account. To ensure that the account is valid, logon to the UCP using the Windows domain account.|  
...
##  <a name="Summary"></a> Summary of Instance Enrollment  
 The summary page lists the information about the instance of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] to add to the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Utility.  
