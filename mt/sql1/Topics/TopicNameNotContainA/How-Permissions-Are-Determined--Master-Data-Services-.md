...
In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/tokens/ssMDSshort_md.md)], the simplest way to configure security is to assign model object permissions to a group that the user is a member of.  
...
## Permissions assigned to a single group or user  
 ...
 ![mds&#95;conc&#95;security&#95;no&#95;overlap](../../Topics/TopicNameNotContainA/images/mds_conc_security_no_overlap.gif "mds_conc_security_no_overlap")  
...
-   Any objects at a higher level are given Inferred Read. For more information about Inferred Read, see [Navigational Access (Master Data Services)](../../Topics/TopicNameNotContainA/Navigational-Access--Master-Data-Services-.md).  
 ...
 ![mds&#95;conc&#95;inheritance&#95;model](../../Topics/TopicNameNotContainA/images/mds_conc_inheritance_model.gif "mds_conc_inheritance_model")  
...
-   Any nodes at higher levels that do not have permissions assigned are implicitly denied.  
 ...
 ![mds&#95;conc&#95;inheritance&#95;hierarchy](../../Topics/TopicNameNotContainA/images/mds_conc_inheritance_hierarchy.gif "mds_conc_inheritance_hierarchy")  
  
### Step 3: The intersection of attribute and member permissions is determined.  
 If the effective attribute permissions are different than the effective member permissions, permissions must be determined for each individual attribute value. For more information, see [Overlapping Model and Member Permissions (Master Data Services)](../../Topics/TopicNameNotContainA/Overlapping-Model-and-Member-Permissions--Master-Data-Services-.md).  
...
## Permissions assigned to multiple groups  
 ...
 ![mds&#95;conc&#95;security&#95;group&#95;overlap](../../Topics/TopicNameNotContainA/images/mds_conc_security_group_overlap.gif "mds_conc_security_group_overlap")  
