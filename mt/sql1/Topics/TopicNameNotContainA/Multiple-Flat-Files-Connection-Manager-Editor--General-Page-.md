---
title: "Multiple Flat Files Connection Manager Editor (General Page)"
ms.custom: na
ms.date: 08/09/2016
 ...
 **Connection manager name**  
 Provide a unique name for the Multiple Flat Files connection in the workflow. The name provided will be displayed within [!INCLUDE[ssIS](../../Topics/TopicNameContainA/tokens/ssIS_md.md)] Designer.  
