...
## View Target Data  
 You can display the data collected into the specified target within [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)].  
...
-   For an event_file target, view the file target data (.XEL file) using one of the following methods:  
    ...
    -   Use File -> Open in [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)].  
  
    -   Drag and Drop the file into [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)].  
  
    -   Double click the .XEL file.  
  
    -   In [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)], right click on a running Extended Events session and select View Target Data.  
...
### Group Results  
 Grouped results are equivalent to the functionality of the **GROUP BY** clause in [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)]. The target data table will show the data grouped together, allowing you to expand and collapse the data.  
...
-   .CSV file  
 ...
 You can export trace results to a .XEL file, table, or .CSV file by selecting **Export to** from the **Extended Events** menu option in [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)].  
