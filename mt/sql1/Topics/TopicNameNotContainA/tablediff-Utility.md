...
-   A row by row comparison between a source table in an instance of [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] acting as a replication Publisher and the destination table at one or more instances of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] acting as replication Subscribers.  
  
-   Perform a fast comparison by only comparing row counts and schema.  
  
-   Perform column-level comparisons.  
  
-   Generate a [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] script to fix discrepancies at the destination server to bring the source and destination tables into convergence.  
 ...
 **-sourceserver** *source_server_name*[**\\***instance_name*]  
 Is the name of the source server. Specify *source_server_name* for the default instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)]. Specify *source_server_name***\\***instance_name* for a named instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)].  
 ...
 **-sourcepassword** *source_password*  
 Is the password for the login used to connect to the source server using [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] Authentication.  
 ...
 **-destinationpassword** *destination_password*  
 Is the password for the login used to connect to the destination server using [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] Authentication.  
  
> [!IMPORTANT]  
>  When possible, supply security credentials at runtime. If you must store credentials in a script file, you should secure the file to prevent unauthorized access.  
  
 **-destinationuser** *destination_login*  
 Is the login used to connect to the destination server using [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] Authentication. If *destination_login* is not supplied, then Windows Authentication is used when connecting to the server. [!INCLUDE[ssNoteWinAuthentication](../../Topics/TopicNameContainA/includes/ssNoteWinAuthentication_md.md)]  
 ...
 **-bf**  *number_of_statements*  
 Is the number of [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statements to write to the current [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] script file when the **-f** option is used. When the number of [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statements exceeds *number_of_statements*, a new [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] script file is created.  
 ...
 **-f** [ *file_name* ]  
 Generates a [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] script to bring the table at the destination server into convergence with the table at the source server. You can optionally specify a name and path for the generated [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] script file. If *file_name* is not specified, the [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] script file is generated in the directory where the utility runs.  
...
## Remarks  
 The **tablediff** utility cannot be used with non-[!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] servers.  
...
|**image**|**varbinary(max)**|  
 ...
 The [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] script generated to bring the destination table into convergence does not include the following data types:  
