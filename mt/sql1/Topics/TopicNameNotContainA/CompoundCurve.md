...
## CompoundCurve instances  
 ...
 ![](../../Topics/TopicNameNotContainA/images/f278742e-b861-4555-8b51-3d972b7602bf.gif "f278742e-b861-4555-8b51-3d972b7602bf")  
  
### Accepted instances  
 **CompoundCurve** instance is accepted if it is an empty instance or meets the following criteria.  
  
1.  All the instances contained by **CompoundCurve** instance are accepted circular arc segment instances. For more information on accepted circular arc segment instances, see [LineString](../../Topics/TopicNameNotContainA/LineString.md) and [CircularString](../../Topics/TopicNameNotContainA/CircularString.md).  
...
```  
 ...
 `@g3` is valid because the **CircularString** instance is valid. For more information on the validity of the **CircularString** instance, see [CircularString](../../Topics/TopicNameNotContainA/CircularString.md).  
