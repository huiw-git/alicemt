...
|**LoginName**|**nvarchar**|Name of the login of the user (either a [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] security login or the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] Windows login credentials in the form of DOMAIN\username).|11|Yes|  
