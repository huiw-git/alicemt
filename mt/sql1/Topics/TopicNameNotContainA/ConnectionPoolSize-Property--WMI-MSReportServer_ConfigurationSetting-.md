...
# ConnectionPoolSize Property (WMI MSReportServer_ConfigurationSetting)
  The connection pool size used by the report server to communicate with the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] instance that hosts the report server database. Read\-only.  
