...
-   Format the results of Transact-SQL queries in JSON format.  
 ...
 ![Overview of built&#45;in JSON support](../../Topics/TopicNameNotContainA/images/JSONSlides1Overview.png "JSONSlides1Overview")  
...
## Use cases  
 ...
 Here are some use cases that show how you can use the built-in JSON support in [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)].  
...
## Analyze JSON data with SQL queries  
 If you have to filter or aggregate JSON data for reporting purposes, you can use OPENJSON to transform JSON to relational format. Then use standard [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] and built-in functions to prepare the reports.  
