...
In preview, in [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameNotContainA/includes/ssBIDevStudioFull.md)], view the Output window. On the report server, view the call stack. For more information, see [Troubleshooting Techniques for Report Problems](Troubleshoot%20Reporting%20Services%20Reports.md).   
