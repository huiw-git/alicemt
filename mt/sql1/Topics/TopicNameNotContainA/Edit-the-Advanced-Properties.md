...
2.  Type a valid value for the property in the **Value** column.  
 ...
 For a description of the properties you can enter, see the available options table in [cdc.xdbcdc_config](../../Topics/TopicNameNotContainA/The-Oracle-CDC-Databases.md#BKMK_cdcxdbcdc_config).  
