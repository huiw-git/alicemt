...
11. Type the name of the account that is used for [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] service application pool, and then click **OK**.  
