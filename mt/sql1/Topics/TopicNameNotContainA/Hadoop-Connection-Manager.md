...
3.  If you enable the **WebHCat** option to invoke a Hive or Pig job on Hadoop, do the following.  
    ...
    3.  Select the **Authentication** method for accessing the WebHCat service. The available values are **Basic** and **Kerberos**.  
         ...
         ![Hadoop connection manager editor with basic authentication](../../Topics/TopicNameNotContainA/media/Hadoop_cm_basic.png "Hadoop_cm_basic")  
  
         ![Hadoop connection manager editor with Kerberos authentication](../../Topics/TopicNameNotContainA/media/Hadoop_cm_kerberos.png "Hadoop_cm_kerberos")  
