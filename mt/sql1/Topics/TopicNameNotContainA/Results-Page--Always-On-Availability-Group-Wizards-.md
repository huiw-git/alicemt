...
# Results Page (Always On Availability Group Wizards)
  This help topic describes the options of the **Results** page. This topic applies to the [!INCLUDE[ssAoNewAgWiz](../../Token/Other/ssAoNewAgWiz_md.md)], [!INCLUDE[ssAoAddRepWiz](../../Token/Other/ssAoAddRepWiz_md.md)], [!INCLUDE[ssAoAddDbWiz](../../Token/Other/ssAoAddDbWiz_md.md)], and [!INCLUDE[ssAoFoAgWiz](../../Token/Other/ssAoFoAgWiz_md.md)] of [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)]. Use this page to view the results of the wizard.  
