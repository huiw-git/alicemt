...
# Filter Dialog Box (MDS Add-in for Excel)
  In the [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)][!INCLUDE[ssMDSXLS](../../Token/Other/ssMDSXLS_md.md)], use the **Filter** dialog box to narrow the list of MDS\-managed data before loading it into Excel.  
