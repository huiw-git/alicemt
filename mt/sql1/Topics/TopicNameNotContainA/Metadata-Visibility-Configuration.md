...
|||  
|-|-|  
|Catalog views|[!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] **sp_help** stored procedures|  
...
|||  
|-|-|  
|Log shipping system tables|[!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Agent system tables|  
|Database maintenance plan system tables|Backup system tables|  
|Replication system tables|Replication and [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Agent **sp_help** stored procedures|  
...
> [!NOTE]  
>  The following example uses the [sys.objects](assetId:///f8d6163a-2474-410c-a794-997639f31b3b) catalog view instead of the [sys.sysobjects](assetId:///44fdc387-67b0-4139-8bf5-ed26cf640cd1) compatibility view.  
...
> [!NOTE]  
>  You can use EXECUTE AS to temporarily switch to the security context of the caller. For more information, see [EXECUTE AS (Transact-SQL)](assetId:///613b8271-7f7d-4378-b7a2-5a7698551dbd).  
...
## See Also  
 ...
 [EXECUTE AS (Transact-SQL)](assetId:///bd517aa3-f06e-4356-87d8-70de5df4494a)   
 [Catalog Views (Transact-SQL)](assetId:///13bccc2f-ed3c-4b58-abd0-ca8bf34a66b8)   
 [Compatibility Views (Transact-SQL)](assetId:///8e4624f5-9d36-4ce7-9c9e-1fe010fa2122)