...
|EXECUTE|CLR types, external scripts, procedures ([!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] and CLR), scalar and aggregate functions ([!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] and CLR), and synonyms|  
...
|RECEIVE|[!INCLUDE[ssSB](../../Topics/TopicNameContainA/includes/ssSB_md.md)] queues|  
...
##  <a name="_permissions"></a> SQL Server Permissions  
 The following table provides a complete list of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] permissions. [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/includes/ssSDS_md.md)] permissions are only available for base securables that are supported. Server level permissions cannot be granted in [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/includes/ssSDS_md.md)], however in some cases database permissions are available instead.  
...
|DATABASE|ALTER ANY SECURITY POLICY|ALSP<br /><br /> Applies to [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] ([!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/includes/ssSQL15_md.md)] through current), [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/includes/ssSDS_md.md)].|SERVER|CONTROL SERVER|  
