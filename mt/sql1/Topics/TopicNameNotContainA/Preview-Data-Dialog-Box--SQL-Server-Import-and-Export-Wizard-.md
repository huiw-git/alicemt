...
# Preview Data Dialog Box (SQL Server Import and Export Wizard)
  After you specify the data that you want to copy, you can optionally preview up to 200 rows of sample data in the **Preview Data** dialog box. This helps you to confirm that the wizard is going to copy the data that you want to copy.  
...
## Screen shot  
 ...
 ![Preview data page of the Import and Export Wizard](../../Topics/TopicNameNotContainA/media/Preview-data.png "Preview data")  
