...
This topic describes how to test connectivity to an instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)], use the **sqlcmd** utility.  
