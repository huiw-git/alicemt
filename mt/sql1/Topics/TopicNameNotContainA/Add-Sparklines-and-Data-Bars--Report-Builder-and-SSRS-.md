...
1.  If you have not done so already, create a [table](../../Topics/TopicNameNotContainA/Tables--Report-Builder--and-SSRS-.md) or [matrix](../../Topics/TopicNameContainA/Create-a-Matrix--Report-Builder-and-SSRS-.md) with the data you want to display.  
