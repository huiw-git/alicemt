...
These restrictions on natively compiled [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] do not apply to interpreted [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] access on memory-optimized tables.  
