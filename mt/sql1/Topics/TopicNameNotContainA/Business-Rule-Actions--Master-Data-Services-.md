...
In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/tokens/ssMDSshort_md.md)], business rule actions are the consequence of business rule condition evaluations. If a condition is true, the action is initiated.  
...
## External Action  
 **External** actions interact with applications outside of [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/tokens/ssMDSshort_md.md)].  
