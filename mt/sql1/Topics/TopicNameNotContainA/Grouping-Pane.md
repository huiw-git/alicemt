...
![ssrs_fyi_note](../../Topics/TopicNameNotContainA/media/ssrs_fyi_note.png) To toggle **Advanced mode**, right-click the down arrow at the side of the Column Groups pane, and then click **Advanced Mode**.  
