...
|**OutputFormat**|One of the [!INCLUDE[ndptecgdiexpanded](../../Topics/TopicNameNotContainA/tokens/ndptecgdiexpanded_md.md)] ([!INCLUDE[ndptecgdi](../../Topics/TopicNameNotContainA/tokens/ndptecgdi_md.md)]) supported output formats: **BMP**, **EMF**, **GIF**, **JPEG**, **PNG**, or **TIFF**.|  
