...
|Enable or disable support for non-[!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Subscribers.|**sp_changepublication**|**is_enabled_for_het_sub**|New snapshot.|  
...
|Enable or disable [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] [!INCLUDE[ssVersion2000](../../Topics/TopicNameContainA/tokens/ssVersion2000_md.md)] partition optimization.|**sp_changemergepublication**|**keep_partition_changes**|Reinitialize subscriptions.|  
