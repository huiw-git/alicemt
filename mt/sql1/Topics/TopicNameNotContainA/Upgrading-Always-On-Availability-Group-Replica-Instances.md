---
title: "Upgrading Always On Availability Group Replica Instances"
ms.custom: na
ms.date: 2016-05-17
...
## Rolling Upgrade Process  
 ...
 ![Availability Group Upgrade in HADR Scenario](../../Topics/TopicNameNotContainA/images/AlwaysOnUpgrade_AG_HADR.gif "AlwaysOnUpgrade_AG_HADR")  
...
## Availability Group with One Remote Secondary Replica  
 ...
 ![Availability Group Upgrade in DR Scenario](../../Topics/TopicNameNotContainA/images/AGUpgrade_AG_DR.gif "AGUpgrade_AG_DR")  
...
-   While upgrading or updating [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] on the primary site, change the availability mode back to asynchronous commit, then revert to synchronous commit when you are ready to fail over to the primary site again  
...
## Availability Group with Failover Cluster Instance Nodes  
 ...
 ![Availability Group Upgrade with FCIs](../../Topics/TopicNameNotContainA/images/AGUpgrade_AG_FCI_DR.gif "AGUpgrade_AG_FCI_DR")  
