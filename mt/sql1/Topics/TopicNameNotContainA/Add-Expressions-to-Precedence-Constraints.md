...
# Add Expressions to Precedence Constraints
 ...
 The expression must evaluate to **True** or **False** and it must be a valid [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] expression. The expression can use literals, system and custom variables, and the functions and operators that the [!INCLUDE[ssIS](../../Token/Other/ssIS_md.md)] expression grammar provides. For example, the expression `@Count == SQRT(144) + 10` uses the variable **Count**, the SQRT function , and the equal \(\=\=\) and add \(\+\) operators. For more information, see [Integration Services &#40;SSIS&#41; Expressions](../../Topics/TopicNameNotContainA/Integration-Services--SSIS--Expressions.md).  
 ...
 ![Precedence constraint between two tasks](../../Images/Image/ImageNotContaina/MW_DTS_03.gif "MW_DTS_03")  
 ...
 ![Expressions on precedence constraints](../../Images/Image/ImageNotContaina/MW_DTS_04.gif "MW_DTS_04")  
  
 You can add or modify an expression by using the **Precedence Constraint Editor** in [!INCLUDE[ssIS](../../Token/Other/ssIS_md.md)] Designer and the Properties window that [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)] provides. However, the Properties window does not provide verification of the expression syntax.  
