...
## Understanding the Structure of a Sequence Clustering Model  
 ...
 ![Structure of sequence clustering model](../../Images/Image/ImageNotContaina/ModelContent_SeqClust.gif "ModelContent_SeqClust")  
...
## Walkthrough of Structure  
 An example might help clarify how the information is stored, and how you can interpret it. For example, you can find the largest order, meaning the longest observed chain in the underlying [!INCLUDE[ssSampleDBDWobject](../../Token/Other/ssSampleDBDWobject_md.md)] data, by using the following query:  
