...
## Create a new control flow package part  
 ...
 ![Create a new control flow template](../../Topics/TopicNameNotContainA/media/Control-flow-templates-create-new.png "Control flow templates create new")  
 ...
 ![Control flow templates in toolbox](../../Topics/TopicNameNotContainA/media/Control-flow-templates-in-toolbox.png "Control flow templates in toolbox")  
...
## Design a control flow package part  
 ...
 ![Step 1 of control flow template design](../../Topics/TopicNameNotContainA/media/Control-flow-template-design-step-1.png "Control flow template design step 1")  
  
 ![Step 2 of control flow template design](../../Topics/TopicNameNotContainA/media/Control-flow-template-design-step-2.png "Control flow template design step 2")  
...
### Drag and drop a control flow package part  
 ...
 ![Add a control flow template to a package](../../Topics/TopicNameNotContainA/media/Control-flow-templates-add-to-package.png "Control flow templates add to package")  
  
 ![Package with multiple control flow templates](../../Topics/TopicNameNotContainA/media/Control-flow-templates-in-package.png "Control flow templates in package")  
...
-   If the package does not use parts, the designer deletes any previously created .dtsx.designer file for the package (that is, any .dtsx.designer file that has the same name as the package).  
 ...
 ![Solution Explorer with control flow templates](../../Topics/TopicNameNotContainA/media/Control-flow-templates-in-Solution-Explorer.png "Control flow templates in Solution Explorer")  
...
### Add a copy of an existing control flow package part or a reference to an existing part  
 ...
 ![Add a new control flow templates from the menu](../../Topics/TopicNameNotContainA/media/Control-flow-templates-add-from-menu.png "Control flow templates add from menu")  
  
 ![Add Copy of Existing Templates dialog box](../../Topics/TopicNameNotContainA/media/Control-flow-templates-Add-Copy-dialog.png "Control flow templates Add Copy dialog")  
...
### Properties tab  
 ...
 ![Properties tab of the Template Configuration dialog box](../../Topics/TopicNameNotContainA/media/Template-Configuration-Properties-tab.png "Template Configuration Properties tab")  
...
### Connection Managers tab  
 ...
 ![Connection Managers tab of the Template Configuration dialog box](../../Topics/TopicNameNotContainA/media/Template-Configuration-Connection-Managers-tab.png "Template Configuration Connection Managers tab")  
...
-   Finally all the content, which no longer includes part information, is saved back to the “.dtsx” package file. This is the file that the SSIS runtime runs.  
 ...
 ![Control flow templates files and flow](../../Topics/TopicNameNotContainA/media/Control-flow-templates-intro.png "Control flow templates intro")  
