...
# XML Task
 ...
 This task enables an [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] package to dynamically modify XML documents at run time. You can use the XML task for the following purposes:  
...
-   [Expressions Page](../../Topics/TopicNameNotContainA/Expressions-Page.md)  
 ...
 For more information about how to set properties in [!INCLUDE[ssIS](../../Topics/TopicNameContainA/tokens/ssIS_md.md)] Designer, click the following topic:  
