...
# Other Non-SQL Server Subscribers
  For a list of non\-[!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Subscribers supported by [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)], see [Non-SQL Server Subscribers](../../Topics/TopicNameNotContainA/Non-SQL-Server-Subscribers.md). This topic includes information about requirements for ODBC drivers and OLE DB providers.  
...
-   Must support long table names such as **MSreplication\_subscriptions**.  
...
-   **IDBProperties**  
 ...
 If the provider supports the **IDBInfo** interface, [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] uses the interface to retrieve information such as the quoted identifier character, maximum SQL statement length, and maximum number of characters in table and column names.  
 ...
 **IAccessor** is necessary to create parameter accessors. If the provider supports **IColumnRowset**, [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] uses that interface to determine whether a column is an identity column.  
