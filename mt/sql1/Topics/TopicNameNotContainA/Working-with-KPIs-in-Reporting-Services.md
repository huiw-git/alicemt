...
![rsCreateKPI1](../../Topics/TopicNameNotContainA/images/rsCreateKPI1.png)  
  
This will present you with the **New KPI** screen.  
  
![rsCreateKPI2](../../Topics/TopicNameNotContainA/images/rsCreateKPI2.png)  
...
1.  Change the fields drop down box from **Set manually**, or **Not set**, to **Dataset field**.  
    ...
    ![rsCreateKPI3](../../Topics/TopicNameNotContainA/images/rsCreateKPI3.png)  
  
2.  Select the **ellipse (…)** in the data box. This will bring up the **Pick a Dataset** screen.  
  
    ![rsCreateKPI4](../../Topics/TopicNameNotContainA/images/rsCreateKPI4.png)  
  
3.  Select the dataset that has the data you want to display.  
  
4.  Choose the field you want to use. Select **OK**.  
  
    ![rsCreateKPI5](../../Topics/TopicNameNotContainA/images/rsCreateKPI5.png)  
  
5.  Change **Value format** to match the format of your value. In this example, the value is a currency.  
  
    ![rsCreateKPI6](../../Topics/TopicNameNotContainA/images/rsCreateKPI6.png)  
  
6.  Select **Apply**.  
  
    ![rsCreateKPI7](../../Topics/TopicNameNotContainA/images/rsCreateKPI7.png)  
...
1.  Select the **ellipse (…)** of the KPI you want to remove. Select **Manage**.  
    ...
    ![rsRemoveKPI1](../../Topics/TopicNameNotContainA/images/rsRemoveKPI1.png)  
  
2.  Select **Delete**. Select **Delete** again on the confirmation dialog.  
  
    ![rsRemoveKPI2](../../Topics/TopicNameNotContainA/images/rsRemoveKPI2.png)  
...
5.  To create a new cache plan, select **New Cache Refresh Plan**.  
    ...
    ![rsRefreshKPI1](../../Topics/TopicNameNotContainA/images/rsRefreshKPI1.png)  
...
8.  The values for the KPI will update when the schedule for the cache refresh plan is run.  
    ...
    ![rsRefreshKPI2](../../Topics/TopicNameNotContainA/images/rsRefreshKPI2.png)  
