---
title: "Legend Properties Dialog Box, General (Report Builder and SSRS)"
ms.custom: na
ms.date: 08/09/2016
...
Use the **Legend** dialog box to define the appearance and layout of the legend in the chart. For more information, see [Formatting the Legend on a Chart (Report Builder and SSRS)](../../Topics/TopicNameContainA/Formatting-the-Legend-on-a-Chart--Report-Builder-and-SSRS-.md).  
