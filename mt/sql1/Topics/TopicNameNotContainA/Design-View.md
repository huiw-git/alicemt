...
---
# Design View
In [!INCLUDE[ssRSnoversion_md](../../Token/Other/ssRSnoversion_md.md)] Report Designer, use Design view to arrange report items in the report. Design view is sometimes called the design surface or layout view.  
  ![ssrs_ssdt_preview](../../Images/Image/ImageNotContaina/ssrs_ssdt_preview.png)
