...
## Thread Safety  
 Any public static \(**Shared** in [!INCLUDE[vbprvb](../../Token/Other/vbprvb_md.md)]\) members of this type are safe for multithreaded operations. Any instance members are not guaranteed to be thread\-safe.  
  
## Example  
 To run the following code, add your server name in place of each \<*servername*\>. Update the path to point to your installation location, if it is not the default. The following code example iterates through each property in the *MSReportServer\_ConfigurationSetting* class, printing the name of each property and its value to the console.  
 ...
 **Platform:** [!INCLUDE[ssRSWMIPlatform](../../Token/Other/ssRSWMIPlatform_md.md)]  
