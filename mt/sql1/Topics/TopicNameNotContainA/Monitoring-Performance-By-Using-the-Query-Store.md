...
The [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Query Store feature provides you with insight on query plan choice and performance. It simplifies performance troubleshooting by helping you quickly find performance differences caused by query plan changes. Query Store automatically captures a history of queries, plans, and runtime statistics, and retains these for your review. It separates data by time windows so you can see database usage patterns and understand when query plan changes happened on the server. You can configure query store using the [ALTER DATABASE SET](assetId:///f76fbd84-df59-4404-806b-8ecb4497c9cc) option.  
...
1.  In Object Explorer, right-click a database, and then click **Properties**.  
    ...
    > [!NOTE]  
    >  Requires at least [!INCLUDE[ssSQL15](../../Topics/TopicNameContainA/tokens/ssSQL15_md.md)] version of [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/tokens/ssManStudio_md.md)].  
...
1.  Use the **ALTER DATABASE** statement to enable the query store. For example:  
    ...
    ```  
     ...
     For more syntax options related to the query store, see [ALTER DATABASE SET Options (Transact-SQL)](assetId:///f76fbd84-df59-4404-806b-8ecb4497c9cc).  
...
##  <a name="Regressed"></a> Use the Regressed Queries Feature  
 ...
 ![Query store tree in Object Explorer](../../Topics/TopicNameNotContainA/images/ObjectExplorerQueryStore.PNG "ObjectExplorerQueryStore")  
  
 Select **Regressed Queries** to open the **Regressed Queries** pane in [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/tokens/ssManStudio_md.md)]. The Regressed Queries pane shows you the queries and plans in the query store. Use the drop down boxes at the top to select queries based on various criteria. Select a plan to see the graphical query plan. Buttons are available to view the source query, force, and unforce a query plan, and refresh the display.  
  
 ![Regressed queries in object explorer](../../Topics/TopicNameNotContainA/images/ObjectExplorerRegressedQueries.PNG "ObjectExplorerRegressedQueries")  
...
##  <a name="Options"></a> Configuration Options  
 ...
 Query the **sys.database_query_store_options** view to determine the current options of the query store. For more information about the values, see [sys.database_query_store_options (Transact-SQL)](assetId:///16b47d55-8019-41ff-ad34-1e0112178067).  
  
 For more information about setting options by using [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statements, see [Option Management](#OptionMgmt).  
  
 [Top](#Top)  
  
##  <a name="Related"></a> Related Views, Functions, and Procedures  
 View and manage Query Storethrough [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/tokens/ssManStudio_md.md)] or by using the following views and procedures.  
  
-   [sys.fn_stmt_sql_handle_from_sql_stmt (Transact-SQL)](assetId:///6794e073-0895-4507-aba3-c3545acc843f)  
  
### Query Store Catalog Views  
 Seven catalog views present information about the Query Store.  
  
-   [sys.database_query_store_options (Transact-SQL)](assetId:///16b47d55-8019-41ff-ad34-1e0112178067)  
  
-   [sys.query_context_settings (Transact-SQL)](assetId:///3c1887df-6bd8-491e-82fc-d25ad9589faf)  
  
-   [sys.query_store_plan (Transact-SQL)](assetId:///b4d05439-6360-45db-b1cd-794f4a64935e)  
  
-   [sys.query_store_query (Transact-SQL0](assetId:///bdee149e-7556-4fc3-8242-925dd4b7b6ac)  
  
-   [sys.query_store_query_text (Transact-SQL)](assetId:///f7032fa0-7c16-4492-bb82-685806c63a8c)  
  
-   [sys.query_store_runtime_stats (Transact-SQL)](assetId:///ccf7a57c-314b-450c-bd34-70749a02784a)  
  
-   [sys.query_store_runtime_stats_interval (Transact-SQL)](assetId:///2be83785-0569-41a3-88c8-59bfa0932e6e)  
  
### Query Store Stored Procedures  
 Six stored procedures configure the Query Store.  
  
-   [sp_query_store_flush_db (Transact-SQL)](assetId:///580c03ae-57fc-4562-a6bb-5ec89521e38c)  
  
-   [sp_query_store_reset_exec_stats (Transact-SQL)](assetId:///899df1ff-e871-44df-9361-f3b87ac3ea31)  
  
-   [sp_query_store_force_plan (Transact-SQL](assetId:///0068f258-b998-4e4e-b47b-e375157c8213)  
  
-   [sp_query_store_unforce_plan (Transact-SQL)](assetId:///a52f91d0-ff1e-46ad-ba36-b32d9623c9ab)  
  
-   [sp_query_store_remove_plan (Transct-SQL)](assetId:///88734726-135b-4b61-9f3f-f568c1fbece6)  
  
-   [sp_query_store_remove_query (Transact-SQL)](assetId:///cc39ca92-3cba-478e-beef-65560aa84007)  
 ...
 **Is Query Store currently active?**  
 ...
 Query [sys.database_query_store_options (Transact-SQL)](assetId:///16b47d55-8019-41ff-ad34-1e0112178067) to determine if Query Store is currently active, and whether it is currently collects runtime stats or not.  
...
###  <a name="Stability"></a> Maintaining Query Performance Stability  
 For queries executed multiple times you may notice that [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] uses different plans, resulting  in different resource utilization and duration. With Query Store you can detect when query performance regressed and determine the optimal plan within a period of interest. You can then force that optimal plan for future query execution.  
 ...
 **Remove plan forcing for a query.** To rely again on the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] query optimizer to calculate the optimal query plan, use **sp_query_store_unforce_plan** to unforce the plan that was selected for the query.  
