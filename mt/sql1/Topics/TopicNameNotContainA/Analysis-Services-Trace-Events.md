...
You can follow the activity of a Microsoft SQL Server Analysis Services (SSAS) instance by capturing and then analyzing the trace events generated by the instance.  Trace events are grouped so that you can more easily find related trace events.  Each trace event contains a set of data relevant to the event; not all pieces of data are relevant to all events.  
 ...
 Trace events can be started and captured using **[!INCLUDE[ssSqlProfiler](../../Topics/TopicNameContainA/tokens/ssSqlProfiler_md.md)]**, see [Use SQL Server Profiler to Monitor Analysis Services](../../Topics/TopicNameNotContainA/Use-SQL-Server-Profiler-to-Monitor-Analysis-Services.md), or can be started from an XMLA command as **SQL Server Extended Events** and later analyzed, see [Monitor Analysis Services with SQL Server Extended Events](../../Topics/TopicNameNotContainA/Monitor-Analysis-Services-with-SQL-Server-Extended-Events.md).  
  
 The following table lists all event categories for [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] with a brief description of the category. From each item in the list you can link to all events in that category and their descriptions; detailed information is available following the title link of each category.  
  
|Event Category|Description|  
|--------------------|-----------------|  
|[Command Events](#bkmk_CommandEvents)|Collection of events for commands.|  
|[Discover Events](#bkmk_DiscoverEvents)|Collection of events for discover requests.|  
|[Discover Server State Events](#bkmk_DiscoverServerStateEvents)|Collection of events for server state discovers.|  
|[Errors and Warnings](#bkmk_ErrorsAndWarnings)|Collection of events for server errors.|  
|[File Load and Save](#bkmk_FileLoadSave)|Collection of events for file load and save operations reporting.|  
|[Locks](#bkmk_Locks)|Collection of lock related events.|  
|[Notification Events](#bkmk_NotificationEvents)|Collection of notification events.|  
|[Progress Reports](#bkmk_ProgressReports)|Collection of events for progress reporting.|  
|[Queries Events](#bkmk_QueriesEvents)|Collection of events for queries.|  
|[Query Processing](#bkmk_QueryProcessing)|Collection of key events during the process of a query execution.|  
|[Security Audit](#bkmk_SecurityAudit)|Collection of database audit event classes.|  
|[Session Events](#bkmk_SessionEvents)|Collection of session events.|  
