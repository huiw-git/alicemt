...
# Change Tracking (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)], you can use change tracking groups to take action when an attribute value changes. Use change tracking when you don’t know what the new value will be, but instead want to know if any change occurred.  
