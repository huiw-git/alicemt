...
In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/tokens/ssMDSshort_md.md)], delete an attribute when you want to permanently delete the attribute and all associated attribute values.  
