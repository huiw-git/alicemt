...
# SQL Server, Database Mirroring Object
  The **SQLServer:Database Mirroring** performance object contains performance counters that report information about [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] database mirroring. The table below lists the counters that this object contains.  
