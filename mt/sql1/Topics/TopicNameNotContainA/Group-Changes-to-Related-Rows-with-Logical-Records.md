...
>  The logical records feature can be used alone or in conjunction with join filters. For more information about join filters, see [Join Filters](../../Topics/TopicNameNotContainA/Join-Filters.md). To use logical records, the compatibility level of the publication must be at least 90RTM.  
 ...
 ![Three table logical record, with column names only](../../Topics/TopicNameNotContainA/media/Logical_Records_01.gif "Logical_Records_01")  
 ...
 ![Three table logical record with values](../../Topics/TopicNameNotContainA/media/Logical_Records_02.gif "Logical_Records_02")  
...
### The Application of Changes As a Unit  
 ...
 ![Three table logical record with values](../../Topics/TopicNameNotContainA/media/Logical_Records_04.gif "Logical_Records_04")  
...
-   The publication must use native snapshot mode. This is the default unless you are replicating to [!INCLUDE[ssEW](../../Topics/TopicNameContainA/includes/ssEW_md.md)], which does not support logical records.  
...
-   Child tables can have only one parent table.  
     ...
     ![Child table with more than one parent table](../../Topics/TopicNameNotContainA/media/Logical_Records_03.gif "Logical_Records_03")  
