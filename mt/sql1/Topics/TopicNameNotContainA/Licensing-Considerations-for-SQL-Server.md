...
# Licensing Considerations for SQL Server
  For more information about [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] licensing options, see [this Microsoft SQL Server Web site](http://www.microsoft.com/en-us/sqlserver/sql-server-2014.aspx).  
