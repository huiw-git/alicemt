...
Displays or changes global configuration settings for PolyBase Hadoop and Azure blob storage connectivity.  
 ...
 ![Topic link icon](../../Topics/TopicNameNotContainA/images/Topic_Link.gif "Topic_Link") [Transact-SQL Syntax Conventions](assetId:///35fbcf7f-8b55-46cd-a957-9b8c7b311241)  
 ...
 **'hadoop connectivity'**  
 Specifies the type of Hadoop data source for all connections from PolyBase to Hadoop clusters or Azure blob storage (WASB). This setting is required in order to create an external data source for an external table. For more information, see [CREATE EXTERNAL DATA SOURCE (Transact-SQL)](assetId:///75d8a220-0f4d-4d91-8ba4-9d852b945509),  
...
## General Remarks  
 In [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)], after running RECONFIGURE, for the run value of the 'hadoop connectivity' to take effect, you need to restart [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)].  
In [!INCLUDE[ssPDW](../../Topics/TopicNameNotContainA/tokens/ssPDW_md.md)], after running RECONFIGURE, for the run value of the 'hadoop connectivity' to take effect, you need to restart the [!INCLUDE[ssPDW](../../Topics/TopicNameNotContainA/tokens/ssPDW_md.md)] region.  
