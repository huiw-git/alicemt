...
### Compression  
 [!INCLUDE[ssEnterpriseEd10](../../Token/Other/ssEnterpriseEd10_md.md)] \(or a later version\) supports [backup compression](../../Topics/TopicNameNotContainA/Backup-Compression--SQL-Server-.md).  
