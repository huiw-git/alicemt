...
-   [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)]: [Set Queued Updating Conflict Resolution Options \(SQL Server Management Studio\)](../../Topics/TopicNameNotContainA/Set-Queued-Updating-Conflict-Resolution-Options--SQL-Server-Management-Studio-.md)  
