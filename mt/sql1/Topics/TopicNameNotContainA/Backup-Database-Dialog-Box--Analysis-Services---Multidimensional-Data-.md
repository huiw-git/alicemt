...
Use the **Backup Database** dialog box in [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] to back up an [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] database to a backup file using the [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] Backup File (.abf) format.  
...
-   In [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)], right-click either the **Databases** folder of an [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] instance or a database in **Object Explorer**, and then click **Backup**.  
  
## Options  
 **Script**  
 Creates a backup script that is based on the options selected in the dialog box. The restore script is written in the [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] Scripting Language (ASSL).  
 ...
 **Database**  
 Displays the name of the currently selected [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] database.  
...
> [!NOTE]  
>  This option is enabled only if the currently selected [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] database uses remote partitions.  
...
|Column|Description|  
|------------|-----------------|  
|**Server**|Displays the [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] instance that manages the remote partitions.|  
|**Database**|Displays the [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] database that contains the remote partitions.|  
