...
You can gain information about the definition or properties of a user-defined function in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)]. You may need to see the definition of the function to understand how its data is derived from the source tables or to see the data defined by the function.  
...
4.  Right-click the function of which you want to view the properties and select **Properties**.  
     ...
     **Schema bound**  
     Indicates whether the function is schema-bound. Values are True and False. For information about schema-bound functions, see the SCHEMABINDING section of [CREATE FUNCTION (Transact-SQL)](assetId:///864b393f-225f-4895-8c8d-4db59ea60032).  
...
3.  Copy and paste one of the following examples into the query window and click **Execute**.  
 ...
 For more information, see [sys.sql_modules (Transact-SQL)](assetId:///23d3ccd2-f356-4d89-a2cd-bee381243f99) and [OBJECT_DEFINITION (Transact-SQL)](assetId:///2ac837c7-eca9-4d29-b06e-72e30450c68d).  
