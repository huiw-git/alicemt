...
[!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/tokens/ssMDSshort_md.md)] now supports the ability to save any pending changes to an entity as changesets. There are two usage scenarios for this feature.  
