 ...
 **Viewer**  
 Choose a viewer to explore the selected mining model. You can use the custom viewer for time series models, or the [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] Mining Content Viewer. You can also use plug\-in viewers if available.  
