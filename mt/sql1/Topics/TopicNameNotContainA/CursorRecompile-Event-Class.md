...
# CursorRecompile Event Class
  The **CursorRecompile** event class describes cursor recompile events that occur in application programming interface \(API\) cursors. Cursor recompile events occur when the [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] recompiles a Transact\-SQL cursor due to a schema change.  
