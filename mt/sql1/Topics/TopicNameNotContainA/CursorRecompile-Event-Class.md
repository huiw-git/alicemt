...
The **CursorRecompile** event class describes cursor recompile events that occur in application programming interface (API) cursors. Cursor recompile events occur when the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] recompiles a Transact-SQL cursor due to a schema change.  
