...
|DLLs for each type of enumerator that [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] supports|[!INCLUDE[ssInstallPathVar](../../Token/Other/ssInstallPathVar_md.md)]DTS\\ForEachEnumerators|Fixed path|  
