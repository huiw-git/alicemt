...
-   **Connection Timeout**: Type the time (in seconds) the program waits for the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] connection to be established before producing a timeout error. The default value is **15**.  
...
-   **Encrypt Connection**: Select **Encrypt Connection** to ensure that the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] connection that being established is encrypted to guarantee privacy.  
