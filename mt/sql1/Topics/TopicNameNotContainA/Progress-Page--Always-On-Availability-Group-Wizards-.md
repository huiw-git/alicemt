...
# Progress Page (Always On Availability Group Wizards)
  Use this dialog box to view the progress of a [!INCLUDE[ssHADR](../../Topics/TopicNameContainA/includes/ssHADR_md.md)] wizard that you are running in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/includes/ssCurrent_md.md)]. The progress bar indicates the relative progress of the steps that the wizard is performing.  
