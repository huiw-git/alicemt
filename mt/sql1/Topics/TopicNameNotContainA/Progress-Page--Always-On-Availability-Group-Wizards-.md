...
Use this dialog box to view the progress of a [!INCLUDE[ssHADR](../../Topics/TopicNameContainA/tokens/ssHADR_md.md)] wizard that you are running in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)]. The progress bar indicates the relative progress of the steps that the wizard is performing.  
