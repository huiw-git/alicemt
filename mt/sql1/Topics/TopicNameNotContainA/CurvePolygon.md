...
> [!IMPORTANT]  
>  For a detailed description and examples of spatial features introduced in [!INCLUDE[ssSQL11](../../Topics/TopicNameContainA/tokens/ssSQL11_md.md)], including the **CurvePolygon** subtype, download the white paper, [New Spatial Features in SQL Server 2012](http://go.microsoft.com/fwlink/?LinkId=226407).  
...
1.  Is an accepted **LineString**, **CircularString**, or **CompoundCurve** instance. For more information on accepted instances, see [LineString](../../Topics/TopicNameNotContainA/LineString.md), [CircularString](../../Topics/TopicNameNotContainA/CircularString.md), and [CompoundCurve](../../Topics/TopicNameNotContainA/CompoundCurve.md).  
...
```  
 ...
 CurvePolygon instances have the same validity rules as Polygon instances with the exception that CurvePolygon instances may accept the new circular arc segment types. For more examples of instances that are valid or not valid, see [Polygon](../../Topics/TopicNameNotContainA/Polygon.md).  
...
## See Also  
 ...
 [geometry Data Type Method Reference](assetId:///d88e632b-6b2f-4466-a15f-9fbef1a347a7)   
 [geography Data Type Method Reference](assetId:///028e6137-7128-4c74-90a7-f7bdd2d79f5e)   
