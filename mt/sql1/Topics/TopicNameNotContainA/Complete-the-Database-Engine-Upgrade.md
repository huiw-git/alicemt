...
After the upgrade to SQL Server 2016 is complete, there are a number of additional steps that you may need to take. These include the following:  
 ...
 After upgrading the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)], complete the following tasks:  
...
-   **Integration Services:**  
     ...
     Migrate Integration Services packages to [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] format. For more information, see [Upgrade Integration Services Packages](../../Topics/TopicNameNotContainA/Upgrade-Integration-Services-Packages.md).  
