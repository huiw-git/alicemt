...
## Overview  
 ...
 The following diagram illustrates this architecture.![Temporal In-Memory Architecture](../../Topics/TopicNameNotContainA/media/Temporal-In-Memory-Architecture.png "Temporal In-Memory Architecture")  
