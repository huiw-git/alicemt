...
# Data Mining Stored Procedures (Analysis Services - Data Mining)
 ...
 For more information about calling [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/includes/ssASnoversion_md.md)] stored procedures, see [Calling Stored Procedures](../Topic/Calling%20Stored%20Procedures.md).  
  
 For general information about the programmability of [!INCLUDE[ssASCurrent](../../Topics/TopicNameContainA/includes/ssASCurrent_md.md)], see [Data Mining Programming](../Topic/Data%20Mining%20Programming.md).  
