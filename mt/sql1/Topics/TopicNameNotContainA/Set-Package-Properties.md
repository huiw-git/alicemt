...
# Set Package Properties
  When you create a package in [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameContainA/tokens/ssBIDevStudioFull_md.md)] by using the graphical interface that [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] provides, you set the properties of the package object in the Properties window.  
...
|**OfflineMode**|Indicates whether the package is in offline mode. This property is read-only. The property is set at the project level. Normally, [!INCLUDE[ssIS](../../Topics/TopicNameContainA/tokens/ssIS_md.md)] Designer tries to connect to each data source used by your package to validate the metadata associated with sources and destinations. You can enable **Work Offline** from the **SSIS** menu, even before you open a package, to prevent these connection attempts and the resulting validation errors when the data sources are not available. You can also enable **Work Offline** to speed up operations in the designer, and disable it only when you want your package to be validated.|  
...
|**UpdateObjects**|Indicates whether the package is updated to use newer versions of the objects it contains, if newer versions are available. For example, if this property is set to **True**, a package that includes a Bulk Insert task is updated to use the newer version of the Bulk Insert task that [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] provides. The default value of this property is **False**.|  
