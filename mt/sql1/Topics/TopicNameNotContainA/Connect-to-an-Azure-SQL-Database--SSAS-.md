...
This page of the **Table Import Wizard** enables you to connect to a [!INCLUDE[ssSDSfull](../../Topics/TopicNameContainA/tokens/ssSDSfull_md.md)]. To access the wizard from the [!INCLUDE[ssBIDevStudio](../../Topics/TopicNameContainA/tokens/ssBIDevStudio_md.md)], on the **Model** menu, click **Import from Data Source**.  
...
>  If you are connecting to an Azure DataMarket dataset, see [Connect to a Report or Data Feed (SSAS)](../../Topics/TopicNameContainA/Connect-to-a-Report-or-Data-Feed--SSAS-.md).  
 ...
 The [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/tokens/ssSDS_md.md)] is a hosted, relational database that you connect to by using SQL Server Authentication. For more information about [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/tokens/ssSDS_md.md)], see the web site [SQL Database](http://go.microsoft.com/fwlink/?LinkID=157856). To connect to a data source, you must have the appropriate provider installed on your computer.  
