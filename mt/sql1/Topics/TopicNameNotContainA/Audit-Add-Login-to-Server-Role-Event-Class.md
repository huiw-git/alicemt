...
# Audit Add Login to Server Role Event Class
  The **Audit Add Login to Server Role** event class occurs whenever a login is added or removed from a fixed server role. This event class is used for the **sp\_addsrvrolemember** and **sp\_dropsrvrolemember** stored procedures.  
