...
Use the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor to create and run scripts containing [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statements. The editor also supports running scripts that contain **sqlcmd** commands.  
  
## Transact-SQL F1 Help  
 The [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor supports linking you to the reference topic for a specific [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statement when you select F1. To do so, highlight the name of a Transact-SQL statement and then select F1. The help search engine will then search for a topic that has an F1 help attribute that matches the string you highlighted.  
...
## Working With the Database Engine Query Editor  
 The [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor is one of four editors implemented in [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)]. For a description of the functionality implemented in the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor and the main tasks you can perform using the editor, see [Query and Text Editors (SQL Server Management Studio)](../../Topics/TopicNameNotContainA/Query-and-Text-Editors--SQL-Server-Management-Studio-.md).  
  
## SQL Editor Toolbar  
 When the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor is open, the SQL Editor toolbar appears with the following buttons.  
 ...
 **Debug**  
 Enables the [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] debugger. This debugger supports debugging actions such as setting breakpoints, watching variables, and stepping through code.  
 ...
 **IntelliSense Enabled**  
 Specifies whether IntelliSense functionality is available in the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor.  
 ...
 **Specify Values for Template Parameters**  
 ...
 You can also add the SQL Editor toolbar by selecting the **View** menu, selecting **Toolbars**, and then selecting **SQL Editor**. If you add the SQL Editor toolbar when no [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor windows are open, all the buttons are unavailable.  
  
## SQL Editor Toolbar  
 When a [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor window is open, you can add the Debug toolbar by selecting the **View** menu, selecting **Toolbars**, and then selecting **Debug**. If you add the Debug toolbar when no [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor windows are open, all the buttons are unavailable.  
  
 **Continue**  
 Runs the code in the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor window until a breakpoint is encountered.  
  
 **Break All**  
 Sets the debugger to break all processes to which the debugger is attached when a break occurs.  
  
 **Stop Debugging**  
 Takes the selected [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor window out of debug mode, and restores the standard execution mode.  
