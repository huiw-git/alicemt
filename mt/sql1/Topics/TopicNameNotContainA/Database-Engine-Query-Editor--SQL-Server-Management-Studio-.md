...
## Working With the Database Engine Query Editor  
 The [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] Query Editor is one of four editors implemented in [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)]. For a description of the functionality implemented in the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)] Query Editor and the main tasks you can perform using the editor, see [Query and Text Editors &#40;SQL Server Management Studio&#41;](../../Topics/TopicNameNotContainA/Query-and-Text-Editors--SQL-Server-Management-Studio-.md).  
