...
# Configure IntelliSense (SQL Server Management Studio)
  Most [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)] IntelliSense options are on by default. You can turn off an IntelliSense option and instead invoke it through a menu command or keystroke combination.  
