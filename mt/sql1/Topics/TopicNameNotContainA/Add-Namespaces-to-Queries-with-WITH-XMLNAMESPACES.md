...
[WITH XMLNAMESPACES (Transact-SQL)](assetId:///3b32662b-566f-454d-b7ca-e247002a9a0b) provides namespace URI support in the following way:  
  
-   It makes the namespace prefix to URI mapping available when [Constructing XML Using FOR XML](../../Topics/TopicNameNotContainA/FOR-XML--SQL-Server-.md) queries.  
  
-   It makes the namespace to URI mapping available to the static namespace context of the [xml Data Type Methods](assetId:///d112b9c9-be9f-435c-a9e6-d21b65778fb7).  
...
```  
 ...
 This is the result. SQLXML users are familiar with this XML template. For more information, see [Constructing XML Using FOR XML](assetId:///5a11cda2-b8a3-4453-848f-641afdaa7024).  
...
## Using WITH XMLNAMESPACES with the xml Data Type Methods  
 The [xml Data Type Methods](assetId:///d112b9c9-be9f-435c-a9e6-d21b65778fb7) specified in a SELECT query, or in UPDATE when it is the **modify()** method, all have to repeat the namespace declaration in their prolog. This can be time-consuming. For example, the following query retrieves product model IDs whose catalog descriptions do include specification. That is, the <`Specifications`> element exists.  
...
## See Also  
 ...
 [XQuery Against the XML Data Type](assetId:///8a69344f-2990-4357-8160-cb26aac95b91)   
 [WITH XMLNAMESPACES (Transact-SQL)](assetId:///3b32662b-566f-454d-b7ca-e247002a9a0b)   
