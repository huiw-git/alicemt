...
# Generate Scripts (SQL Server Management Studio)
  [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)] provides two mechanisms for generating [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] scripts. You can create scripts for multiple objects by using the **Generate and Publish Scripts Wizard.**. You can also generate a script for individual objects or multiple objects by using the **Script as** menu in **Object Explorer**.  
