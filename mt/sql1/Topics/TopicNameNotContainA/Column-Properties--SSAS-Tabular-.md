 ...
 **Reporting Properties**  
 ...
 For detailed information on setting [!INCLUDE[ssCrescent](../../Topics/TopicNameContainA/tokens/ssCrescent_md.md)] table behavior properties, see [Configure Table Behavior Properties for Power View Reports (SSAS Tabular)](../../Topics/TopicNameNotContainA/Configure-Table-Behavior-Properties-for-Power-View-Reports--SSAS-Tabular-.md).  
