...
1.  Use the [sys.fulltext_languages](assetId:///2ed6b53d-1cf2-4763-9d58-36ea24a610ef) catalog view, as follows:  
...
1.  Use the [sp_help_fulltext_system_components](assetId:///ac1fc7a0-7f46-4a12-8c5c-8d378226a8ce) system stored procedure, as follows:  
...
1.  Use the [sp_fulltext_service](assetId:///17a91433-f9b6-4a40-88c4-8c704ec2de9f) system stored procedure to update the list of languages, as follows:  
...
2.  Copy the new DLL file into the directory containing the standard [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] DLL files for the server instance. The default location is:  
