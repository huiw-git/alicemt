...
|Symbolic Name||  
|Message Text|Database '%ls' was restored; however, an error was encountered while replication was being restored\/removed. The database has been left offline. See the topic MSSQL\_ENG003165 in SQL Server Books Online.|  
