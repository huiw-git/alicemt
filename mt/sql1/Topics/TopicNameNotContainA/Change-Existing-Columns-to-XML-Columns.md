...
> [!NOTE]  
>  The script will run against [!INCLUDE[ssSampleDBobject](../../Token/Other/ssSampleDBobject_md.md)] database, because the XML schema collection, `Production.ProductDescriptionSchemaCollection`, is created as part of the [!INCLUDE[ssSampleDBobject](../../Token/Other/ssSampleDBobject_md.md)] database.  
