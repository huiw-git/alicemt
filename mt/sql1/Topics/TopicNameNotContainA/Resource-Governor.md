...
-   Resource management is limited to the [!INCLUDE[ssDEnoversion](../../Topics/TopicNameContainA/includes/ssDEnoversion_md.md)]. Resource Governor can not be used for [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/includes/ssASnoversion_md.md)], [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/includes/ssISnoversion_md.md)], and [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)].  
...
-   The resource pool provides and limits the resources required by the application, for example, Application 3.  
 ...
 ![Resource Governor Functional Components](../../Topics/TopicNameNotContainA/media/rg_basic_funct_components.gif "rg_basic_funct_components")  
