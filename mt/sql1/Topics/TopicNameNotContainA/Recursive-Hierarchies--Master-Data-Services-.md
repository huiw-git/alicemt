...
# Recursive Hierarchies (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)], a recursive hierarchy is a derived hierarchy that includes a recursive relationship. A recursive relationship exists when an entity has a domain\-based attribute based on the entity itself.  
  
## Recursive Hierarchy Example  
 A typical recursive hierarchy example is an organizational structure. In [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)], you would do this by creating an Employee entity with a domain\-based attribute called Manager. The Manager attribute is populated from the list of employees. In this sample organization, all employees can be managers.  
  
 ![mds_conc_recursive_table_w_data](../../Images/Image/ImageNotContaina/mds_conc_recursive_table_w_data.gif "mds_conc_recursive_table_w_data")  
 ...
 ![mds_conc_recursive_UI_structure](../../Images/Image/ImageNotContaina/mds_conc_recursive_UI_structure.gif "mds_conc_recursive_UI_structure")  
 ...
 ![mds_conc_recursive_UI_example_anchored](../../Images/Image/ImageNotContaina/mds_conc_recursive_UI_example_anchored.gif "mds_conc_recursive_UI_example_anchored")  
 ...
 ![mds_conc_recursive_UI_example_nonanchored](../../Images/Image/ImageNotContaina/mds_conc_recursive_UI_example_nonanchored.gif "mds_conc_recursive_UI_example_nonanchored")  
