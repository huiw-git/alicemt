...
# Lift Chart (Analysis Services - Data Mining)
 ...
 In [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] Data Mining, the lift chart can compare the accuracy of multiple models that have the same predictable attribute. You can also assess the accuracy of prediction either for a single outcome (a single value of the predictable attribute), or for all outcomes (all values of the specified attribute).  
...
### Lift Chart with Target Value  
 ...
 ![lift chart showing two models](../../Topics/TopicNameNotContainA/media/NewLiftChart_TM30_30.gif "NewLiftChart_TM30_30")  
...
### Lift Chart for Model with No Target Value  
 ...
 ![Lift chart showing correct predictions](../../Topics/TopicNameNotContainA/media/Lift1.gif "Lift1")  
