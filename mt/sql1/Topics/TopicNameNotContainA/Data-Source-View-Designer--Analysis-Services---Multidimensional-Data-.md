...
A data source view (DSV) is a logical view of an external relational data source used to create cubes and dimensions in a multidimensional model.  
 ...
 After a DSV is generated, you can use the **Data Source View Designer** in [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameContainA/tokens/ssBIDevStudioFull_md.md)] to work directly on the DSV, which can be useful if the underlying data source is missing data elements needed in a multidimensional model.  
...
-   Right-click a data source view in **Solution Explorer** and select **Open** or **View Designer**.  
 ...
 ![Data Source View Designer](../../Topics/TopicNameNotContainA/images/SSAS_DSVDesigner.PNG "SSAS_DSVDesigner")  
