...
-   [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] does not support generating keyset-driven or static [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] cursors asynchronously. [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] cursor operations such as OPEN or FETCH are batched, so there is no need for the asynchronous generation of [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] cursors. [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] continues to support asynchronous keyset-driven or static application programming interface (API) server cursors where low latency OPEN is a concern, due to client round trips for each cursor operation.  
...
3.  Copy and paste the following example into the query window and click **Execute**. This example shows how to use [sp_configure](assetId:///d18b251d-b37a-4f5f-b50c-502d689594c8) to set the `cursor threshold` option to `0` so that cursor keysets are generated asynchronously.  
...
## See Also  
 [@@CURSOR_ROWS (Transact-SQL)](assetId:///31bd7a97-7f28-42a8-ba24-24d16d22973d)   
