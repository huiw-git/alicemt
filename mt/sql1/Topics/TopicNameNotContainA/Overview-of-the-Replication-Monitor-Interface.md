...
-   **Subscription Watch List** tab  
    ...
    -   Is my replication system healthy?  
     ...
     This tab is not available for Distributors that are running versions of [!INCLUDE[ssKatmai](../../Token/Other/ssKatmai_md.md)] or earlier.  
...
-   **Subscription Watch List** tab  
    ...
    -   Is my replication system healthy?  
     ...
     This tab is not displayed for Distributors running versions prior to [!INCLUDE[ssVersion2005](../../Token/Other/ssVersion2005_md.md)].  
...
-   **Tracer Tokens** tab \(transactional replication only\)  
    ...
    -   How long will it take a transaction committed now to reach a Subscriber in transactional replication?  
     ...
     This tab is not displayed for Distributors running [!INCLUDE[ssKatmai](../../Token/Other/ssKatmai_md.md)] or earlier. For more information on tracer tokens, see [Measure Latency and Validate Connections for Transactional Replication](../../Topics/TopicNameNotContainA/Measure-Latency-and-Validate-Connections-for-Transactional-Replication.md).  
