...
This topic describes the common uses for [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] report parameters, the properties you can set, and much more. Report parameters enable you to control report data, connect related reports together, and vary report presentation. You can use report parameters in paginated reports you create in [!INCLUDE[ssRBnoversion](../../Topics/TopicNameContainA/tokens/ssRBnoversion_md.md)] and Report Designer,  and also in mobile reports you create in [!INCLUDE[SS_MobileReptPub_Long](../../Topics/TopicNameContainA/tokens/SS_MobileReptPub_Long_md.md)].  
  
||  
|-|  
|[!INCLUDE[applies](../../Topics/TopicNameContainA/tokens/applies_md.md)] [!INCLUDE[ssRBnoversion](../../Topics/TopicNameContainA/tokens/ssRBnoversion_md.md)] [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] SharePoint mode and Native mode|  
  
 To try adding a parameter to a report yourself, see [Tutorial: Add a Parameter to Your Report (Report Builder)](assetId:///eab34ec4-b3ad-4a76-95cc-07b2f75ee6d7).  
...
-   Filter data from a shared dataset in a [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] mobile report. See [Create mobile reports with SQL Server Mobile Report Publisher](../../Topics/TopicNameNotContainA/Create-mobile-reports-with-SQL-Server-Mobile-Report-Publisher.md) for more information.  
...
##  <a name="UserInterface"></a> Viewing a Report with Parameters  
 ...
 ![View report with parameters](../../Topics/TopicNameNotContainA/images/ssRB_RptParamViewRpt.png "ssRB_RptParamViewRpt")  
 ...
 **Dataset query or stored procedure with parameters**  
 ...
 ![Report Builder Parameter Dataset Properties](../../Topics/TopicNameNotContainA/images/ssRB_ParamDatasetProps.png "ssRB_ParamDatasetProps")  
