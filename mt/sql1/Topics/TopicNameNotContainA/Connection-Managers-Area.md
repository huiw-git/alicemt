...
Packages use connection managers to connect to data sources such as files, relational databases, and servers.  
 ...
 Use the **Connections Managers** area of [!INCLUDE[ssIS](../../Topics/TopicNameContainA/tokens/ssIS_md.md)] Designer to add, delete, modify, rename, and copy and paste the connection managers.  
