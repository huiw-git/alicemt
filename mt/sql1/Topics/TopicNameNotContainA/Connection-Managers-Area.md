...
# Connection Managers Area
 ...
 Use the **Connections Managers** area of [!INCLUDE[ssIS](../../Topics/TopicNameContainA/includes/ssIS_md.md)] Designer to add, delete, modify, rename, and copy and paste the connection managers.  
