...
# Audit Login Change Property Event Class
  The **Audit Login Change Property** event class occurs when you use the **sp\_defaultdb** stored procedure, the **sp\_defaultlanguage** stored procedure, or the ALTER LOGIN statement to modify a property of a login.  
