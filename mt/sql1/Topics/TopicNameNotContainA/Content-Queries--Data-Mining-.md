...
###  <a name="bkmk_DecTree"></a> Example 2: Content Query on a Decision Trees Model  
 ...
 In your prediction query, you add the prediction function [PredictNodeId (DMX)](assetId:///fb236645-ad7e-4c54-9c4c-1af47cad7ad5), to get the ID of the related node, as shown in the following example:  
...
## See Also  
 [SELECT statement](assetId:///61e97285-4a06-4434-9a40-38cde5af7c3f)   
