...
1.  Open [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] Internet Explorer 7.0 or later.  
...
|----------|-----------------|------------|  
|![Report icon](../../Topics/TopicNameContainA/images/hlp_16doc.gif "hlp_16doc")|Report|Click the report icon or name to open the report. The report opens in a separate window.|  
|![Model icon](../../Topics/TopicNameContainA/images/model_icon.gif "model_icon")|Report model|Click the report model icon to open model property pages.|  
|![Linked report icon](../../Topics/TopicNameContainA/images/hlp_16linked.gif "hlp_16linked")|Linked report|Click the report icon or name to open the linked report. The report opens in a separate window.|  
|![Folder icon](../../Topics/TopicNameNotContainA/images/hlp_16folder.gif "hlp_16folder")|Folder|Click the folder icon or name to open the folder.|  
|![Subscription icon](../../Topics/TopicNameNotContainA/images/hlp_16subscription.gif "hlp_16subscription")|Subscription|Click a subscription icon or description to edit a subscription.|  
|![Data&#45;driven subscription icon](../../Topics/TopicNameNotContainA/images/hlp_16subscriptiondd.gif "hlp_16subscriptiondd")|Data-driven subscription|Click a data-driven subscription icon or description to edit a subscription.|  
|![generic resource icon](../../Topics/TopicNameContainA/images/hlp_16file.gif "hlp_16file")|Resource|Click the resource icon or name to open the resource. The resource opens in a separate window.|  
|![Shared data source icon](../../Topics/TopicNameContainA/images/hlp_16datasource.png "hlp_16datasource")|Shared data source item|Click a shared data source icon to open the property pages, report list, and subscription list of the data source.|  
|![Property Page icon](../../Topics/TopicNameNotContainA/images/hlp_16prop.gif "hlp_16prop")|Property page|Click the property icon to access additional pages to set properties and security.|  
