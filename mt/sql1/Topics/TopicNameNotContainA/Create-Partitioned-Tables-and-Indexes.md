...
2.  In the **Database Properties –** *database\_name* dialog box, under **Select a page**, select **Filegroups**.  
...
9. Expand the **Tables** folder and create a table as you normally would. For more information, see [Create Tables &#40;Database Engine&#41;](../../Topics/TopicNameNotContainA/Create-Tables--Database-Engine-.md). Alternatively, you can specify an existing table in the next procedure.  
