...
# Relational Query Designer (SSAS)
  The relational query designer helps you create a query that specifies the data to retrieve from [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] and [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssSDSFull](../../Token/Other/ssSDSfull_md.md)] relational databases and [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssDWfull](../../Token/Other/ssDWfull_md.md)]. Use the graphical query designer to explore the metadata, interactively build the query, and view the results of your query.  Use the text\-based query designer to view the query that was built by the graphical query designer or to modify a query. You can also import an existing query from a file or report.  
...
#### Group and Aggregate  
 ...
 [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] uses [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] and [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssDWfull](../../Token/Other/ssDWfull_md.md)] uses [!INCLUDE[DWsql](../../Token/Other/DWsql_md.md)]. Both dialects of the SQL language support the clause, keyword, and aggregates that the query designer provides.  
...
#### Command Type StoredProcedure  
 ...
 ![Stored procedure in text-based query designer](../../Images/Image/ImageNotContaina/rs_relational_text_SP.gif "rs_relational_text_SP")  
