---
title: "Relational Query Designer (SSAS)"
ms.custom: na
ms.date: 08/09/2016
...
The relational query designer helps you create a query that specifies the data to retrieve from [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] and [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] [!INCLUDE[ssSDSfull](../../Topics/TopicNameContainA/tokens/ssSDSfull_md.md)] relational databases and [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] [!INCLUDE[ssDWfull](../../Topics/TopicNameNotContainA/tokens/ssDWfull_md.md)]. Use the graphical query designer to explore the metadata, interactively build the query, and view the results of your query.  Use the text-based query designer to view the query that was built by the graphical query designer or to modify a query. You can also import an existing query from a file or report.  
...
|![Run the query](../../Topics/TopicNameNotContainA/images/rsQDIcon_Run.gif "rsQDIcon_Run")|Run the query and display the result set in the Result pane.|  
...
#### Command Type StoredProcedure  
 ...
 ![Stored procedure in text&#45;based query designer](../../Topics/TopicNameNotContainA/images/rs_relational_text_SP.gif "rs_relational_text_SP")  
