...
2.  In the control flow, use an Execute SQL task or [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] expressions to calculate the endpoints.  
