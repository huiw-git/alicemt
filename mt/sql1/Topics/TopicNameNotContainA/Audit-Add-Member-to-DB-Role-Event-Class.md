...
# Audit Add Member to DB Role Event Class
  The **Audit Add Member to DB Role** event class occurs whenever a login is added to or removed from a database role. This event class is used with the **sp\_addrolemember**, **sp\_changegroup**, and **sp\_droprolemember** stored procedures.  
