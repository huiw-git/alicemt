...
-   Run agents continuously instead of on very frequent schedules.  
    ...
    -   [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)]: [Specify Synchronization Schedules](../../Topics/TopicNameNotContainA/Specify-Synchronization-Schedules.md)  
...
-   Use the **–SubscriptionStreams** parameter for the Distribution Agent.  
     ...
     A value for this agent parameter can be specified using the **@subscriptionstreams** of [sp_addsubscription (Transact-SQL)](assetId:///61ddf287-1fa0-4c1a-8657-ced50cebf0e0).  
