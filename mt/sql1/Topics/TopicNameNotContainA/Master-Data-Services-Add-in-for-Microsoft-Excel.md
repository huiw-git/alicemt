...
|----------------------|-----------|  
|Create a connection to a [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)] repository.|[Connect to an MDS Repository &#40;MDS Add-in for Excel&#41;](../../Topics/TopicNameNotContainA/Connect-to-an-MDS-Repository--MDS-Add-in-for-Excel-.md)|  
