...
To use your source data for [!INCLUDE[ssDQSnoversion](../../Topics/TopicNameContainA/tokens/ssDQSnoversion_md.md)] (DQS) operations, and export your processed data, you can do either of the following:  
