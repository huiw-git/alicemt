...
The [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] and [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Agent run on the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] Windows operating systems as services. For more information about services, see [Manage the Database Engine Services](../../Topics/TopicNameNotContainA/Manage-the-Database-Engine-Services.md).  
