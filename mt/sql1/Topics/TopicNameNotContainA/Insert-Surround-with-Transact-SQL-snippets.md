...
A surround-with snippet is a template you can use as a starting point when enclosing a set of [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statements in a BEGIN, IF, or WHILE block.  
...
## Inserting Surround-with Snippets  
 ...
 After inserting the snippet, you must change the replacement text to form a valid [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statement. For more information, see [Complete Transact-SQL Snippets](../../Topics/TopicNameNotContainA/Complete-Transact-SQL-Snippets.md).  
  
#### To insert a surround-with snippet  
  
1.  In the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] Query Editor window, select the set of statements to be included in the block.  
