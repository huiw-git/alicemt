...
##  <a name="bkmk_supportedstrings"></a> Connection string formats used in Analysis Services  
 This section lists all of the connection string formats supported by Analysis Services. With the exception of connections to [!INCLUDE[ssGemini](../../Token/Other/ssGemini_md.md)] databases, you can specify these connections strings in applications that connect to Analysis Services.  
 ...
 **Http\(s\) connections to [!INCLUDE[ssGemini](../../Token/Other/ssGemini_md.md)] workbooks \(.xlsx, .xlsb or .xlsm files\)**  
  
 `Data Source=<URL>`, where the URL is the SharePoint path to a [!INCLUDE[ssGemini](../../Token/Other/ssGemini_md.md)] workbook that has been published to a SharePoint library. For example, “Data Source\=http:\/\/localhost\/Shared Documents\/Sales.xlsx”.  
 ...
 **Embedded [!INCLUDE[ssGemini](../../Token/Other/ssGemini_md.md)] connections**  
  
 `Data Source=$Embedded$` where $embedded$ is a moniker that refers to an embedded [!INCLUDE[ssGemini](../../Token/Other/ssGemini_md.md)] data model inside the workbook. This connection string is created and managed internally. Do not modify it. Embedded connection strings are resolved by the [!INCLUDE[ssGemini](../../Token/Other/ssGemini_md.md)] for Excel add\-in on client workstations, or by [!INCLUDE[ssGemini](../../Token/Other/ssGemini_md.md)] for SharePoint instances in a SharePoint farm.  
...
##  <a name="bkmk_encrypt"></a> Encrypting Connection Strings  
 ...
 [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] encrypts and stores the connection strings it uses to connect to each of its data sources. If the connection to a data source requires a user name and password, you can have [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] store the name and password with the connection string, or prompt you for the name and password each time a connection to the data source is required. Having [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] prompt you for user information means that this information does not have to be stored and encrypted. However, if you store this information in the connection string, this information does need to be encrypted and secured.  
  
 To encrypt and secure the connection string information, [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] uses the Data Protection API.  
  
 [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] uses a separate encryption key to encrypt connection string information for each [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] database. [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] creates this key when you create a database, and encrypts connection string information based on the [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] startup account. When [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] starts, the encrypted key for each database is read, decrypted, and stored. [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] then uses the appropriate decrypted key to decrypt the data source connection string information when [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] needs to connect to a data source.  
