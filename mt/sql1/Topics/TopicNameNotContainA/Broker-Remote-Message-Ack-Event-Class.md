...
|**EventSubClass**|**nvarchar**|The type of event subclass, providing more information about each event class. This column can contain the following values:<br /><br /> **Message With Acknowledgement Sent**:<br />                    [!INCLUDE[ssSB](../../Topics/TopicNameContainA/tokens/ssSB_md.md)] sent an acknowledgement as part of a normal sequenced message.<br /><br /> **Acknowledgement Sent**:<br />                    [!INCLUDE[ssSB](../../Topics/TopicNameContainA/tokens/ssSB_md.md)] sent an acknowledgement outside a normal sequenced message.<br /><br /> **Message With Acknowledgement Received**:<br />                  [!INCLUDE[ssSB](../../Topics/TopicNameContainA/tokens/ssSB_md.md)] received an acknowledgement as part of a normal sequenced message.<br /><br /> **Acknowledgement Received**:<br />                  [!INCLUDE[ssSB](../../Topics/TopicNameContainA/tokens/ssSB_md.md)] received an acknowledgement outside a sequenced message.|21|Yes|  
...
|**SPID**|**int**|The server process ID assigned by [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] to the process that is associated with the client.|12|Yes|  
