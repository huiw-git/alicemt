...
Use the **QuickWatch** dialog box to quickly view the data type and value of one [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] expression, such as a variable or parameter, when you are debugging [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] code. To watch multiple expressions, you can also add the expression to a **Watch** window.  
...
1.  In the **Expression** list box, type or select the expression that you want. The following [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] expressions are supported:  
