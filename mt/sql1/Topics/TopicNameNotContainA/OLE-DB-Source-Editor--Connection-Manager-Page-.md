...
> [!NOTE]  
>  To load data from a data source that uses [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] Office Excel 2007, use an OLE DB source. You cannot use an Excel source to load data from an Excel 2007 data source. For more information, see [Configure OLE DB Connection Manager](../../Topics/TopicNameNotContainA/Configure-OLE-DB-Connection-Manager.md).  
>   
>  To load data from a data source that uses [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] Office Excel 2003 or earlier, use an Excel source. For more information, see [Excel Source Editor (Connection Manager Page)](../../Topics/TopicNameNotContainA/Excel-Source-Editor--Connection-Manager-Page-.md).  
...
1.  Add the OLE DB source to the [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] package, in [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameContainA/tokens/ssBIDevStudioFull_md.md)].  
