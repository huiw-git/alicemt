...
# Annotations (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)], annotations are comments that you enter to provide details about transactions.  
...
-   The **Explorer** functional area of the [!INCLUDE[ssMDSmdm](../../Token/Other/ssMDSmdm_md.md)] web application.  
  
-   The **Version Management** functional area of the [!INCLUDE[ssMDSmdm](../../Token/Other/ssMDSmdm_md.md)] web application.  
  
-   The MDS [!INCLUDE[ssMDSXLS](../../Token/Other/ssMDSXLS_md.md)].  
