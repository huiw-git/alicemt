...
---
# InstanceID Property (WMI MSReportServer_Instance)
  This object supports the [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] infrastructure and is not intended to be used directly from your code.  
