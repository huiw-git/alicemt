...
|----------|-------------------------|  
|Prepare [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] Instance.|`dbcreator` fixed-server role|  
