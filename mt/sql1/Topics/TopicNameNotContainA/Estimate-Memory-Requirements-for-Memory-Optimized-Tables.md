...
Whether you are creating a new memory\-optimized table or migrating an existing disk\-based table to an [!INCLUDE[hek_2](../../Token/Other/hek_2_md.md)] memory\-optimized table, it is important to have a reasonable estimate of each table’s memory needs so you can provision the server with sufficient memory. This section describes how to estimate the amount of memory that you need to hold data for a memory\-optimized table.  
...
Starting with [!INCLUDE[ssSQL15](../../Token/Other/ssSQL15_md.md)], any one database can persist up to **2 terabytes** of user data in all its memory-optimized tables combined. This refers only to tables declared with SCHEMA_AND_DATA, and does not include SCHEMA_ONLY tables.
...
For information on how hash indexes work in [!INCLUDE[hek_2](../../Token/Other/hek_2_md.md)] memory\-optimized tables, see [Hash Indexes](../../Topics/TopicNameNotContainA/Hash-Indexes.md).  
