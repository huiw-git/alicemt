 ...
 **Measure groups in the Power View Field List**  
 ...
 ![Field List in Power View](../../Images/Image/ImageNotContaina/DAXMD_PowerViewFieldList.gif "DAXMD_PowerViewFieldList")  
 ...
 **Measures and KPIs in a measure group**  
 ...
 ![Measure group in Power View Field List](../../Images/Image/ImageNotContaina/DAXMD_FieldList_Group.gif "DAXMD_FieldList_Group")  
 ...
 **Measure as variant**  
 ...
 ![Non-aggregatable hierarchy in Power View](../../Images/Image/ImageNotContaina/DAXMD_NonAggrAttrib.gif "DAXMD_NonAggrAttrib")  
 ...
 **Dimension, attributes and hierarchies in SQL Server Data Tools \(SSDT\) and Power View Field List**  
 ...
 ![Dimensions in SSDT and in Power View Field List](../../Images/Image/ImageNotContaina/DAXMD_SSDT_Dimensions.gif "DAXMD_SSDT_Dimensions")  
 ...
 **Dimension attribute geography types in SSDT and Power View Field List**  
 ...
 ![Dimension attribute geography types](../../Images/Image/ImageNotContaina/DAXMD_SSDT_Attribute_Geog_Types.gif "DAXMD_SSDT_Attribute_Geog_Types")  
 ...
 **Power View report with calculated members**  
 ...
 ![Calculated members in Power View](../../Images/Image/ImageNotContaina/DAXMD_CalcMembersInPowerView.gif "DAXMD_CalcMembersInPowerView")  
 ...
 **ImageURL dimension attribute type in SSDT**  
 ...
 ![Dimension attribute properties](../../Images/Image/ImageNotContaina/DAXMD_DimAttribute_properties.gif "DAXMD_DimAttribute_properties")  
 ...
 **Parent\-child hierarchies in Power View**  
 ...
 ![Parent-child hierarchies](../../Images/Image/ImageNotContaina/DAXMD_SSDT_Hierarchies.gif "DAXMD_SSDT_Hierarchies")  
 ...
 **Pinned Filters**  
 ...
 ![Pinned Filter](../../Images/Image/ImageNotContaina/DAXMD_PinnedFilterInPowerView.gif "DAXMD_PinnedFilterInPowerView")  
...
## CSDLBI Annotations  
 ...
 Multidimensional metadata is represented as a tabular model namespace in a CSDLBI document, or CSDL out, when a DISCOVER\_CSDL\_METADATA request is sent to the Analysis Services instance.  
  
 **Sample DISCOVER\_CSDL\_METADATA request**  
...
```  
 ...
 DISCOVER\_CSDL\_METADATA request has the following restrictions:  
  
|Name|Required|Description|  
|----------|--------------|-----------------|  
|CATALOG\_NAME|Yes|The catalog\\database name.|  
|PERSPECTIVE\_NAME|Yes, if the cube contains more than one perspective. Optional if there is only one cube or there is a default perspective.|The cube name or perspective name in the multidimensional database.|  
