 ...
 **Measure groups in the Power View Field List**  
 ...
 ![Field List in Power View](../../Topics/TopicNameNotContainA/images/DAXMD_PowerViewFieldList.gif "DAXMD_PowerViewFieldList")  
 ...
 **Measures and KPIs in a measure group**  
 ...
 ![Measure group in Power View Field List](../../Topics/TopicNameNotContainA/images/DAXMD_FieldList_Group.gif "DAXMD_FieldList_Group")  
 ...
 **Measure as variant**  
 ...
 ![Non&#45;aggregatable hierarchy in Power View](../../Topics/TopicNameNotContainA/images/DAXMD_NonAggrAttrib.gif "DAXMD_NonAggrAttrib")  
 ...
 **Dimension, attributes and hierarchies in SQL Server Data Tools (SSDT) and Power View Field List**  
 ...
 ![Dimensions in SSDT and in Power View Field List](../../Topics/TopicNameNotContainA/images/DAXMD_SSDT_Dimensions.gif "DAXMD_SSDT_Dimensions")  
 ...
 **Dimension attribute geography types in SSDT and Power View Field List**  
 ...
 ![Dimension attribute geography types](../../Topics/TopicNameNotContainA/images/DAXMD_SSDT_Attribute_Geog_Types.gif "DAXMD_SSDT_Attribute_Geog_Types")  
 ...
 **Power View report with calculated members**  
 ...
 ![Calculated members in Power View](../../Topics/TopicNameNotContainA/images/DAXMD_CalcMembersInPowerView.gif "DAXMD_CalcMembersInPowerView")  
 ...
 **ImageURL dimension attribute type in SSDT**  
 ...
 ![Dimension attribute properties](../../Topics/TopicNameNotContainA/images/DAXMD_DimAttribute_properties.gif "DAXMD_DimAttribute_properties")  
 ...
 **Parent-child hierarchies in Power View**  
 ...
 ![Parent&#45;child hierarchies](../../Topics/TopicNameNotContainA/images/DAXMD_SSDT_Hierarchies.gif "DAXMD_SSDT_Hierarchies")  
 ...
 **Pinned Filters**  
 ...
 ![Pinned Filter](../../Topics/TopicNameNotContainA/images/DAXMD_PinnedFilterInPowerView.gif "DAXMD_PinnedFilterInPowerView")  
...
|VERSION|Yes|CSDL version requested by client. Multidimensional features and constructs are supported in version 2.0.|  
 ...
 For more detailed information about CSDLBI annotations for tabular models, see [Extensions to CSDL Reference](assetId:///63b3e069-6ba5-474e-b769-47b7cc87b7dd) on MSDN, and [\[MS-CSDLBI\]: Conceptual Schema Definitions File Format with Business Intelligence Annotations](http://msdn.microsoft.com/library/jj161299\(SQL.105\).aspx).  
