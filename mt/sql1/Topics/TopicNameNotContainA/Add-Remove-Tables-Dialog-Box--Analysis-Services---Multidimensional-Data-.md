...
# Add/Remove Tables Dialog Box (Analysis Services - Multidimensional Data)
  Use the **Add/Remove Tables** dialog box in [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameContainA/includes/ssBIDevStudioFull_md.md)] to add or remove tables in a data source to or from a data source view. You can display the **Add/Remove Tables** dialog box by:  
