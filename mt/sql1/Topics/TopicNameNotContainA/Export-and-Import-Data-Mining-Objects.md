---
title: "Export and Import Data Mining Objects"
ms.custom: na
ms.date: 06/29/2016
...
In addition to the functionality provided in [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] for backing up, restoring, and migrating solutions, SQL Server Data Mining provides the ability to quickly transfer data mining structures and models between different servers by using Data Mining Extensions (DMX).  
 ...
 This section provides an overview of how to transfer data mining structures and models by using DMX statements. For details of the syntax, together with examples, see [EXPORT (DMX)](assetId:///97617071-e560-4080-81af-a80276fc0823) and [IMPORT (DMX)](assetId:///c053bc88-2daf-4ebb-81d7-5a330250536d).  
...
## Exporting Data Mining Structures  
 ...
 If the mining structure has been processed and the results have been cached, which is the default behavior, when you export the mining structure, the definition contains a summary of the data on which the structure is based. To remove this summary, you must clear the cache associated with the mining structure by performing a **Process Clear Structure** operation. For more information, see [Process a Mining Structure](../../Topics/TopicNameContainA/Process-a-Mining-Structure.md).  
