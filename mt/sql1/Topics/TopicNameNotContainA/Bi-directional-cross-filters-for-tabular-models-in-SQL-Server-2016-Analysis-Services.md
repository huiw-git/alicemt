...
# Bi-directional cross filters for tabular models in SQL Server 2016 Analysis Services
 ...
 ![SSAS-BIDI-1-Filteroption](../../Images/Image/ImageNotContaina/SSAS-BIDI-1-Filteroption.PNG "SSAS-BIDI-1-Filteroption")  
...
## Walkthrough an example  
 ...
 ![SSAS-BIDI-2-Model](../../Images/Image/ImageNotContaina/SSAS-BIDI-2-Model.PNG "SSAS-BIDI-2-Model")  
...
>  By default, during data import, table relationships are created for you in many\-to\-one configurations derived from the foreign key and primary key relationships between the fact table and related dimension tables.  
 ...
 ![ssas-bidi-3-defaultrelationships](../../Images/Image/ImageNotContaina/ssas-bidi-3-defaultrelationships.PNG "ssas-bidi-3-defaultrelationships")  
 ...
 ![ssas-bidi-4-excelSumSales](../../Images/Image/ImageNotContaina/ssas-bidi-4-excelSumSales.PNG "ssas-bidi-4-excelSumSales")  
 ...
 ![ssas-bidi-5-prodcount-nofilter](../../Images/Image/ImageNotContaina/ssas-bidi-5-prodcount-nofilter.png "ssas-bidi-5-prodcount-nofilter")  
 ...
 ![ssas-bidi-6-prodcount-withfilter](../../Images/Image/ImageNotContaina/ssas-bidi-6-prodcount-withfilter.png "ssas-bidi-6-prodcount-withfilter")  
...
5.  On table selection, ctrl\-select the following tables:  
    ...
    -   DimPromotion  
     ...
     ![ssas-bidi-7-ImportData](../../Images/Image/ImageNotContaina/ssas-bidi-7-ImportData.PNG "ssas-bidi-7-ImportData")  
