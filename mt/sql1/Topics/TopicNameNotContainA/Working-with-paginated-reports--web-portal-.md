...
2.  Select **Paginated Report**.  
    ...
    ![ssRSWebPortal-new-report](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-new-report.png)  
...
> [!NOTE] If you don’t see paginated reports in the folder, make sure you are viewing paginated reports. You can select **View** from the menu bar in the upper right of the web portal. Make sure **Paginated Reports** is checked.  
  
1.  Select the **ellipse (…)** for the dataset you want to manage.  
      
    ![ssRSWebPortal-manage-report1](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-manage-report1.png)  
  
2.  Select **Manage** which will take you to the edit screen.  
    
    ![ssRSWebPortal-manage-report2](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-manage-report2.png)  
...
![ssRSWebPortal-report-properties](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-report-properties.png)  
...
![ssRSWebPortal-report-parameters](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-report-parameters.png)  
   
## Data Source  
You can point to a shared data source, or enter connection information for a custom data source.  
  
![ssRSWebPortal-report-datasource](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-report-datasource.png)  
...
To use this option, you must have previously configured the unattended execution account for your report server. The unattended execution account is used to connect to external data sources when other courses of credentials are not available. If you specify this option and the account is not configured, the connection to the report data source will fail and report processing will not occur. For more information about this account, see [Configure the Unattended Execution Account (SSRS Configuration Manager)](../../Topics/TopicNameNotContainA/Configure-the-Unattended-Execution-Account--SSRS-Configuration-Manager-.md).  
...
![ssRSWebPortal-report-subscription1](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-report-subscription1.png)  
...
![ssRSWebPortal-report-caching1](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-report-caching1.png)  
   
Selecting **Cache Copies of this report and use them when available** will present you with some more options.  
  
![ssRSWebPortal-report-caching2](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-report-caching2.png)  
...
> [!NOTE] This does not refresh the cache.  
...
![ssRSWebPortal-report-caching3](../../Topics/TopicNameNotContainA/images/ssRSWebPortal-report-caching3.png)  
