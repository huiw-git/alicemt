...
2.	Select **Paginated Report**.  
    ...
    ![ssRSWebPortal-new-report](../../Images/Image/ImageContaina/ssRSWebPortal-new-report.png)  
...
1.	Select the **ellipse (…)** for the dataset you want to manage.  
    ...
    ![ssRSWebPortal-manage-report1](../../Images/Image/ImageContaina/ssRSWebPortal-manage-report1.png)  
  
2.	Select **Manage** which will take you to the edit screen.  
    
    ![ssRSWebPortal-manage-report2](../../Images/Image/ImageContaina/ssRSWebPortal-manage-report2.png)  
...
![ssRSWebPortal-report-properties](../../Images/Image/ImageNotContaina/ssRSWebPortal-report-properties.png)  
...
![ssRSWebPortal-report-parameters](../../Images/Image/ImageNotContaina/ssRSWebPortal-report-parameters.png)  
   
## Data Source  
You can point to a shared data source, or enter connection information for a custom data source.  
  
![ssRSWebPortal-report-datasource](../../Images/Image/ImageNotContaina/ssRSWebPortal-report-datasource.png)  
...
![ssRSWebPortal-report-subscription1](../../Images/Image/ImageNotContaina/ssRSWebPortal-report-subscription1.png)  
...
![ssRSWebPortal-report-caching1](../../Images/Image/ImageNotContaina/ssRSWebPortal-report-caching1.png)  
   
Selecting **Cache Copies of this report and use them when available** will present you with some more options.  
  
![ssRSWebPortal-report-caching2](../../Images/Image/ImageNotContaina/ssRSWebPortal-report-caching2.png)  
...
![ssRSWebPortal-report-caching3](../../Images/Image/ImageNotContaina/ssRSWebPortal-report-caching3.png)  
