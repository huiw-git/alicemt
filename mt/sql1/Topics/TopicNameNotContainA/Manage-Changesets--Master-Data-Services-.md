---
title: Manage Changesets (Master Data Services)
ms.custom: 
  - SQL2016_New_Updated
...
# Manage Changesets (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/includes/ssMDSshort_md.md)] you can manage all changes by model and version.  
...
1.  In the [!INCLUDE[ssMDSmdm](../../Topics/TopicNameContainA/includes/ssMDSmdm_md.md)], select the model and version and then click **Explorer**.  
