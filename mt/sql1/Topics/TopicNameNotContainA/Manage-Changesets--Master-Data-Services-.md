...
# Manage Changesets (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)] you can manage all changes by model and version.  
...
1.  In the [!INCLUDE[ssMDSmdm](../../Token/Other/ssMDSmdm_md.md)], select the model and version and then click **Explorer**.  
