...
# Integration Services Deployment Wizard
 ...
 You can launch the Deployment Wizard by typing **SQL Server Deployment Wizard** in Windows Search menu bar or by searching for the executable file **ISDeploymentWizard.exe** under SQL Server installation folder such as “C:\Program Files (x86)\Microsoft SQL Server\130\DTS\Binn”. If you see the **Introduction** page, click **Next** to switch to the **Select Source** page. The settings on this page are different for each deployment model. Follow  steps in the [Project Deployment Model](../../Topics/TopicNameNotContainA/Integration-Services-Deployment-Wizard.md#ProjectModel) section or [Package Deployment Model](../../Topics/TopicNameNotContainA/Integration-Services-Deployment-Wizard.md#PackageModel) section based on the model you selected in this page.  
  
##  <a name="ProjectModel"></a> Project Deployment Model  
  
### Select Source  
 To deploy a project deployment file that you created, select **Project deployment file** and enter the path to the .ispac file. To deploy a project that resides in the [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/includes/ssISnoversion_md.md)] catalog, select **Integration Services catalog**, and then enter the server name and the path to the project in the catalog. Click **Next** to see the **Select Destination** page.  
  
### Select Destination  
 To select the destination folder for the project in the [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/includes/ssISnoversion_md.md)] catalog, enter the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] instance or click **Browse** to select from a list of servers. Enter the project path in SSISDB or click **Browse** to select it. Click **Next** to see the **Review** page.  
