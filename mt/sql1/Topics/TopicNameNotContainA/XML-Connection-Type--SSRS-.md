...
-   *An XML Query element*  
 ...
 For more information about query syntax, see [XML Query Syntax for XML Report Data (SSRS)](../../Topics/TopicNameNotContainA/XML-Query-Syntax-for-XML-Report-Data--SSRS-.md) in the [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] documentation in [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] [Books Online](http://go.microsoft.com/fwlink/?linkid=121312) on msdn.microsoft.com.  
...
### Requirements for Retrieving XML Document Data  
 ...
 For more information, see [Element Path Syntax for XML Report Data (SSRS)](../../Topics/TopicNameNotContainA/Element-Path-Syntax-for-XML-Report-Data--SSRS-.md) in the [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] documentation in [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] [Books Online](http://go.microsoft.com/fwlink/?linkid=121312) on msdn.microsoft.com.  
...
##  <a name="Remarks"></a> Remarks  
 ...
 There is no built-in support for retrieving XML documents from a [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] database.  
