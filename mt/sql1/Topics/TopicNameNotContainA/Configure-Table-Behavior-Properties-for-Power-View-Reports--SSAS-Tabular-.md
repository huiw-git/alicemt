...
> [!NOTE]  
>  Table behavior properties only affect tabular models used as data models in [!INCLUDE[ssCrescent](../../Token/Other/ssCrescent_md.md)]. Table behavior properties are not supported in Excel pivot reports.  
...
1.  In [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)], click the table \(tab\) for which you are configuring a default field list.  
...
## Setting the Row Identifier property  
 ...
 In [!INCLUDE[ssCrescent](../../Token/Other/ssCrescent_md.md)], setting a row identifier enables the following additional properties: **Keep Unique Rows** property, **Default Label** property, and **Default Image** property.  
  
 You can also use **Row Identifier** by itself, as a standalone property, to enable the following:  
  
-   Use of binary images in a report. By removing ambiguity around row uniqueness, [!INCLUDE[ssCrescent](../../Token/Other/ssCrescent_md.md)] can determine how to assign default images and default labels for a given row.  
...
### Tables are missing one or more rows  
 ...
 ![Default group consolidates 2 into 1](../../Images/Image/ImageNotContaina/SSAS_JonYang_NoRowID.gif "SSAS_JonYang_NoRowID")  
 ...
 ![Row data containing duplicates based on row ID](../../Images/Image/ImageNotContaina/SSAS_JonYang.gif "SSAS_JonYang")  
 ...
 **Before: Default grouping based on fields in matrix**  
 ...
 ![Matrix layout grouped on Row Identifier](../../Images/Image/ImageNotContaina/SSAS_RptProp_matrixRowID.gif "SSAS_RptProp_matrixRowID")  
 ...
 **Before: Default grouping based on fields in a chart**  
 ...
 ![Chart based on default grouping at field level](../../Images/Image/ImageNotContaina/SSAS_RptProp_chartfieldgroup.gif "SSAS_RptProp_chartfieldgroup")  
  
 **After: Grouping on row identifier \(row identifier becomes the axis\)**  
  
 ![Chart based on row ID grouping](../../Images/Image/ImageNotContaina/SSAS_Rptprop_chartRowId.gif "SSAS_Rptprop_chartRowId")  
