...
4.  View the rowgroups by using the sys.dm_db_column_store_row_group_physical_stats dynamic management view (DMV).  
    ...
    ```  
     ...
     ![OPEN rowgroups](../../Topics/TopicNameNotContainA/media/cci_openrowgroups.png "cci_openrowgroups")  
...
5.  Use ALTER INDEX REORGANIZE with the COMPRESS_ALL_ROW_GROUPS option to force all rowgroups to be compressed into the columnstore.  
    ...
    ```  
     ...
     ![TOMBSTONE and COMPRESSED rowgroups](../../Topics/TopicNameNotContainA/media/cci_tombstone_compressed_rowgroups.png "cci_tombstone_compressed_rowgroups")  
...
6.  For query performance, its much better to combine small rowgroups together.  ALTER INDEX REORGANIZE will combine COMPRESSED rowgroups together. Now that the delta rowgroups are compressed into the columnstore, run ALTER INDEX REORGANIZE again to combine the small COMPRESSED rowgroups. This time you don't need the COMPRESS_ALL_ROW_GROUPS option.  
    ...
    ```  
     ...
     ![Combined rowgroups](../../Topics/TopicNameNotContainA/media/cci_compressed_rowgroups.png "cci_compressed_rowgroups")  
...
### Rebuild Process  
 To rebuild a columnstore index, [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)]:  
...
2.  Re-compresses all data into the columnstore. Two copies of the columnstore index exist while the rebuild is taking place. When the rebuild is finished, [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] deletes the original columnstore index.  
