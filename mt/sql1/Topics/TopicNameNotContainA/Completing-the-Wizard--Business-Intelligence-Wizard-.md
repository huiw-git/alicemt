---
title: Completing the Wizard (Business Intelligence Wizard)
ms.custom: na
...
## Options  
 **Changes**  
 Displays changes that have been made to objects in the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/includes/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/includes/ssASnoversion_md.md)] project.  
