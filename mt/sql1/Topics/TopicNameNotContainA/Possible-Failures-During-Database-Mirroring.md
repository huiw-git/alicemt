...
-   Use the [ALTER DATABASE <database\> SET PARTNER TIMEOUT <integer\>](assetId:///15f8affd-8f39-4021-b092-0379fc6983da) statement.  
  
 **To view the current time-out value**  
  
-   Query **mirroring_connection_timeout** in [sys.database_mirroring](assetId:///480de2b0-2c16-497d-a6a3-bf7f52a7c9a0).  
