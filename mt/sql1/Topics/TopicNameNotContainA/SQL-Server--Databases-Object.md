...
|**Commit table entries**|The size of the in-memory portion of the commit table for the database. For more information, see [sys.dm_tran_commit_table (Transact-SQL)](assetId:///732d23c5-1f6c-4e96-bc85-8f29b520cf0e).|  
