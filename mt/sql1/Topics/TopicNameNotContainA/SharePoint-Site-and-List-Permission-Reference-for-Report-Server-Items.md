...
|Add and Customize Pages|Add, change, or delete HTML pages or Web Part pages, and edit the Web site using a [!INCLUDE[winSPServ](../../Token/Other/winSPServ_md.md)]\-compatible editor.|X|||Add or remove a Report Viewer Web Part.|  
