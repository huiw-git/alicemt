...
# Tables (Report Builder  and SSRS)
 In [!INCLUDE[ssRSnoversion_md](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)], you can use a table to display detail data or grouped data, or a combination of both in a paginated report.   
...
> [!NOTE]  
>  You can publish tables separately from a report as report parts. Read more about [Report Parts](../../Topics/TopicNameNotContainA/Report-Parts--Report-Builder-and-SSRS-.md).  
