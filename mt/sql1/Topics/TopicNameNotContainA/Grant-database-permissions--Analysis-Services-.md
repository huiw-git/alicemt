...
# Grant database permissions (Analysis Services)
 ...
 ![Create role dialog showing database permissions](../../Images/Image/ImageNotContaina/SSAS_PermsDBRole.png "SSAS_PermsDBRole")  
...
1.  In [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)], connect to the instance of [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)], open the **Databases** folder, select a database, and right\-click **Roles** | **New Role**.  
