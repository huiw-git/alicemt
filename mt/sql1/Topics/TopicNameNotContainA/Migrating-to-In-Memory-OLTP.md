---
title: Migrating to In-Memory OLTP
H1: na
ms.custom: 
  - SQL2016_New_Updated
...
# Migrating to In-Memory OLTP
  The articles in this section of the Table of Contents discusses how to migrate database objects to use In\-Memory OLTP \(Online Transaction Processing\).  
