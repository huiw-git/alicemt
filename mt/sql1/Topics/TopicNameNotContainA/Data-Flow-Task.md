...
## Multiple Flows  
 ...
 ![Data flows](../../Topics/TopicNameNotContainA/images/MW_DTS_09.gif "MW_DTS_09")  
  
## Log Entries  
 [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] provides a set of log events that are available to all tasks. [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] also provides custom log entries to many tasks. For more information, see [Integration Services (SSIS) Logging](../../Topics/TopicNameNotContainA/Integration-Services--SSIS--Logging.md) and [Custom Messages for Logging](../../Topics/TopicNameNotContainA/Custom-Messages-for-Logging.md). The Data Flow task includes the following custom log entries:  
...
-   [Adding the Data Flow Task Programmatically](assetId:///0ca03712-a82e-4aa7-949b-f869a8936ddf)  
