...
-   If you attempt to concatenate two numbers, the [!INCLUDE[ssGemini](../../Topics/TopicNameContainA/tokens/ssGemini_md.md)] add-in will present them as strings and then concatenate. The following expression returns "1234": = 12 & 34  
