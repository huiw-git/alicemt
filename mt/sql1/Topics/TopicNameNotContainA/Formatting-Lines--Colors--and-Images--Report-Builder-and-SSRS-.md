...
[!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] gives you the ability to format lines, colors, data regions, images, and other report items.  
