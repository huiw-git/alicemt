...
## Related Tasks  
 For instructions about how to add a source and a connection manager using the Source Assistant, see [Add a Source using Source Assistant](../../Topics/TopicNameContainA/Add-a-Source-using-Source-Assistant.md).  
