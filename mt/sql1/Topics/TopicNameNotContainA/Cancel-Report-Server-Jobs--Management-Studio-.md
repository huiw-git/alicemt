...
-   A system job is one that is initiated by the report server. System jobs include scheduled report processing.  
 ...
 To open this page, start [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)], connect to a report server, right\-click **Jobs**, and then click **Cancel All Jobs**. You can also open **Jobs**, right\-click a job that is running on the report server, and select **Cancel Job\(s\)**.  
