...
# Temporal Table Metadata Views and Functions
  [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] and [!INCLUDE[sqldbesa](../../Token/Other/sqldbesa_md.md)] include a number of metabase views and functions to enable administrators to retrieve information about temporal tables.  
