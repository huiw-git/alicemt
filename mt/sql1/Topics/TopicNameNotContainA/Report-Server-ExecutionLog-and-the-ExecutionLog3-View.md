...
-   [ExecutionLog3](#bkmk_executionlog3)  
  
-   [The AdditionalInfo field](#bkmk_additionalinfo)  
  
-   [ExecutionLog2](#bkmk_executionlog2)  
  
-   [ExecutionLog](#bkmk_executionlog)  
  
##  <a name="bkmk_sharepoint"></a> Configuration Settings for a SharePoint mode Report Server  
 You can turn report execution logging on or off from the system settings of a [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] service application.  
...
2.  Click the name of the [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] service application you want to configure.  
...
1.  From the **System Settings** page of your [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] services application, find the **User-defined** section.  
...
-   **ExternalImages**  
     ...
     Added in [!INCLUDE[ssSQL11](../../Topics/TopicNameContainA/tokens/ssSQL11_md.md)]  
