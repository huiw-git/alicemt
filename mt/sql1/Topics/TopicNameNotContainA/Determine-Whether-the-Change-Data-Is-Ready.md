...
## Understanding the Components of the Solution  
 The solution described in this topic uses 4 [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] components:  
...
1.  In [!INCLUDE[ssBIDevStudioFull](../../Token/Other/ssBIDevStudioFull_md.md)], in the **Variables** window, create the following variables:  
...
1.  On the **Control Flow** tab of the [!INCLUDE[ssIS](../../Token/Other/ssIS_md.md)] Designer, add a For Loop container to the control flow.  
...
6.  In the Main procedure, enter one of the following lines of code:  
    ...
    -   If you are programming in [!INCLUDE[vbprvb](../../Token/Other/vbprvb_md.md)], enter the following line of code:  
