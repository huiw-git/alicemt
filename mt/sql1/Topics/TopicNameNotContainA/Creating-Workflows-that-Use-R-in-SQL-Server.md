...
# Creating Workflows that Use R in SQL Server
 ...
 Using [!INCLUDE[rsql_productname](../../Token/Other/rsql_productname_md.md)] provides multiple advantages:  
...
-   Integration. [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] is the central point of operations for many other data management tasks and applications that consume enterprise. Using data already in the database ensures that data is consistent and up\-to\-date. Rather than process data in R, you can rely on enterprise data pipelines including [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] and Azure Data Factory. Reporting of results or analyses is easy via Power BI or [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)].  
...
##  <a name="bkmk_ssis"></a> Create Efficient Workflows that Span R and the Database  
 ...
 Because [!INCLUDE[rsql_productname](../../Token/Other/rsql_productname_md.md)] enables you to run complex operations in R via Transact\-SQL and stored procedures, you can integrate R\-specific tasks with existing ETL processes without minimal re\-development work. Rather than perform a chain of memory\-ntensive tasks in R, data preparation can be optimized using the most efficient tools, including [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] and [!INCLUDE[tsql](../../Token/Other/tsql_md.md)].  
  
 For example, you can combine R with [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] in scenarios such as these:  
  
-   Use [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] tasks to create necessary objects in the SQL database  
  
-   Use conditional branching to switch compute context for R jobs  
  
-   Run R jobs that generate their own data  
  
-   Use [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] to call an R script saved in a text variable  
...
-   Use R in the Execute SQL Task to generate data and save it into [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)]  
...
##  <a name="bkmk_ssrs"></a> Create Visualizations that Span R and Enterprise Reporting Tools  
 ...
 Using [!INCLUDE[rsql_productname](../../Token/Other/rsql_productname_md.md)], you can run complex operations in R via [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] stored procedures, which can easily be consumed by a variety of enterprise reporting tools, including [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] and Power BI.  
  
-   Visualize graphics objects returned from an R script   
    using [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)]  
...
## Samples and Resources  
 ...
 This CodePlex project provides the code to help you create a custom report item that renders the graphics output of  R as an image that can be used in [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] reports.  By using the custom report item, you can:  
  
-   Publish charts and plots created using the R Graphics Device to [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] dashboards  
  
-   Pass [!INCLUDE[ssRSnoversion](../../Token/Other/ssRSnoversion_md.md)] parameters to R plots  
