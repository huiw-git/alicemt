...
|ServerName|Contains the name of the [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] instance on which the command event occurred.|  
...
|ConnectionID|Contains the unique connection ID associated with the command event.|  
|TextData|Contains the text data associated with the command event.|  
|ServerName|Contains the name of the [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] instance on which the command event occurred.|  
