...
|ServerName|Contains the name of the [!INCLUDE[msCoName](../../Token/Other/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] instance on which the command event occurred.|  
...
|ConnectionID|Contains the unique connection ID associated with the command event.|  
|TextData|Contains the text data associated with the command event.|  
|ServerName|Contains the name of the [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] instance on which the command event occurred.|  
