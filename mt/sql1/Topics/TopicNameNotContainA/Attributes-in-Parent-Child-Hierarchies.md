...
# Attributes in Parent-Child Hierarchies
 ...
 The **MembersWithDataCaption** property of the parent attribute provides [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/includes/ssASnoversion_md.md)] with the naming template used to generate member names for data members.  
...
## Using Data Members  
 ...
 ![Gross sales volume dimension with three levels](../../Topics/TopicNameNotContainA/media/agdatamember1.gif "agdatamember1")  
