...
In [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)], a general assumption is usually made about the content of members in a dimension. Leaf members contain data derived directly from underlying data sources; nonleaf members contain data derived from aggregations performed on child members.  
 ...
 This setting does not override the normal aggregation behavior for nonleaf members; the data member is always included as a child member for the purposes of aggregation. However, a custom rollup formula can be used to override the normal aggregation behavior. The Multidimensional Expressions (MDX) [DataMember](assetId:///65bf21e8-1cb2-4ae8-bfbe-bb4d72589557) function gives you the ability to access the value of the associated data member regardless of the value of the **MembersWithData** property.  
  
 The **MembersWithDataCaption** property of the parent attribute provides [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] with the naming template used to generate member names for data members.  
...
## Using Data Members  
 ...
 ![Gross sales volume dimension with three levels](../../Topics/TopicNameNotContainA/images/agdatamember1.gif "agdatamember1")  
