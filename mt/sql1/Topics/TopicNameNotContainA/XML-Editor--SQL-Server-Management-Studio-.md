...
> [!NOTE]  
>  [!INCLUDE[msCoName](../../Topics/TopicNameContainA/tokens/msCoName_md.md)] IntelliSense options are not available on the toolbar. When in the XML Editor, to access the options, on the **Edit** menu, click **IntelliSense**.  
