...
## Creating backups  
**Note!** For partial or copy-only backups, you must use the [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)][BACKUP](../Topic/BACKUP%20\(Transact-SQL\).md) statement with the PARTIAL or COPY_ONLY option, respectively.  
