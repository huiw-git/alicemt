...
# Create a Derived Hierarchy (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)], create a derived hierarchy when you want a level\-based hierarchy that ensures that members exist at the correct level. Derived hierarchies are based on the domain\-based attribute relationships that exist in a model.  
