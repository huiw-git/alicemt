...
3.  Copy and paste the following example into the query window and click **Execute**.  
 ...
 For more information, see [CREATE USER &#40;Transact-SQL&#41;](../Topic/CREATE%20USER%20\(Transact-SQL\).md) which contains many more [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] examples.  
