...
# Set Up a SQL Server Database Alert (Windows)
 ...
 Alerts also can be defined using Microsoft [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] and [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Agent. For more information, see [Alerts](../Topic/Alerts.md).  
