...
|------------|-----------------|-----------------|  
|![rs&#95;IconMapLayerWizard](../../Topics/TopicNameContainA/images/rs_IconMapLayerWizard.gif "rs_IconMapLayerWizard")|Map Layer Wizard|To add a layer by using a wizard, click **New layer wizard**.|  
|![rs&#95;IconMapAddLayer](../../Topics/TopicNameContainA/images/rs_IconMapAddLayer.gif "rs_IconMapAddLayer")|Add Layer|To manually add a layer, click **Add Layer**, and then click the type of map layer to add.|  
|![rs&#95;IconMapPolygonLayer](../../Topics/TopicNameContainA/images/rs_IconMapPolygonLayer.gif "rs_IconMapPolygonLayer")|Polygon Layer|Add a map layer that displays areas or shapes that are based sets of polygon coordinates.|  
|![rs&#95;IconMapLineLayer](../../Topics/TopicNameContainA/images/rs_IconMapLineLayer.gif "rs_IconMapLineLayer")|Line Layer|Add a map layer that displays paths or routes that are based on sets of line coordinates.|  
|![rs&#95;IconMapPointLayer](../../Topics/TopicNameContainA/images/rs_IconMapPointLayer.gif "rs_IconMapPointLayer")|Point Layer|Add a map layer that displays locations that are based on sets of point coordinates.|  
|![rs&#95;IconMapTileLayer](../../Topics/TopicNameContainA/images/rs_IconMapTileLayer.gif "rs_IconMapTileLayer")|Tile Layer|Add a map layer that displays Bing Map tiles that correspond to the current map view area that is defined by the viewport.|  
...
-   Run the map layer wizard. This wizard enables you to change options for a layer that you created by using the map layer wizard. In the Map pane, right-click the layer, and on the toolbar, click the layer wizard button (![rs&#95;IconMapLayerWizard](../../Topics/TopicNameContainA/images/rs_IconMapLayerWizard.gif "rs_IconMapLayerWizard")).  
...
2.  ![Arrow icon used with Back to Top link](../../Topics/TopicNameContainA/images/UpArrow16x16.gif "UpArrow16x16") [Back to Top](#BackToTop)  
