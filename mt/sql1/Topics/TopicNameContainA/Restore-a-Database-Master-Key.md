...
This topic describes how to restore the database master key in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] by using [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)].  
...
4.  Copy and paste the following example into the query window and click **Execute**.  
 ...
 For more information, see [RESTORE MASTER KEY (Transact-SQL)](assetId:///70ceb951-31a2-4fc4-a0c1-e6c18eeb3ae7)