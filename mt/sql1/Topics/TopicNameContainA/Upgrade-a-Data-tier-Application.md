...
###  <a name="LimitationsRestrictions"></a> Limitations and Restrictions  
 DAC uprades can only be performed in [!INCLUDE[ssSDS](../../Token/Other/ssSDS_md.md)], or [!INCLUDE[ssVersion2005](../../Token/Other/ssVersion2005_md.md)] Service Pack 4 \(SP4\) or later.  
...
4.  Use **add\_DacActionStarted** and **add\_DacActionFinished** to subscribe to the DAC upgrade events.  
...
### Example \(PowerShell\)  
 The following example upgrades a DAC named MyApplication on a default instance of the [!INCLUDE[ssDE](../../Token/Other/ssDE_md.md)], using a new DAC version in a MyApplicationVNext.dacpac package.  
