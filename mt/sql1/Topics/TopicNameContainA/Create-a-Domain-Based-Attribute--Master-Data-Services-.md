...
In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/tokens/ssMDSshort_md.md)], create a domain-based attribute to populate an attribute's values with members from an entity.  
