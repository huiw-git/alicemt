...
7.  Optionally, click the **Advanced Replay Options**tab to specify the following options:  
    ...
    -   To control how [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)] manages processes during replay, configure **Health Monitor Options**.  
