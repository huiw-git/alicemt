...
# Manage (Open, Unlock, Rename, and Delete) a Data Quality Project
  This topic describes how to manage a data quality project by using [!INCLUDE[ssDQSClient](../../Topics/TopicNameContainA/includes/ssDQSClient_md.md)] such as open, unlock, rename, and delete a data quality project.  
