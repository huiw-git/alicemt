---
title: Implementing SQL_VARIANT in a Memory-Optimized Table
H1: na
ms.custom: na
...
# Implementing SQL_VARIANT in a Memory-Optimized Table
  Consider an example of a table with **SQL\_VARIANT** column:  
...
```  
 ...
 Now you can load data into \[T1\_HK\] from T1 by opening a cursor on T1:  
...
```  
 ...
 You can convert data back to **SQL\_VARIANT** as follows:  
