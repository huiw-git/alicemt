---
title: Assign a Reader and Writer Role to a Package
ms.custom: na
...
1.  In Object Explorer, locate the [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/includes/ssISnoversion_md.md)] connection.  
