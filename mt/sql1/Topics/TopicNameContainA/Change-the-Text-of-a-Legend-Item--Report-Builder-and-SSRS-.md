---
title: "Change the Text of a Legend Item (Report Builder and SSRS)"
ms.custom: na
ms.date: 06/29/2016
...
2.  Click **Legend** and in the **Custom legend text** box, type a keyword.  
 ...
 The following table provides examples of chart-specific keywords to use for the **Custom Legend Text** property. For more information about keywords, see [Formatting Data Points on a Chart (Report Builder and SSRS)](../../Topics/TopicNameContainA/Formatting-Data-Points-on-a-Chart--Report-Builder-and-SSRS-.md).  
