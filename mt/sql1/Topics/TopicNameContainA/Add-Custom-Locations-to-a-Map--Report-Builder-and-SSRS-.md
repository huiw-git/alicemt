...
# Add Custom Locations to a Map (Report Builder and SSRS)
  After you add a map to a [!INCLUDE[ssRSnoversion_md](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] paginated report, you can add your own point locations.  
