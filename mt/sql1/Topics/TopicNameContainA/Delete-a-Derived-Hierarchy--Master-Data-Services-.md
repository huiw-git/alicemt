---
title: Delete a Derived Hierarchy (Master Data Services)
ms.custom: na
...
# Delete a Derived Hierarchy (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/includes/ssMDSshort_md.md)], delete a derived hierarchy when you are sure you no longer need it.  
