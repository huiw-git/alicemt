---
title: "Create a Calculated Table (SSAS Tabular)"
ms.custom: 
  - SQL2016_New_Updated
ms.date: 08/09/2016
...
6.  Create relationships to other tables in the model. See [Create a Relationship Between Two Tables (SSAS Tabular)](../../Topics/TopicNameContainA/Create-a-Relationship-Between-Two-Tables--SSAS-Tabular-.md) if you need help with this step.  
...
## See Also  
 ...
 [Data Analysis Expressions (DAX) in Analysis Services](assetId:///abb336c9-3346-4cab-b91b-90f93f4575e5)   
