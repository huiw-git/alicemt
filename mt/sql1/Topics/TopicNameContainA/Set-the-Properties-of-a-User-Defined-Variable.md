...
To set the properties of a user-defined variable in [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)], you can use one of the following features:  
...
> [!NOTE]  
>  [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] also provides a set of system variables whose properties cannot be updated, with the exception of the **RaiseChangedEvent** property.  
...
4.  In [!INCLUDE[ssIS](../../Topics/TopicNameContainA/tokens/ssIS_md.md)] Designer, click the **Package Explorer** tab and expand the Package node.  
