...
# Set the Properties of a User-Defined Variable
  To set the properties of a user\-defined variable in [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)], you can use one of the following features:  
...
> [!NOTE]  
>  [!INCLUDE[ssISnoversion](../../Token/Other/ssISnoversion_md.md)] also provides a set of system variables whose properties cannot be updated, with the exception of the RaiseChangedEvent property.  
...
4.  In [!INCLUDE[ssIS](../../Token/Other/ssIS_md.md)] Designer, click the **Package Explorer** tab and expand the Package node.  
