...
# Save Trace Results to a Table (SQL Server Profiler)
  This topic describes how to save trace results to a database table by using [!INCLUDE[ssSqlProfiler](../../Token/Other/ssSqlProfiler_md.md)].  
...
3.  In the **Connect to server** dialog box, connect to the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] database that will contain the trace table.  
