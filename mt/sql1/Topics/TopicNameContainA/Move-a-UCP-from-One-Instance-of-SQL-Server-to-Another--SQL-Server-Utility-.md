...
6.  Enroll instances into the new UCP to make them managed by the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] Utility. For more information, see [Enroll an Instance of SQL Server &#40;SQL Server Utility&#41;](../../Topics/TopicNameNotContainA/Enroll-an-Instance-of-SQL-Server--SQL-Server-Utility-.md).  
