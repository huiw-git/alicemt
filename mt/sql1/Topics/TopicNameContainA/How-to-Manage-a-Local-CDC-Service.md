...
4.  You can carry out the following tasks when working with a CDC service.  
    ...
    -   **Delete the service**  
         ...
         **Note**: If the service is running when deleting the service, the service is stopped before being deleted.  
         ...
         For information about the data you must enter in the Connect to SQL Server dialog box, see [Manage an Oracle CDC Service](../../Topics/TopicNameNotContainA/Manage-an-Oracle-CDC-Service.md) and [Connection to SQL Server for Delete](../../Topics/TopicNameNotContainA/Connection-to-SQL-Server-for-Delete.md).  
