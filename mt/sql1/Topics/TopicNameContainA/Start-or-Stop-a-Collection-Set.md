...
This topic describes how to start or stop a collection set in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)].  
...
-   To obtain information about collection sets, query the [syscollector_collection_sets](assetId:///db0def92-f25b-45da-9709-eab972b33800) catalog view.  
...
3.  Copy and paste the following example into the query window and click **Execute**. This example uses [sp_syscollector_start_collection_set](assetId:///d8357180-f51e-4681-99f9-0596fe2d2b53) to start the collection set that has the ID of `1`.  
...
3.  Copy and paste the following example into the query window and click **Execute**. This example uses [sp_syscollector_stop_collection_set](assetId:///4668cfb7-462f-40d0-948c-8f740a792a4d) to stop the collection set that has the ID of `1`.  
...
## See Also  
 [Data Collector Views (Transact-SQL)](assetId:///a005e885-7813-4c7e-b332-b01d9e9d4054)   
