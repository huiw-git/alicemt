...
2.  In **Solution Explorer**, double-click the package to open it in [!INCLUDE[ssIS](../../Topics/TopicNameContainA/tokens/ssIS_md.md)] Designer, or right-click and select **View Designer**.  
