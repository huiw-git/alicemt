...
# Connect to a Registered Server (SQL Server Management Studio)
  This topic describes how to connect to a registered server in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)]. If the server is not running or cannot be found on the network, Registered Servers displays an error.  
