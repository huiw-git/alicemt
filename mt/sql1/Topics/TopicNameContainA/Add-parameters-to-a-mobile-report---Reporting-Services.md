...
You can create [!INCLUDE[ssRSnoversion_md](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] mobile report with parameters, so you and your report readers can filter your reports. A reports with parameters can also be the target of a [drillthrough from a source report](../../Topics/TopicNameContainA/Add-drillthrough-from-a-mobile-report-to-other-mobile-reports-or-URLs.md). 
...
2. Select the **Data** tab in the upper-left corner of [!INCLUDE[SS_MobileReptPub_Long](../../Topics/TopicNameContainA/tokens/SS_MobileReptPub_Long.md)].   
...
5. Navigate to the shared datasets on the server and select one that has parameters.  
   ...
   ![SSMRP_PforParam](../../Topics/TopicNameContainA/images/SSMRP_PforParam.png)  
  
6. Select the cog on the tab, then select **Param {}**.  
  
   ![SSMRP_ParamWheel](../../Topics/TopicNameContainA/images/SSMRP_ParamWheel.png)  
  
7. Select the report element that will pass values to the parameter.  
  
   ![SSMRP_SetParam](../../Topics/TopicNameContainA/images/SSMRP_SetParam.png)  
