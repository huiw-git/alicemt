...
---
# Shrink a Database
  This topic describes how to shrink a database by using Object in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Token/Other/tsql_md.md)].  
...
-   Consider the following information when you plan to shrink a database:  
    ...
    -   Unless you have a specific requirement, do not set the AUTO\_SHRINK database option to ON.  
