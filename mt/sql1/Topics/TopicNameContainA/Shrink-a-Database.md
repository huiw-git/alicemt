...
---
# Shrink a Database
This topic describes how to shrink a database by using Object in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/includes/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)].  
...
-   To view the current amount of free (unallocated) space in the database. For more information, see [Display Data and Log Space Information for a Database](../../Topics/TopicNameContainA/Display-Data-and-Log-Space-Information-for-a-Database.md)  
...
3.  Copy and paste the following example into the query window and click **Execute**. This example uses [DBCC SHRINKDATABASE](assetId:///fc976afd-1edb-4341-bf41-c4a42a69772b) to decreases the size of the data and log files in the `UserDB` database and to allow for `10` percent free space in the database.  
  
 [!CODE [DBCC#DBCC_SHRINKDB1](../CodeSnippet/SQL15/tsql/dbcc#dbcc_shrinkdb1)]  
...
## See Also  
 ...
 [DBCC](assetId:///c6da8c04-5b6b-459a-9f76-110c92ca8b29)   
 [DBCC SHRINKFILE](assetId:///e02b2318-bee9-4d84-a61f-2fddcf268c9f)   
