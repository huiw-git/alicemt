...
1.  In [!INCLUDE[ssSqlProfiler](../../Token/Other/ssSqlProfiler_md.md)], open the template for the trace filter that you want to modify. On the **File** menu, click **Templates**, and then choose **Edit Template**.  
