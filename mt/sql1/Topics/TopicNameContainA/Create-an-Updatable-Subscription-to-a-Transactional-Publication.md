...
# Create an Updatable Subscription to a Transactional Publication
  This feature has been removed from [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)]. It was last available in [!INCLUDE[ssKilimanjaro](../../Token/Other/ssKilimanjaro_md.md)]. We recommend that you use peer\-to\-peer transactional replication instead.  
