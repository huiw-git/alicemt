...
-   Save the dataset directly to the report server or SharePoint site.  
 ...
 Use Report Designer in [!INCLUDE[ssBIDevStudioFull](../../Topics/TopicNameContainA/tokens/ssBIDevStudioFull_md.md)] to do the following tasks:  
...
1.  Open Report Builder. The **New report or dataset pane** opens, as shown in the following figure:  
     ...
     ![rs&#95;NewSharedDataset](../../Topics/TopicNameContainA/images/rs_NewSharedDataset.gif "rs_NewSharedDataset")  
