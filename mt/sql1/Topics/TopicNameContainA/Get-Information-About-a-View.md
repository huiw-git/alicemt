...
You can gain information about a view’s definition or properties in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)]. You may need to see the definition of the view to understand how its data is derived from the source tables or to see the data defined by the view.  
...
2.  Right-click the view of which you want to view the properties and select **Properties**.  
     ...
     **Schema bound**  
     Indicates whether the view is schema-bound. Values are True and False. For information about schema-bound views, see the SCHEMABINDING portion of [CREATE VIEW (Transact-SQL)](assetId:///aecc2f73-2ab5-4db9-b1e6-2f9e3c601fb9).  
...
3.  Copy and paste one of the following examples into the query window and click **Execute**.  
 ...
 For more information, see [sys.sql_modules (Transact-SQL)](assetId:///23d3ccd2-f356-4d89-a2cd-bee381243f99), [OBJECT_DEFINITION (Transact-SQL)](assetId:///2ac837c7-eca9-4d29-b06e-72e30450c68d) and [sp_helptext (Transact-SQL)](assetId:///24135456-05f0-427c-884b-93cf38dd47a8).  
...
3.  Copy and paste the following example into the query window and click **Execute**.  
 ...
 For more information, see [sys.sql_expression_dependencies (Transact-SQL)](assetId:///78a218e4-bf99-4a6a-acbf-ff82425a5946) and [sys.objects (Transact-SQL)](assetId:///f8d6163a-2474-410c-a794-997639f31b3b).