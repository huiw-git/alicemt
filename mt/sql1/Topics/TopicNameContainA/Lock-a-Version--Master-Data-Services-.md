...
In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/tokens/ssMDSshort_md.md)], lock a version of a model to prevent changes to the model's members and their attributes.  
