...
This topic describes how to move an existing index from its current filegroup to a different filegroup in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)].  
...
-   You cannot move indexes created using a UNIQUE or PRIMARY KEY constraint using [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/tokens/ssManStudio_md.md)]. To move these indexes use the [CREATE INDEX](assetId:///d2297805-412b-47b5-aeeb-53388349a5b9) statement with the (DROP_EXISTING=ON) option in [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)].  
