...
Use either the **Database Mail Configuration Wizard** or [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] to create Database Mail public and private profiles.  
...
###  <a name="Prerequisites"></a> Prerequisites  
 Create one or more Database Mail accounts for the profile. For more information about creating Database Mail accounts, see [Create a Database Mail Account](../../Topics/TopicNameContainA/Create-a-Database-Mail-Account.md).  
...
-   In Object Explorer, connect to the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] instance you want to configure Database Mail on, and expand the server tree.  
...
-   Connect to the [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] instance.  
  
-   To create a new profile, run the system stored procedure [sysmail_add_profile_sp (Transact-SQL)](assetId:///a828e55c-633a-41cf-9769-a0698b446e6c) as follows:  
...
-   For each account, run the stored procedure [sysmail_add_profileaccount_sp (Transact-SQL)](assetId:///7cbf430f-1997-45ea-9707-0086184de744) as follows:  
...
-   For each database role or user that will send mail using this profile, grant access to the profile. To do this, run the stored procedure [sysmail_add_principalprofile_sp (Transact-SQL)](assetId:///b2a0b313-abb9-4c23-8511-db77ca8172b3) as follows:  
...
-   To grant public access, run the stored procedure [sysmail_add_principalprofile_sp (Transact-SQL)](assetId:///b2a0b313-abb9-4c23-8511-db77ca8172b3) as follows:  
