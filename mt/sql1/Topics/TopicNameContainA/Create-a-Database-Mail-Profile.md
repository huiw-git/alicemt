...
# Create a Database Mail Profile
  Use either the **Database Mail Configuration Wizard** or [!INCLUDE[tsql](../../Token/Other/tsql_md.md)] to create Database Mail public and private profiles.  
...
-   In Object Explorer, connect to the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] instance you want to configure Database Mail on, and expand the server tree.  
...
-   Connect to the [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] instance.  
