---
title: Create a Singleton Query in the Data Mining Designer
H1: na
ms.custom: na
...
# Create a Singleton Query in the Data Mining Designer
  A singleton query is useful if you want to create a prediction for a single case. For more information about singleton queries, see [Data Mining Queries](../../Topics/TopicNameNotContainA/Data-Mining-Queries.md).  
 ...
 The following code shows an example of a singleton query against the targeted mailing model, TM\_Decision\_Tree.  
...
2.  Click **Select Model** on the **Mining Model** table.  
     ...
     For example, to create the sample code shown at the start of this topic, select TM\_Decision\_Tree, and then click **OK**.  
