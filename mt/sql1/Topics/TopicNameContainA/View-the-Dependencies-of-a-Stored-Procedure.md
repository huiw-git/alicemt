...
This topic describes how to view stored procedure dependencies in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)].  
...
4.  Copy and paste the following examples into the query editor. The first example creates the `uspVendorAllInfo` procedure, which returns the names of all the vendors in the [!INCLUDE[ssSampleDBCoFull](../../Topics/TopicNameContainA/tokens/ssSampleDBCoFull_md.md)] database, the products they supply, their credit ratings, and their availability.  
...
## See Also  
 ...
 [sys.dm_sql_referencing_entities (Transact-SQL)](assetId:///c16f8f0a-483f-4feb-842e-da90426045ae)   
 [sys.dm_sql_referenced_entities (Transact-SQL)](assetId:///077111cb-b860-4d61-916f-bac5d532912f)   
