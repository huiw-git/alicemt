...
If the database mirroring endpoints use Windows Authentication,, you can use [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] to add or replace a witness. Adding a witness in [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/tokens/ssManStudio_md.md)] also changes the operating mode to high-safety mode with automatic failover.  
