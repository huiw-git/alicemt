...
# Create a SQL Server Database Alert
 ...
 For more information about using System Monitor to set up a [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] database alert, see [Set Up a SQL Server Database Alert &#40;Windows&#41;](../../Topics/TopicNameContainA/Set-Up-a-SQL-Server-Database-Alert--Windows-.md) .  
