...
-   Prior to [!INCLUDE[ssCurrentLong](../../Topics/TopicNameContainA/tokens/ssCurrentLong_md.md)], changing the schema of a temporal table required you to set **SYSTEM_VERSIONING = OFF**. However, beginning with  [!INCLUDE[ssCurrentLong](../../Topics/TopicNameContainA/tokens/ssCurrentLong_md.md)], you can now add, drop or alter temporal table columns without changing system-versioning state.  
