...
1.  In Data Mining Designer in [!INCLUDE[ssBIDevStudio](../../Topics/TopicNameContainA/includes/ssBIDevStudio_md.md)], select either the **Mining Structure** tab or the **Mining Models** tab.  
