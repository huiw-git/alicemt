...
-   The component editors that [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/includes/ssISnoversion_md.md)] provides. These editors include only the custom properties of each data flow component.  
...
4.  In the data flow designer, right-click the data flow component, and then click **Show Advanced Editor**.  
    ...
    > [!NOTE]  
    >  In [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/includes/ssNoVersion_md.md)], data flow components that support multiple inputs cannot use the **Advanced Editor**.  
...
5.  In the **Advanced Editor** dialog box, do any of the following steps:  
    ...
    -   To view a list of the available input columns and to update the names of output columns, click the **Input Columns** tab.  
        ...
        > [!NOTE]  
        >  The Input Columns tab is available only when working with transformations or destinations. For more information, see [Integration Services Transformations](../../Topics/TopicNameNotContainA/Integration-Services-Transformations.md).  
