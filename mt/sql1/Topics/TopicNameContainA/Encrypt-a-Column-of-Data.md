...
# Encrypt a Column of Data
  This topic describes how to encrypt a column of data by using symmetric encryption in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/includes/ssCurrent_md.md)] using [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)]. This is sometimes known as column-level encryption, or cell-level encryption.  
