...
In this tutorial, you'll use a wizard to create a pie chart in a [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/includes/ssRSnoversion_md.md)] paginated report in [!INCLUDE[ssRBnoversion](../../Topics/TopicNameContainA/includes/ssRBnoversion_md.md)]. Then you'll modify the pie chart a little, just to get an idea of what's possible. You can do this tutorial two different ways. Both methods have the same outcome—a pie chart like the one in this illustration:  
...
### Using a [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] query that contains data for this tutorial  
 ...
 The [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] query does require a few other prerequisites. For more information, see [Tutorials: Prerequisites (Report Builder)](assetId:///9b8346a6-f4f4-4ad3-bc98-8f2be342ef2d).  
...
18. To continue modifying your pie chart, go to [After You Run the Wizard](#AfterWizard) in this article.  
 ...
 ![Arrow icon used with Back to Top link](../../Topics/TopicNameContainA/media/UpArrow16x16.gif "UpArrow16x16") [Back to Top](#TwoWays)  
