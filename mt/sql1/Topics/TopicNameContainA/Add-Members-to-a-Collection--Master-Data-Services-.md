---
title: Add Members to a Collection (Master Data Services)
ms.custom: na
...
# Add Members to a Collection (Master Data Services)
  In [!INCLUDE[ssMDSshort](../../Topics/TopicNameContainA/includes/ssMDSshort_md.md)], you can add leaf and consolidated members to a collection.  
...
-   A collection must exist. For more information, see [Create a Collection &#40;Master Data Services&#41;](../../Topics/TopicNameContainA/Create-a-Collection--Master-Data-Services-.md).  
