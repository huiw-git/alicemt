...
# Create a Master Data Manager Web Application (Master Data Services)
  The [!INCLUDE[ssMDSmdm](../../Token/Other/ssMDSmdm_md.md)] web application provides an interface for users to work with master data and for administrators to configure and administer MDS.  
...
-   Create a new website, which automatically creates a web application.  
 ...
 After you create the web application, you associate it with the [!INCLUDE[ssMDSshort](../../Token/Other/ssMDSshort_md.md)] database.  
...
## To create a Master Data Manager web application in a new website  
 When you create a new website, the root web application is the [!INCLUDE[ssMDSmdm](../../Token/Other/ssMDSmdm_md.md)] web application. The web application is also added to a new application pool.  
  
> [!NOTE]  
>  If you follow this procedure, you cannot specify a virtual path and alias of the [!INCLUDE[ssMDSmdm](../../Token/Other/ssMDSmdm_md.md)] web application. If you want to specify a virtual path and alias for [!INCLUDE[ssMDSmdm](../../Token/Other/ssMDSmdm_md.md)], you must create a web application in an existing website that is not already configured as a [!INCLUDE[ssMDSmdm](../../Token/Other/ssMDSmdm_md.md)] web application.  
  
 Additionally, [!INCLUDE[ssMDScfgmgr](../../Token/Other/ssMDScfgmgr_md.md)] supports creating sites with HTTP bindings only. To add an HTTPS binding, create a new site and application in [!INCLUDE[ssMDScfgmgr](../../Token/Other/ssMDScfgmgr_md.md)] and then see [Secure a Master Data Manager Web Application](../../Topics/TopicNameContainA/Secure-a-Master-Data-Manager-Web-Application.md) for more information.  
...
3.  On the **Web Configuration** page, from the **Website** list, select the website in which you want to create the [!INCLUDE[ssMDSmdm](../../Token/Other/ssMDSmdm_md.md)] web application.  
