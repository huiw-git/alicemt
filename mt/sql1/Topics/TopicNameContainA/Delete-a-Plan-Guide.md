...
---
# Delete a Plan Guide
You can delete (drop) a plan guide in [!INCLUDE[ssCurrent](../../Topics/TopicNameContainA/tokens/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)]. Using [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)], you can also delete all of the plan guides in a database.  
...
3.  Copy and paste the following example into the query window and click **Execute**.  
 ...
 For more information, see [sp_control_plan_guide (Transact-SQL)](assetId:///c96d43d5-6507-4d66-b3f5-f44c0617cb5c).