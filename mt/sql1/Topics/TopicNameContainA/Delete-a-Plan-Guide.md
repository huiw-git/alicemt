...
---
# Delete a Plan Guide
  You can delete \(drop\) a plan guide in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)] or [!INCLUDE[tsql](../../Token/Other/tsql_md.md)]. Using [!INCLUDE[tsql](../../Token/Other/tsql_md.md)], you can also delete all of the plan guides in a database.  
