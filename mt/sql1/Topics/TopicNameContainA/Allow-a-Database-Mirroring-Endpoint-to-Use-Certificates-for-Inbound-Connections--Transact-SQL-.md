...
1.  Create a login for the other system.  
    ...
    ```  
     ...
     To view the logins on this server instance, you can use the following [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statement:  
...
2.  Create a user for that login.  
    ...
    ```  
     ...
     To view the users on this server instance, you can use the following [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statement:  
...
4.  Associate the certificate with the user created in step 2.  
    ...
    ```  
     ...
     To view the certificates on this server instance, use the following [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statement:  
...
5.  Grant CONNECT permission on the login for the remote mirroring endpoint.  
     ...
     For example, to grant permission on HOST_A to the remote server instance on HOST_B to connect to its local login—that is, to connect to `HOST_B_login`—use the following [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] statements:  
