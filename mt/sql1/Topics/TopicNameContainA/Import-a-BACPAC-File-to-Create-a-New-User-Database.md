...
Import a data-tier application (DAC) file – a .bacpac file – to create a copy of the original database, with the data, on a new instance of the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)], or to [!INCLUDE[ssSDSfull](../../Topics/TopicNameContainA/tokens/ssSDSfull_md.md)]. Export-import operations can be combined to migrate a DAC or database between instances, or to create a logical backup, such as creating an on-premise copy of a database deployed in [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/tokens/ssSDS_md.md)].  
...
## Database Options and Settings  
 ...
 Some database options, such as TRUSTWORTHY, DB_CHAINING, and HONOR_BROKER_PRIORITY, cannot be adjusted as part of the import process. Physical properties, such as the number of filegroups, or the numbers and sizes of files cannot be altered as part of the import process. After the import completes, you can use the ALTER DATABASE statement, [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)], or [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)] PowerShell to tailor the database. For more information, see [Databases](../../Topics/TopicNameNotContainA/Databases.md).  
  
## Limitations and Restrictions  
 A DAC can be imported to [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/tokens/ssSDS_md.md)], or an instance of the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/tokens/ssDE_md.md)] running [!INCLUDE[ssVersion2005](../../Topics/TopicNameContainA/tokens/ssVersion2005_md.md)] Service Pack 4 (SP4) or later. If you export a DAC from a higher version, the DAC may contain objects not supported by [!INCLUDE[ssVersion2005](../../Topics/TopicNameContainA/tokens/ssVersion2005_md.md)]. You cannot deploy those DACs to instances of [!INCLUDE[ssVersion2005](../../Topics/TopicNameContainA/tokens/ssVersion2005_md.md)].  
...
1.  Connect to the instance of [!INCLUDE[ssNoVersion](../../Topics/TopicNameContainA/tokens/ssNoVersion_md.md)], whether on-premise or in [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/tokens/ssSDS_md.md)].  
...
-   **Edition of [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/tokens/ssSDS_md.md)]** – Specify [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/tokens/ssSDS_md.md)] Business or [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/tokens/ssSDS_md.md)] Web. For more information about editions of [!INCLUDE[ssSDS](../../Topics/TopicNameContainA/tokens/ssSDS_md.md)], see this [SQL Database](http://www.windowsazure.com/home/tour/database/) web site.  
