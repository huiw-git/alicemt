...
# Export a Policy-Based Management Policy
  This topic describes how to export a Policy\-Based Management policy in [!INCLUDE[ssCurrent](../../Token/Other/ssCurrent_md.md)] by using [!INCLUDE[ssManStudioFull](../../Token/Other/ssManStudioFull_md.md)].  
