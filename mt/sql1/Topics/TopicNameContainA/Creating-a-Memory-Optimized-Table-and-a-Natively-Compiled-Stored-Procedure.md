...
-   Create natively compiled stored procedures to access data in memory-optimized tables. For more information, see [CREATE PROCEDURE &#40;Transact-SQL&#41;](../Topic/CREATE%20PROCEDURE%20\(Transact-SQL\).md). You can also use a traditional, interpreted [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] to access data in memory-optimized tables.  
  
-   As needed, migrate data from existing tables to memory-optimized tables.  
  
 For information on how to use [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/includes/ssManStudioFull_md.md)] to create memory-optimized tables, see [SQL Server Management Studio Support for In-Memory OLTP](../../Topics/TopicNameNotContainA/SQL-Server-Management-Studio-Support-for-In-Memory-OLTP.md).  
