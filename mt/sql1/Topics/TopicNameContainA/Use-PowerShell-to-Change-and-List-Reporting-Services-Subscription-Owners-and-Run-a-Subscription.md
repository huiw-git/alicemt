---
title: "Use PowerShell to Change and List Reporting Services Subscription Owners and Run a Subscription"
ms.custom: na
ms.date: 06/29/2016
...
# Use PowerShell to Change and List Reporting Services Subscription Owners and Run a Subscription
  Starting with [!INCLUDE[ssKilimanjaro](../../Topics/TopicNameContainA/tokens/ssKilimanjaro_md.md)][!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] you can programmatically transfer the ownership of a [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] subscription from one user to another. This topic provides several Windows PowerShell scripts you can use to change or simply list subscription ownership. Each sample includes sample syntax for both Native mode and SharePoint mode. After you change the subscription owner, the subscription will then execute in the security context of the new owner, and the User!UserID field in the report will display the value of new owner. For more information on the object model the PowerShell samples call, see [ChangeSubscriptionOwner](assetId:///M:ReportService2010.ReportingService2010.ChangeSubscriptionOwner(System.String,System.String))  
...
### Permissions  
 This section summarizes the permission levels required to use each of the methods for both Native and SharePoint mode [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)]. The scripts in this topic use the following [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)] methods:  
...
-   List Subscriptions: [ReportOperation Enumeration](../Topic/ReportOperation%20Enumeration.md) on the report AND the user is the subscription owner) OR ReadAnySubscription.  
 ...
 **Tested environments**  
 ...
 The scripts in this topic were tested on PowerShell version 3 and with the following versions of [!INCLUDE[ssRSnoversion](../../Topics/TopicNameContainA/tokens/ssRSnoversion_md.md)]:  
...
##  <a name="bkmk_run_1_subscription"></a> Script: Run (fire) a single subscription  
 ...
 For more information on the configuration file, see [RsReportServer.config Configuration File](../../Topics/TopicNameNotContainA/RsReportServer.config-Configuration-File.md).  
...
## See Also  
 [ListSubscriptions](assetId:///M:ReportService2010.ReportingService2010.ListSubscriptions(System.String))   
 ...
 [ListChildren](assetId:///M:ReportService2010.ReportingService2010.ListChildren(System.String,System.Boolean))   
 [FireEvent](assetId:///M:ReportService2010.ReportingService2010.FireEvent(System.String,System.String,System.String))  
