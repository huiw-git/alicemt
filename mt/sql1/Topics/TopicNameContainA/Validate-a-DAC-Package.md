...
-   View the contents of the [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] scripts by opening them in the [!INCLUDE[ssDE](../../Topics/TopicNameContainA/includes/ssDE_md.md)] Query Editor in [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/includes/ssManStudio_md.md)].  
...
##  <a name="ViewUpgradeActions"></a> View Upgrade Actions  
 Before using a new version of a DAC package to upgrade a DAC that was deployed from an earlier DAC package, you can generate a report that contains the [!INCLUDE[tsql](../../Topics/TopicNameContainA/includes/tsql_md.md)] statements that will be run during the upgrade, and then review the statements.  
