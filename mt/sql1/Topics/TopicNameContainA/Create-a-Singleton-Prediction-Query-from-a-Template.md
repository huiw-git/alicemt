...
```  
 ...
 The procedure that follows describes how to use the Template Explorer in [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] to quickly create this query.  
...
3.  In the **Connect to Analysis Services** dialog box, type the name of the server that has the instance of [!INCLUDE[ssASnoversion](../../Topics/TopicNameContainA/tokens/ssASnoversion_md.md)] that contains the mining model to be queried.  
...
## See Also  
 [Creating Predictions (Data Mining Tutorial)](assetId:///a8410ed2-bb98-4d51-a9eb-b239be1201c2)