...
A database may need to perform either an insert of an update, depending on whether a particular row already exists in the database.  
 ...
 Without using the **MERGE** statement, the following is one approach you can use in [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)]:  
...
```  
 ...
 Another [!INCLUDE[tsql](../../Topics/TopicNameContainA/tokens/tsql_md.md)] method to implement a merge:  
