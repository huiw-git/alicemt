...
# Correlate a Trace with Windows Performance Log Data (SQL Server Profiler)
  [!INCLUDE[ssSqlProfiler](../../Token/Other/ssSqlProfiler_md.md)] can correlate Microsoft Windows System Monitor counters with [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] or [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] [!INCLUDE[ssASnoversion](../../Token/Other/ssASnoversion_md.md)] events. Windows System Monitor logs system activity for specified counters in performance logs.  
...
1.  In [!INCLUDE[ssSqlProfiler](../../Token/Other/ssSqlProfiler_md.md)], open a saved trace file or trace table. You cannot correlate a running trace that is still collecting event data. For accurate correlation with System Monitor data, the trace must contain both **StartTime** and **EndTime** data columns.  
  
2.  On the [!INCLUDE[ssSqlProfiler](../../Token/Other/ssSqlProfiler_md.md)] **File** menu, click **Import Performance Data**.  
...
5.  In the **Performance object** list, select a performance object you want to monitor. The names of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] performance objects for default instances of [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] start with [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] and named instances start with MSSQL$*instanceName*.  
  
6.  Add as many counters as necessary for your [!INCLUDE[ssNoVersion](../../Token/Other/ssNoVersion_md.md)] instance and other important values, such as processor time and disk time.  
