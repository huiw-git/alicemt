...
# Manage a Knowledge Base
  This topic describes how to perform management functions on a knowledge base in [!INCLUDE[ssDQSnoversion](../../Token/Other/ssDQSnoversion_md.md)] \(DQS\). You can delete a knowledge base, unlock it, discard your work on it, rename it, and display its properties.  
...
####  <a name="Permissions"></a> Permissions  
 You must have the dqs\_kb\_editor role or the dqs\_administrator on the DQS\_MAIN database to open a knowledge base.  
...
2.  In the [!INCLUDE[ssDQSClient](../../Token/Other/ssDQSClient_md.md)] home screen, click **Open knowledge base**.  
...
4.  In the context menu, you can do the following:  
    ...
    5.  **Delete**: Click to remove the knowledge base from the DQS\_MAIN database on [!INCLUDE[ssDQSServer](../../Token/Other/ssDQSServer_md.md)].  
