...
1.  Execute **fn\_trace\_getinfo** by specifying the ID of the trace about which information is needed. This function returns a table that lists the trace, trace property, and information about the property.  
...
1.  Execute **fn\_trace\_getinfo** by specifying `0` or `default`. This function returns a table that lists all the traces, their properties, and information about these properties.  
...
## .NET Framework Security  
 To run the built\-in function **fn\_trace\_getinfo**, the user needs the following permission:  
