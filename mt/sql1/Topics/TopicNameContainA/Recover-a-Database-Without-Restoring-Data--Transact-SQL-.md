 ...
 **Example**  
 ...
 The following example recovers the [!INCLUDE[ssSampleDBobject](../../Topics/TopicNameContainA/tokens/ssSampleDBobject_md.md)] sample database in a restore operation without restoring data.  
