...
You can move a Resource Governor workload group to a different resource pool by using either [!INCLUDE[ssManStudioFull](../../Topics/TopicNameContainA/tokens/ssManStudioFull_md.md)] or Transact-SQL.  
...
###  <a name="LimitationsRestrictions"></a> Limitations and Restrictions  
 You cannot move a workload group if there is a pending Resource Governor configuration operation. You can determine whether there is a configuration pending by querying the [sys.dm_resource_governor_configuration](assetId:///c89aab6a-0434-4ce6-af8c-f8a1a3284e38) dynamic management view to get the current status of is_configuration_pending.  
 ...
 **To move a workload group by using [!INCLUDE[ssManStudio](../../Topics/TopicNameContainA/tokens/ssManStudio_md.md)]**  
