...
These procedures describe how to add, delete, and change the scope of a user-defined variable in a package by using the **Variables** window.  
 ...
 [!INCLUDE[ssISnoversion](../../Topics/TopicNameContainA/tokens/ssISnoversion_md.md)] also provides system variables that make system information available at run time and can be used in containers such as packages and event handlers. You cannot delete system variables.  
