...
Use the **Specify a Unary Operator** page to select a dimension that has a parent attribute defined and to which the Business Intelligence Wizard will apply unary operators. For more information about parent attributes, see [Dimension Designer (Analysis Services - Multidimensional Data)](assetId:///59de1ea2-e7a9-4a53-9ee0-14be52e95643).  
