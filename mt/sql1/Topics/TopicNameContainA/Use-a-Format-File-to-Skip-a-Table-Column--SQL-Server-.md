...
## Sample Table and Data File  
 The following examples require a table named `myTestSkipCol` in the [!INCLUDE[ssSampleDBnormal](../../Topics/TopicNameContainA/tokens/ssSampleDBnormal_md.md)] sample database under the **dbo** schema. Create this table as follows:  
...
>  You might have to specify the name of the server instance to which you are connecting. Also, you might have to specify the user name and password. For more information, see [bcp Utility](../../Topics/TopicNameNotContainA/bcp-Utility.md).  
 ...
 ![default non&#45;XML format file for myTestSkipCol](../../Topics/TopicNameContainA/images/myTestSkipCol-f-c_DEFAULT_fmt.gif "myTestSkipCol-f-c_DEFAULT_fmt")  
