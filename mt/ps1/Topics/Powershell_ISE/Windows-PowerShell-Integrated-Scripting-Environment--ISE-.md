...
-   **Brace matching**. The ISE[!INCLUDE[ise_2](../../Tokens/ise_2_md.md)] highlights matching braces to help you ensure you have the right number of closing braces to match your opening ones. Use CTRL\-\[ to locate the closing brace that matches the opening brace that the cursor is on.
...
> [!NOTE]
> Because [!INCLUDE[ise_2](../../Tokens/ise_2_md.md)] requires a graphical user interface, you can’t run it on the Server Core option of Windows Server.
